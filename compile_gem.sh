...
make clean
qmk compile --compiledb -c -j 0 -e TARGET="wired_via_$TAG" -kb nuphy/gem80/ansi -km via

echo "[default] Compiling for wired"
make clean
qmk compile --compiledb -c -j 0 -e TARGET="wired_default_$TAG" -kb nuphy/gem80/ansi -km default
...
make clean
qmk compile --compiledb -c -j 0 -e TARGET="threemode_via_$TAG" -kb nuphy/gem80/ansi -km via

echo "[default] Compiling for three-mode"
make clean
qmk compile --compiledb -c -j 0 -e TARGET="threemode_default_$TAG" -kb nuphy/gem80/ansi -km default
