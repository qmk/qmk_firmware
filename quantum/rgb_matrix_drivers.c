...
#if defined(IS31FL3731) || defined(IS31FL3733) || defined(IS31FL3737) || defined(IS31FL3741) || defined(IS31FL3236)
...
#    else
static void flush(void) { IS31FL3236_update_pwm_buffers(DRIVER_ADDR_1); }
