...
#define SQ_T(n) (n < SEQUENCER_TRACKS ? SEQUENCER_TRACK_MIN + n : KC_NO)
    ...
    DZ_POINTER_CENTER,
    DZ_POINTER_TOP_LEFT,
    DZ_POINTER_TOP_RIGHT,
    DZ_POINTER_BOTTOM_LEFT,
    DZ_POINTER_BOTTOM_RIGHT,
    DZ_POINTER_USER0,
    DZ_POINTER_USER1,
    DZ_POINTER_USER2,
    DZ_POINTER_USER3,
...
// Digitizer aliases
#define DZ_TIP1 DZ_TIP_PRIMARY
#define DZ_TIP2 DZ_TIP_SECONDARY
#define DZ_BAR1 DZ_BARREL_PRIMARY
#define DZ_BAR2 DZ_BARREL_SECONDARY
#define DZ_PICK DZ_TABLET_PICK
#define DZ_INVT DZ_INVERT
#define DZ_ERSR DZ_ERASER
#define DZ_P_C  DZ_POINTER_CENTER
#define DZ_P_TL DZ_POINTER_TOP_LEFT
#define DZ_P_TR DZ_POINTER_TOP_RIGHT
#define DZ_P_BL DZ_POINTER_BOTTOM_LEFT
#define DZ_P_BR DZ_POINTER_BOTTOM_RIGHT
#define DZ_P_U0 DZ_POINTER_USER0
#define DZ_P_U1 DZ_POINTER_USER1
#define DZ_P_U2 DZ_POINTER_USER2
#define DZ_P_U3 DZ_POINTER_USER3

#define DZ_BUTTON_MIN DZ_TIP_PRIMARY
#define DZ_BUTTON_MAX DZ_ERASER
#define DZ_POINTER_MIN DZ_POINTER_CENTER
#define DZ_POINTER_MAX DZ_POINTER_USER3
#define DZ_CODE_MIN DZ_BUTTON_MIN
#define DZ_CODE_MAX DZ_POINTER_MAX
