...
#define SQ_T(n) (n < SEQUENCER_TRACKS ? SEQUENCER_TRACK_MIN + n : KC_NO)
    ...
    KC_PROGRAMMABLE_BUTTON1,
    KC_PROGRAMMABLE_BUTTON2,
    KC_PROGRAMMABLE_BUTTON3,
    KC_PROGRAMMABLE_BUTTON4,
    KC_PROGRAMMABLE_BUTTON5,
    KC_PROGRAMMABLE_BUTTON6,
    KC_PROGRAMMABLE_BUTTON7,
    KC_PROGRAMMABLE_BUTTON8,
    KC_PROGRAMMABLE_BUTTON9,
    KC_PROGRAMMABLE_BUTTON10,
    KC_PROGRAMMABLE_BUTTON11,
    KC_PROGRAMMABLE_BUTTON12,
    KC_PROGRAMMABLE_BUTTON13,
    KC_PROGRAMMABLE_BUTTON14,
    KC_PROGRAMMABLE_BUTTON15,
    KC_PROGRAMMABLE_BUTTON16,
    KC_PROGRAMMABLE_BUTTON17,
    KC_PROGRAMMABLE_BUTTON18,
    KC_PROGRAMMABLE_BUTTON19,
    KC_PROGRAMMABLE_BUTTON20,
    KC_PROGRAMMABLE_BUTTON21,
    KC_PROGRAMMABLE_BUTTON22,
    KC_PROGRAMMABLE_BUTTON23,
    KC_PROGRAMMABLE_BUTTON24,
    KC_PROGRAMMABLE_BUTTON25,
    KC_PROGRAMMABLE_BUTTON26,
    KC_PROGRAMMABLE_BUTTON27,
    KC_PROGRAMMABLE_BUTTON28,
    KC_PROGRAMMABLE_BUTTON29,
    KC_PROGRAMMABLE_BUTTON30,
    KC_PROGRAMMABLE_BUTTON31,
    KC_PROGRAMMABLE_BUTTON32,
...
#define KC_PROGRAMMABLE_BUTTON_MIN KC_PROGRAMMABLE_BUTTON1
#define KC_PROGRAMMABLE_BUTTON_MAX KC_PROGRAMMABLE_BUTTON32
