...
_Static_assert(KC_TRANSPARENT == 1, "");
...
_Static_assert(KC_BACKSPACE == 0x2A, "");
_Static_assert(KC_TAB == 0x2B, "");
_Static_assert(KC_SPACE == 0x2C, "");
_Static_assert(KC_MINUS == 0x2D, "");
_Static_assert(KC_EQUAL == 0x2E, "");
_Static_assert(KC_LEFT_BRACKET == 0x2F, "");
_Static_assert(KC_RIGHT_BRACKET == 0x30, "");
_Static_assert(KC_BACKSLASH == 0x31, "");
_Static_assert(KC_SEMICOLON == 0x33, "");
...
_Static_assert(KC_CAPS_LOCK == 0x39, "");
...
_Static_assert(KC_LEFT_CTRL == 0xE0, "");
_Static_assert(KC_LEFT_SHIFT == 0xE1, "");
_Static_assert(KC_LEFT_ALT == 0xE2, "");
_Static_assert(KC_LEFT_GUI == 0xE3, "");
_Static_assert(KC_RIGHT_CTRL == 0xE4, "");
_Static_assert(KC_RIGHT_SHIFT == 0xE5, "");
_Static_assert(KC_RIGHT_ALT == 0xE6, "");
_Static_assert(KC_RIGHT_GUI == 0xE7, "");
...
_Static_assert(KC_NONUS_BACKSLASH == 0x64, "");
_Static_assert(KC_INTERNATIONAL_1 == 0x87, "");
_Static_assert(KC_INTERNATIONAL_2 == 0x88, "");
_Static_assert(KC_INTERNATIONAL_3 == 0x89, "");
_Static_assert(KC_INTERNATIONAL_4 == 0x8A, "");
_Static_assert(KC_INTERNATIONAL_5 == 0x8B, "");
_Static_assert(KC_LANGUAGE_1 == 0x90, "");
_Static_assert(KC_LANGUAGE_2 == 0x91, "");
...
_Static_assert(KC_KB_POWER == 102, "");
_Static_assert(KC_MENU == 118, "");
_Static_assert(KC_KP_EQUAL_AS400 == 134, "");
_Static_assert(KC_INTERNATIONAL_6 == 140, "");
_Static_assert(KC_INTERNATIONAL_7 == 141, "");
_Static_assert(KC_INTERNATIONAL_8 == 142, "");
_Static_assert(KC_INTERNATIONAL_9 == 143, "");
_Static_assert(KC_LANGUAGE_3 == 146, "");
_Static_assert(KC_LANGUAGE_4 == 147, "");
_Static_assert(KC_LANGUAGE_5 == 148, "");
_Static_assert(KC_LANGUAGE_6 == 149, "");
_Static_assert(KC_LANGUAGE_7 == 150, "");
_Static_assert(KC_LANGUAGE_8 == 151, "");
_Static_assert(KC_LANGUAGE_9 == 152, "");
_Static_assert(KC_ERASE == 153, "");
_Static_assert(KC_SYSTEM_REQUEST == 154, "");
