...
#define RGBLED_BREATHING_INTERVAL_BASE
...
#define RGBLED_RAINBOW_MOOD_INTERVAL_BASE
...
#define RGBLED_RAINBOW_SWIRL_INTERVAL_BASE
...
#define RGBLED_SNAKE_INTERVAL_BASE
...
#define RGBLED_KNIGHT_INTERVAL_BASE
...
typedef union {
  uint32_t raw;
  struct {
    uint8_t breathing_interval :5;
    uint8_t rainbow_mood_interval :5;
    uint8_t rainbow_swirl_interval :5;
    uint8_t snake_interval :5;
    uint8_t knight_interval :5;
  };
} interval_config_t;
