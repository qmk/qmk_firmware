...
#define IS_CONNECTION_KEYCODE(code) ((code) >= QK_OUTPUT_AUTO && (code) <= QK_2P4GHZ_UNPAIR)
...
#define CONNECTION_KEYCODE_RANGE            QK_OUTPUT_AUTO ... QK_2P4GHZ_UNPAIR
