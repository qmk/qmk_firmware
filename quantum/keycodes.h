...
#define IS_CONSUMER_KEYCODE(code) ((code) >= KC_AUDIO_MUTE && (code) <= KC_DO_NOT_DISTURB)
...
#define CONSUMER_KEYCODE_RANGE              KC_AUDIO_MUTE ... KC_DO_NOT_DISTURB
