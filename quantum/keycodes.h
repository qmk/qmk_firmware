...
// Keycodes
    ...
    MAGIC_CAPSLOCK_TO_CONTROL = 0x7001,
    MAGIC_SWAP_LALT_LGUI = 0x7002,
    MAGIC_SWAP_RALT_RGUI = 0x7003,
    MAGIC_NO_GUI = 0x7004,
    MAGIC_SWAP_GRAVE_ESC = 0x7005,
    MAGIC_SWAP_BACKSLASH_BACKSPACE = 0x7006,
    MAGIC_HOST_NKRO = 0x7007,
    MAGIC_SWAP_ALT_GUI = 0x7008,
    MAGIC_UNSWAP_CONTROL_CAPSLOCK = 0x7009,
    MAGIC_UNCAPSLOCK_TO_CONTROL = 0x700A,
    MAGIC_UNSWAP_LALT_LGUI = 0x700B,
    MAGIC_UNSWAP_RALT_RGUI = 0x700C,
    MAGIC_UNNO_GUI = 0x700D,
    MAGIC_UNSWAP_GRAVE_ESC = 0x700E,
    MAGIC_UNSWAP_BACKSLASH_BACKSPACE = 0x700F,
    MAGIC_UNHOST_NKRO = 0x7010,
    MAGIC_UNSWAP_ALT_GUI = 0x7011,
    MAGIC_TOGGLE_NKRO = 0x7012,
    MAGIC_TOGGLE_ALT_GUI = 0x7013,
    MAGIC_SWAP_LCTL_LGUI = 0x7014,
    MAGIC_SWAP_RCTL_RGUI = 0x7015,
    MAGIC_UNSWAP_LCTL_LGUI = 0x7016,
    MAGIC_UNSWAP_RCTL_RGUI = 0x7017,
    MAGIC_SWAP_CTL_GUI = 0x7018,
    MAGIC_UNSWAP_CTL_GUI = 0x7019,
    MAGIC_TOGGLE_CTL_GUI = 0x701A,
    MAGIC_EE_HANDS_LEFT = 0x701B,
    MAGIC_EE_HANDS_RIGHT = 0x701C,
    MAGIC_TOGGLE_GUI = 0x701D,
    MAGIC_TOGGLE_CONTROL_CAPSLOCK = 0x701E,
    MAGIC_SWAP_ESCAPE_CAPSLOCK = 0x701F,
    MAGIC_UNSWAP_ESCAPE_CAPSLOCK = 0x7020,
    MAGIC_TOGGLE_ESCAPE_CAPSLOCK = 0x7021,
    MAGIC_TOGGLE_BACKSLASH_BACKSPACE = 0x7022,
    MI_ON = 0x7100,
    MI_OFF = 0x7101,
    MI_TOG = 0x7102,
    MI_C = 0x7110,
...
#define IS_MAGIC_KEYCODE(code) ((code) >= MAGIC_SWAP_CONTROL_CAPSLOCK && (code) <= MAGIC_TOGGLE_BACKSLASH_BACKSPACE)
