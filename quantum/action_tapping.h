...
#ifdef TAP_FLOW_TERM
/**
 * Callback to specify the keys where Tap Flow is enabled.
 *
 ...
 * it. If the callback returns true for both keycodes, Tap Flow is enabled.
 *
...
/**
 * Callback to customize Tap Flow filtering.
 *
