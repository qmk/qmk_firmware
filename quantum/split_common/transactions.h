...
typedef void (*slave_callback_t)(uint8_t initiator2target_buffer_size, const volatile void *initiator2target_buffer, uint8_t target2initiator_buffer_size, volatile void *target2initiator_buffer);
