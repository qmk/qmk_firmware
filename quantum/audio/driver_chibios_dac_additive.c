...
static const dacsample_t dac_buffer_square[DAC_BUFFER_SIZE] = {
    [0 ... DAC_BUFFER_SIZE / 2 - 1]               = 0,              // first and
    [DAC_BUFFER_SIZE / 2 ... DAC_BUFFER_SIZE - 1] = DAC_SAMPLE_MAX, // second half
};
