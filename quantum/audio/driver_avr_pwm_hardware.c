...
/*
  ...
  the primary channel_1 can be connected to either pin PC4 PC5 or PC6 (the later beeing used by most AVR based keyboards) with a PMW signal generated by timer3
