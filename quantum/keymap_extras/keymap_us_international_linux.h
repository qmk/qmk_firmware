...
#define QMK_US_INTERNATIONAL_LINUX_KEYCODES_MAJOR 0
#define QMK_US_INTERNATIONAL_LINUX_KEYCODES_MINOR 0
#define QMK_US_INTERNATIONAL_LINUX_KEYCODES_PATCH 1
