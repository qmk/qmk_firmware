...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_65_ansi_blocker(
        ...
        KC_VOLU,          _______, _______, KC_CALC, _______, _______, KC_NLCK, KC_MAIL, _______, _______, KC_MSTP, KC_PAUS, _______, _______,
        KC_VOLD, KC_MRWD, KC_MFFD,                            KC_MPLY,                   _______, _______,          KC_MPRV, _______, KC_MNXT
    )
};
