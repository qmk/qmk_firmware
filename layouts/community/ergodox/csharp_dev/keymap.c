...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_RPRN,        KC_Q,         KC_W,   KC_E,   KC_R,   KC_T,   KC_BSPC,
...
[FKEYS] = LAYOUT_ergodox(
       ...
       KC_TRNS,KC_TRNS,KC_TRNS,M(MACRO_VOID),M(MACRO_BOOL),M(MACRO_BREAK),KC_BSLS,
       ...
       KC_TILD, M(MACRO_PARENTHESE), KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_TRNS, KC_TRNS,
                         KC_PGUP,KC_PGDN,  KC_INSERT,   KC_PSCR,  KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
