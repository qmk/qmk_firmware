...
La touche "Esc", placée en bas à gauche, agit aussi comme une touche "Ctrl" lorsqu'elle est maintenue et simule alors temporairement un clavier QWERTY. De cette façon, il devient possible d'utiliser des raccourcis clavier pratiques (couper, copier, coller...) comme sur un système QWERTY avec la touche la plus en bas à gauche du clavier et les lettres X, C, V... telles qu'elles seraient placées sur un clavier QWERTY. Par exemple, "Esc" + "x" (BÉPO) seront traduits en "Ctrl" + "c". Toutes les lettres du clavier QWERTY sont supportées et les raccourcis courants (couper, copier, coller, sélectionner tous, annuler) deviennent accessibles d'une main et permettent de garder la main droite libre pour la souris.
