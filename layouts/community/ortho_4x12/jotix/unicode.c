...
#define UN_S    XP(DBOX_CORNER_1, DBOX_UNION_1)
#define UN_D    XP(DBOX_CORNER_2, DBOX_UNION_2)
#define UN_F    XP(DBOX_CORNER_3, DBOX_UNION_3)
#define UN_G    XP(DBOX_CORNER_4, DBOX_UNION_4)
#define UN_H    XP(BOX_CORNER_1, BOX_UNION_1)
#define UN_J    XP(BOX_CORNER_2, BOX_UNION_2)
#define UN_K    XP(BOX_CORNER_3, BOX_UNION_3)
#define UN_L    XP(BOX_CORNER_4, BOX_UNION_4)
#define UN_SCLN XP(BOX_HORIZONTAL, DBOX_HORIZONT)
#define UN_QUOT XP(BOX_VERTICAL, DBOX_VERTICAL)
#define UN_Z    XP(SQUARE_ROOT, CUBE_ROOT)
