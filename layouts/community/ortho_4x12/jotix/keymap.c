 ...
 * +--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
 * |  lctrl |  lalt  |  lower |unicode |  lgui  |  space |  space |   fn   |   del  |  left  |  down  |  right | 
 * +--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
 */
[_QWERTY] = LAYOUT_ortho_4x12 ( 
    ...
    KC_LCTL, KC_LALT, LOWER,   UNICODE, KC_LGUI, KC_SPC,  KC_SPC,  RAISE,   KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT
),
 ...
 * |        |   F1   |   F2   |   F3   |   F4   |        |        |    7   |    8   |    9   |    -   |        |
 * +--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
 * |        |   F5   |   F6   |   F7   |   F8   |        |        |    4   |    5   |    6   |    +   | penter |
 * +--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
 * |        |   F9   |   F10  |   F11  |   F12  |        |  nmlck |    1   |    2   |    3   |    *   |    /   |
 * +--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
 * |        |        |        |        |        |        |        |        |    0   |    .   |    (   |    )   |
 * +--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
 */
[_LOWER] = LAYOUT_ortho_4x12 (
    ...
    _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, _______, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, KC_PENT,
    _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_NLCK, KC_P1,   KC_P2,   KC_P3,   KC_PAST, KC_PSLS,
...
[_RAISE] = LAYOUT_ortho_4x12 (
    ...
    _______, _______, _______, _______, _______, _______, KC_MINS, KC_EQL,  _______, _______, KC_PGUP, _______,
...
[_UNICODE] = LAYOUT_ortho_4x12 ( 
    ...
    _______, X(DIZY), X(ANGR), X(COPY), X(QUAD), X(CUBE), N_UNIC,  X(NEUT), X(LDQU), X(RDQU), X(ARRU), X(QUES),
    _______, _______, _______, _______, _______, _______, _______, _______, _______, X(ARRL), X(ARRD), X(ARRR)
),
