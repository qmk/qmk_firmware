...
[UNICODE] = LAYOUT_ortho_4x12(
    _______, _______,      _______, UM(EUR), _______, _______, _______, XP(SUE, BUE), _______, XP(SOE, BOE), _______, _______,
    _______, XP(SAE, BAE), UM(SS),  _______, _______, _______, _______, _______,      _______, _______,      _______, _______,
