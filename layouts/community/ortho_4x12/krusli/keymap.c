...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  KC_PSCR, KC_LCTL, KC_LGUI, KC_LALT, MO(_LOWER), KC_SPC,  KC_SPC,  MO(_RAISE), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  _______, RGB_SAD, RGB_SAI, RGB_HUI, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  _______, KC_MRWD, KC_MPLY, KC_MNXT, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
),
