...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [4] = LAYOUT_split_3x5_3(
        ...
        KC_A,         KC_R, KC_S,                          KC_T,    KC_D,           KC_H,          KC_N,          KC_E,                         KC_I,   KC_O,
        LSFT_T(KC_Z), KC_X, KC_C,                          KC_V,    KC_B,           KC_K,          KC_M,          KC_COMMA,                     KC_DOT, RSFT_T(KC_SLSH),
                            TD(TD_LALT_ESC_WINDOWS_EMOJI), KC_LALT, LCTL_T(KC_SPC), LT(6, KC_TAB), LT(7, KC_ENT), TD(TD_LALT_ESC_WINDOWS_EMOJI)
    ),
    [5] = LAYOUT_split_3x5_3(
        KC_Q, KC_W, KC_F, KC_P,                          KC_G,    KC_J,   KC_L,          KC_U,          KC_Y,                         KC_BSPC,
        KC_A, KC_R, KC_S, KC_T,                          KC_D,    KC_H,   KC_N,          KC_E,          KC_I,                         KC_O,
        KC_Z, KC_X, KC_C, KC_V,                          KC_B,    KC_K,   KC_M,          KC_COMMA,      KC_DOT,                       KC_SLSH,
                          TD(TD_LALT_ESC_WINDOWS_EMOJI), KC_LCTL, KC_SPC, LT(6, KC_TAB), LT(7, KC_ENT), TD(TD_LALT_ESC_WINDOWS_EMOJI)
    ),
