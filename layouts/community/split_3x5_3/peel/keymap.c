...
// http://www.keyboard-layout-editor.com/#/gists/c5b045c538d84c5df37c1fc0fe485e2a
  ...
  // |------+------+------+------+------+------+------+------+------+------+------+------|
  // |      |  GUI |  Alt |  Esc | Space|  Tab | Bksp |  Ent | Left | Down |  Up  | Right|
  // `-----------------------------------------------------------------------------------'

  [_COLEMAK] = LAYOUT_split_3x5_3( \
    KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,      KC_J,     KC_L,    KC_U,    KC_Y,   KC_SCLN, \
    HOME_A,  HOME_R,  HOME_S,  HOME_T,  KC_G,      KC_M,     HOME_N,  HOME_E,  HOME_I, HOME_O,  \
    KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,      KC_K,     KC_H,    KC_COMM, KC_DOT, TD_QUOT, \
                      LT_ESC,  TD_SPC,  CTL_TAB,   CTL_BSPC, TD_ENT,  LT_LEFT                   \
  ),
...
// http://www.keyboard-layout-editor.com/#/gists/79cdc09e5317d5ea0d84809c49fe9465
  ...
  [_LCOLEMAK] = LAYOUT_split_3x5_3( \
    S(KC_Q), S(KC_W), S(KC_F), S(KC_P), S(KC_B),   S(KC_J),  S(KC_L), S(KC_U), S(KC_Y), TD_COLN, \
    S(KC_A), S(KC_R), S(KC_S), S(KC_T), S(KC_G),   S(KC_M),  S(KC_N), S(KC_E), S(KC_I), S(KC_O), \
    S(KC_Z), S(KC_X), S(KC_C), S(KC_D), S(KC_V),   S(KC_K),  S(KC_H), KC_SLSH, KC_QUES, TD_DQOT, \
                      LT_ESC,  ___x___, CTL_TAB,   CTL_BSPC, KC_MINS, PS_LEFT                    \
  ),
  ...
  [_RCOLEMAK] = LAYOUT_split_3x5_3( \
    S(KC_Q), S(KC_W), S(KC_F), S(KC_P), S(KC_B),           S(KC_J),  S(KC_L), S(KC_U), S(KC_Y), TD_COLN, \
    S(HOME_A), S(HOME_R), S(HOME_S), S(HOME_T), S(KC_G),   S(KC_M), S(HOME_N), S(HOME_E), S(HOME_I), S(HOME_O), \
    S(KC_Z), S(KC_X), S(KC_C), S(KC_D), S(KC_V),           S(KC_K),  S(KC_H), TD_TILD, TD_GRV,  TD_DQOT, \
                      LT_ESC,  KC_UNDS, CTL_TAB,           CTL_BSPC, ___x___, PS_LEFT  \
  ),
...
// http://www.keyboard-layout-editor.com/#/gists/5e11e5e90ee2b40cb5caf0f9231f23f7
  ...
  [_NUMBER] = LAYOUT_split_3x5_3( \
    _______, _______, OS_CALT, _______, _______,  _______, KC_7,    KC_8,    KC_9,    KC_SLSH, \
    OS_CTL,  OS_GUI,  OS_ALT,  TD_SHEX, _______,  _______, KC_4,    KC_5,    KC_6,    KC_ASTR, \
    _______, _______, OS_SALT, _______, _______,  _______, KC_1,    KC_2,    KC_3,    KC_MINS, \
                      ___x___, ___x___, ___x___,  KC_EQL,  LT_0,    KC_PLUS \
  ),
  ...
  [_NUMSYM] = LAYOUT_split_3x5_3( \
    _______, _______, _______, ___x___, _______,  _______, KC_AMPR, KC_TILD, KC_QUES, KC_COLN, \
    ___x___, ___x___, ___x___, ___x___, _______,  KC_GT  , KC_DLR,  KC_PERC, KC_CIRC, KC_PIPE, \
    _______, _______, _______, ___x___, _______,  KC_LT  , KC_EXLM, KC_AT,   KC_HASH, KC_X   , \
                      ___x___, ___x___, ___x___,  KC_SPC,  KC_BSLS, ___x___  \
  ),
...
// http://www.keyboard-layout-editor.com/#/gists/475b46cf0546fd102b5d7cb729c490a6
  ...
  [_SYMBOL] = LAYOUT_split_3x5_3( \
    TD_LCBR, KC_DOT,  KC_ASTR, KC_AMPR, KC_RCBR,  _______, KC_HOME, KC_UP,   KC_END,  KC_PGUP, \
    TD_LPRN, PS_CIRC, PS_PERC, PS_DLR,  KC_RPRN,  _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, \
    TD_LBRC, KC_HASH, KC_AT,   KC_EXLM, KC_RBRC,  _______, _______, TD_LT,   TD_GT,   _______, \
                      ___x___, LT_BSLS, PS_PIPE,  ___x___, ___x___, ___x___ \
  ),
...
// http://www.keyboard-layout-editor.com/#/gists/863abbf3ae716a267b60337a953588d5
  ...
  [_MOUSE] = LAYOUT_split_3x5_3( \
    ...
    _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, \
                      _______, _______, ___x___,  _______, _______, ___x___                    \
  ),
...
// http://www.keyboard-layout-editor.com/#/gists/08f08c811c7dc502617f0758bce59bf6
  ...
  [_ADJUST] = LAYOUT_split_3x5_3( \
    _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, \
    AU_ON,   BACKLIT, _______, _______, _______,  _______, _______, _______, _______, _______, \
    RESET,   _______, _______, _______, _______,  _______, _______, _______, _______, _______, \
                      _______, ___x___, _______,  _______, ___x___, _______  \
                                 )
};
