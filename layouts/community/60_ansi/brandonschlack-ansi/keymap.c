...
[_BASE] = LAYOUT_60_ansi( \
    ...
    KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             MM_RGPY, MT_RALT, MT_RFDN, MT_RCRT  \
),
 ...
 * ├──────┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴────────┤
 * │        │LYR│Thm│   │   │RST│   │Mte│Prv│Nxt│PgD│   MteSft │
 * ├────┬───┴┬──┴─┬─┴───┴───┴───┴───┴───┴──┬┴───┼───┴┬────┬────┤
 * │    │    │    │                        │    │    │    │    │
 * └────┴────┴────┴────────────────────────┴────┴────┴────┴────┘
 */
[_FN] = LAYOUT_60_ansi( \
    ...
    _______,          RGB_LYR, RGB_THM, _______, _______, RESET,   _______, QM_MAKE, KC_MRWD, KC_MFFD, KC_PGDN,          MM_RSFT, \
