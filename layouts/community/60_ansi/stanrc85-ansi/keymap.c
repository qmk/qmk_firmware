...
#define _____ KC_TRNS //readability
#define DEFAULT 0 	//Custom ANSI
#define LAYER1 1 	//Default ANSI
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_60_ansi(
		...
		_____, _____, LCA(KC_QUOT), KC_VOLU, LCA(KC_SCLN), _____, _____, KC_HOME, KC_UP, KC_END, _____, _____, _____, RESET,
		KC_CAPS, _____, KC_MUTE, KC_VOLD, KC_MPLY, _____, _____, KC_LEFT, KC_DOWN, KC_RGHT, _____, _____, _____,
		_____, _____, _____, _____, _____, _____, _____, _____, _____, _____, _____, _____, 
		_____, _____, _____, _____, _____, _____, _____, _____),
		
	[3] = LAYOUT_60_ansi(
		RESET, _____, _____, _____, _____, _____, _____, _____, _____, _____, _____, _____, _____, _____, 
		_____, _____, _____, _____, _____, _____, _____, _____, _____, _____, _____, _____, _____, RESET, 
		KC_CAPS, _____, _____, TG(1), _____, _____, BL_STEP, BL_DEC, BL_INC, BL_TOGG, _____, _____, _____, 
		_____, _____, _____, RGB_VAD, RGB_VAI, RGB_SAI, RGB_HUD, RGB_HUI, RGB_MOD, RGB_TOG, _____, _____, 
		_____, _____, _____, _____, _____, _____, _____, _____)
};
