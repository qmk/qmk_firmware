...
[_BASE] = LAYOUT_60_ansi_split_bs_rshift( \
    ...
    KC_LCTL,  KC_LALT,  KC_LGUI,                          KC_SPC,                             KC_RGUI, LFT_ALT, DWN_FN1, RGT_CTL  \
),
...
[_FN1] = LAYOUT_60_ansi_split_bs_rshift( \
    ...
    _______,          RGB_LYR, RGB_THM, _______, _______, RESET,   _______, _______, KC_MRWD, KC_MFFD, KC_PGDN, _______, _______, \
