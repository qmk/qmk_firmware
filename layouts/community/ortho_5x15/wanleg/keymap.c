...
#define LAYOUT_75_base( \
  ...
  LAYOUT_wrapper( \
     ...
     K01,	K02,	K03,	K04,	K05,	K06, KC_KP_7, KC_KP_8, KC_KP_9,		K07,	K08,	K09,	K0A,	K0B,	K0C, \
     K11,	K12,	K13,	K14,	K15,	K16, KC_KP_4, KC_KP_5, KC_KP_6,		K17,	K18,	K19,	K1A,	K1B,	K1C, \
     K21,	K22,	K23,	K24,	K25,	K26, KC_KP_1, KC_KP_2, KC_KP_3,		K27,	K28,	K29,	K2A,	K2B,	K2C, \
     K31,	K32,	K33,	K34,	K35,	K36, KC_KP_0, KC_KP_0, KC_KP_DOT,	K37,	K38,	K39,	K3A,	K3B,	K3C  \
  )
...
#define LAYOUT_75_base( \
  ...
  LAYOUT_wrapper( \
     KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_NLCK,  QWERTY75, GHERKIN75, FUNCTION75, \
     K01,	K02,	K03,	K04,	K05,	K06,	K07,	K08,	K09,	K0A,	K0B,	K0C, KC_KP_7, KC_KP_8, KC_KP_9, \
     K11,	K12,	K13,	K14,	K15,	K16,	K17,	K18,	K19,	K1A,	K1B,	K1C, KC_KP_4, KC_KP_5, KC_KP_6, \
     K21,	K22,	K23,	K24,	K25,	K26,	K27,	K28,	K29,	K2A,	K2B,	K2C, KC_KP_1, KC_KP_2, KC_KP_3, \
     K31,	K32,	K33,	K34,	K35,	K36,	K37,	K38,	K39,	K3A,	K3B,	K3C, KC_KP_0, KC_KP_0, KC_KP_DOT\
  )
#endif  
...
[GK75] = LAYOUT_75_base_wrapper(
  ...
  TD(TD_SFT_CAPS), SFT_T(KC_Z), KC_X, KC_C, LT(NUM75, KC_V), LT(ETC75, KC_B), KC_N, LT(DIR75, KC_M), GUI_T(KC_COMM), ALT_T(KC_DOT), CTL_T(KC_BSPC), SFT_T(KC_ENT),
  KC_LCTL, KC_LGUI, KC_LALT, KC_LALT, NUMBER75, ETCETERA75, KC_SPC,DIRECTION75, KC_RGUI, KC_RALT, KC_DEL, KC_RCTL
),
#endif
 /* QWERTY 75
 * .--------------------------------------------------------------------------------------------------------------------------------------.
