...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_60_ansi_arrow_7u(
        ...
        KC_LCTL, KC_LGUI,       KC_LALT,             KC_SPC,                               KC_LEFT, KC_DOWN, KC_RGHT, MO(_FN)
    ),
    // Fn Layer
    [_FN] = LAYOUT_60_ansi_arrow_7u(
        ...
        KC_VOLU,          _______, _______, KC_CALC, _______, _______, KC_NLCK, KC_MAIL, _______, _______, KC_MSTP, KC_PGUP, KC_PAUS,
        KC_VOLD, KC_MRWD,          KC_MFFD,                   KC_MPLY,                                     KC_MPRV, KC_PGDN, KC_MNXT, _______
    )
};
