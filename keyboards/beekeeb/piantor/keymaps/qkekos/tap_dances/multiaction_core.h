...
bool td_process_record(uint16_t keycode, keyrecord_t *record, bool *return_value);bool td_process_record(uint16_t keycode, keyrecord_t *record, bool *return_value);
