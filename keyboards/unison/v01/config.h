...
#define MATRIX_ROW_PINS { B0, F4, F6, F0, F7, B1, F5, F1, E6, C7 }
#define MATRIX_COL_PINS { B0, F4, F6, F0, F7, B1, F5, F1, E6, C7 }
#define UNUSED_PINS
...
/* Rotary Encoder */
#define ENCODERS_PAD_A { B2, D2, D5, D6, B4 }
#define ENCODERS_PAD_B { B3, D3, D4, D7, B5 }
...
#ifdef RGB_DI_PIN
  #define RGBLED_NUM 22 // Volume(5) + OLED(3) + Rotary Encoder(6) + Under(8)
//   #define RGBLIGHT_LED_MAP {0,1,2,3,13,12,4,5,6,7,8,9,10,11} // Left --> Right --> Under 〓実物確認
