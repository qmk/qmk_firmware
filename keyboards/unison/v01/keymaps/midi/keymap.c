...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT(
                        KC_MUTE,                            KC_MUTE,        KC_MUTE,        KC_MUTE,        KC_MUTE,        KC_MUTE,
        KC_NLCK,KC_PSLS,KC_PAST,KC_PMNS,ESC_NUM,KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL,
        KC_P7,  KC_P8,  KC_P9,  KC_PMNS,KC_TAB,     KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_BSPC,
        KC_P4,  KC_P5,  KC_P6,  KC_PPLS,KC_LCTL,    KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_ENT,
        KC_P1,  KC_P2,  KC_P3,  KC_PENT,S_CAP,  S_CAP,  KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_UP,  LOWER,
        KC_P0,  KC_P0,  KC_PDOT,KC_PENT,KC_ENT, KC_ENT, KC_LALT,KC_LGUI,KC_SPC, KC_SPC, SP_RAI, SP_RAI, KC_RGUI,KC_RALT,KC_LEFT,KC_DOWN,KC_RGHT
    ),
    [_WIN] = LAYOUT(
        ...
        _______,_______,_______,    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,    _______,_______,
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
        _______,_______,_______,XXXXXXX,KC_LGUI,KC_LALT,_______,_______,_______,_______,_______,KC_RALT,KC_APP, XXXXXXX,_______,_______,_______
    ),
    // [_NUM] = LAYOUT(
    ...
    [_MIDI] = LAYOUT(
                        _______,                            _______,        _______,        _______,        _______,        _______,
        _______,_______,XXXXXXX,MI_Fs_3,MI_Gs_3,MI_As_3,XXXXXXX,MI_Cs_4,MI_Ds_4,XXXXXXX,MI_Fs_4,MI_Gs_4,MI_As_4,XXXXXXX,MI_Cs_5,MI_Ds_5,XXXXXXX,
    ...
    [_LOWER] = LAYOUT(
                        _______,                            _______,        _______,        _______,        _______,        _______,
        _______,_______,KC_PAUS,KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12, KC_INS, KC_DEL,
        _______,_______,KC_PSCR,    _______,_______,_______,_______,_______,_______,_______,_______,_______,KC_HOME,KC_UP,      KC_END, KC_VOLU,
        _______,_______,_______,    _______,_______,_______,_______,_______,_______,_______,KC_HOME,KC_PGUP,KC_LEFT,KC_RGHT,    _______,KC_VOLD,
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_END, KC_PGDN,KC_DOWN,_______,_______,_______,
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______
    ),
    // [_RAISE] = LAYOUT(
    ...
    [_ADJUST] = LAYOUT(
                        _______,                            _______,        _______,        _______,        _______,        _______,
        _______,_______,_______,RGB_HUI,RGB_SAI,RGB_VAI,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
        _______,_______,_______,    MIDI,   WIN,    _______,RESET,  _______,RGB_HUI,RGB_SAI,RGB_VAI,_______,RGB_RMOD,_______,   _______,_______,
        _______,_______,_______,    AU_TOG, CK_TOGG,MU_TOG, MU_MOD, _______,RGB_HUD,RGB_SAD,RGB_VAD,RGB_TOG,RGB_MOD,_______,    _______,_______,
        _______,_______,_______,_______,CK_RST, CK_DOWN,CK_UP  ,_______,_______,NUM,     MAC,   _______,_______,_______,_______,_______,_______,
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______
    )
};
