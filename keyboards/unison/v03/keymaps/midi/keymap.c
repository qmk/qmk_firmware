...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT(
        ...
        KC_TAB,     KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_LBRC,KC_GRV, KC_BSLS,KC_LBRC,KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,       KC_BSPC,
        KC_LCTL,    KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_SCLN,  KC_P5,  KC_P6,  KC_QUOT,KC_H,   KC_J,   KC_K,   KC_L,   KC_MINS,    KC_ENT,
        KC_LSFT,KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_P1,  KC_P2,  KC_P3,  XXXXXXX,KC_N,   KC_M,   KC_COMM,KC_DOT, KC_UP,  SFT_SLS,
        KC_CAPS,KC_CAPS,KC_LALT,XXXXXXX,KC_LGUI,SP_LOW, SP_LOW, KC_P0,  KC_P0,  KC_PDOT,KC_PENT,SP_RAI, SP_RAI, KC_RCTL,KC_LEFT,KC_DOWN,KC_RGHT
    ),
    [_WIN] = LAYOUT(
