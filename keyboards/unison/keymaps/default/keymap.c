...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(
        ...
        KC_P1,  KC_P2,  KC_P3,  KC_PENT,KC_LSFT,KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_UP,  KC_SLSH,
        KC_P0,  KC_P0,  KC_PDOT,KC_PENT,KC_BSLS,KC_GRV, KC_LGUI,KC_LALT,KC_SPC, KC_SPC, KC_SPC, KC_SPC, KC_SPC, KC_RALT,KC_LEFT,KC_DOWN,KC_RGHT
    )
};
