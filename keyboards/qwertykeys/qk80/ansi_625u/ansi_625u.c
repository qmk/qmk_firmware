...
led_config_t g_led_config = { {
    ...
    { 77, 78, 79, NO_LED,80, NO_LED,81,     82,    83,     84, 50, 76,    85,  86, 87  }
}, {
    ...
    { 0, 64 }, { 14, 64 }, { 28, 64 },                         { 70, 64 },                          { 112, 64 }, { 126, 64 }, { 140, 64 },                           { 182, 64 }, { 196, 64 }, { 210, 64 },{ 224, 64 }
}, {
...
bool process_record_kb(uint16_t keycode, keyrecord_t *record) {
  if (record->event.pressed) {
    switch(keycode) {
        ...
        case KC_F14:
        rgb_matrix_toggle(); //rgb 矩阵开关
        break;

        case KC_F15:
        rgb_matrix_step();  //rgb向后切换animation模式
        break;

        case KC_F16:  
        rgb_matrix_step_reverse();  //rgb向前切换animation模式
        break;
