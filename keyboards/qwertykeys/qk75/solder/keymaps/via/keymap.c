...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_sol(
		KC_ESC,  KC_F1,   KC_F2,   KC_F3,  KC_F4,    KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_F13,  KC_MUTE, KC_VOLD, KC_VOLU, 
	...
	bool encoder_update_user(uint8_t index, bool clockwise) {
		...
		if (index == 0) {
			if (clockwise) {
				tap_code(dynamic_keymap_get_keycode(biton32(layer_state), 4, 14));
			} else {
