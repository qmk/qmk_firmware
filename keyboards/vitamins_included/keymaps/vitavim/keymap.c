...
//  KC_LCTL,        KC_LGUI, KC_LALT, MO(1), KC_DEL, KC_SPC, KC_SPC, KC_BSPC, KC_A,   KC_LEFT, KC_DOWN,       KC_RGHT
...
/* VIM layer that adds vim navigation by holding the ; key.
 * ,--------------------------------------------------------------------------------------.
 * |  Tab   |  "'  |  b  |  w  |   e    |  d  |   y  | Vol- | Vol+ | TO(0)|  TG(2) |  Del |
 * |--------+------+-----+-----+--------+-----+------+------+------+------+--------+------|
