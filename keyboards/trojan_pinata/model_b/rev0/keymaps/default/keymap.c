...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_F13,  KC_ENT,  KC_HOME,
...
static const char PROGMEM blank[] = {   // what? this is a waste of memory??? too bad!
    // 'blank', 128x32px
