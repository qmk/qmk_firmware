 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | LSHIFT | ;      | Q      | J      | K      | X      |        |        |        | B      | M      | W      | V      | Z      | SFT_ENT|
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | LGUI   | LALT   | FN     |        | SPACE  | SPACE  |        | BACKSPC| BACKSPC|        | FN     | RALT   | RGUI   | RCTRL  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */

    [_BASE] = LAYOUT_grid( /* QWERTY */
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,  _______, _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
        KC_TAB,  KC_QUOT, KC_COMM, KC_DOT,  KC_P,    KC_Y,    _______,  _______, _______, KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_SLSH,
        KC_CAPS, KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    _______,  _______, _______, KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_MINS,
        KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    _______,  _______, _______, KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_SFTENT,
        KC_LCTL, KC_LGUI, KC_LALT, MO(_FN), _______, KC_SPC,  _______,  _______, _______, KC_BSPC, _______, MO(_FN), KC_RALT, KC_RGUI, KC_RCTL
    ),
