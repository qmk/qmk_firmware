...
#define KC_DN_CTL LT(_NAV, KC_LCTL)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_7u_space(
    ...
    KC_TAB,  KC_A,  KC_S,  KC_D,  KC_SF, KC_G, KC_H, KC_SJ, KC_K,    KC_L,   KC_QUOT,
    KC_LSFT, KC_Z,  KC_X,  KC_C,  KC_V,  KC_B, KC_N, KC_M,  KC_COMM, KC_DOT, KC_SLSH,
    KC_LGUI, KC_DN_CTL, 	 			  KC_UP_SPC, 				KC_RALT,   KC_RGUI
  ),

 [_SYM] = LAYOUT_7u_space(
    KC_TRNS, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,     KC_0,    KC_TRNS,
    KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_EQUAL, KC_MINS,
    KC_TRNS, KC_PIPE, KC_BSLS, KC_LPRN, KC_LBRC, KC_SCLN, KC_COLN, KC_RBRC, KC_RPRN, KC_PLUS,  KC_UNDS,
