...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
	[BASE] = LAYOUT_4key_2u_inner(
      ...
      KC_GRV,   KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     LT1_PSCR,            KC_BSLS,  KC_H,     KC_J,     KC_K,      KC_L,     KC_SCLN, KC_QUOT, 
      KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_NO,               KC_NO,    KC_N,     KC_M,     KC_COMM,   KC_DOT,   KC_SLSH, KC_RSFT, 
      KC_LCTL,  MEH_F13, KC_LGUI,   KC_LALT, KC_SPC,    KC_DEL,   CS_F14,              MO(2),    KC_ENT,   KC_BSPC,  ALL_, KC_F15, KC_INS, TT(3)
      ),
