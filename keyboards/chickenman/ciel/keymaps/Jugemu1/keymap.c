...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT_60_ansi_split_bs_rshift(
        ...
        _______, _______, _______, _______, _______, _______, _______,    KC_HOME,   _______,   KC_UP,  _______, _______, _______,           _______,
        _______, _______, _______, _______, _______, _______, _______,     KC_END,   KC_LEFT, KC_DOWN, KC_RIGHT, KC_BSPC,                    _______,
        _______,          _______, _______, _______, KC_BSPC, _______,    KC_PGUP,   KC_PGDN, _______,  _______, _______,           _______, _______,
