...
#define PRODUCT_ID      0x6553 // 65 - S
#define DEVICE_VER      0x0001
#define MANUFACTURER    AEBoards
#define PRODUCT         AEBoards Satellite Rev1
...
/* key matrix pins */
#define MATRIX_ROW_PINS { B0, B1, F0, F4, F1 }
#define MATRIX_COL_PINS { E6, D5, B2, B3, B7, F6, F7, C7, C6, B6, B5, B4, D7, D6, D4 }
#define UNUSED_PINS
