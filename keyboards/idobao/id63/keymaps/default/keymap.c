...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_63_ansi(
        ...
        KC_LCTL, KC_LGUI,          KC_LALT,                   KC_SPC,                    KC_MENU, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [1] = LAYOUT_63_ansi(
        ...
        _______,          RESET,   _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, _______,
