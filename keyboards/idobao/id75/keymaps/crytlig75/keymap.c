...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ortho_5x15(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, KC_LALT, MO(1),   KC_SPC,  KC_SPC,  KC_SPC,  KC_RALT, KC_RGUI, MO(2),   KC_RCTL, TG(1),   MO(1),   KC_PSCR
    ),
    ...
    [1] = LAYOUT_ortho_5x15(
        ...
        _______, KC_LEFT, KC_DOWN,  KC_RGHT, _______, _______, KC_BSLS, KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT, _______, _______, _______, KC_INS,
