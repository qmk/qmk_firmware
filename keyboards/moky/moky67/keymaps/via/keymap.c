...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_tkl_f13_ansi( /* Base */
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,                   USE_ENC,
    ...
    [1] = LAYOUT_tkl_f13_ansi( /* Base */
        KC_GRV,  KC_MYCM, KC_WHOM, KC_MAIL, KC_CALC, KC_MSEL, KC_MSTP, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, US_BATQ,                   USE_ENC,
        QK_BOOT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, USE_SAI, USE_HUI, RGB_MOD,                   _______,
    ...
    [2] = LAYOUT_tkl_f13_ansi(  /* Base */
        KC_ESC,  KC_BRMD, KC_BRMU, KC_F3,   _______, KC_F5,   KC_F6,   KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_BSPC,                   USE_ENC,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,                   KC_SCRL,
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,                    KC_DEL,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,                   KC_RSFT,          KC_UP,
    ...
    [3] = LAYOUT_tkl_f13_ansi(  /* FN */
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  US_BATQ,                   USE_ENC,
        QK_BOOT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, USE_SAI, USE_HUI, RGB_MOD,                   _______,
        _______, TO(0),   TO(2),   _______, _______, _______, _______, _______, _______, RGB_TOG, _______, _______,          _______,                   _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,          RGB_VAI,
