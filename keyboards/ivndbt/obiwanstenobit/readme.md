...
![ObiWanStenobit](https://i.imgur.com/OKkenaR.jpeg "ObiWanStenobit v1 prototype")

* Keyboard maintainer: [ivndbt](https://github.com/ivndbt)
* Hardware supported: Pro Micro RP2040
* Hardware Availability: ObiWanStenobit is open-source, check the [project repository](https://github.com/ivndbt/obiwanstenobit)
