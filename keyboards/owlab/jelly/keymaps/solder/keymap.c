...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_jelly_solder(
		...
		KC_LSFT, KC_Z,    KC_X,   KC_C,   KC_V,  KC_B,  KC_N,  KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_DEL, KC_HOME,
		KC_LCTL, KC_LGUI, KC_LALT,KC_BSLS,KC_SPC,KC_APP,MO(1), KC_LEFT, KC_DOWN, KC_PGDN, KC_PGUP, KC_END, KC_RGHT,KC_UP),

	[1] = LAYOUT_jelly_solder(
