...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        ...
        KC_TAB,  KC_X,    KC_V,    KC_L,    KC_C,    KC_W,    TG(SYMB),         TG(SYMB), KC_K,    KC_H,    KC_G,    KC_F,    KC_Q,    KC_BSLS,
        KC_BSPC, KC_U,    KC_I,    KC_A,    KC_E,    KC_O,    KC_HYPR,           KC_MEH,  KC_S,    KC_N,    KC_R,    KC_T,    KC_D,    KC_Y,
        KC_LSFT, LCTL_T(KC_Z),KC_X,KC_C,    KC_P,    KC_Z,                                KC_B,    KC_M,    KC_COMM, KC_DOT,  LCTL_T(KC_SLSH), KC_LSFT,
   LT(SYMB,KC_GRV),WEBUSB_PAIR,A(KC_LSFT),KC_LEFT, KC_RGHT,       LALT_T(KC_APP),    RCTL_T(KC_ESC),   MO(LAYER_4),   KC_DOWN, KC_LBRC, KC_RBRC, TT(SYMB),
    ...
    [LAYER_4] = LAYOUT_moonlander(
        ...
        KC_TRNS, KC_EXLM, KC_BSPC, KC_UP,   KC_RCBR, KC_PIPE, KC_TRNS,           KC_TRNS, KC_UP,   KC_7,    KC_8,    KC_9,    KC_ASTR, KC_F12,
        KC_TRNS, KC_HASH, KC_LEFT, KC_DOWN, KC_RGHT, KC_GRV,  KC_TRNS,           KC_TRNS, KC_DOWN, KC_4,    KC_5,    KC_6,    KC_PLUS, KC_TRNS,
        KC_TRNS, KC_PERC, KC_CIRC, KC_LBRC, KC_ENT,  KC_TILD,                             KC_AMPR, KC_1,    KC_2,    KC_3,    KC_BSLS, KC_TRNS,
