...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_halfmoon(
    RGB_MOD,        TO(1),          TO(2),          TO(3),          KC_TRANSPARENT, KC_TRANSPARENT, RESET,
    HSV_152_255_255,KC_7,           KC_8,           KC_9,           KC_MINUS,       KC_SLASH,       RGB_TOG,
    HSV_74_255_255, KC_4,           KC_5,           KC_6,           KC_PLUS,        KC_ASTR,        TOGGLE_LAYER_COLOR,
    HSV_0_245_245,  KC_1,           KC_2,           KC_3,           KC_DOT,         KC_EQUAL,
    RGB_SLD,        KC_0,           KC_ENTER,       KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_AUDIO_MUTE,
    KC_MEDIA_PLAY_PAUSE,KC_MEDIA_PREV_TRACK,KC_MEDIA_NEXT_TRACK
  ),
  [1] = LAYOUT_halfmoon(
    KC_ESCAPE,      TD(DANCE_0),    TD(DANCE_1),    TD(DANCE_2),    TD(DANCE_3),    TD(DANCE_4),    LALT(KC_RBRC),
    KC_S,           KC_I,           KC_M,           KC_L,           KC_W,           KC_C,           LALT(KC_LBRC),
    TD(DANCE_5),    KC_H,           KC_E,           KC_B,           KC_P,           KC_V,           LCTL(LSFT(KC_N)),
    KC_LSFT,       LCTL(KC_X),     LCTL(KC_C),     LCTL(KC_V),     LCTL(KC_MINUS), LCTL(LSFT(KC_EQUAL)),
    TO(0),          KC_LCTL,       KC_LALT,        LCTL(LSFT(KC_K)),KC_Z,           LCTL(KC_S),
    LCTL(KC_Z),     LCTL(LSFT(KC_Z)),KC_TRANSPARENT
  ),
  [2] = LAYOUT_halfmoon(
    KC_UP,          TD(DANCE_6),    TD(DANCE_7),    TD(DANCE_8),    TD(DANCE_9),    TD(DANCE_10),   KC_KP_PLUS,
    KC_DOWN,        LCTL(KC_E),     LALT(LCTL(KC_M)),TD(DANCE_11),   TD(DANCE_12),   KC_T,           KC_KP_MINUS,
    KC_DELETE,      LSFT(KC_A),     KC_S,           LALT(LCTL(KC_K)),KC_F,           TD(DANCE_13),   KC_TRANSPARENT,
    KC_LSFT,       TD(DANCE_14),   LCTL(KC_X),     TD(DANCE_15),   TD(DANCE_16),   KC_K,
    TO(0),          KC_RALT,        KC_LEFT,        KC_RIGHT,       KC_LCTL,       LCTL(KC_S),
    KC_SPACE,       KC_LGUI,        KC_ENTER
  ),
  [3] = LAYOUT_halfmoon(
    KC_ESCAPE,      TD(DANCE_17),   TD(DANCE_18),   TD(DANCE_19),   TD(DANCE_20),   TD(DANCE_21),   LCTL(KC_X),
    KC_DELETE,      TD(DANCE_22),   KC_M,           KC_I,           KC_O,           LCTL(LSFT(KC_SLASH)),LCTL(KC_C),
    LCTL(KC_A),     KC_J,           KC_K,           KC_L,           KC_V,           LCTL(KC_G),     LCTL(KC_V),
    KC_LSFT,       LCTL(KC_D),     LSFT(KC_T),     LCTL(KC_K),     LCTL(KC_MINUS), LCTL(LSFT(KC_EQUAL)),
    TO(0),          KC_LCTL,       KC_LALT,        KC_GRAVE,       KC_SPACE,       LCTL(KC_S),
    LCTL(KC_Z),     LCTL(LSFT(KC_Y)),KC_TRANSPARENT
  ),
};
...
void dance_13_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[13].step) {
        ...
        case SINGLE_HOLD: register_code16(LCTL(LSFT(KC_G))); break;
...
void dance_13_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[13].step) {
        ...
        case SINGLE_HOLD: unregister_code16(LCTL(LSFT(KC_G))); break;
