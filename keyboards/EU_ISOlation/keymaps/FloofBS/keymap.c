...
combo_t key_combos[COMBO_COUNT] = {
    ...
    [WOMBO] = COMBO(wombo_combo, womboComboString)
};
...
// Fix this shitpost at some point. It is supposed to do the shitpost but for some reason comes out to e
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    case womboComboString:
