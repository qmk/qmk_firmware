...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_EUISO_BIGSPACE(
        ...
        MO(_FN1), MO(_FN3), KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,  KC_G,   KC_H,   KC_J,  KC_K,    KC_L,    KC_SCLN, LT(_FN2, KC_QUOT),
        MO(_FN2), KC_CAPS,  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,  KC_B,   KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH, LT(_FN1, KC_ENT),
    ...
    [_FN3] = LAYOUT_EUISO_BIGSPACE(
        ...
        _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______,    KC_F5,   KC_F6,   KC_F7,  KC_F8,  _______,
