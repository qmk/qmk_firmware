...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_65_ansi(
        ...
        _______, KC_MUTE, KC_VOLD, KC_PAUS, _______, _______, _______, _______, _______, KC_4,    KC_5,    KC_6,             RGB_SAD,  RGB_HUD,
        _______, KC_PIPE, _______, _______, _______, _______, _______, _______, _______, KC_1,    KC_2,    KC_3,             RGB_VAI,  RGB_TOG,
        _______, _______, _______,                            KC_PSCR,          _______, _______, _______, RGB_MODE_REVERSE, RGB_VAD,  RGB_MODE_FORWARD
    )
};