...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_1] = LAYOUT_ortho_4x4( _______, _______, _______, _______, _______, _______, _______, _______, RGB_SAD, RGB_SAI, RGB_HUD, RGB_HUI, _______, RGB_TOG, RGB_RMOD, RGB_MOD )};
