 ...
 * @LastEditTime   : 2022-01-27 11:48:18
 * @FilePath       : \qmk_firmware\keyboards\7liang\tp32\keymaps\default\keymap.c
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // |----------|----------|----------|----------|----------|         [    ]            |----------|----------|----------|----------|----------|
         KC_A,      KC_S,      KC_D,    LT(3, KC_F), LT(2, KC_G),                         LT(2, KC_H), LT(3, KC_J), KC_K,    KC_L,      KC_ENT,
    // |----------|----------|----------|----------|----------|-----------,---------------|----------|----------|----------|----------|----------|
         KC_Z,      KC_X, MT(MOD_LSFT, KC_C), KC_V,  LT(1, KC_B),  KC_BTN1,   KC_BTN2,    LT(1, KC_N), KC_M,      KC_RSFT,   KC_SPC,    KC_BSPC
    // `-----------------------------------------------------------------------------------------------------------------------------------------'
    ),
    ...
    // |----------|----------|----------|----------|----------|-----------,---------------|----------|----------|----------|----------|----------|
         KC_LCTL,   KC_LWIN,   _______,   KC_LALT,   _______,   KC_WH_D,    KC_WH_U,        KC_RALT,   KC_RCTL,   _______,   _______,   KC_DEL
    // `-----------------------------------------------------------------------------------------------------------------------------------------'
    ),
