...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_iso(
        ...
        KC_PSCR, KC_TRNS, KC_LSFT, KC_LCTL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    [_RAISE] = LAYOUT_iso(
        ...
        KC_TRNS, KC_LGUI, KC_TRNS,                   MO(3),   KC_TRNS, KC_TRNS,                   KC_TRNS, KC_RGUI, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS
    ),
    ...
    [_SETTINGS] = LAYOUT_iso(
        ...
        KC_NO,   KC_NO,   KC_NO,                      KC_NO,   KC_NO,   KC_NO,                     KC_NO,   KC_NO,   KC_NO,            RGB_HUD, RGB_VAD, RGB_HUI
    ),
};
