...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_ansi(
      ...
      KC_LCTL, KC_LGUI, KC_LALT,   MO(1),      KC_SPC,     MO(2), KC_RALT, KC_RGUI, KC_RCTL,      KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_RAISE] = LAYOUT_ansi(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS,   MO(3),     KC_TRNS,     KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS
  ),
