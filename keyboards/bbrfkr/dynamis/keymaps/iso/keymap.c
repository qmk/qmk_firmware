...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_iso(
      ...
      KC_TRNS, KC_TRNS, KC_BTN3, KC_BTN2, KC_BTN1, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MUTE,
      KC_TRNS, KC_LGUI, KC_TRNS,   KC_TRNS,     KC_TRNS,   KC_TRNS, MO(3), KC_RGUI, KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS,
      KC_VOLD, KC_VOLU
  ),
  ...
  [_SETTINGS] = LAYOUT_iso(
      ...
      KC_NO, RGB_TOG, RGB_MOD, RGB_RMOD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
