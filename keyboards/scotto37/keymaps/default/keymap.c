...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_3x10_7(
        ...
        KC_LSFT,      KC_TRNS,    KC_LCTL, KC_LALT, LGUI_T(KC_SPC), KC_TRNS, LT(1, KC_TAB), LT(2, KC_ENT), KC_TRNS, KC_RSFT 
    ),
    [1] = LAYOUT_ortho_3x10_7(
        ...
        KC_LSFT,         KC_TRNS, KC_LCTL, KC_LALT, LGUI_T(KC_SPC), KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_RSFT 
    ),
