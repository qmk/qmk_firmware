...
/* Keymap (Base Layer) Default Layer
   ...
   */
[_QWERTY] = LAYOUT(
  KC_ESC,  KC_1,    KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_GRAVE, KC_BRK,  \
  KC_TAB,  KC_Q,    KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,          MATHEMAGIC,   \
...
[_FUNCTION] = LAYOUT(
  ...
  */
[_LOWERMATH] = LAYOUT(
 _______, H(00b9), H(00b2), H(00b3), H(2074), H(2075), H(2076), H(2077), H(2078), H(2079), H(2070), H(207b), H(207a), H(2295), H(2260), _______, \
  ...
  */
[_UPPERMATH] = LAYOUT(
 _______, H(2081), H(2082), H(2083), H(2084), H(2085), H(2086), H(2087), H(2088), H(2089), H(2080), H(208b), H(208a), H(2297), H(2248), _______, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  if (keycode == MATHEMAGIC) {
    if (record->event.pressed) {
      layer_on(shifted ? _UPPERMATH : _LOWERMATH);
    } else {
      layer_off(shifted ? _UPPERMATH : _LOWERMATH);
    }
  }
  return true;
}
