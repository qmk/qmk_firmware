...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
               ...
               KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,
               KC_LCTL,  KC_LALT, KC_LGUI, LT1_SPC, KC_SPC,  LT1_SPC, KC_LEFT, KC_DOWN, KC_RGHT, MO(2)
             ),
    [1] = LAYOUT(
               ...
               KC_VOLD,  KC_MUTE, KC_VOLU, KC_TRNS, KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO
             ),
    [2] = LAYOUT(
