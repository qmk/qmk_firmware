...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL,          KC_LALT,          KC_SPC,  KC_LGUI,          KC_SPC,  MO(_FN),            KC_RCTL,                           KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FN] = LAYOUT_split_bksp_275_rspace(
    KC_TRNS, RGB_TOG, RGB_MOD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, BL_TOGG, BL_DEC,  BL_INC,  KC_TRNS, KC_TRNS, KC_INS,
