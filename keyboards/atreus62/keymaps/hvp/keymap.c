...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT( /* Right */
    ...
    _______, _______, _______, _______, _______, KC_LBRC,                     KC_RBRC, KC_UNDERSCORE, KC_PLUS, KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE, KC_PIPE ,
  ...
  LAYOUT(/* Left */
    ...
    KC_DELETE, _______, _______, _______, _______, KC_LEFT_PAREN, KC_RIGHT_PAREN,            KC_UNDERSCORE, KC_PLUS, KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE, KC_PIPE,
  ...
  LAYOUT(/* Esc */
    ...
    _______,  _______, _______, _______, _______, _______, KC_MUTE,  KC_MPLY,  _______, KC_MSTP, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT
  ),
