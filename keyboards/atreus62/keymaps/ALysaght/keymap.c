 ...
 * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
 * |Shift |   Z  |   X  |   C  |   V  |   B  ||GuiBsp||Space ||   N  |   M  |   ,  |   .  |   /  |SftEnt|
 * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
 * | NUM  |Ctrl  | Alt  |   _  |Lower |GuiBsp|`------'`------'|Space |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------'                `-----------------------------------------'
 */
  ...
  [_QWERTY] = LAYOUT(
    ...
    TG(_NUM),  KC_LCTL, KC_LALT, KC_UNDS,   LOWER,   LGUI_T(KC_BSPC), LGUI_T(KC_BSPC), KC_SPC, KC_SPC,   RAISE,    KC_LEFT, KC_DOWN,     KC_UP,   KC_RIGHT
  ),
