 ...
 * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
 * |Shift |   Z  |   X  |   C  |   V  |   B  || Bksp ||SftEnt||   N  |   M  |   ,  |   .  |   /  |SftEnt|
 * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
 * | NUM  |Ctrl  | Alt  |   _  |Lower |Super |`------'`------'|Space |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------'                `-----------------------------------------'
 */
  ...
  [_QWERTY] = LAYOUT(
    ...
    TG(_NUM),  KC_LCTL, KC_LALT, KC_UNDS,   LOWER,   KC_LGUI,  KC_BSPC,  KC_SFTENT, KC_SPC,   RAISE,    KC_LEFT, KC_DOWN,     KC_UP,   KC_RIGHT
  ),
 ...
 * |      |      |      |      |      |      ||  Del ||      ||      |      |      |      |      |      |
 * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
 * |      |      |      |ScrSht|      |      |`------'`------'|  Ins |      | Mute | VolD | VolU | Play |
 * `-----------------------------------------'                `-----------------------------------------'
 */
