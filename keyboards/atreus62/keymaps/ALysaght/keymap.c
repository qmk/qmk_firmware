 ...
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |  ` sd  |   Q  |   W  |   E  |   R  |   T  |                |   Y  |   U  |   I  |   O  |   P  |  [   |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * | Tab  |   A  |   S  |   D  |   F  |   G  |,------.,------.|   H  |   J  |   K  |   L  |   ;  |  '   |
 * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
 * |Shift |   Z  |   X  |   C  |   V  |   B  ||GuiBsp||GuiSpc||   N  |   M  |   ,  |   .  |   /  |SftEnt|
 * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
 * | NUM  |Ctrl  | Alt  |   _  |Lower |GuiBsp|`------'`------'|GuiSpc|Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------'                `-----------------------------------------'
 */
  ...
  [_QWERTY] = LAYOUT(
    ...
    TG(_NUM),  KC_LCTL, KC_LALT, KC_UNDS,   LOWER,   LGUI_T(KC_BSPC), LGUI_T(KC_BSPC), LGUI_T(KC_SPC), LGUI_T(KC_SPC),   RAISE,    KC_LEFT, KC_DOWN,     KC_UP,   KC_RIGHT
  ),
 ...
 * |      |      |      |      |      |      ||  Del ||      ||      |      |      |      |      |      |
 * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
 * |MUTmic|      |      |ScrSht|      |      |`------'`------'|  Ins |      | Mute | VolD | VolU | Play |
 * `-----------------------------------------'                `-----------------------------------------'
 */
  ...
  [_LOWER] = LAYOUT(
    ...
    SGUI(KC_F12), _______, _______, SGUI(C(KC_4)), _______, _______,   KC_DEL, _______, KC_INS, _______, KC_MUTE, KC_VOLD, KC_VOLU,  KC_MPLY
  ),
 ...
 * |      |      |      |      |      |      |,------.,------.|  NO  |   4  |   5  |   6  |   -  |  NO  |
 * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
 * |      |      |      |      |      |      || Bksp ||Enter || Spc  |   1  |   2  |   3  |   /  |Enter |
 * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
 * |      |      |      |      |      |Clear |`------'`------'|   0  |   .  | Left | Down |  Up  |Right |
 * `-----------------------------------------'                `-----------------------------------------'
 */
  ...
  [_NUM] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, KC_C,    KC_BSPC, KC_PENT, KC_KP_0, KC_PDOT, KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT
  ),
