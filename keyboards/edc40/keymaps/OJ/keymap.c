...
const uint16_t PROGMEM keymaps [][MATRIX_ROWS][MATRIX_COLS] = {
    [_QW] = LAYOUT( /* Qwerty */
      ...
      KC_LSHFT,   KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM,    KC_DOT,
    ...
    [_L2] = LAYOUT( /* F Keys */
      ...
      _______,  KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______, _______, UC(0xc3b6), UC(0xc3a4), KC_ENT,
