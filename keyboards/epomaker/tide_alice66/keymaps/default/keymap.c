...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( /* win FN */
        ...
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   KC_USB,  _______,   _______,  _______,  _______,  _______,  KC_2G4,  _______,  RM_HUEU,  RM_NEXT,  _______,
        _______,  KC_NO,    TO(_MBL), _______,  _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,  HS_BATQ,            _______,
        _______,  RM_TOGG,  _______,  _______,  _______, _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),          RM_VALU,  _______,
    ...
    [_FFL] = LAYOUT(
        ...
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   _______, _______,  _______,  _______,  _______,  _______,  KC_2G4,   _______,  RM_HUEU,  RM_NEXT,  _______,
