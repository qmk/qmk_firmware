...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( /* Base */
        EE_CLR,   KC_MYCM,  KC_WHOM,  KC_MAIL,  KC_CALC,  KC_MSEL,  KC_MSTP,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,  RL_MOD,   _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_SCRL,  KC_PAUSE, _______,  _______,  _______,            RM_TOGG,  _______,
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   KC_2G4,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            RM_NEXT,  _______,
        _______,  KC_NO,    TO(_MBL), _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,                      RM_HUEU,  _______,
        _______,  _______,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,                      MO(_FBL), RM_VALU,  _______,
        _______,  GU_TOGG,  _______,                      HS_BATQ,                                _______,  _______,  _______,            RM_SPDD,  RM_VALD,  RM_SPDU),

    [_MBL] = LAYOUT( /* Base */
        KC_ESC,   KC_BRID,  KC_BRIU,  KC_MCTL,  HS_SIRI,  KC_F5,    KC_F6,    KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_PSCR,  KC_INS,   KC_DEL,
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,             KC_BSPC,  KC_HOME,
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,            KC_BSLS,  KC_END,
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,                      KC_ENT,   KC_PGUP,
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,                      KC_RSFT,  KC_UP,    KC_PGDN,
    ...
    [_MFL] = LAYOUT( /* Base */
        ...
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   KC_2G4,   _______,  _______,  KC_F13,   KC_F14,   KC_F15,   _______,  _______,  _______,            RM_NEXT,  _______,
        _______,  TO(_BL),  KC_NO,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,                      RM_HUEU,  _______,
        _______,  _______,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,                      MO(_FBL), RM_VALU,  _______,
        _______,  _______,  _______,                      HS_BATQ,                                _______,  _______,  _______,            RM_SPDD,  RM_VALD,  RM_SPDU),
    [_FBL] = LAYOUT( /* Base */
        QK_BOOT,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
        _______,  _______,  BT_TEST,  _______,  _______,  _______,  _______,  _______,  _______,  KC_ENCW,  _______,  _______,  _______,            _______,  _______,
