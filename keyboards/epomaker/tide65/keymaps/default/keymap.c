...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( /* win FN */
        ...
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   _______, KC_USB,   _______,  _______,  _______,  _______,  KC_2G4,   KC_HOME,  KC_SCRL,  RM_NEXT,  _______,
        _______,  KC_NO,    TO(_MBL), _______,  _______, _______,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,            HS_BATQ,  _______,
        _______,  RM_TOGG,  _______,  _______,  _______, _______,  _______,  _______,  RM_HUEU,  _______,            _______,  MO(_DEFA),RM_VALU,  _______,
        KC_FTOG,  GU_TOGG,  _______,  EE_CLR,   EE_CLR,  EE_CLR,   EE_CLR,                       KC_RCTL,            _______,  RM_SPDD,  RM_VALD,  RM_SPDU
    ),
    ...
    [_MFL] = LAYOUT(
        ...
        _______,  RM_TOGG,  _______,  _______,  _______, _______,  _______,  _______,  RM_HUEU,  _______,            _______,  MO(_DEFA),RM_VALU,  _______,
        KC_FTOG,  _______,  _______,  EE_CLR,   EE_CLR,  EE_CLR,   EE_CLR,                       KC_RCTL,            _______,  RM_SPDD,  RM_VALD,  RM_SPDU
    ),
    ...
    [_FMFL] = LAYOUT(
        KC_GRV,   KC_BRID,  KC_BRIU,  KC_F3,    KC_F4,   RM_VALD,  RM_VALU,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,  _______,
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   _______, KC_USB,   _______,  _______,  _______,  _______,  KC_2G4,   KC_HOME,  KC_SCRL,  RM_NEXT,  _______,
