...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( /* Base */
        ...
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   _______,   KC_USB,  _______,  _______,  _______,  MO(_DEFA),KC_2G4,   _______,  KC_INS,   RM_NEXT,  _______,
        ...
        _______,  GU_TOGG,  _______,  EE_CLR,             _______,  EE_CLR,   EE_CLR,             _______,  _______,  _______,  RM_SPDD,  RM_VALD,  RM_SPDU),
    ...
    [_MFL] = LAYOUT( /* Base */
        _______,  KC_BRID,  KC_BRIU,  KC_F3,    KC_F4,    RM_VALD,  RM_VALU,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   _______,   KC_USB,  _______,  _______,  _______,  MO(_DEFA),KC_2G4,   _______,  KC_INS,   RM_NEXT,  _______,
        _______,  TO(_BL),  KC_NO,    _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,  _______,  _______,  HS_BATQ,  RL_MOD,
        _______,  RM_TOGG,  _______,  _______,  _______,  _______,  _______,  _______,  RM_HUEU,  _______,  _______,  MO(_DEFA),          RM_VALU,  _______,
        _______,  _______,  _______,  EE_CLR,             _______,  EE_CLR,   EE_CLR,             _______,  _______, _______,  RM_SPDD,  RM_VALD,  RM_SPDU),
    [_DEFA] = LAYOUT( /* Base */
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
