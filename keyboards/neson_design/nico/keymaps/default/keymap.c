...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_xt_ansi_blocker_split_bs(
        ...
        KC_F9,   KC_F10,     KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, KC_RGUI,          KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [1] = LAYOUT_65_xt_ansi_blocker_split_bs(
        ...
        _______, _______,    QK_BOOT, UG_TOGG, UG_NEXT, _______, KC_F16,  KC_F17,  _______, _______, _______, _______, _______, KC_PGUP, KC_PGDN, _______,          _______,
        _______, _______,    _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_HOME, KC_END,           _______,          _______,
