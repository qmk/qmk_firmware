...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
      ...
      KC_LCTL,  KC_LGUI,  KC_LALT,                        KC_SPC,                                  KC_RALT,   LT(1),    KC_DEL,   KC_RCTL),

  // 1: Function Layer
  KEYMAP(
      KC_GRV,   KC_F1,    KC_F2,   KC_F3,      KC_F4,     KC_F5,    KC_F6,   KC_F7,  KC_F8,  KC_F9,   KC_F10,           KC_F11,  KC_F12,      \
      KC_TAB,   KC_WH_U,  KC_UP,   KC_WH_D,    KC_BSPC,   KC_HOME,  KC_CALC, KC_NO,  KC_INS, KC_NO,   KC_PSCR, KC_SLCK, KC_PAUS,  KC_DEL,     \
      KC_NO,    KC_LEFT,  KC_DOWN, KC_RIGHT,   KC_PGUP,   KC_PGDN,  KC_END,  KC_NO,  KC_NO,   KC_HOME, KC_PGUP,  KC_NO,    KC_ENT,            \
      KC_LSFT,  KC_NO,    KC_NO,   RGB_TOG,    RGB_MOD,   RGB_HUI,  RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD,                  KC_INS,     \
