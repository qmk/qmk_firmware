...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
      ...
      TD(TD_KC_RSFT_CAPS), KC_NO,   KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH,  TD(TD_KC_RSFT_CAPS), KC_UP,    KC_DEL,      \
      KC_LCTL, KC_LGUI, KC_LALT,                 TD(TD_SPC_ENT),                          KC_RGUI, F(0),     KC_LEFT, KC_DOWN,  KC_RIGHT),
  ...
  KEYMAP(
      ...
      KC_LCTL, KC_LGUI, KC_LALT,                 TD(TD_SPC_ENT),                          KC_RGUI, F(0),     KC_HOME, KC_PGDOWN,KC_END),
