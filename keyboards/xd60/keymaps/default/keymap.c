...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
      ...
      KC_LCTL, KC_LGUI, KC_LALT,                 TD(TD_ESC_CAPS),                          KC_RGUI, F(0),     KC_LEFT, KC_DOWN,  KC_RIGHT),
  ...
  KEYMAP(
      ...
      KC_LCTL, KC_LGUI, KC_LALT,                 TD(TD_ESC_CAPS),                          KC_RGUI, F(0),     KC_HOME, KC_PGDOWN,KC_END),
