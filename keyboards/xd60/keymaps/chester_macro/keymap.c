...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
      ...
      KC_GRV,   RGB_TOG, KC_UP,   RGB_MOD, RGB_HUI,RGB_SAI,RGB_VAI,KC_TRNS,  KC_UP, KC_SLCK,   KC_PAUS, KC_HOME,  KC_END,           KC_PSCR,    \
      KC_TRNS,   KC_LEFT, KC_DOWN, KC_RIGHT,RGB_HUD, RGB_SAD, RGB_VAD,KC_LEFT,  KC_DOWN,  KC_RIGHT,   KC_PGUP, KC_PGDN,  KC_TRNS,             KC_ENT,    \
      KC_LSFT, KC_TRNS,   KC_TRNS,   ICON_EMAIL,  CHESTER_EMAIL,KC_TRNS,  KC_TRNS,  KC_TRNS,KC_TRNS,KC_TRNS, KC_INS,  KC_DEL,  KC_TRNS, KC_RSFT,  KC_VOLU,      \
      KC_LCTL, KC_LGUI, KC_LALT,                          KC_SPC,                          KC_RCTL, KC_TRNS,     KC_RALT, KC_MUTE,KC_VOLD),
