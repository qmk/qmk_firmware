...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_masahide(
			...
			KC_LCTL, KC_LALT, KC_LGUI,					LT(1,KC_SPC),KC_SPC,      KC_RALT,KC_RGUI, KC_RCTL,	KC_RALT, KC_LEFT,  KC_DOWN, KC_RGHT),

	[1] = LAYOUT_masahide(
			KC_TILD, KC_F1,   KC_F2,   KC_F3,	KC_F4,	KC_F5,       KC_F6,       KC_F7,  KC_F8,   KC_F9,   KC_F10,  KC_F11,   KC_F12,	KC_DEL,
			KC_TAB,  KC_Q,	  KC_W,    KC_E,	KC_R,	KC_T,		 KC_LEFT,     KC_DOWN,KC_UP,   KC_RGHT,	KC_P,	 KC_LBRC,  KC_RBRC, KC_BSLS,
			KC_CAPS, KC_A,	  KC_S,    KC_D,	KC_F,	KC_G,		 KC_H,	      KC_J,   KC_K,    KC_L,	KC_SCLN, KC_QUOT,  KC_ENT,			 
			KC_LSFT, KC_Z,	  KC_X,    KC_C,	KC_V,	KC_B,		 KC_N,	      KC_M,   KC_COMM, KC_DOT,	KC_SLSH, KC_UP,					 
			KC_LCTL, KC_LALT, KC_LGUI,					LT(1,KC_SPC),LT(2,KC_SPC),KC_RALT,KC_RGUI, KC_APP,	KC_RALT, KC_LEFT,  KC_DOWN, KC_RGHT),
	...
	[2] = LAYOUT_masahide(
			...
			KC_CAPS, KC_A,	  KC_S,    KC_D,	KC_F,	KC_G,		 KC_H,	      KC_J,   KC_K,    KC_L,	KC_SCLN, KC_QUOT,  KC_ENT,			 
			KC_LSFT, KC_Z,	  KC_X,    KC_C,	KC_V,	KC_B,		 KC_N,	      KC_M,   KC_COMM, KC_DOT,	KC_SLSH, KC_UP,					 
			KC_LCTL, KC_LALT, KC_LGUI,					LT(1,KC_SPC),KC_SPC,      KC_RALT,KC_RGUI, KC_APP,	KC_RALT, KC_LEFT,  KC_DOWN, KC_RGHT),
};
