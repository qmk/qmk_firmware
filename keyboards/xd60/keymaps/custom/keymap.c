...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_all_rev3(
      ...
      KC_LCTL, KC_LALT, KC_LGUI,          KC_LSFT,                KC_SPC,         KC_ESC,  KC_RALT, KC_RCTL,  KC_LEFT, KC_DOWN,  KC_RIGHT),
  // 1: Function Layer
  LAYOUT_all_rev3(
      KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,    KC_F9,    KC_F10,   KC_F11,  KC_F12,  KC_TRNS,   KC_TRNS, \
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MUTE,  KC_VOLU,  KC_VOLD,  KC_TRNS, KC_TRNS,            KC_TRNS,  \
