...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_75_ansi_split_space(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, KC_VOLD, KC_SPC,  KC_VOLU, KC_SPC,           KC_SPC,           KC_RALT, MO(1),   KC_RCTL,      KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_75_ansi_split_space(
        ...
        _______, _______, _______, KC_MPRV, _______, KC_MNXT, _______,          _______,          _______, _______, _______,      _______, _______, _______
    ),
    [2] = LAYOUT_75_ansi_split_space(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,         _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
