...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLMAK] = LAYOUT_ortho_5x14(
        ...
        KC_LCTL, KC_A  ,KC_R   ,KC_S   , KC_T  , KC_D  , KC_PGDN  , 			KC_PGUP  , KC_H   , KC_N    , KC_E    , KC_I   , KC_Y    ,KC_QUOT ,
    ...
    [_RAISE] = LAYOUT_ortho_5x14(
        ...
        KC_TRNS, KC_TRNS  ,KC_TRNS   ,KC_TRNS   , KC_TRNS  , KC_TRNS  , KC_TRNS  ,              KC_TRNS  , KC_LEFT , KC_DOWN    , KC_UP , KC_RIGHT , KC_SCLN,KC_QUOT ,
        KC_TRNS, KC_TRNS  ,KC_TRNS   ,KC_TRNS   , KC_TRNS  , KC_TRNS  , KC_TRNS ,               KC_TRNS  , KC_TRNS , KC_TRNS    , KC_TRNS , KC_TRNS , KC_NUBS, KC_TRNS,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_COLMAK] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    rgblight_set_layer_state(2, layer_state_cmp(state, _COLMAK));
    return state;
}
