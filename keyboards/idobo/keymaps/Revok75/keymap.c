...
/* FUNCTION
* .--------------------------------------------------------------------------------------------------------------------------------------.
* | ESC    | F1     | F2     | F3     | F4     | F5     | F6    | F7     | F8     | F9     | F10    | -       | MUTE  | VOLDN   | VOLUP  |
* |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
...
*/
 ...
 [_FN] = { /* OSLAYOUT + NUMPAD + MEDIA + LIGHTING */
   { KC_TRNS, KC_F1,     KC_F2,						 KC_F3,    		   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_TRNS, KC_MUTE, KC_VOLD, KC_VOLU},
