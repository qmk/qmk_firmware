...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QW_W] = LAYOUT_ortho_5x15( /* QWERTY WIN*/
	...
	/* FUNCTION
	* .--------------------------------------------------------------------------------------------------------------------------------------.
	* | ESC    | F1     | F2     | F3     | F4     | F5     | F6    | F7     | F8     | F9     | F10    | MUTE    | VOLDN  | VOLUP  | DEL    |
	* |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
	...
	*/
 	...
 	[_FN] = LAYOUT_ortho_5x15( /* OSLAYOUT + NUMPAD + MEDIA + LIGHTING */
  	KC_TRNS, KC_F1,     KC_F2,						 KC_F3,    		   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_MUTE, KC_VOLD, KC_VOLU, KC_DEL, \
