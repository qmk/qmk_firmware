...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_ortho_5x15( \
    ...
    KC_ESC,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,        _______,   RESET, KC_INS,   KC_H,         KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,  \
    KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,        _______, _______, _______,  KC_N,         KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_EQUAL, \
    KC_LCTL,   _______, KC_LGUI, KC_LALT, KC_SPC,  MO(_RAISE),  _______, _______, _______,  OSL(_RAISE),  KC_BSPC, KC_RALT, _______, _______,  KC_ENT    \
  ),
