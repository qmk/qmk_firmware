 ...
 */
 ...
 [QWE] = LAYOUT_ortho_5x15(
  ...
  CTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_KP_4, KC_KP_5, KC_KP_6, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
        ...
        MO(MED), KC_LGUI, KC_LALT, MO(MED), MO(SYM), KC_SPC,  KC_KP_0, KC_PDOT, KC_PENT, KC_SPC,  MO(SYM), MO(MED), KC_RALT, KC_RGUI, MO(MAX) \
 ),
 ...
 [OSX] = LAYOUT_ortho_5x15(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, KC_LGUI, _______, _______, MO(SYM), _______, _______, _______, _______, _______, MO(SYM), _______, _______, KC_RGUI, _______ \
 ),
/* SYMBOL
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 ...
 */
 [SYM] = LAYOUT_ortho_5x15(
    LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS,\
    LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, KC_INS,  KC_HOME, KC_PGUP,   LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, KC_DEL,  \
    LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, KC_DEL,  KC_END,  KC_PGDN,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, LG_TRNS, LG_TRNS, \
    LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, LG_TRNS, KC_P1,   KC_P2,   KC_P3,   LG_TRNS, LG_TRNS, KC_LBRC, KC_RBRC, LG_TRNS, LG_TRNS, \
    _______, _______, _______, _______, _______, _______, KC_P0,   KC_PDOT, KC_PENT, _______, _______, _______, _______, _______, _______ \
 ),
