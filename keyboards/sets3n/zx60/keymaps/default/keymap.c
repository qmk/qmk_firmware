...
// 0:Base Layer
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,           KC_SPC,           KC_SPC,           KC_RALT, KC_MO(1), XXXXXXXX, KC_RGUI, KC_RCTL
    ),
...
// 1:Fn Layer
    [1] = LAYOUT(
        ...
        _______, KC_NO,   _______, _______, BL_DEC,  BL_TOGG, BL_INC,  BL_STEP, _______, _______, _______, _______,          _______, _______, 
