...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_default(
    ...
    KC_CAPS, KC_A   , KC_S   , KC_D   , KC_F   , KC_G   , KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT, KC_ENT , KC_NO  , KC_PGDN, KC_KP_4, KC_KP_5, KC_KP_6, KC_PPLS,
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_NO  , KC_NO  , KC_SPC , KC_NO  , KC_NO  , KC_NO  , KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_NO  , KC_RIGHT,KC_KP_0, KC_KP_0, KC_KP_DOT , KC_PMNS 
  )
};
