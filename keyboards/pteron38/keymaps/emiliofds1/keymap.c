...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MOVEMENT] = LAYOUT_split_3x5_3_encoder(
      ...
      KC_NO,   KC_MS_BTN5,  KC_ESCAPE,     KC_MS_BTN4,    KC_MS_WH_DOWN,    KC_MPRV,            KC_MNXT, KC_DEL,     KC_CUT,     KC_COPY,  KC_PASTE,    KC_NO,
  ...
  [_GAMING] = LAYOUT_split_3x5_3_encoder(
      ...
      KC_LCTL,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_G,    TO(_QWERTY), KC_NO,    KC_NO,    KC_NO, KC_NO,  KC_NO,
                       KC_G, KC_LGUI, KC_SPC, KC_LALT,           TO(_WOW), KC_NO, KC_NO, TO(_LOL)
  ),
