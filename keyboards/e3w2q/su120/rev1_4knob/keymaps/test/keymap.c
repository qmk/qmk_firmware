...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   *  |  SA6  SB6  SC6  SD6  SE6  SF6 
   *  `-------------------------------
   */

  [_DEFAULT] = LAYOUT( /* Base */ 
    SEND_A1,  SEND_B1,  SEND_C1,  SEND_D1,  SEND_E1,  SEND_F1,  
    SEND_A2,  SEND_B2,  SEND_C2,  SEND_D2,  SEND_E2,  SEND_F2,  
    SEND_A3,  SEND_B3,  SEND_C3,  SEND_D3,  SEND_E3,  SEND_F3,  
    SEND_A4,  SEND_B4,  SEND_C4,  SEND_D4,  SEND_E4,  SEND_F4,  
    SEND_A5,  SEND_B5,  SEND_C5,  SEND_D5,  SEND_E5,  SEND_F5,  
    SEND_A6,  SEND_B6,  SEND_C6,  SEND_D6,  SEND_E6,  SEND_F6,  

    SEND_SA1, SEND_SB1, SEND_SC1, SEND_SD1, SEND_SE1, SEND_SF1, 
    SEND_SA2, SEND_SB2, SEND_SC2, SEND_SD2, SEND_SE2, SEND_SF2, 
    SEND_SA3, SEND_SB3, SEND_SC3, SEND_SD3, SEND_SE3, SEND_SF3, 
    SEND_SA4, SEND_SB4, SEND_SC4, SEND_SD4, SEND_SE4, SEND_SF4, 
    SEND_SA5, SEND_SB5, SEND_SC5, SEND_SD5, SEND_SE5, SEND_SF5, 
    SEND_SA6, SEND_SB6, SEND_SC6, SEND_SD6, SEND_SE6, SEND_SF6  
  ),
};
