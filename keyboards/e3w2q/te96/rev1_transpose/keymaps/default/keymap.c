...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   *  |    H    J    K    L    ; Entr 
   *  |    N    M    ,    .    / Shft 
   *  | Spce  HEN KANA  Alt Ctrl MO(1)
   *  | XXXX XXXX PgUp XXXX   Up  F12 
   *  | XXXX XXXX PgDn Left Down Rght 
   *  `-------------------------------
   */
  ...
  [0] = LAYOUT( /* Base */ 
    ...
    KC_SPC,   KC_HENK,  KC_KANA,  KC_RALT,  KC_RCTL,  MO(1),    
    XXXXXXX,  XXXXXXX,  KC_PGUP,  XXXXXXX,  KC_UP,    KC_F12,   
    XXXXXXX,  XXXXXXX,  KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RGHT   
  ),
