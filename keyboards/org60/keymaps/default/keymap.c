...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // 1: Function Layer
  [1] = LAYOUT(
    RESET,   KC_F1,   KC_F2,   KC_F3,    KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NO,           \
    ...
    KC_LSFT,          KC_NO,   KC_APP,   BL_STEP, KC_NO,   KC_NO,   KC_VOLD, KC_VOLU, KC_MUTE, KC_END,           KC_RSFT, KC_PGUP, KC_INS, \
    KC_LCTL, KC_LGUI, KC_LALT,                             KC_SPC,                             KC_RGUI, F(0),    KC_HOME, KC_PGDN, KC_END
  ),
