...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * |Adjust| Ctrl | Alt  | GUI  |Lower | Space|RGBTOG|Raise | Left | Down |  Up  |Right |
    * `-----------------------------------------------------------------------------------'
    *                                              ^ encoder button
    */
        ...
        MO(3),   KC_LCTL, KC_LALT, KC_LGUI, MO(1),   KC_SPC,  RGB_TOG, MO(2),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
        ),
    ...
    */
        ...
        _______, _______, _______, _______, _______, _______, KC_MUTE, _______,    KC_MNXT,    KC_VOLD, KC_VOLU, KC_MPLY
        ),
