...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QW] = LAYOUT_ortho_4x12_wrapper (
        ...
        FN,      KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC, KC_SPC,  RAISE,   KC_DOWN, KC_UP,   KC_RGHT, T_DL     \
    ),
  ...
  */
  [_FN] = LAYOUT_ortho_4x12_wrapper (
        ...
        KC_TAB,    M05,       M06,       M07,       M08,       _______,   _______,   _______,  KC_LEFT,    KC_DOWN,   KC_RGHT,   T_UR,     \
