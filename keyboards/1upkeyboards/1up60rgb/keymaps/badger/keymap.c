...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MOVE]    = LAYOUT_60_ansi_split_rshift(\
     ...
     _______,    MM_UH,    MM_BH,    MAC_CPY,  MAC_PST,  IJ_IMPH,  _______,  IJ_REN,   IJ_IMPL,  IJ_DECL,  IJ_USAG,  KC_UP,     _______,  \
     _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______),

  [_FUNCTION] = LAYOUT_60_ansi_split_rshift(\
     KC_ESC,    KC_F1,    KC_F2,    KC_F3,    KC_F4,     KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,    KC_F12,   KC_DEL, \
     _______,   _______,  _______,  _______,  _______,   KC_MSTP,  KC_MPLY,  KC_PGUP,  _______,  _______,  KC_PGDN,  KC_VOLD,   KC_VOLU,  KC_INS, \
  ...
  [_MACRO]     = LAYOUT_60_ansi_split_rshift(\
     KC_ESC,    DF_1,     DF_2,     KC_F3,    KC_F4,     KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,    KC_F12,   KC_DEL, \
  ...
  [_CONFIG]     = LAYOUT_60_ansi_split_rshift(\
     ...
     _______,   LAG_SWP,  LAG_NRM,  KC_CAPS,  RGB_RMOD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  RGB_M_K,  _______,  _______,  _______,   _______, \
     _______,   _______,  _______,  _______,  _______,   _______,  _______,  _______)
};
