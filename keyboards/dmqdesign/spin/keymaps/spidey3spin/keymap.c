...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MACRO] = LAYOUT(
                MO(_FN),       HELLO,         CH_SUSP,       TO(_MACRO),
                KC_NO,         KC_NO,         KC_NO,         TO(_NUMPAD),
                C(A(KC_COMM)), KC_NO,         C(A(KC_DOT)),  TO(_RGB),
                KC_NO,         CH_ASST,       CH_CPNL
                ),
...
const rgblight_segment_t PROGMEM _macro_layer[] = RGBLIGHT_LAYER_SEGMENTS({0, 1, HSV_GREEN});
const rgblight_segment_t PROGMEM _numpad_layer[] = RGBLIGHT_LAYER_SEGMENTS({1, 1, HSV_GREEN});
const rgblight_segment_t PROGMEM _rgb_layer[] = RGBLIGHT_LAYER_SEGMENTS({2, 1, HSV_GREEN});
