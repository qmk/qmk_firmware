...
[1] = LAYOUT_60_iso( /* FN */
    ...
    _______,  _______,  KC_UP,    _______,  _______,  _______,  _______,  _______,  KC_PSCR,  KC_SLCK,  KC_PAUS,  KC_UP,    _______,          \
...
/* TODO: replace RESET with QK_BOOT below */
[3] = LAYOUT_60_iso( /* RGB and media controls */
    ...
    KC_CAPS,  _______,  _______,  _______,  S1_DEC,   S1_INC,   S2_DEC,   S2_INC,   _______,  _______,  _______,  _______,  _______,  _______,\
