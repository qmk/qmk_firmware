...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_alice( /* FN */
        ...
        KC_END,  _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, RGB_HUI, RGB_HUD, _______, _______, _______, _______, _______,
                 _______, _______, _______, _______, _______, _______, RGB_SAI, RGB_SAD, _______, _______, _______, _______, _______, _______,
