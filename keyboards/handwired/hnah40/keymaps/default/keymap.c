...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT( /* Base */
    ...
    [_RAISE] = LAYOUT( /* Base */
    QK_BOOT, KC_1,  KC_UP,  KC_TRNS, KC_TRNS, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_DEL, 
    KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_ENT,
