...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WINBASE] = LAYOUT_wrapper( \
             _______________DVORAK_L1___________________, KC_SPC,       KC_____, _______________DVORAK_R1___________________, \
    RGB_TOG, _______________DVORAK_L2___________________, KC_B,         KC_____, _______________DVORAK_R2___________________, KC_____, \
  ...
  [_GAMER] = LAYOUT_wrapper( \
    ...
    RGB_MOD, KC_LSFT, KC_X,    KC_Z,    KC_C,    KC_3,        KC_M,        KC_____, _________________MEDIA_____________________, KC_____, \
             KC_____, KC_____,       MO(_GAMR1), KC_LSFT,   KC_SPC,        KC_____, KC_____, KC_____,           KC_____, KC_____, \
