...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WINBASE] = LAYOUT_wrapper( \
             _______________DVORAK_L1___________________, KC_____,      KC_____, _______________DVORAK_R1___________________, \
    RGB_TOG, _______________DVORAK_L2___________________, KC_____,      KC_____, _______________DVORAK_R2___________________, KC_____, \
    RGB_MOD, _______________WINDVK_L3___________________, KC_____,      KC_____, _______________WINDVK_R3___________________, KC_____, \
  ...
  [_MACBASE] = LAYOUT_wrapper( \
             _______________DVORAK_L1___________________, KC_____,      KC_____, _______________DVORAK_R1___________________, \
    RGB_TOG, _______________DVORAK_L2___________________, KC_____,      KC_____, _______________DVORAK_R2___________________, KC_____, \
    RGB_MOD, _______________MACDVK_L3___________________, KC_____,      KC_____, _______________MACDVK_R3___________________, KC_____, \
             KC_____, KC_____,          KC_____, KC_____, KC_____,      KC_____, KC_____, KC_____,          KC_____, KC_____, \
  ...
  [_GAMER] = LAYOUT_wrapper( \
             KC_R,    KC_Q,    KC_W,    KC_E,    KC_1,      KC_ESC,        RGB_TOG, _________________RGB_1_____________________, \
    RGB_TOG, KC_F,    KC_A,    KC_S,    KC_D,    KC_2, LSFT(KC_F2),        KC_____, _________________RGB_2_____________________, KC_____, \
    RGB_MOD, KC_LSFT, KC_X,    KC_Z,    KC_C,    KC_3,        KC_M,        KC_____, _________________MEDIA_____________________, KC_____, \
             KC_____, KC_____,          KC_1,    KC_2,        KC_3,        KC_____, KC_____, KC_____,           KC_____, KC_____, \
                                     MO(_GAMR1), KC_LSFT,   KC_SPC,        KC_____, KC_____, KC_____ \
  ),

  [_GAMR1] = LAYOUT_wrapper( \
             KC_____, KC_____, KC_____, KC_____, KC_____,  KC_ESC,        RGB_TOG, _________________RGB_1_____________________, \
    RGB_TOG, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,       KC_6,        KC_____, _________________RGB_2_____________________, KC_____, \
    RGB_MOD, KC_____, KC_____, KC_____, KC_____, KC_____, KC_____,        KC_____, _________________MEDIA_____________________, KC_____, \
             KC_____, KC_____,          KC_____, KC_____, KC_____,        KC_____, KC_____, KC_____,           KC_____, KC_____, \
  ...
  [_FUNC] = LAYOUT_wrapper( \
             _____________FUNC_L1_______________________,    KC_____,      KC_____, _____________FUNC_1_______________, KC_____,\
    KC_____, ________MAC_MISSION_CTRL__________, LGUI(KC_L), KC_____,      KC_____, _____________FUNC_2_______________, KC_____, KC_____, \
    RGB_MOD, _____________FUNC_L3_______________________,    KC_____,      KC_____, _____________FUNC_3_______________, KC_____, KC_____, \
             KC_____, KC_____,          KC_____, KC_____,    KC_____,      KC_____, KC_____, KC_____,          KC_____, KC_____, \
