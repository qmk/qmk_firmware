...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MACBASE] = LAYOUT_wrapper( \
             _________________RGB_1_____________________, KC_____,      KC_____, _______________DVORAK_R1___________________, \
    KC_____, _________________RGB_2_____________________, KC_____,      KC_____, _______________DVORAK_R2___________________, KC_____, \
