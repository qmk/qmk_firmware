...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MACBASE] = LAYOUT_wrapper( \
    ...
    KC_____, _______________DVORAK_L2___________________, KC_____,      KC_____, _______________DVORAK_R2___________________, KC_____, \
    KC_____, _______________MACDVK_L3___________________, KC_____,      KC_____, _______________MACDVK_R3___________________, KC_____, \
