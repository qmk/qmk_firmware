...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_F] = LAYOUT_english_international(
        ...
        _______,  _______, _______, _______, _______ /*QK_BACKLIGHT_STEP*/, _______, _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END
    ),
    [_F_L] = LAYOUT_english_international(
        _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, KC_BRID, KC_BRIU, KC_MYCM, XXXXXXX, KC_PSCR, KC_CPNL, KC_INS,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, MO(_F_T),_______, _______, _______ /*QK_BACKLIGHT_STEP*/, _______, _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END
    ),
    [_F_T] = LAYOUT_english_international(
