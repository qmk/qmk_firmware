...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_all( /* Base */
    KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4,   KC_F5, KC_F6, KC_F7, KC_F8,   KC_F9, KC_F10, KC_F11, KC_F12,    KC_PSCR, KC_SLCK, KC_PAUS,    KC_MYCM, KC_CALC, KC_MPLY, MO(1),\
  ...
  [_FN] = LAYOUT_all( /* Base */
    RESET,       BL_STEP,RGB_TOG, RGB_MOD, RGB_RMOD,     RGB_HUI, RGB_HUD, RGB_VAI, RGB_VAD,     _______, _______, _______, _______,    _______, _______, _______,    _______, _______, _______, _______,\
...
void rgb_matrix_indicators_user(void)
{
        ...
        } else if (IS_LED_ON(host_keyboard_leds(), USB_LED_NUM_LOCK))
        {
            rgb_matrix_set_color(30, 0xFF, 0x00, 0x00);
        } else if (IS_LED_ON(host_keyboard_leds(), USB_LED_SCROLL_LOCK))
        {
