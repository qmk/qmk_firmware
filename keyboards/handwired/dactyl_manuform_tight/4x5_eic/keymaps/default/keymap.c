...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        GT_A,  AT_S,    CT_D,     ST_F,  KC_G,   KC_LBRC,    KC_RBRC, KC_H,   ST_J, CT_K,    AT_L,   GT_SCLN,
    ...
    [_LOWER] = LAYOUT(
        ...
        KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LPRN,            KC_RPRN, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
        _______, _______, _______, _______, _______,                              _______, KC_BSLS, KC_PIPE, _______, _______,
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, _______, _______, _______, _______,                      _______, _______, _______, _______, _______,
                 QK_BOOT, _______,                                                          _______, A(KC_TAB),
