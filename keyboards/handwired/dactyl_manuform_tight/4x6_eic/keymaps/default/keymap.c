...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        KC_ESC,  KC_Q,  KC_W,    KC_E,    KC_R,  KC_T,   KC_EQL,     KC_MINS, KC_Y,   KC_U,  KC_I,    KC_O,   KC_P,    KC_BSLS,
    ...
    [_LOWER] = LAYOUT(
        ...
        KC_CAPS, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,            _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV,
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT, _______, _______,    _______, _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END,  _______,
        _______, _______, _______, _______, _______, _______,                      _______, _______, _______, _______, _______, _______,
                          _______, _______,                                                          _______, A(KC_TAB),
