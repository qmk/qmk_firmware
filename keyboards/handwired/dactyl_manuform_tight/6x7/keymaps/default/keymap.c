...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_CAPS, KC_ESC,  KC_Q,  KC_W,    KC_E,    KC_R,  KC_T,                       KC_Y,   KC_U,  KC_I,    KC_O,   KC_P,    KC_BSLS, KC_PSCR,
        KC_HOME, KC_TAB,  KC_A,  KC_S,    KC_D,    KC_F,  KC_G,                       KC_H,   KC_J,  KC_K,    KC_L,   KC_SCLN, KC_QUOT, KC_END,
