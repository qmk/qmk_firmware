 ...
 * |--------+--------+--------+--------+--------+--------+----------------|            |--------+--------+--------+--------+--------+--------+--------|
 * |KC_TAB,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,  KC_MPLY,                       KC_MPLY, KC_H,    KC_J,   KC_K,     KC_L,    KC_SCLN,KC_QUOT |
 * |--------+--------+--------+--------+--------+--------+----------------|            |--------+--------+--------+--------+--------+--------+--------|
 * |KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  KC_SPC,                       KC_RCMD, KC_N,    KC_M,   KC_COMM,  KC_DOT,  KC_UP,  KC_ENTER|
 * |--------+--------+--------+--------+--------+--------+--------------------|        |--------+--------+--------+--------+--------+--------+--------|
 *         KC_EQUAL,   LOWER,  KC_LCTL, KC_RALT,   KC_LCMD,  KC_KB_VOLUME_DOWN|        | KC_NO,   KC_SPC,  RAISE,  KC_SLASH, KC_LEFT, KC_DOWN,KC_RIGHT
 *                                       |------------------------------------|        |--------------------------|
 */
[_QWERTY] = LAYOUT_frame_48(
    ...
    KC_TAB,     KC_A,     KC_S,       KC_D,       KC_F,     KC_G,     KC_MPLY,                    KC_MPLY,    KC_H,       KC_J,         KC_K,       KC_L,     KC_SCLN,  KC_QUOT,
    KC_LSFT,    KC_Z,     KC_X,       KC_C,       KC_V,     KC_B,     KC_SPC,                     KC_RCMD,    KC_N,       KC_M,         KC_COMM,    KC_DOT,   KC_UP,    KC_ENTER,
    KC_MINUS,   KC_EQUAL, FN_MO13,    KC_LCTL,    KC_RALT,  KC_LCMD,                              KC_NO,      KC_SPC,     FN_MO23,      KC_SLASH,      KC_LEFT,  KC_DOWN,  KC_RIGHT
),

[_LOWER] = LAYOUT_frame_48(
    KC_ESC,     KC_EXLM,  KC_AT,       KC_HASH,    KC_DLR,   KC_PERC,                             KC_NO,      KC_CIRC,    KC_AMPR,     KC_ASTR,    KC_LPRN,  KC_RPRN,  KC_BSPC,
    ...
    KC_TRNS,    KC_TRNS,  FN_MO13,     KC_TRNS,    KC_TRNS,  KC_TRNS,                             KC_NO,      KC_TRNS,    FN_MO23,     KC_ENT,       KC_RALT,  KC_TRNS,  KC_TRNS
),
...
[_RAISE] = LAYOUT_frame_48(
    ...
    KC_TRNS,    KC_TRNS,  FN_MO13,     KC_TRNS,    KC_SPC,   KC_TRNS,                             KC_NO,      KC_TRNS,    FN_MO23,    KC_ENT,     KC_RALT,  KC_TRNS,  KC_TRNS
),
[_ADJUST] = LAYOUT_frame_48(
    ...
    KC_TRNS,    KC_TRNS,  KC_TRNS,     KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,                   KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,
    KC_TRNS,    KC_TRNS,  KC_TRNS,     KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,                   KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,
    KC_TRNS,    KC_TRNS,  FN_MO13,     KC_TRNS,    KC_TRNS,  KC_TRNS,                             KC_NO,      KC_TRNS,    FN_MO23,     KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS
),
};
