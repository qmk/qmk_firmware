...
/*
  ...
  [_NUMPAD] = LAYOUT_split60( \
    ...
    _______,  _______,  _______,  QWERTY,          _______,                 KC_P0,  KC_PDOT,   _______,    _______, _______  \
  ),
...
/*
  ...
  [_FN] = LAYOUT_split60( \
    ...
    _______,  _______,  _______, _______,  _______,  _______,   KC_END,  _______,  KC_VOLD,  KC_VOLU,    KC_MUTE,                     _______,   \
