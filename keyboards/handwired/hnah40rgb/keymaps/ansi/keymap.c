...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_L2] = LAYOUT_ansi(/* Base */
                 RM_TOGG,         RM_PREV,  KC_UP,     RM_NEXT,   RM_HUEU,  RM_VALU,  RM_SATU,  RM_SPDU,  KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS,
                 KC_TRNS,         KC_LEFT,  KC_DOWN,   KC_RGHT,   RM_HUED,  RM_VALD,  RM_SATD,  RM_SPDD,  KC_TRNS,  KC_TRNS,  KC_TRNS,
