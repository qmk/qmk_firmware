...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(KC_ESC,  KC_1,    KC_2,    KC_3,   KC_4,  KC_5,   KC_GRV,                  KC_MINS,    KC_6,   KC_7,   KC_8,    KC_9,    KC_0,    KC_BSPC,
	             KC_TAB,  KC_Q,    KC_W,    KC_E,   KC_R,  KC_T,   TD(OP_QT),               TD(CL_QT),  KC_Y,   KC_U,   KC_I,    KC_O,    KC_P,    KC_EQL,
				 ...
				 KC_LCTL, KC_LGUI, KC_LALT, KC_DEL, LT(1,KC_BSPC), KC_SPC, KC_ENT,          KC_ENT,     KC_SPC, KC_APP, KC_LEFT, KC_RGHT, KC_UP,   KC_DOWN),
