...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_PC] = LAYOUT(
      ...
      KC_LCTL, KC_LGUI, KC_LALT,                                     KC_SPACE,                  KC_RALT, MO(_FN), KC_APP,  KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT,     KC_P0,            KC_PDOT),
  [_MAC] = LAYOUT(
      ...
      KC_LCTL, KC_LALT, KC_LGUI,                                     KC_SPACE,                  KC_RALT, MO(_FN), KC_APP,  KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT,     KC_P0,            KC_PDOT),
  [_FN] = LAYOUT(
