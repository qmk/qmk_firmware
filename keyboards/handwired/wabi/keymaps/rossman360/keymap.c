...
[_BASE] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_MINS, KC_UP, \
    CMDBSP,  ALTDEL,           CTRLSP,  KC_TAB,  PGMOD  , ENTMOD , SPCMOD , MO(_DEL),                  KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
[_DEL] = LAYOUT(
...
[_NUM] = LAYOUT(
    ...
    _______, _______,          _______, KC_0   , _______, KC_NO  , KC_NO  , KC_0   ,                   _______, _______, _______  \
  ),
};
