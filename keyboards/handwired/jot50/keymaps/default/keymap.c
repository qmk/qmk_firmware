...
#define _FUNCT LAYOUT_ortho_5x12 (\
    ...
    KC_GRV,  KC_F11,  KC_F12,  _______, _______, _______, _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______,\
    _______, KC_VOLD, KC_MUTE, _______, _______, _______, _______, _______, _______, _______, _______, KC_BSLS,\
    _______, KC_MPRV, KC_MPLY, _______, _______, _______, _______, _______, _______, _______, _______, _______,\
