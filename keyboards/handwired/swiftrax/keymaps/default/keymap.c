  ...
  switch (keycode) {
	...
	case RAGE:
	 ...
	 case RAND:
	  ...
	  case STR:
      if (record->event.pressed) { //RAND String
        // when keycode STR is pressed
		send_string("Hello \n");
      } else {
        // when keycode STR is released
      }
	  break;
  }
  return true;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT( /*base layer*/
		STR, RAND, KC_ESC, 	KC_1, 	KC_2, 	KC_3, 	KC_4, 	KC_5, 	KC_6, 	KC_7, 	KC_8, 	KC_9, 	KC_0, 	 KC_MINS, 	KC_EQL, KC_GRV, KC_BSLS, 
		...
		KC_LGUI, KC_F17, KC_LCTL, KC_LALT, 				KC_SPC, 			FN, 	KC_LCTL, 				   	  KC_LEFT, KC_DOWN, KC_RGHT), 
		
	[1] = LAYOUT( /*dvorak*/
		_______, RAND, KC_ESC, 	KC_1, 	KC_2, 	KC_3, 	KC_4, 	KC_5, 	KC_6, 	KC_7, 	KC_8, 	KC_9, 	KC_0, 	 KC_RBRC, 	KC_LBRC, KC_GRV, KC_BSLS, 
	...
	[2] = LAYOUT( /*fn layer*/
		RAGE, _______, _______, 	KC_F1, 	KC_F2, 	KC_F3, 	KC_F4, 	KC_F5, 	KC_F6, 	KC_F7, 	KC_F8, 	KC_F9, 	KC_F10, 	 KC_F11, 	KC_F12, _______, _______, 
		_______, _______, _______, 	_______, 	_______, 	_______, 	_______, 	_______, 	_______, 	_______, 	_______, 	_______, 	_______, 	 _______, 	_______,_______,_______, 
		_______, _______, KC_CAPS, _______, 	_______, 	_______, 	_______, 	_______, 	_______, 	_______, 	_______, 	_______, 	_______, _______, 	_______, KC_BTN3, _______, 
		_______, _______, _______, _______, 	_______, 	_______, 	_______, 	_______, 	_______, 	_______,   _______,_______, _______, _______, 	_______, 			_______, 
		_______, KC_PSCR, _______, _______, 				_______, 			_______, 	_______, 				   KC_MPRV, _______, KC_MNXT),
};
