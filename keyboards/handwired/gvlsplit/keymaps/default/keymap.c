...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_UP, KC_LCTL, KC_LGUI, KC_LALT, MO(1), KC_SPC, KC_ESC,    KC_BSPC, KC_ENT, MO(2), MO(3), KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_RAISE] = LAYOUT(
        KC_TILD, KC_EXLM, KC_HASH, KC_DLR, KC_PERC,                 KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                   KC_NO, KC_NO, KC_LBRC, KC_RBRC, KC_NO, KC_NO, KC_NO,
