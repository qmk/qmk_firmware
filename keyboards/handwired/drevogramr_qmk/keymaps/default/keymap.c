...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_CAPS,            KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCOLON,KC_QUOTE,           KC_ENT,   KC_PGDN,  \
    ...
    [1] = LAYOUT(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  NK_TOGG,  TG(2),    GUI_OFF,  KC_NLCK,  KC_SLCK,  KC_INS,  \
        ...
        _______,            _______,  _______,  _______,  _______,  _______,  _______,  KC_P0,    KC_P0,    KC_PDOT,  KC_PPLS,            _______,  BL_INC,   _______, \
        _______,  GUI_ON,   _______,                                _______,                                _______,  _______,  _______,  BL_BRTG,  BL_DEC,   BL_TOGG  \
    ),
