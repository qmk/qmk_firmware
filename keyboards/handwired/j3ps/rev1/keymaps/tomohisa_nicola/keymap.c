...
/*      KC_ESC,  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, \
  ...
  [_NICOLA] = LAYOUT( \
      ...
      KC_LCTL, KC_LCTL, NG_A,    NG_S,    NG_D,    NG_F,    NG_G,   NG_H,    NG_J,    NG_K,    NG_L,    NG_SCLN, KC_QUOT, KC_ENT,  _______, \
      KC_LSFT, KC_LSFT, NG_Z,    NG_X,    NG_C,    NG_V,    NG_B,   NG_N,    NG_M,    NG_COMM, NG_DOT,  NG_SLSH, KC_ENT , EISU, KANA, \
      _______,  _______, _______, KC_LGUI, NG_SHFTL,  LOWER,   KC_SPC, RAISE,   KC_ENT,  NG_SHFTR,  KC_BSPC, KC_DEL,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, _______, KC_MNXT, KC_VOLD, KC_MPLY,  EISU,  _______,  KC_PGDN,  KC_LEFT,  KC_DOWN, KC_RGHT, _______, _______, _______, _______, \
      _______, _______, _______, _______, _______,  _______,  _______,  _______,  _______,  _______, _______, _______, _______, EISU, KANA, \
      _______, _______, _______, _______, _______,  _______,  _______,  _______,  KANA,  _______, _______, _______, _______, _______, _______,_______\
      ),
...
*/
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD,  _______,  _______,  _______,  _______, _______, _______, _______, EISU, KANA, \
      _______, _______, _______, _______, _______,  _______,  _______,  _______,  _______,  _______, _______, _______, _______, _______, _______,_______\
      ),
