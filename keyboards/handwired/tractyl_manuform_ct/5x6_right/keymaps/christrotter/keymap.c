...
[_MOUSE] = LAYOUT( \
    ...
    _______, _______, _______, _______, _______, _______,                               _______, _______, _______, _______, _______, _______,
                _______, _______,  KC_MACLOCK, _______, KC_CAD,         _______, _______, _______, _______, _______, _______,
                                _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______
),
[_NAV] = LAYOUT( \
    _______, _______, _______, _______, _______, _______,                               KC_PGUP, _______, KC_UP, _______, _______, KC_MACSHOT,
