...
[_NAV] = LAYOUT( \
    ...
    KC_ESC,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                               KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLASH, KC_P,
                KC_BSPC, KC_DEL,  KC_ESC, KC_LBRC, KC_RBRC,        KC_HOME, KC_END, KC_LGUI, KC_R, KC_ENTER, KC_SPACE,
                                KC_LSFT, KC_LALT, KC_LGUI, KC_R,        KC_PGUP, KC_PGDN, KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT
)
};
