...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
     ...
     //_FUNC_CAPS_LALT_LGUI_SPC_BSPC  _ENT_SPC_RGUI_RALT_APP_FUNC
      KC_ESC,  KC_1, KC_2, KC_3, KC_4, KC_5, KC_xx,                    KC_xx,   KC_6, KC_7, KC_8,    KC_9,   KC_0,    KC_BSPC,
    ...
    [_FN] = LAYOUT(
     ...
     //_TRNS_PSCR_TRNS_TRNS_NO_NO              _NO_NO_TRNS_TRNS_PSCR_TRNS
      KC_xx, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_xx,               KC_xx,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
       KC_xx, KC_xx,   KC_PAUS, KC_SLCK, KC_xx,   KC_xx,   KC_xx,             KC_xx,  KC_xx,   KC_xx,   KC_SLCK, KC_PAUS, KC_xx,   KC_F12,
      KC___, KC_HOME, KC_xx,   KC_UP,   KC_xx,   KC_PGUP, KC_INS,              KC_INS, KC_PGUP, KC_xx,   KC_UP,   KC_xx,   KC_HOME, KC___,
     KC___, KC_END,  KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_DEL, KC_xx,  KC_xx, KC_DEL, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  KC___, 
     KC___,    KC_PSCR,       KC___,    KC___,   KC_xx,        KC_xx,    KC_xx,   KC_xx, KC___,           KC___,    KC_PSCR,          KC___
    )
};
