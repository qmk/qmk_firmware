...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LBRC, KC_RBRC,                                                           KC_MINS, KC_EQL, KC_RALT, KC_RCTL,
                                            ...
                                            KC_HOME, KC_PGUP, KC_LGUI,       KC_RGUI, KC_PGDN, KC_END
    ),

    [_LOWER] = LAYOUT(
        KC_TILD,KC_EXLM, KC_AT ,KC_HASH,KC_DLR ,KC_PERC,                        KC_CIRC,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,_______,
        _______,_______,_______,_______,_______,KC_LBRC,                        KC_RBRC, KC_P7 , KC_P8 , KC_P9 ,_______,_______,
        _______,_______, KC_INS,KC_PAUS,KC_PSCR,KC_LPRN,                        KC_RPRN, KC_P4 , KC_P5 , KC_P6 ,_______,_______,
    ...
    [_RAISE] = LAYOUT(
        ...
        _______,_______,_______,_______,_______,KC_TRNS,                        KC_TRNS,_______,KC_NUM,KC_INS ,KC_SCRL,KC_MUTE,
