...
#define TKMGR RCS(KC_ESC)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        KC_F1,   KC_F2, KC_F3,   KC_F4,   KC_F5,   KC_F6,   DKMGR,        TKMGR,    KC_F7, KC_F8, KC_F9,   KC_F10,  KC_F11,  KC_F12,
        ...
        KC_LALT, APP_P, KC_LEFT, KC_RGHT,                                                         KC_UP,   KC_DOWN, APP_N,   KC_RALT,
                                          ...
                                          KC_LGUI, KC_LSFT, KC_HOME,      KC_END, KC_RSFT, KC_RGUI
    ),
