...
[_QWERTY] = LAYOUT(
    ...
    KC_LCTL,            MO(_FN),KC_LGUI, KC_LALT, KC_SPC,         KC_BSPC,          KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
 ),
...
[_LOWER] = LAYOUT(
  ...
  QK_BOOT, _______, KC_HOME, KC_UP,   KC_END,  _______, _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
  _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_NUHS, KC_NUBS, _______, _______, _______,
...
[_RAISE] = LAYOUT(
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
  _______, _______, KC_HOME, KC_UP,   KC_END,  _______, QK_BOOT, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
  _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_NUHS, KC_NUBS, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______
),
...
[_FN] =  LAYOUT(
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  \
    KC_PSCR, _______, _______, RGB_HUD, RGB_HUI, _______, KC_MINS, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, \
    KC_MPRV, KC_MPLY, KC_MNXT, RGB_SAD, RGB_SAI, _______, KC_PLUS, _______, _______, _______, _______, _______, \
    KC_VOLD, KC_MUTE, KC_VOLU, RGB_VAD, RGB_VAI, _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, RGB_TOG, RGB_RMOD,RGB_MOD,                   _______, _______, _______, RGB_M_R, RGB_M_SW \
 )
