...
bool encoder_update_user(uint8_t index, bool clockwise) {
  if (index == 0) { /* First encoder */
    if (clockwise) {
      ...
      tap_code(pgm_read_word(&keymaps[biton32(layer_state)][0][7]));
    } else {
      //tap_code(KC_MS_WH_DOWN);
      //tap_code(dynamic_keymap_get_keycode(biton32(layer_state),1,7));
      tap_code(pgm_read_word(&keymaps[biton32(layer_state)][1][7]));
    }
  }else if (index == 1) { /* First encoder */
    if (clockwise) {
      //tap_code(KC_MS_WH_UP);
      //tap_code(dynamic_keymap_get_keycode(biton32(layer_state),2,7));
      tap_code(pgm_read_word(&keymaps[biton32(layer_state)][2][7]));
    } else {
      //tap_code(KC_MS_WH_DOWN);
      //tap_code(dynamic_keymap_get_keycode(biton32(layer_state),3,7));
      tap_code(pgm_read_word(&keymaps[biton32(layer_state)][3][7]));
    }
  }
  return true;
  }
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* |--L1---+--L2---+--L3---+--L4---+--L5---+--L6---+--L7---+--L8---+--L9---+|   |--R1---+--R2---+--R3---+--R4---+--R5---+--R6---+--R7---+--R8---+---R9--+--R10--+---R11--+ | */
      ...
      LT(_FN1,KC_LGUI),         KC_LEFT,KC_RGHT,MT(KC_RCTL,KC_SPC), KC_BSPC,  KC_LALT,  LT(_FN3,KC_APP),KC_ENT, MT(KC_RSFT,KC_SPC), KC_UP,  KC_DOWN,
        LSFT_T(KC_TAB), KC_TAB,                                                                                                                 KC_MS_WH_UP,KC_MS_WH_DOWN
    /* |--------+-------+-------+-------+-------+-------+-------+-------+-------+-------|   |--------+-------+-------+-------+-------+-------+-------+-------+-------+-------|*/
    ),
   ...
   LALT(KC_TAB),KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_HOME,                 KC_PGUP, KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC,   KC_RBRC,  KC_BSLS,
        ...
        LCTL(KC_Z), LCTL(KC_Y),                                                                                                                 KC_MS_WH_UP,KC_MS_WH_DOWN
     /* |--------+-------+-------+-------+-------+-------+-------+-------+-------+-------|   |--------+-------+-------+-------+-------+-------+-------+-------+-------+-------|*/
),
    /*  Mouse layer */
    [_FN2] = LAYOUT(
    /* |--L1---+--L2---+--L3---+--L4---+--L5---+--L6---+--L7---+--L8---+--L9---+| */
      ...
      LT(_FN1,KC_LGUI),            KC_LEFT,KC_RGHT,MT(KC_RCTL,KC_SPC),KC_BSPC, KC_LALT,     LT(_FN3,KC_APP),KC_ENT,MT(KC_RSFT,KC_SPC), KC_UP,  KC_DOWN,
        KC_UP, KC_UP,                                                                                                                 KC_MS_WH_UP,KC_MS_WH_DOWN
    /* |--------+-------+-------+-------+-------+-------+-------+-------+-------+-------|   |--------+-------+-------+-------+-------+-------+-------+-------+-------+-------|*/
    ),
    /*  Other layer */
    [_FN3] = LAYOUT(
