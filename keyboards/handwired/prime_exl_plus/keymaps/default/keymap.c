...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  LAYOUT(
		...
		KC_F5,		KC_F6,		KC_P1,		KC_P2,		KC_P3,		KC_PPLS,			KC_LSFT, 	KC_Z, 		KC_X, 		KC_C, 		KC_V, 		KC_B,			MO(3), 		KC_N, 		KC_M, 		KC_COMM,	KC_DOT, 	KC_SLSH,   	KC_LSFT,
	...
	LAYOUT(
		...
		KC_LSFT,	KC_Z,		  KC_X,		  KC_C,		  KC_V,		  KC_V,			    KC_LSFT, 	KC_Z, 		KC_X, 		KC_C, 		KC_V, 		KC_B,			MO(3), 		KC_N, 		KC_M, 		KC_COMM,	KC_DOT, 	KC_SLSH,   	KC_LSFT,
	...
	LAYOUT(
		...
		RGB_MODE_RAINBOW,	  KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,				KC_TRNS, 		KC_TRNS, 		KC_TRNS, 		KC_TRNS, 	  KC_TRNS,    KC_TRNS,		KC_TRNS, 		KC_TRNS, 		KC_TRNS,  	KC_TRNS, 	  KC_TRNS,    KC_TRNS,    KC_TRNS,
