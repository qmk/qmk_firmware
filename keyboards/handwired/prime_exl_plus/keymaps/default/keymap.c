...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  LAYOUT(
		KC_NLCK, 	KC_LPRN, 	KC_RPRN, 	KC_PSLS, 	KC_PAST, 	KC_BSPC, 				KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC,
		RGB_TOG, 	RGB_MOD, 		KC_P7, 		KC_P8, 		KC_P9, 		KC_DEL,					KC_GRV, 		KC_Q, 			KC_W, 		KC_E, 			KC_R, 		KC_T,				 		KC_Y, 			KC_U, 			KC_I, 			KC_O, 				KC_P, 	KC_LBRC, KC_RBRC,
		RGB_VAI,	RGB_VAD,		KC_P4,		KC_P5,		KC_P6,		KC_PMNS,				KC_TAB, 		KC_A, 			KC_S, 			KC_D, 			KC_F, 		KC_G,			 	 		KC_H, 			KC_J, 			KC_K, 			KC_L, 				KC_QUOT, 	KC_ENT,
		RGB_MODE_RAINBOW,		KC_F6,		KC_P1,		KC_P2,		KC_P3,		KC_PPLS,				KC_LSFT, 	KC_Z, 			KC_X, 			KC_C, 			KC_V, 		KC_B,				 		MO(3), 		KC_N, 			KC_M, 		KC_COMM,	KC_DOT, 	KC_SLSH, 	KC_LSFT,
		KC_F7,		KC_F8,		TO(2),			KC_PDOT,	KC_P0,		KC_PENT,       KC_LCTL, 	KC_LALT, 	KC_LBRC, 	 			MO(1),									KC_SPC, 					KC_MINS,  			KC_LGUI, 	MO(4)
    )
/*
	[1] = LAYOUT(
