...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        ...
        _______ , _______,_______ ,_______ ,_______ , _______,                    _______, KC_TILD , _______ , _______ , KC_EQL  , KC_UNDS,
    ...
    [_RAISE] = LAYOUT(
        ...
        _______ , _______,_______,_______,_______,KC_LBRC,                        QK_BOOT,_______,_______,_______ ,_______,KC_MUTE,
        _______ , KC_LEFT,KC_UP  ,KC_DOWN,KC_RGHT,KC_LPRN,                        KC_RPRN,KC_HOME,KC_PGUP,KC_PGDN,KC_END,KC_VOLU,
        ...
        _______ , _______,_______,_______,                                        _______, _______ , _______ , LALT(KC_TAB),
                                  KC_VOLD,KC_MUTE,KC_VOLU,                        _______,KC_EQL , _______
    )
};
