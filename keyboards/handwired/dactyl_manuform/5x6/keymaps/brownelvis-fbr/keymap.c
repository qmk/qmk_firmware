...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_5x6_fbr(
     KC_ESC , KC_1  , KC_2  , KC_3  , KC_4  , KC_5  ,                         KC_6  , KC_7  , KC_8  , KC_9  , KC_0  ,KC_MINS,
     KC_TAB , KC_Q  , KC_W  , KC_E  , KC_R  , KC_T  ,                         KC_Y  , KC_U  , KC_I  , KC_O  , KC_P  ,KC_BSLASH,
     KC_LSFT, KC_A  , KC_S  , KC_D  , KC_F  , KC_G  ,                         KC_H  , KC_J  , KC_K  , KC_L  ,KC_SCLN,KC_QUOT,
     KC_LSFT, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_UP,KC_SLSH,
     OSM(MOD_LCTL),KC_LGUI,OSM(MOD_LALT),OSL(LOWER), KC_DEL, LOWER,           RAISE, KC_BSPC, OSL(RAISE), KC_LEFT, KC_DOWN, KC_RIGHT,                                       
                                      KC_LSFT,KC_SPC,                         KC_ENT,  KC_LSFT
  ),

  [_LOWER] = LAYOUT_5x6_fbr(

     KC_TILD,KC_MYCM, KC_WHOM ,KC_MAIL,KC_CALC ,_______,                     _______, KC_P7, KC_P8,KC_P9,_______,KC_PLUS,
  ...
  [_RAISE] = LAYOUT_5x6_fbr(
       ...
       _______,_______,KC_EQL ,_______,_______,_______,                        _______,_______,_______,_______,_______,_______,
                                       _______,_______,                        _______,_______
  ),
