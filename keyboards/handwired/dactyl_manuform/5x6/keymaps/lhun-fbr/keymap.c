...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6_fbr(
     ...
     KC_LGUI, KC_LALT , KC_LBRC,KC_RBRC, RAISE, KC_SPC,                       KC_ENT, LOWER, KC_PLUS, KC_LEFT, KC_DOWN, KC_RIGHT,                                       
                                      KC_GRAVE,KC_DEL,                        KC_BSPC,  KC_RSFT
  ),
  ...
  [_LOWER] = LAYOUT_5x6_fbr(
     ...
     _______,_______,_______, _______,_______,_______,            SYS,_______, _______,_______,_______,_______,
                                             KC_MHEN,KC_HENK,            _______,_______
