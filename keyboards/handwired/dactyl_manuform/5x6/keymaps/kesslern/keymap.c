...
//  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______,
    _______, _______, _______, S(DV_C), S(DV_V), S(DV_X),          _______, _______, _______, _______, _______, _______,
    _______, _______, _______, SFT_TAB, KC_TAB , _______,          _______, _______, _______, _______, _______, _______,
    _______, _______, _______, DV_C   , DV_V   , DV_X   ,          _______, _______, _______, _______, _______, _______,
                                        _______, _______,          _______, _______,
                                        _______, _______,          _______, _______,
                                        _______, _______,          _______, _______,
                                        _______, _______,          _______, _______
