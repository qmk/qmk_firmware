...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        S_ALL,   COPY,  KC_LBRC, KC_RBRC,                                         KC_MINS, KC_EQL, CUT,     PSTE,
    ...
    [_LOWER] = LAYOUT(
        ...
        _______,KC_END, KC_PGDN,KC_PGUP,KC_HOME,_______,            KC_PAST,KC_P4,  KC_P5,  KC_P6,  KC_PPLS,_______,
        _______,KC_SCRL,KC_INS, KC_PAUS,KC_PSCR,_______,            KC_PSLS,KC_P1,  KC_P2,  KC_P3,  KC_PENT,_______,
