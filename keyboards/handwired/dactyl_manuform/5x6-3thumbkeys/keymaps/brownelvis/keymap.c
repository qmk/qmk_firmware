...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6_3tk(
     ...
     KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT,KC_SLASH,KC_RSFT,
             KC_LGUI,KC_LALT,KC_DEL , RAISE , KC_SPC,                         KC_ENT, LOWER , KC_BSPC,KC_PGUP,KC_PGDN
  ...
  [_LOWER] = LAYOUT_5x6_3tk(
     ...
     _______,_______,_______,_______,_______,_______,                        KC_P0, KC_P1 , KC_P2 , KC_P3 ,KC_EQL ,KC_UNDS,
              _______,_______,_______,SYS, _______,                          _______, _______,_______, _______,_______
  ),
  ...
  [_RAISE] = LAYOUT_5x6_3tk(
       ...
       _______,_______,_______,_______,_______,_______,                        _______, KC_PLUS,KC_MINS,KC_EQL,_______,_______,
               _______,_______,_______,_______,_______,                        _______, SYS,_______, _______,_______
  ),
