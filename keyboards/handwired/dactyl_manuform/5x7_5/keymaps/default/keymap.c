...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x7_5(
        ...
        OSM(MOD_LSFT),    KC_Z,    KC_X,   KC_C,   KC_V,    KC_B,                                               KC_N, KC_M, KC_COMM,  KC_DOT, KC_SLSH, OSM(MOD_RSFT),
              KC_CAPS, KC_LGUI,   TAB_L,  TAB_R,         TT(_FN),  KC_SPC,  KC_HOME,        KC_RCTL, KC_BSPC, KC_ENT,       KC_LEFT,   KC_UP, KC_DOWN,       KC_RGHT,
                                                                  KC_LALT,   KC_END,        KC_PGUP, KC_PGDN          
    ),
    ...
    [_FN] = LAYOUT_5x7_5(
        ...
        _______,   _______,   KC_LEFT,    KC_DOWN,  KC_RGHT,   _______,   QK_BOOT,                                  TASK, _______,   _______,   _______,   _______,   _______,   _______,
        _______,   _______,   _______,   _______,   _______,   _______,                                                   _______,   _______,   _______,   _______,   _______,   _______,
        KC_MSTP,   KC_MPLY,   KC_MPRV,   KC_MNXT,              _______,   _______,   _______,            KC_DEL, _______, _______,              _______,   _______,   _______,   _______,
                                                                          _______,   _______,            _______, _______
    ),

    [_NUMPAD] = LAYOUT_5x7_5(
        _______,   _______,   _______,   _______,   _______,   _______,  _______,                                 ______, _______,   KC_NUM,    _______,   KC_PMNS,   KC_PPLS,   _______,
