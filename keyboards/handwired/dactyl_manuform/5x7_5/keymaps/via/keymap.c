...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x7_5(
        // left hand
              ...
              KC_LCTL,    KC_A,    KC_S,   KC_D,   KC_F,    KC_G,   TG(3),
        OSM(MOD_LSFT),    KC_Z,    KC_X,   KC_C,   KC_V,    KC_B,
              KC_CAPS, KC_LGUI,  KC_APP, KC_DEL,           TT(1),  KC_SPC,  KC_HOME,
                                                                  KC_LALT,   KC_END,
        // right hand
                                KC_7,   KC_8, KC_9,    KC_0, KC_MINS,  KC_EQL,        KC_GRV,
                             KC_RBRC,   KC_Y, KC_U,    KC_I,    KC_O,    KC_P,       KC_BSLS,
                               TG(2),   KC_H, KC_J,    KC_K,    KC_L, KC_SCLN,       KC_QUOT,
                                        KC_N, KC_M, KC_COMM,  KC_DOT, KC_SLSH, OSM(MOD_RSFT),
                    KC_PGUP, KC_BSPC, KC_ENT,       KC_LEFT,   KC_UP, KC_DOWN,       KC_RGHT,
                    KC_PGDN, KC_RCTL
    ),
