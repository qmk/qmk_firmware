...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(/* Base Layer (0th Layer) - default Layout */
                 ...
                 KC_L,     KC_S,     KC_N,     KC_T,     KC_D,     KC_END,        KC_F5,    KC_F6,     KC_F7,    KC_F8,          KC_BSPC,  KC_P,     KC_I,     KC_A,     KC_E,     KC_K,
                 KC_Z,     KC_M,     KC_C,     KC_V,     KC_B,                    KC_F9,    KC_F10,    KC_F11,   KC_F12,                   KC_W,     KC_G,     KC_COMM,  KC_DOT,   KC_ENT, 
                 KC_LALT,  KC_MINS,  KC_EQL,   KC_LBRC,  KC_GRV,    KC_LCTL,      KC_HOME,  KC_UP,     KC_END,   KC_PGUP,       KC_RCTL,   KC_BSLS,  KC_RBRC,  KC_SCLN,  KC_SLSH,  KC_RALT,
	                       KC_LSFT,  KC_TAB,              KC_SPC,   KC_LGUI,      KC_LEFT,  KC_DOWN,   KC_RGHT,  KC_PGDN,       KC_RGUI,  KC_SPC,              KC_DEL,   KC_RSFT   
				 ),                                                                                                            
