...
[_BL] = LAYOUT_pterodactyl(  // layer 0 : default
  ...
  LT(_SYMB,KC_GRV),      KC_QUOT,  LALT(KC_LSFT),  KC_LEFT,  KC_RGHT,  KC_SPC,
        ...
        // right hand
                             ...
                             KC_H,   KC_J,     KC_K,     KC_L,  LT(_MDIA, KC_SCLN),  GUI_T(KC_QUOT),
                             KC_N,   KC_M,  KC_COMM,   KC_DOT,     CTL_T(KC_SLSH),         KC_RSFT,
                             KC_ENT, KC_UP, KC_DOWN,  KC_LBRC,            KC_RBRC,       TT(_SYMB),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    printf("KL: kc: %u, col: %u, row: %u, pressed: %u\n", keycode, record->event.key.col, record->event.key.row, record->event.pressed);
#endif
  return true;
}
