...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_ARSTG] = LAYOUT(
        KC_GRV  , KC_1    , KC_2    , KC_3    , KC_4    , KC_5    , KC_MINS ,       KC_EQL  , KC_6    , KC_7    , KC_8    , KC_9    , KC_0    , TG_GME  ,
        ...
        KC_LCTL , KC_LGUI , KC_LALT , KC_DEL  ,                                                                   KC_RALT , KC_RGUI , KC_CAPS , KC_RCTL ,
                                                        KC_ENT  , KC_TAB ,       RCTL_T(KC_ENT) , RSFT_T(KC_SPC)  ,
                                                          TT_NUM  , KC_LSFT ,       TT_NUM  , TT_SYM ,
                                                          KC_LCTL , KC_LGUI ,       KC_RCTL , KC_BSPC
    ),
    [_GAME] = LAYOUT(
        KC_GRV  , KC_1    , KC_2    , KC_3    , KC_4    , KC_5    , KC_MINS ,       KC_EQL  , KC_6    , KC_7    , KC_8    , KC_9    , KC_0    , TG_GME  ,
        KC_TAB  , KC_R    , KC_Q    , KC_W    , KC_E    , KC_T    , KC_LBRC ,       KC_RBRC , KC_Y    , KC_U    , KC_I    , KC_O    , KC_P    , KC_BSLS ,
        KC_ESC  , KC_F    , KC_A    , KC_S    , KC_D    , KC_G    , KC_PSCR ,       KC_PAUS , KC_H    , KC_J    , KC_K    , KC_L    , KC_SCLN , KC_QUOT ,
        KC_LSFT , KC_V    , KC_Z    , KC_X    , KC_C    , KC_B    ,                           KC_N    , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC_RSFT ,
    ...
    [_NUMPAD] = LAYOUT(
        ...
        KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS ,                                                                   KC_P0   , KC_PDOT , KC_PCMM , KC_NO   ,
                                                        KC_TRNS , KC_PENT ,           KC_TRNS , KC_TRNS ,
                                                          KC_TRNS , KC_TRNS ,       KC_TRNS , KC_TRNS ,
                                                          KC_TRNS , KC_TRNS ,       KC_TRNS , KC_TRNS
    ),
    [_SYMBOLS] = LAYOUT(
        ...
        KC_TRNS , KC_CIRC , KC_SLSH , KC_ASTR , KC_BSLS , AD_DDS  ,                           KC_TILD , KC_DLR  , KC_LCBR , KC_RCBR , KC_AT   , KC_TRNS ,
        KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS ,                                                                   KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS ,
                                                        KC_TRNS , KC_TRNS ,           KC_TRNS , KC_TRNS ,
                                                          KC_TRNS , KC_TRNS ,       KC_TRNS , KC_TRNS ,
                                                          KC_TRNS , KC_TRNS ,       KC_TRNS , KC_TRNS
