...
#define SPLIT_LAYOUT(\
    ...
    { lc7r0, lc6r0, lc5r0, lc4r0, lc3r0, lc2r0 ,lc1r0, lc0r0 }, \
    { lc7r1, lc6r1, lc5r1, lc4r1, lc3r1, lc2r1 ,lc1r1, lc0r1 }, \
    { lc7r2, lc6r2, lc5r2, lc4r2, lc3r2, lc2r2 ,lc1r2, lc0r2 }, \
    { lc7r3, lc6r3, lc5r3, lc4r3, lc3r3, lc2r3 ,lc1r3, lc0r3 }, \
    { lc7r4, lc6r4, lc5r4, lc4r4, lc3r4, lc2r4 ,lc1r4, lc0r4 } \
}
