...
[BASE] = LAYOUT_albatross(  // layer 0 : default
        // left hand
           KC_ESC,   KC_NO,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,
            KC_NO,  KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,
            KC_NO,  KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,   KC_NO,
            KC_NO, KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,   KC_NO,
            KC_NO, KC_LSPO,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_NO, KC_CAPS,
            KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_LALT, KC_LCTL, KC_BSPC,  KC_TAB,  KC_DEL,
                                                                           KC_NO,   KC_NO,
        // right hand
                     KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,   KC_NO, TG(GAME),
                      KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL,
                     KC_NO,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_BSLS, RGB_VAD,
                     KC_NO,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, RGB_SPI,
            KC_NO,   KC_NO,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSPC, RGB_SPD,
          KC_LWIN,  KC_ENT,  KC_SPC, KC_RCTL, KC_RALT,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
            KC_NO,   KC_NO
    ),
