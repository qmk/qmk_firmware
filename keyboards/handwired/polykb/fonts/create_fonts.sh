...
fontconvert -f~/repos/noto-sans-jp/NotoSansJP-Regular.otf "-s${size_jp}" -v _Hiragana_ 12353 12447 > "NotoSansJP_Regular_Hiragana_${size_jp}pt.h"
fontconvert -f~/repos/noto-sans-jp/NotoSansJP-Regular.otf "-s${size_jp}" -v _Punct_ 0x3001 0x3002 0x300c 0x300d > "NotoSansJP_Regular_Punct_${size_jp}pt.h"
