...
fontconvert -f~/repos/Noto_Sans_Symbols_2/NotoSansSymbols2-Regular.ttf "-s${size_em}" -r50 -v _Diamond_ 0x2756 0x2756 > "generated/NotoSansSymbols2_Regular_Diamond_${size_em}pt.h"
