...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = KEYMAP(
		...
		LCTL_T(KC_MINS), KC_LGUI, LALT_T(KC_EQL), LT(3, KC_SPC) , LT(4, KC_ESC),          RGUI_T(KC_SPC) , KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT),

	[1] = KEYMAP(
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,             KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLD, KC_VOLU, KC_TRNS,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                      KC_PSCR, KC_F7  , KC_F8  , KC_F9  , KC_F12 , KC_MPRV,  KC_MNXT, KC_MPLY,
	...
	[3] = KEYMAP(
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,             KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                      KC_TRNS, RSFT(KC_7), RSFT(KC_8), RSFT(KC_9), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                      KC_PMNS, RSFT(KC_4), RSFT(KC_5), RSFT(KC_6), KC_PLUS, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                      KC_PAST, RSFT(KC_1), RSFT(KC_2), RSFT(KC_3), KC_PSLS, KC_TRNS,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                               RSFT(KC_0), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

	[4] = KEYMAP(
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,             KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL,
		C(KC_TAB), A(KC_F4)  , C(KC_W), C(KC_R) , KC_TRNS, KC_TRNS,                KC_WBAK, C(KC_PGUP), C(KC_PGDN), KC_WFWD, C(KC_P), KC_LPRN, KC_RPRN, KC_TRNS,
		KC_TRNS, KC_HOME, C(KC_S), KC_DEL , KC_RGHT, KC_TRNS,                      KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), KC_LEFT,                      C(KC_N), KC_TRNS, KC_PGUP, KC_PGDN, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
