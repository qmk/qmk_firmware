...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = KEYMAP(
		...
		KC_LCTL, KC_LGUI, KC_LALT, KC_SPC , LT(4, KC_ESC),                         KC_SPC , KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT),
	...
	[4] = KEYMAP(
		...
		C(KC_TAB), A(KC_F4)  , C(KC_W), C(KC_R) , KC_TRNS, KC_TRNS,                      KC_WBAK, C(KC_PGUP), C(KC_PGDN), KC_WFWD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_HOME, C(KC_S), KC_DEL , KC_RGHT, KC_TRNS,                      KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, C(KC_Z), KC_CUT, KC_COPY, KC_PSTE, KC_LEFT,                      KC_HOME, KC_PGUP, KC_PGDN, KC_END, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
