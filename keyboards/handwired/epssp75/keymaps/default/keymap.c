...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_epssp_75(
		...
		KC_CAPS,	KC_HOME,	KC_LEFT,	KC_DOWN,	KC_RGHT,	KC_END,		KC_DEL,		KC_HOME,	KC_VOLU,	KC_END,		KC_BSPC,	KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_QUOT,
		KC_LSFT,	LCA(KC_F2),	KC_TAB,		KC_F2,		KC_F5,		KC_F23,					KC_MUTE,	KC_VOLD,	KC_MUTE,				KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_RSFT,
