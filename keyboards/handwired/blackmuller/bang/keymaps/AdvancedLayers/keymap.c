...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ,
    [1] = LAYOUT(
        KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_MPLY, KC_MSTP, KC_MPRV, KC_MNXT,

        KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS,
        KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_BSPC, KC_LBRC, KC_RBRC, KC_BSLS, KC_P7,   KC_P8,   KC_P9,   KC_PPLS,
        KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  KC_QUOT,          KC_ENT,  KC_P4,   KC_P5,   KC_P6,
        KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_INS,  KC_RSFT,          KC_P1,   KC_P2,   KC_P3,            KC_PENT,
        KC_SPC,           KC_RALT, KC_RGUI, KC_APP,  KC_RCTL,                   KC_P0,            KC_PDOT
    )
};
