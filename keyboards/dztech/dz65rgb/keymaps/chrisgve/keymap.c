...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_65_ansi(
        ...
        CTL_T(KC_CAPS), KC_A,    KC_S,    LT(_DIR, KC_D),    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_PGDN,
    ...
    [_DIR] = LAYOUT_65_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, MO(_FULL_DIR), _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, _______, _______,          _______, _______,
