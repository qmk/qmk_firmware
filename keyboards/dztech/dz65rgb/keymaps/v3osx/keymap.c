...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_65_ansi(
        ...
        _______, _______, _______, _______, _______,  LSFT(LCTL(KC_4)), _______, _______, _______,_______, KC_PSCR, _______, _______, _______, KC_END, \
        _______, _______,_______, _______, _______,_______ ,_______ ,_______ , _______, LCTL(LGUI(KC_Q)), _______, _______,          KC_WSCH, _______, \
