...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_65_ansi(
        ...
        _______, _______, _______, _______, _______,  LGUI(LSFT(KC_S)), _______, _______, _______,_______, KC_PSCR, _______, _______, _______, KC_END, \
        _______, _______,_______, _______, _______,_______ ,_______ ,_______ , _______, LGUI(KC_L), _______, _______,          KC_WSCH, _______, \
