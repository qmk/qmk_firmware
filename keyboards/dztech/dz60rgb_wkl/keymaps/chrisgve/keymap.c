...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY_MAC] = LAYOUT_60_tsangan_hhkb(
		...
		KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, CU_BSPC,
	...
	[_MOUSE] = LAYOUT_60_tsangan_hhkb(
		...
		_______, _______, _______, _______, _______, _______, _______, KC_WH_U, KC_WH_D, _______, _______,                   _______, _______,
	...
	[_EX_MOUSE] = LAYOUT_60_tsangan_hhkb(
		...
		TG_MSE,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_U, KC_WH_D, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX,
