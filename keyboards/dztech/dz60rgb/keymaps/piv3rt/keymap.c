...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEF] = LAYOUT(
        ...
        KC_LCTL, LT_NUM,  LM_LALT,                            KC_SPC,                    RALT_F6, MO(_FNC), KC_LEFT,  KC_DOWN, KC_RGHT
    ),
    [_MAC] = LAYOUT(
        ...
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______, _______,
        KC_LGUI, KC_LCTL, LT_NUM,                             _______,                   _______, _______,  _______,  _______, _______
    ),
    [_FNC] = LAYOUT(
        ...
        _______,          _______, KC_CALC, CCED,    _______, _______, _______, _______, FRQLT,   FRQGT,    TG(_MAC), KC_VOLU, KC_MUTE,
    ...
    [_NUM] = LAYOUT(
        KC_NLCK, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,    KC_PMNS,  KC_PPLS, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_P4,   KC_P5,   KC_P6,    _______,  _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,    _______,           KC_PENT,
        _______,          _______, _______, _______, _______, _______, _______, _______, KC_P0,   KC_PDOT,  _______,  _______, _______,
...
void rgb_matrix_indicators_user(void) {
    ...
    if (!g_suspend_state && rgb_matrix_config.enable) {
        ...
        if (led_state.num_lock && (layer_state_is(_FNC) || layer_state_is(_NUM))) {
            // ESC key = 13
            rgb_matrix_set_color(13, 0xff, 0x55, 0x55);
        }

        if (layer_state_is(_MAC)) {
            // OS key = 61
            rgb_matrix_set_color(61, 0xff, 0x55, 0x55);
        }

        if (layer_state_is(_NUM)) {
            // Num pad
            for (int i=0; i<3; i++) {
                rgb_matrix_set_color(3 + i, 0xff, 0x55, 0x55);
                rgb_matrix_set_color(17 + i, 0xff, 0x55, 0x55);
                rgb_matrix_set_color(30 + i, 0xff, 0x55, 0x55);
            }
            rgb_matrix_set_color(44, 0xff, 0x55, 0x55);
            rgb_matrix_set_color(45, 0xff, 0x55, 0x55);
            return;
        }
