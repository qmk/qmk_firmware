...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LAYER2] = LAYOUT_60_ansi_arrow( /* LIGHT */
	...
	[_LAYER3] = LAYOUT_60_ansi_arrow( /* NUMPAD */
