...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LAYER1] = LAYOUT( /* FN */
		...
		KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    LGUI(LSFT(KC_5)),   KC_SLCK,  KC_PAUS,  KC_NO,    KC_NO,   RESET,\
		KC_NO,    KC_VOLU,  KC_VOLD,  KC_MUTE,  KC_EJCT,  KC_NO,    KC_ASTR,  KC_PSLS,  KC_HOME,  KC_PGUP,  KC_NO,    KC_NO,    KC_NO,    KC_NO, \
		KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_PPLS,  KC_PMNS,  KC_END,   KC_PGDN,  MO(5),              KC_MPLY,            KC_NO, \
		KC_NO,    KC_NO,    KC_NO,                        TO(4),                        KC_NO  ,  KC_TRNS, KC_MPRV,   KC_MSTP,            KC_MFFD),
	[_LAYER2] = LAYOUT( /* LIGHT */
		...
		KC_NO,    RGB_VAD,  RGB_VAI,  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    RGB_MOD,            KC_TRNS, \
		KC_NO,    KC_NO,    KC_NO,                        KC_NO,                        KC_NO,    KC_NO,    RGB_SPD,  RGB_RMOD,           RGB_SPI),
	[_LAYER3] = LAYOUT( /* NUMPAD */
		KC_NLCK,  KC_PSLS,  KC_PAST,  KC_PMNS,  KC_PPLS,  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_PSLS,  KC_PAST,  KC_PMNS,  KC_PPLS,  KC_NO, \
		KC_NO,    KC_P7,    KC_P8,    KC_P9,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_P7,    KC_P8,    KC_P9,    KC_NO,    KC_NO,    TO(0), \
		KC_NO,    KC_P4,    KC_P5,    KC_P6,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_P4,    KC_P5,    KC_P6,    KC_NO,              KC_PENT, \
		KC_NO,    KC_P1,    KC_P2,    KC_P3,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_P1,    KC_P2,    KC_P3,    KC_NO,              KC_NO, \
		KC_NO,    KC_P0,    KC_PDOT,                      KC_ENT,                       KC_P0,    KC_PDOT,  KC_NO,    KC_NO,              KC_NO),
	[_LAYER4] = LAYOUT( /* WIN */
		KC_GESC,  KC_1,     KC_2,     KC_3,  KC_4,  KC_5,  KC_6,    KC_7,  KC_8,    KC_9,     KC_0,            KC_MINS,  KC_EQL,  KC_BSPC, \
	...
	[_LAYER5] = LAYOUT( /* FN */
		KC_BRMD,  KC_BRMU, LCTL(KC_UP), LSFT(KC_F12),     KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_DEL , \
