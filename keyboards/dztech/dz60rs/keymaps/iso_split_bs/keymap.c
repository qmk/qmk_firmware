...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_LAYER0] = LAYOUT_60_iso_split_bs(
	...
	KC_LCTL,  KC_LGUI, KC_LALT, KC_NO,                              KC_SPC,  KC_NO,   KC_RALT, MO(1),   MO(2),   KC_RCTL),
 [_LAYER1] = LAYOUT_60_iso_split_bs(
	KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,             KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_GRV,
	...
	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MAGIC_TOGGLE_NKRO, KC_TRNS, KC_DEL,  KC_END,  KC_PGDN, KC_TRNS, 
	KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,                              KC_TRNS,           KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
 [_LAYER2] = LAYOUT_60_iso_split_bs(
	KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_GRV,
