...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_60_ansi(
        ...
        KC_LCTL,        KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, MO(1),   KC_RALT, KC_RCTL
    ),
    ...
    [_DIR] = LAYOUT_60_ansi(
        ...
        _______, _______, _______, _______, MO(_FULL_DIR), _______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______, _______, _______,
