...
//          _______, _______, _______, _______,                            _______,                            _______, _______, _______,
    ...
    [_BL] = LAYOUT_60_ansi(
        ...
        KC_LCTL,        KC_LGUI, KC_LALT,                            SPC_ML,                             KC_RALT, TG(_NP), MO(_UL), KC_RCTL
    ),
    // modify/movement layer
    [_ML] = LAYOUT_60_ansi(
    ...
    // keypad layout. start 1 from home row, use enter, space & symbols as per normal
    [_NP] = LAYOUT_60_ansi(
        KC_GRV,         _______, _______, _______, _______, _______, _______, KC_7,    KC_8,    KC_9,    _______, _______, _______, _______,
        _______,        RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, KC_4,    KC_5,    KC_6,    _______, _______, _______, _______,
        _______,        _______, _______, _______, _______, _______, _______, KC_1,    KC_2,    KC_3,    _______, _______,          _______,
        _______,                 _______, _______, BL_DEC,  BL_TOGG, BL_INC,  _______, KC_0,    _______, _______, _______,          _______,
        _______,        _______, _______,                            _______,                            _______, _______, _______, _______
    ),
};
