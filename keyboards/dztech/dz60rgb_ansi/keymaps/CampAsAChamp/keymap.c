...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    [0] = LAYOUT_60_ansi(
        ...
        LCTL_T(KC_LBRC),        KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, MO(2),   KC_APP,   RCTL_T(KC_RBRC)
    ),
   ...
   */
    [1] = LAYOUT_60_ansi(
        ...
        _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, KC_LCBR, KC_RCBR, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,          _______,
        _______,          _______, _______, KC_CALC, _______, _______, _______, KC_MINS, KC_UNDS, _______,  _______,          _______,
