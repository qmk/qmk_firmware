 ...
 *
 * ,-------------------------------------------.                         ,-------------------------------------------.
 * | L1/ESC |   Q  |   D  |   R  |   W  |   B  |                         |   J  |   F  |   U  |   P  | ;  : |  | \   |
 * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 * |Ctrl/BS |   A  |   S  |   H  |   T  |   G  | RMB  |           |      |   Y  |   N  |   E  |   O  |   I  |  ' "   |
 * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
 ...
 */
[BASE] = LAYOUT_gergo(
    LT(NUMB, KC_ESC),       KC_Q,  KC_D,   KC_R,   KC_W, KC_B,                                          KC_J,   KC_F, KC_U,    KC_P,   KC_SCLN, KC_PIPE,
    MT(MOD_LCTL, KC_BSPC),  KC_A,  KC_S,   KC_H,   KC_T, KC_G, KC_BTN2,                       KC_TRNS,  KC_Y,   KC_N, KC_E,    KC_O,   KC_I,    KC_QUOT,
    KC_RSFT,                KC_Z,  KC_X,   KC_M,   KC_C, KC_V, KC_BTN1, KC_BTN3,     KC_PGDN, KC_BSPC,  KC_K,   KC_L, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
 ...
 */
[SYMB] = LAYOUT_gergo(
    KC_TRNS, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE,                                            DF(BASE), DF(QWERTY), KC_TRNS, KC_TRNS, KC_TRNS, KC_BSLS,
