...
const PROGMEM naginata_keymap ngmap[] = {
  ...
  {.key = B_M|B_Q                  , .kana = "pu"      }, // ぷ
  {.key = B_V|B_P                  , .kana = "pe"      }, // ぺ
  {.key = B_M|B_Z                  , .kana = "po"      }, // ぽ

  // 小書き
  {.key = B_T|B_H                  , .kana = "xya"     }, // ゃ
  {.key = B_T|B_P                  , .kana = "xyu"     }, // ゅ
  {.key = B_T|B_I                  , .kana = "xyo"     }, // ょ
  {.key = B_T|B_J                  , .kana = "xa"      }, // ぁ
  {.key = B_T|B_K                  , .kana = "xi"      }, // ぃ
  {.key = B_T|B_L                  , .kana = "xu"      }, // ぅ
  {.key = B_T|B_O                  , .kana = "xe"      }, // ぇ
  {.key = B_T|B_N                  , .kana = "xo"      }, // ぉ
  {.key = B_T|B_L|B_SHFT           , .kana = "xwa"     }, // ゎ
  {.key = B_G                      , .kana = "xtu"     }, // っ
  ...
  {.key = B_M|B_Q|B_J              , .kana = "fa"      }, // ふぁ
  {.key = B_M|B_Q|B_K              , .kana = "fi"      }, // ふぃ
  {.key = B_M|B_Q|B_O              , .kana = "fe"      }, // ふぇ
  {.key = B_M|B_Q|B_N              , .kana = "fo"      }, // ふぉ
  {.key = B_M|B_Q|B_P              , .kana = "fyu"     }, // ふゅ
