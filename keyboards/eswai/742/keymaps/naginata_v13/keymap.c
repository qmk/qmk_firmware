...
static void render_kana(void) {
    static const char PROGMEM kana1[] = {
      0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xc8, 0xc9, 0xca, 0xcb, 0xcc, 0xcd
    };
    static const char PROGMEM kana2[] = {
      0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xd0, 0xd1, 0xd2, 0xd3, 0xd4
    };
    oled_write_ln_P(PSTR("   "), false);
    oled_write_P(kana1, false);
    oled_write_ln_P(PSTR("   "), false);
    oled_write_P(kana2, false);
    oled_write_ln_P(PSTR("   "), false);
    oled_write_ln_P(PSTR("   "), false);
}

static void render_eisu(void) {
    static const char PROGMEM eisu1[] = {
      0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xd8, 0xd9, 0xda, 0xdb, 0xdc
    };
    static const char PROGMEM eisu2[] = {
      0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xcd, 0xe0, 0xe1, 0xe2, 0xe3, 0xe4
    };
    oled_write_ln_P(PSTR("   "), false);
    oled_write_P(eisu1, false);
    oled_write_ln_P(PSTR("   "), false);
    oled_write_P(eisu2, false);
    oled_write_ln_P(PSTR("   "), false);
    oled_write_ln_P(PSTR("   "), false);
}
