...
/* _QGMLWY
  ...
  |        `        |        1        |        2        |        3        |        4        |        5        |        6        |        7        |        8        |        9        |        0        |        -        |        +        |        /        |        *        |
  +-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+
  |       ESC       |        Q        |        G        |        M        |        L        |        W        |        :        |                 |        Y        |        F        |        U        |        B        |        H        |      BSPC       |                 |
  +-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+
  |       TAB       |        D        |        S        |        T        |        N        |        R        |        \        |                 |        I        |        A        |        E        |        O        |        '        |       ENT       |                 |
  +-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+
  |      LCTL       |        Z        |        X        |        C        |        V        |        J        |        (        |        )        |        K        |        P        |        ,        |        .        |        ?        |       UP        |       DEL       |
  +-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+-----------------+
...
*/
  [_QGMLWY] = LAYOUT(
    ...
    KC_ESC           ,KC_Q             ,KC_G             ,KC_M             ,KC_L             ,KC_W             ,JP_COLN          ,                  KC_Y             ,KC_F             ,KC_U             ,KC_B             ,KC_H             ,KC_BSPC                         , \
    KC_TAB           ,KC_D             ,KC_S             ,KC_T             ,KC_N             ,KC_R             ,JP_BSLS          ,                  KC_I             ,KC_A             ,KC_E             ,KC_O             ,JP_QUOT          ,KC_ENT                          , \
    KC_LCTL          ,KC_Z             ,KC_X             ,KC_C             ,KC_V             ,KC_J             ,JP_LPRN          ,JP_RPRN          ,KC_K             ,KC_P             ,JP_COMM          ,JP_DOT           ,JP_QUES          ,KC_UP            ,KC_DEL           , \
...
/* _LOWER
  ...
  +------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+
  |  __  |  XX  |  XX  |  XX  |  XX  |  XX  |  XX  |      |  /   |  7   |  8   |  9   |  +   | DEL  |      |
  +------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+
  |  __  |  XX  |  XX  |  XX  |  XX  |  XX  |  XX  |      |  *   |  4   |  5   |  6   |  -   |A(ENT)|      |
  +------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+
  |  __  |  XX  |  XX  |  XX  |  XX  |  XX  |  [   |  ]   |  0   |  1   |  2   |  3   |  =   | PGUP |  __  |
  +------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+
...
*/
  [_LOWER] = LAYOUT(
    ...
    _______  ,XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,          JP_SLSH  ,KC_7     ,KC_8     ,KC_9     ,JP_PLUS  ,KC_DEL          , \
    _______  ,XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,          JP_ASTR  ,KC_4     ,KC_5     ,KC_6     ,JP_MINS  ,A(KC_ENT)       , \
    _______  ,XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,JP_LBRC  ,JP_RBRC  ,KC_0     ,KC_1     ,KC_2     ,KC_3     ,JP_EQL   ,KC_PGUP  ,_______  , \
...
*/
  [_SHIFT] = LAYOUT(
    JP_TILD   ,JP_EXLM   ,JP_AT     ,JP_HASH   ,JP_DLR    ,JP_PERC   ,JP_CIRC   ,JP_AMPR   ,JP_ASTR   ,JP_LPRN   ,JP_RPRN   ,JP_UNDS   ,JP_EQL    ,XXXXXXX   ,XXXXXXX   , \
    S(KC_ESC) ,S(KC_Q)   ,S(KC_G)   ,S(KC_M)   ,S(KC_L)   ,S(KC_W)   ,JP_SCLN   ,           S(KC_Y)   ,S(KC_F)   ,S(KC_U)   ,S(KC_B)   ,_______   ,S(KC_BSPC)        , \
    S(KC_TAB) ,S(KC_D)   ,S(KC_S)   ,S(KC_T)   ,S(KC_N)   ,S(KC_R)   ,JP_PIPE   ,           S(KC_I)   ,S(KC_A)   ,S(KC_E)   ,S(KC_O)   ,JP_DQT    ,S(KC_ENT)         , \
    _______   ,S(KC_Z)   ,S(KC_X)   ,S(KC_C)   ,S(KC_V)   ,S(KC_J)   ,JP_LT     ,JP_GT     ,S(KC_K)   ,S(KC_H)   ,S(KC_P)   ,_______   ,JP_SLSH   ,S(KC_UP)  ,S(KC_DEL) , \
