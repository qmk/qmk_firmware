...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // |       |       |       |       |       |                                                          |  cps  |   ←   |   ↓   |   ↑   |   →   |
  // |-------+-------+-------+-------+-------|                                                          |-------+-------+-------+-------+-------|
  // |  gui  |  alt  |  ctl  |  sht  |       |                                                          | insrt | home  | paged | pageu |  end  |
  // --------+-------+-------+-------+-------|                                                          |-------+-------+-------+-------+-------|
  //                 |       |  ___  |       |                                                          |  ent  |  bsp  |  del  |
  //                 --------+-------+--------                                                          --------+-------+--------
    XXXXXXX,            XXXXXXX,            XXXXXXX,            XXXXXXX,            XXXXXXX,            XXXXXXX,            XXXXXXX,            XXXXXXX,            XXXXXXX,            XXXXXXX,
  ...
  //                 --------+-------+--------                                                          --------+-------+--------
    ...
    KC_TILD,            KC_EXLM,            KC_AT,              KC_HASH,            KC_UNDS,            XXXXXXX,            KC_LSFT,            KC_LCTL,            KC_LALT,            KC_LGUI,
  ...
  //                 --------+-------+--------                                                          --------+-------+--------
    ...
    KC_GRV,             KC_1,               KC_2,               KC_3,               KC_MINS,            XXXXXXX,            KC_LSFT,            KC_LCTL,            KC_LALT,            KC_LGUI,
                                            KC_DOT,             KC_0,               KC_RBRC,            XXXXXXX,            _______,            XXXXXXX
  ),
  [FUN] = LAYOUT_split_3x5_3(
  // -----------------------------------------                                                          -----------------------------------------
  // | PrScr |  F 7  |  F 8  |  F 9  |  F12  |                                                          |       |       |       |       |       |
  // |-------+-------+-------+-------+-------|                                                          |-------+-------+-------+-------+-------|
  // | pause |  F 4  |  F 5  |  F 6  |  F11  |                                                          |       |       |       |       |       |
  // |-------+-------+-------+-------+-------|                                                          |-------+-------+-------+-------+-------|
  // | scrlk |  F 1  |  F 2  |  F 3  |  F10  |                                                          |       |  sht  |  ctl  |  alt  |  gui  |
  // --------+-------+-------+-------+-------|                                                          |-------+-------+-------+-------+-------|
  //                 |  app  |  spc  |  tab  |                                                          |       |       |  ___  |
  //                 --------+-------+--------                                                          --------+-------+--------
    ...
    KC_SCRL,             KC_F1,              KC_F2,              KC_F3,             KC_F10,             XXXXXXX,            KC_LSFT,            KC_LCTL,            KC_LALT,            KC_LGUI,
