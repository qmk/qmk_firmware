...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYM] = LAYOUT_default(
    XXXXXXX, XXXXXXX, KC_AMPR, KC_ASTR, KC_LPRN,  XXXXXXX,   KC_PIPE,    KC_TILD,    XXXXXXX, XXXXXXX,    XXXXXXX,
    XXXXXXX, XXXXXXX, KC_DLR,  KC_PERC, KC_CIRC,  XXXXXXX,    TD(TD_BRC), TD(TD_PRN), KC_EQL,  TD(TD_CRT), KC_QUOT,
    XXXXXXX, XXXXXXX, KC_EXLM, KC_AT,   KC_HASH,  XXXXXXX,   TD(TD_ARR), TD(TD_LNE), KC_PLUS, KC_GRV,     KC_BSLS,
                  KC_TRNS, KC_TRNS,   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS
  ),

  [_FUNCT] = LAYOUT_default(
