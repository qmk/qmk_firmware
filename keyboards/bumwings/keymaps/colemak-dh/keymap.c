...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_14x4_bum_thumbs(
    	...
    	KC_LCTL,  KC_A,    KC_R,    KC_S,    KC_T,   KC_G,   KC_BSPC, KC_BSPC,        KC_M,   KC_N,    KC_E,     KC_I,    KC_O,     KC_MINUS,
    	KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_D,   KC_V,   KC_LGUI, KC_LALT,        KC_K,   KC_H,    KC_COMMA, KC_DOT,  KC_QUOTE, KC_RSFT,
