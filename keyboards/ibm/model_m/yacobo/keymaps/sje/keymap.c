...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_fullsize_ansi_wkl( /* Function layer */
    ...
    MO(1),   KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,          _______,                             _______, _______, _______,
    KC_CAPS, 	      _______,  _______, _______, _______, _______, _______, _______, _______, _______,  _______,         _______,          KC_VOLU,           _______, _______, _______, _______,
