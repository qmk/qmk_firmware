...
#define ISSI_ADDR_1 0b1010000
#define ISSI_ADDR_2 0b1010000
...
const Point g_map_led_to_point[BACKLIGHT_LED_COUNT] PROGMEM = {
	// LA0..LA47
	{0,0}, {0,16}, {0,32}, {0,48}, {17,0}, {17,16}, {17,32}, {34,48}, {34,0}, {34,16}, {34,32}, {51,48},
	{51,0}, {51,16}, {51,32}, {68,48}, {68,0}, {68,16}, {68,32}, {85,48}, {85,0}, {85,16}, {85,32}, {102,48},
	{102,0}, {102,16}, {102,32}, {119,48}, {119,0}, {119,16}, {119,32}, {136,48}, {136,0}, {136,16}, {136,32},
	{153,48}, {153,0}, {153,16}, {153,32}, {170,48}, {170,0}, {170,16}, {170,32}, {187,48},{187,0}, {187, 16}, {187,32},
	{255,255},// LA48 does not exist, dummy
	// LA49..LA50
	{204,0}, {204,16},
	{255,255},// LA51 does not exit, dummy
	// LA52..LA60
	{221,48}, {221,0}, {221,16}, {221,32}, {221,64}, {0,64}, {17,64}, {34,64}, {102,64},
	{255,255},// LA61 does not exit, dummy
	{170,64}, {187,64}, {204,64}
};
const Point g_map_led_to_point_polar[BACKLIGHT_LED_COUNT] PROGMEM = {
	// LA0..LA47
	{0,0}, {0,16}, {0,32}, {0,48}, {17,0}, {17,16}, {17,32}, {34,48}, {34,0}, {34,16}, {34,32}, {51,48},
