...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_numpad_split0(
        ...
        CTRLMA, KC_UP, LCTL(KC_TAB), KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, KC_RGUI, MO(2), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT, KC_PENT
    ),

    [1] = LAYOUT_60_numpad_split0(
    ...
    [2] = LAYOUT_60_numpad_split0(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _____,  _____,  _____,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _____,  _____,  _____,    _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _____,  _____,  _____,
        _______, _______, _______,                            _______,                            _______, _______, _______, _______, _____,  _____,  _____,  _______
    ),
};
