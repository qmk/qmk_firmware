...
// DI pin = PB1, which is AF02, TIM3_CH4 (table 9 in datasheet)
    ...
    #define WS2812_DMA_STREAM STM32_DMA1_STREAM2        // DMA1 Stream  2 for TIM4_UP (table 28 in reference manual)
    #define WS2812_DMA_CHANNEL 5                        // DMA Channel 5 for TIM4_UP  (table 28 in reference manual)
