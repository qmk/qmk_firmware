...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =    {
    ...
    */
    [0] = LAYOUT(
        ...
        RGB_MOD, KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,                    KC_ENT,  KC_P4,   KC_P5,   KC_P6,
    ...
    [1] = LAYOUT(
        ...
        C(KC_V), _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______,
        C(KC_C), _______, _______, _______,                    _______                                   , _______, _______, _______, _______, _______, _______, _______, _______
    )
};
