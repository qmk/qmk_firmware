...
// DI pin = PB8, which is AF02, TIM4_CH3 (table 9 in datasheet)
#ifdef RGBLIGHT_ENABLE
    // #define RGB_DI_PIN B8
    #define WS2812_PWM_DRIVER PWMD3     // TIM4
    #define WS2812_PWM_CHANNEL 4        // CH3
    #define WS2812_PWM_PAL_MODE 2       // AF2

    #define WS2812_DMA_STREAM STM32_DMA1_STREAM2        // DMA1 Stream  6 for TIM4_UP (table 28 in reference manual)
    #define WS2812_DMA_CHANNEL 5                        // DMA Channel 2 for TIM4_UP  (table 28 in reference manual)
