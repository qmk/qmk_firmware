...
/* Raise
 * ,-----------------------------------------------------------------------------------.
 * |   `  |      |      | End  |      |      |      |Pg Up | Wake |Sleep |Power | Del  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
...
[_RAISE] = LAYOUT_plaid_grid(
    KC_GRV , _______, _______, KC_END, _______, _______, _______,  KC_PGUP, KC_WAKE, KC_SLEP, KC_POWER , KC_DEL , 
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MPRV, KC__VOLUP, KC_MUTE
),

/* Adjust (Lower + Raise)
 * ,-----------------------------------------------------------------------------------.
 * |Reset | Red  |Green | Rmod | Gmod |Rblink|Gblink| Rkey | Gkey | Rcar | Gcar |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
