...
#define LOWER LT(_LOWER, KC_ASTR)
#define RAISE LT(_RAISE, KC_ENT)
#define NUM   TT(_NUM)
#define NAV   LT(_NAV, KC_LEFT)

//Mods
#define CR_ESC LCTL_T(KC_ESC)
...
[_QWERTY] = LAYOUT_plaid_grid(
    ...
    CR_ESC , KC_A   , KC_S   , KC_D   , KC_F ,   KC_G  ,  KC_H  ,  KC_J ,   KC_K   , KC_L   , KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V ,   KC_B  ,  KC_N  ,  KC_M ,   KC_COMM, KC_DOT , KC_SLSH, SH_ENT ,
    NUM    , KC_RALT, KC_LALT, KC_LGUI, LOWER,   SH_SPC,  SH_SPC,  RAISE,   NAV    , KC_DOWN, KC_UP  , KC_RGHT
),

/* Num
 * ,-----------------------------------------------------------------------------------.
 * | Tab  |   Q  |   W  |   E  |   R  |   T  |   Y  |   1  |   2  |   3  |   /  |   (  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Esc  |   A  |   S  |   D  |   F  |   G  |   H  |   4  |   5  |   6  |   *  |   )  |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   7  |   8  |   8  |   -  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | RAlt | Alt  | GUI  |Lower |    Space    |Raise |   0  |   .  |   +  |  ,   |
 * `-----------------------------------------------------------------------------------'
 */
[_NUM] = LAYOUT_plaid_grid(
    KC_TILD, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC, KC_CIRC, KC_P1, KC_P2, KC_P3  , KC_PSLS, KC_BSPC,
    KC_DEL , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  , KC_P4, KC_P5, KC_P6  , KC_PAST, KC_QUOT,
    _______, KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12 , KC_P7, KC_P8, KC_P9  , KC_PMNS, KC_PENT,
    _______, _______, _______, _______, _______, _______, _______, RAISE, KC_P0, KC_PDOT, KC_PPLS, KC_COMM
),
...
[_LOWER] = LAYOUT_plaid_grid(
    ...
    _______, _______, _______, _______, _______, KC_DEL , KC_DEL , _______   , KC_MPRV   , KC_VOLD, KC_VOLU, KC_MPLY
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      | VolU | VolU | BrigU| BrigD|
 * `-----------------------------------------------------------------------------------'
 */
[_ADJUST] = LAYOUT_plaid_grid(
    RESET  , LED_1  , LED_2  , LED_3  , LED_4  , LED_5  , LED_6  , LED_7  , LED_8   , LED_9  , LED_0  , KC_DEL ,
    _______, _______, MU_MOD , AU_ON  , AU_OFF , AG_NORM, AG_SWAP, QWERTY , NUM     , PLOVER , _______, _______,
