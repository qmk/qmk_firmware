 ...
 * `-----------------------------------'           \-----------------------------------|
 *    |LCtrl|  /LGUI /LAlt /SpLSy/SpLSy/           \SpLNu\SpLNu\RAlt \RCtrl\  /  |  `  |
 *    `-----'  `-----------------------'           `-----------------------------------'
 */
        ...
        KC_LCTL,          KC_LGUI, KC_LALT, LTS_SPC, LTS_SPC,            LTN_SPC, LTN_SPC, KC_RALT, KC_RCTL, KC_SLSH, KC_GRV
    ),
 ...
 */
        ...
        _______, XXXXXXX, KC_4,    KC_5,    KC_6,    KC_DOT,   KC_RPRN,   XXXXXXX, KC_LEFT, KC_DOWN, KC_RIGHT,XXXXXXX, XXXXXXX,
 ...
 *    `-----'  `-----------------------'           `-----------------------------------'
 */
        _______, XXXXXXX, S(KC_1), S(KC_2), S(KC_3), XXXXXXX, KC_LPRN,   S(KC_MINS), S(KC_EQL), KC_PGUP, XXXXXXX, KC_BSPC,
        _______, XXXXXXX, S(KC_4), S(KC_5), S(KC_6), XXXXXXX, KC_RPRN,   XXXXXXX,    KC_HOME,   KC_PGDN, KC_END,  XXXXXXX, XXXXXXX,
 ...
 * |     |     / F1  / F2  / F3  /     /     /     \     \     \VolUp\     \     | Del |
 * |-----------------------------------------/     \-----------------------------------|
 * |CapsL|LEDEn/ F4  / F5  / F6  /     /     /     \     \MPrev\VolDn\MNext\     |     |
 * |-----------------------------------------'     \-----------------------------------|
 * |     |     / F7  / F8  / F9  /     /           \     \     \VMute\     \     |     |
 * `-----------------------------------'           \-----------------------------------|
 ...
 */
        ...
        KC_CAPS, LED_EN,  KC_F4,   KC_F5,   KC_F6,   XXXXXXX, XXXXXXX,   XXXXXXX, KC_MPRV, KC_VOLD, KC_MNXT, XXXXXXX, _______,
