...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x5_3(
        MT(MOD_LSFT | MOD_LGUI, KC_Q),    KC_W,    KC_E,    KC_R,    KC_T,                               KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,
        LCTL_T(KC_A),    LALT_T(KC_S),    LGUI_T(KC_D),    KC_F,    KC_G,                               KC_H,    KC_J,    RGUI_T(KC_K),   RALT_T(KC_L),     RCTL_T(KC_SCLN),
        KC_Z,    TD(TD_5),    TD(TD_3),     TD(TD_4),    KC_B,                               KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
                                   KC_LSFT, LT(MO(1), KC_ESC), KC_SPC,                         KC_BSPC, LT(MO(2), KC_ENT), KC_RSFT
    ),
