...
#ifdef OLED_ENABLE
/* A sprite of the QMK logo. */
extern const char PROGMEM qmk_logo[64];
/* A sprite of the Kyria logo (fits the whole OLED display). */
extern const char PROGMEM kyria_logo[1024];
#endif
