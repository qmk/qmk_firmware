...
[_LOWER] = LAYOUT(
    ...
    _______, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD, _______, _______,  _______, _______, KC_AMPR,  KC_EQL, KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT,
 ...
 * |       |   1   |   2   |   3   |   4   |   5   |                                  |   6   |   7   |   8   |   9   |   0   |       |
 * |-------+-------+-------+-------+-------+-------|                                  |-------+-------+-------+-------+-------+-------|
 * |       | Prev  | Play  | Next  | VolUp | Mute  |                                  |       |  Left |  Down |  Up   | Right |       |
 * |-------+-------+-------+-------+-------+-------+---------------.  ,---------------+-------+-------+-------+-------+-------+-------|
 * |       |       |       |       | VolDn |       |       |       |  |       |       |       |       |       |       |       |       |
 * `-------+-------+-------+-------+-------+-------+-------+-------|  |-------+-------+-------+-------+-------+-----------------------'
 *                         |       |       |       |       |       |  |       |       |       |       |       |
...
[_RAISE] = LAYOUT(
    ...
    _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLU, KC_MUTE,                                      _______, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______,
