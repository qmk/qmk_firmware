...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOLS] = LAYOUT(
        ...
        KC_TRNS,      DE_EURO, KC_AMPR, KC_TILD, KC_SLASH, KC_PIPE,       KC_NO,           KC_NO,                 KC_NO,   KC_NO,          KC_NO,         KC_LBRC, KC_RBRC, KC_UNDS, KC_GRV,  KC_NO,
                                        KC_TRNS, NAV,      ALT_T(KC_TAB), GUI_T(KC_SPACE), SFT_T(KC_ENT),         KC_LSFT, GUI_T(KC_BSPC), ALT_T(KC_DEL), KC_TRNS, NAV),
    [_NUMBERS] = LAYOUT(
        ...
        KC_TRNS,      KC_NO, KC_F1, KC_F2, KC_F3,   KC_F10,        KC_NO,           KC_NO,                        KC_NO,   KC_NO,          KC_COMM,       KC_1, KC_2,   KC_3, KC_MINS, KC_SLASH,
                                    MCO,   KC_TRNS, ALT_T(KC_TAB), GUI_T(KC_SPACE), SFT_T(KC_ENT),                KC_LSFT, GUI_T(KC_BSPC), ALT_T(KC_DEL), MCO,  KC_TRNS),
    [_NAV] = LAYOUT(
        KC_TRNS,      KC_ACL2, KC_WH_D, C(KC_UP),   KC_WH_U, G(KC_PLUS),                                                                     C(KC_LEFT),    G(A(KC_LEFT)), G(A(KC_UP)), G(A(KC_RIGHT)), C(KC_RIGHT), KC_TRNS,
        ...
        KC_TRNS,      KC_ACL0, KC_BTN2, KC_MS_DOWN, KC_BTN1, G(KC_MINS),    KC_NO,           KC_NO,                 KC_NO,   KC_NO,          KC_ENT,        C(S(KC_TAB)),  KC_DOWN,     C(KC_TAB),      KC_NO,       KC_PGDN,
                                        KC_TRNS,    KC_TRNS, ALT_T(KC_TAB), GUI_T(KC_SPACE), SFT_T(KC_ENT),         KC_LSFT, GUI_T(KC_BSPC), ALT_T(KC_DEL), KC_TRNS,       KC_TRNS),
    [_MEDIA_CODE] = LAYOUT(
