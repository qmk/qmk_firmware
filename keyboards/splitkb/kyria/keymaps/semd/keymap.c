...
*/
    [_QWERTY] = LAYOUT(
      ...
      KC_LCTL,      KC_Z,   KC_X,   KC_C,   KC_V,   KC_B, KC_RGUI, KC_SPC,     KC_ENT, CW_TOGG, KC_N, KC_M,    KC_COMM, KC_DOT,  KC_DOWN, KC_RGHT,
 ...
 */
    [_LOWER] = LAYOUT(
      ...
      KC_LCTL,  KC_GRV,   KC_TILD, SC_AMP,  SC_PIPE, SC_DOLL, KC_RGUI, _______, _______, _______, KC_SCLN, KC_PGDN, KC_END, _______,  _______,  _______,
                                _______, KC_LALT, KC_RGUI, KC_TRNS, KC_SPC,  KC_ENT, MO(_RAISE),  KC_RALT,  KC_RSFT, KC_LEFT
  ...
  */
    [_RAISE] = LAYOUT(
      ...
      KC_LCTL, _______, _______, KC_NUHS, _______, _______, TG(_NUMBERS),KC_SPC, KC_ENT, KC_TRNS,KC_MINS, SC_DQUO, SC_COLO, SC_SCOL, KC_SLSH, SC_UNSC,
                             _______, KC_LALT, KC_RGUI, MO(_LOWER), KC_SPC,        KC_ENT, KC_TRNS,  KC_RALT,  KC_CAPS, KC_LEFT
    ),
/*
 ...
 */
    [_NUMBERS] = LAYOUT(
      ...
      _______,  _______, _______, _______, _______, _______, TG(_NUMBERS), KC_SPC,   KC_ENT, _______, KC_COMM,  KC_1, KC_2, KC_3, SC_EQUA, _______,
