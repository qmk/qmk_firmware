...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEFAULT] = LAYOUT(
        ...
        KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    MO(_NAV),  MO(_FN), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLASH, KC_RCTL,
                                   KC_APP, KC_LALT, KC_LGUI, KC_ENT,             KC_SPACE, KC_BSPC, KC_RALT, KC_RGUI
    ),
...
bool encoder_update_user(uint8_t index, bool clockwise) {
    if (index == 0) { // Assuming right encoder is index 0
