...
* From the [QMK Configurator](https://config.qmk.fm/#/splitkb/aurora/corne/rev1/LAYOUT_split_3x5_2_thumb), hit the "import QMK keymap json file" button (it has a drawing with an up arrow on it).
