...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
      ...
      *                           └─────┘   └─────┘
      */
	[0] = LAYOUT(                 ALT_T(KC_Q), KC_W, KC_F, KC_P, KC_G,       KC_J, KC_L, KC_U, KC_Y, ALT_T(KC_SCLN), 
	                              ...
	                              CTL_T(KC_Z), KC_X, KC_C, KC_V, KC_B,       KC_K, KC_M, KC_COMM, KC_DOT, CTL_T(KC_SLSH), 
	                                       LT(3,KC_TAB), LT(1,KC_SPC),       LT(2,KC_BSPC), KC_ENT),
     /*
      * ┌─────┬─────┬─────┬─────┬─────┐       ┌─────┬─────┬─────┬─────┬─────┐
      ...
      *                           └─────┘   └─────┘
      */
	[1] = LAYOUT(  ALT_T(KC_WH_U), KC_BTN2, KC_MS_U, KC_BTN1, KC_VOLU,       KC_PGUP, KC_HOME, KC_UP, KC_END, KC_DEL, 
      ...
      *                           └─────┘   └─────┘
      */
    [2] = LAYOUT(   ALT_T(KC_ESC), KC_LCBR, KC_LBRC, KC_LPRN, KC_TILD,       KC_CIRC, KC_RPRN, KC_RBRC, KC_RCBR, KC_GRV,
      ...
      *                           └─────┘   └─────┘
      */
	[3] = LAYOUT(                 ALT_T(KC_1), KC_2, KC_3, KC_4, KC_5,       KC_6, KC_7, KC_8, KC_9, KC_0, 
	                        SFT_T(KC_NO), KC_NO, KC_NO, KC_NO, KC_F11,       KC_F12, KC_NO, KC_NO, KC_NO, KC_TAB,
