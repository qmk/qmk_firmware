...
const uint16_t PROGMEM combo_at_sign[] = {KC_Q, KC_U, COMBO_END};
const uint16_t PROGMEM combo_backslash[] = {KC_I, KC_Y, COMBO_END};
const uint16_t PROGMEM combo_circumflex[] = {KC_P, KC_S, COMBO_END};
const uint16_t PROGMEM combo_colon[] = {KC_T, KC_G, COMBO_END};
const uint16_t PROGMEM combo_dollar[] = {KC_S, KC_L, COMBO_END};
const uint16_t PROGMEM combo_equal[] = {KC_T, KC_H, COMBO_END};
const uint16_t PROGMEM combo_exclamation_mark[] = {KC_E, KC_W, COMBO_END};
const uint16_t PROGMEM combo_grave[] = {KC_I, KC_Q, COMBO_END};
...
const uint16_t PROGMEM combo_question_mark[] = {KC_B, KC_E, COMBO_END};
const uint16_t PROGMEM combo_quote[] = {KC_T, KC_N, COMBO_END};
const uint16_t PROGMEM combo_quote_double[] = {KC_A, KC_U, COMBO_END};
const uint16_t PROGMEM combo_semicolon[] = {KC_G, KC_R, COMBO_END};
const uint16_t PROGMEM combo_slash[] = {KC_C, KC_R, COMBO_END};
