...
// Compilation
// qmk compile -kb splitkb/elora -km kobrakai
 ...
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        | Play/| PgDn | NUM  | Shift| Home |  | End  | Space| Enter| PgUp | Mute |
 *                        | Pause|  Alt |      |      | Ctrl |  | Ctrl |      | SYM  | AltGr|      |
 *                        `----------------------------------'  `----------------------------------'
 *
 * ,---------------------------.      ,------.                 ,---------------------------.      ,------.
 * |     |      |       |      |      | Mute |                 |      |      |      |      |      | Mute |
...
//  |,        ,        ,        ,        ,        ,        ,        ,        ,|   |        ,        ,        ,        ,        ,        ,        ,        ,| 
    ...
    [_DVORAK] = LAYOUT_myr(
       ...
       KC_BSLS, KC_SCLN, KC_Q   , KC_J   , KC_K   , KC_X   , KC_LGUI,TO(_NUM),     TO(_SYM), KC_BSPC, KC_B   , KC_M   , KC_W   , KC_V   , KC_Z   , KC_SLSH,
                                  KC_MPLY,ALT_PGDN, NUM    , KC_LSFT,CTL_HOME,     CTL_END , KC_SPC , SYM_ENT,ALT_PGUP, KC_MUTE,
								 
	// Myriad Module bindings
       _______,  _______, _______, _______,    KC_MUTE,                             _______, _______, _______, _______,    KC_MUTE
	),
