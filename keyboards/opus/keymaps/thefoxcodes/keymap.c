...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // [_MEDIA] = LAYOUT(
  //     KC_TRNS, SGUI(KC_5), SGUI(KC_3), SGUI(KC_4), MEH(KC_4), KC_VOLU, LCTL(LGUI(KC_LEFT)), LCAG(KC_LEFT), LCAG(KC_RGHT), LCTL(LGUI(KC_RIGHT)), MEH(KC_RGHT), LALT(LGUI(KC_POWER)),
  //     KC_CAPS, KC_F11, KC_MPRV, KC_MNXT, KC_MPLY, KC_VOLD, LALT(LGUI(KC_LEFT)), LALT(LGUI(KC_DOWN)), LALT(LGUI(KC_UP)), LALT(LGUI(KC_RIGHT)), MEH(KC_LEFT), KC_TRNS,
  //     KC_BRID, KC_BRIU, LGUI(KC_MINS), LGUI(KC_PLUS), LGUI(KC_GRV), KC_MUTE, LCTL(LGUI(LSFT(KC_LEFT))), LALT(LGUI(KC_F)), LALT(LGUI(KC_C)), LCTL(LGUI(LSFT(KC_RIGHT))), MEH(KC_UP), RESET,
  //     LCTL(LSFT(KC_TAB)), LCTL(KC_TAB), KC_NO, KC_NO, MEH(KC_RGHT), MEH(KC_LEFT)
  //    ),
  [_WORD] = LAYOUT(
