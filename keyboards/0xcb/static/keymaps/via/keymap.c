...
[_FN4] = LAYOUT(
                                                                                                       _______,
    _______, KC_MUTE, KC_VOLU, KC_VOLD, KC_MPRV, KC_MNXT, KC_MSTP, KC_INS,  KC_HOME, KC_DEL,  KC_END,  _______,
    _______, _______, KC_BRIU, KC_BRIU, _______, _______, _______, KC_PGUP, KC_UP,   KC_PGDN,          _______,
