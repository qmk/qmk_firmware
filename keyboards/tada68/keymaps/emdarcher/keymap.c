...
[_FL] = LAYOUT_ansi(
  ...
  _______,KC_LEFT,KC_DOWN,KC_RIGHT,_______,_______,_______,_______,_______,_______,KC_MRWD,KC_MFFD,        _______,KC_END, \
...
uint32_t layer_state_set_user(uint32_t state){
    ...
    state = update_tri_layer_state(state, _FL, _CL, _ML);
    return state;
}
