  ...
  if(record->event.pressed){
    switch(keycode) {
      ...
      case WHAT_EVENT:
        SEND_STRING(SS_TAP(X_T));
        _delay_ms(70);
        SEND_STRING("What a crazy series of events!");
        _delay_ms(50);
        SEND_STRING(SS_TAP(X_ENTER));
        return false; break;
    }
...
[_BL] = KEYMAP_ANSI(
   ...
   * |-----------------------------------------------------------------|
   * |     |   |WhS|   |   |Nmw|   |   |   |BLB|BL-|BL |BL+|Foobr|ToNUM|
   * |-----------------------------------------------------------------|
   * |KC_NO |Mas|   |   |   |   |WhE|   |   |   |   |Mnu|        |PgUp |
   * |-----------------------------------------------------------------|
   * |        |   |   |   |   |   |   |   |   |   |   |      |   |PgDn |
   * |-----------------------------------------------------------------|
...
[_FL] = KEYMAP_ANSI(
  ...
  _______,_______,WHAT_SAVE,_______,_______,NUM_WANG,_______,_______,_______,BL_BRTG,BL_DEC,BL_TOGG, BL_INC, KC_MAIL,TG(_NUM), \
  XXXXXXX,MASSIVE,_______,_______,_______,_______,WHAT_EVENT,_______,_______,_______,_______,KC_APPLICATION,        _______,KC_PGUP, \
   ...
   * |----------------------------------------------------------------|
   * |Tab |NumL| up|   |   |   |Np4|Np5|Np6|   |   | / | * |     |ev.w| 15
   * |----------------------------------------------------------------|
...
[_NUM] = KEYMAP_ANSI(
  ...
  KC_TAB,KC_NUMLOCK, KC_UP,XXXXXXX,XXXXXXX, XXXXXXX,KC_P4,KC_P5,KC_P6,XXXXXXX,XXXXXXX,KC_PSLS,KC_PAST, XXXXXXX,WORK_USRNM, \
