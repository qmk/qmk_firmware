...
[_BL] = KEYMAP_ANSI(
  ...
  KC_LCTL, KC_LALT,KC_LGUI,                KC_SPC,                        KC_RGUI,MO(_FL),KC_RCTRL, KC_LEFT,KC_DOWN,KC_RGHT),
...
[_FL] = KEYMAP_ANSI(
  ...
  KC_LCTL,KC_LEFT,KC_DOWN,KC_RIGHT,_______,_______,_______,KC_PSCR,KC_SLCK,_______,_______,_______,        _______,KC_END, \
