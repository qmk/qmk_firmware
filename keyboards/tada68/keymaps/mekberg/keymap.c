...
//  |    Tab     |    Q   |    W   |    E   |    R   |    T   |    Y   |    U   |    I   |    O   |    P   |    Å   |    ¨   |            |  End   |
     LT(2,KC_TAB), KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    SE_ARNG, KC_RBRC,              KC_END,
//  |--------------------------------------------------------------------------------------------------------------------------|          |--------|
//  |    LCtrl     |    A   |    S   |    D   |    F   |    G   |    H   |    J   |    K   |    L   |   Ö    |   Ä    |   '    |   Enter  |  PgUp  |
        KC_LCTL,     KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,   SE_OUML, SE_AUML, KC_NUHS,   KC_ENT,  KC_PGUP,
//  |----------------------------------------------------------------------------------------------------------------------------------------------|
//  |  LShift  |   <>   |    Z   |   X    |   C    |    V   |    B   |    N   |    M   |   ,    |   .    |   -    |   RShift     |   Up   |  PgDn  |
      KC_LSFT,   SE_LT,  KC_Z,    KC_X,    KC_C,     KC_V,    KC_B,    KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH,    KC_RSFT,     KC_UP,  KC_PGDN,
//  |----------------------------------------------------------------------------------------------------------------------------------------------|
...
//  |  Caps Lock   |  Left  |  Down  | Right  | BLight |        |        |        |        |        |        |        |        |          | VolUp  |
        KC_CAPS,    KC_LEFT, KC_DOWN, KC_RGHT, BL_BRTG, ______,   ______,  ______,  ______,  ______,  ______,  ______,  ______,   ______,  MY_VOLU,
//  |----------------------------------------------------------------------------------------------------------------------------------------------|
...
//  |----------------------------------------------------------------------------------------------------------------------------------------------|
//  |          |          |          |                                                       |        |        |        |  Prev  |  Play  |  Fwd   |
      ______,    ______,    ______,                          ______,                           ______,  ______,  XXXXXX, MY_PREV, MY_PLAY, MY_NEXT
//  `----------------------------------------------------------------------------------------------------------------------------------------------'
	),
