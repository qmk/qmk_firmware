...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_all(
        ...
        _______, _______, _______, _______, _______,  _______, _______, _______,  _______,  _______, _______, RM_SPDD, RM_SPDU, _______,          RM_SATU,
        _______, _______, KC_UP,   _______, _______,  _______, _______, _______,  _______,  _______, _______, _______, _______, _______,          RM_SATD,
        ...
        _______, GU_TOGG, _______,                             _______,                              _______, _______, _______, RM_HUEU, RM_VALD, RM_NEXT
    ),
};
