...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT(
        KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_CALC,  KC_PSCR,   KC_SCRL,  KC_PAUSE, KC_MUTE,
    ...
    [_FL] = LAYOUT(
        _______,  KC_MYCM,  KC_WHOM,  KC_MAIL,  KC_CALC,  KC_MSEL,  KC_MSTP,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_CALC,   RP_END,   RM_NEXT,  _______, _______,
        _______,  RP_P0,    RP_P1,    RP_P2,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  RM_TOGG,   RL_MOD,   RM_HUEU,  KC_PAUSE,
        ...
        _______,  KC_NO,    TO(_MBL), _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,  _______,            _______,
        _______,  DEB_TOG,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),                               RM_VALU,
        _______,  GU_TOGG,  _______,                      EE_CLR,                       _______,  _______,  _______,  KC_RCTL,                       RM_SPDD,  RM_VALD,  RM_SPDU),
    ...
    [_MFL] = LAYOUT(
        _______,  KC_BRID,  KC_BRIU,  KC_F3,    KC_F4,    RM_VALD,  RM_VALU,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,   KC_VOLU, KC_CALC,   RP_END,   RM_NEXT,  _______, _______,
        _______,  RP_P0,    RP_P1,    RP_P2,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______, RM_TOGG,   RL_MOD,   RM_HUEU,  KC_PAUSE,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,  _______,   _______, _______,   _______,  _______,  _______,
        _______,  TO(_BL),  KC_NO,    _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,  _______,            _______,
        _______,  DEB_TOG,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),                               RM_VALU,
        _______,  KC_LALT,  KC_LGUI,                      EE_CLR,                       _______,  _______,  _______,  _______,                       RM_SPDD,  RM_VALD,  RM_SPDU),
