...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		LCTL(KC_C), KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_PSLS, KC_PAST, KC_INS, KC_BSPC, 
		KC_TAB, KC_LBRC, KC_UP, KC_RBRC, KC_LCBR, KC_RCBR, KC_NUM, KC_P7, KC_P8, KC_P9, KC_PPLS, KC_D=`
		LCTL(KC_X), LALT(KC_F4), LALT(KC_ESC), KC_MUTE, KC_MSTP, KC_MPLY, KC_PGDN, KC_P1, KC_P2, KC_P3, KC_BSLS, TO(0), 
		KC_LGUI, KC_LALT, KC_LCTL, KC_SPC, KC_ENT, KC_SPC, KC_P0, KC_PDOT),
