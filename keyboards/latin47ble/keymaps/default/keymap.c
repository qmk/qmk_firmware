...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_LCTL, KC_LGUI, KC_LALT,    KC_PGUP, KC_PGDOWN,      KC_SPC,       KC_X1, KC_1,  KC_2,  KC_3,  KC_4,KC_NO),	
    [1] = LAYOUT_47( 
	...
	KC_LCTL, KC_LGUI, KC_LALT,    KC_PGUP, KC_PGDOWN,      KC_SPC,       KC_X1, RGB_TOG, RGB_MOD,  KC_MY_COMPUTER,KC_CALCULATOR,KC_NO),	
    [2] = LAYOUT_47( 
