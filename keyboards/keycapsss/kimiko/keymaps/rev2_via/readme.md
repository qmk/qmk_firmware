...
- Support for VIA enabled  
	- plus some extra RGB effects
	- The firmware size is approaching the maximum - 28562/28672 (99%, 110 bytes free)
	- the json file for the via configurator is included: kimiko_rev2_via.json  <br />  
<br />  
