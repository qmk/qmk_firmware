...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------|  |------+------+------+------+------+------|
     * |Things| ESC  | GUI  | Alt  |Lower | Space|  |Space |Raise | Left | Down |  Up  |Right |
     * `------------------------------------------  ------------------------------------------'
     */
    [_BASE] = LAYOUT(
       ...
       THINGS,  KC_ESC,  KC_LGUI, KC_LALT, LOWER,   KC_SPC, KC_MUTE, KC_MPLY, KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
    ),
