...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* FN Layer (Based on Poker 3 FN layout)
     ...
     * |-----------------------------------------------------------------------------------------+
     * |        |     |  Up |     |     |     | Calc| PgUp|  Up | PgDn|PrtSc|Scrlk|Pause|        |
     * |-----------------------------------------------------------------------------------------+
     * |         | Left| Down|Right|     |     | Home| Left| Down|Right| Ins | Del |             |
     * |-----------------------------------------------------------------------------------------+
     * |           | App |     |     |     |     | End |     |     |     |     |                 |
     * |-----------------------------------------------------------------------------------------+
     * |       |     |       |                                            |        |     |       |
  ...
  [1] = LAYOUT_all( \
    ...
    _______,  _______,  KC_UP,    _______,  _______,  _______,  KC_CALC,  KC_PGUP,  KC_UP,    KC_PGDN,  KC_PSCR,  KC_SLCK,  KC_PAUS,  _______, \
