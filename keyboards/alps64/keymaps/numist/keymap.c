...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT_aek_103(
    ...
    KC_LCTL, KC_LALT, KC_LGUI,                   LT(_FL ,KC_SPC),                              KC_RGLT, KC_RADN, KC_RCRT
  ),
  [_FL] = LAYOUT_aek_103(
    KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,
    _______, KC_HOME, KC_UP,   KC_END,  _______, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_PGUP, RESET,
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_PAUS, _______, KC_PGUP,
