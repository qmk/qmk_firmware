...
#define KC_LSUP LSFT_T(KC_PGUP)
#define KC_LCDN LCTL_T(KC_PGDN)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT_aek_103(
    ...
    KC_LSUP, KC_Z,    KC_X,    KC_C,   KC_V,     KC_B,    KC_N,    KC_M,    KC_COMM,  KC_DOT,  KC_SLSH, KC_RSUP,
    KC_LCDN, KC_LALT, KC_LGUI,                   LT(_FL ,KC_SPC),                              KC_RGLT, KC_RADN, KC_RCRT
  ),
  [_FL] = LAYOUT_aek_103(
    ...
    _______, KC_UNDO, KC_CUT,  KC_COPY, KC_PSTE, _______, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, KC_PGUP,
