...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_KEY_OVERRIDE] = LAYOUT_kc(
    ...
    ____, ____, ____, ____, UNDS, PLUS, LCBR,   RCBR, ____, LPRN, RPRN, ____, ____, PIPE,
    ____, ____, ____, ____, MINS, EQL , ____,   PENT, ____, ____, ____, ____, COLN, DQUO,
  ...
  [_FN2] = LAYOUT_kc(
    ...
    ____, ____, ____, ____, ____, ____, WH_D,   ____, ____, ____, ____, ____, ____, ____,
  ...
  [_NUM] = LAYOUT_kc(
    ...
    ____, ____, ____, ____, ____, ____, WH_U,   ____, 0   , DOT , COMM, ASTR, ____, ____,
    ____, ____, ____, ____, ____, ____, ____,   ____, ____, ____, ____, ____, ____, ____
  )
};
