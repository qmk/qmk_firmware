...
#define MC_PSCR LGUI(LSFT(KC_3)) // MacOS Print Screen
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* Dvorak */
  /*
   * Use this to have access to US Dvorak layout when connecting your
   * keyboard to a computer that only has US QWERTY.
   */
  [_DV] = LAYOUT_60_ansi(
    //       .        .        .        .        .        .        .        .        .        .        .        .        .        .        .
  ...
  [_FW] = LAYOUT_60_ansi(
    ...
    _______, KC_CALC, KC_UP,   _______, _______, _______, KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_PGUP, KC_PSCR, KC_SLCK, KC_PAUS, \
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______, KC_PENT,          \
    _______, _______, KC_APP,  BL_DEC,  BL_TOGG, BL_INC,  BL_BRTG, KC_MUTE, KC_VOLD, KC_VOLU, TG(_DV), _______,                   \
    _______, _______, _______,                   TG(_NP),                                     _______, MO(_MA), _______, _______  \
  ),
  ...
  [_FM] = LAYOUT_60_ansi(
    //       .        .        .        .        .        .        .        .        .        .        .        .        .        .        .
    KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MC_PSCR, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          \
    _______, MC_UNDO, MC_CUT,  MC_COPY, MC_PSTE, BL_TOGG, _______, _______, _______, _______, TG(_DV), _______,                   \
  ...
  [_NP] = LAYOUT_60_ansi(
    ...
    _______, _______, _______,                   TO(_NP),                                     _______, _______, _______, _______  \
  ),
