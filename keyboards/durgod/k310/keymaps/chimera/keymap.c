...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------|  |--------------|  ,---------------.
     * | ` | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 | 0 | - | = |Backsp |  | Ins|Home|PgUp|  |NLk| / | * | - |
     * |-----------------------------------------------------------|  |--------------|  |---------------|
     ...
     * |-----------------------------------------------------------|   ,-------------.  |-----------|Ent|
     * |Ctrl|Gui |Alt |      Space            |Alt |Func |App|Ctrl |   |Lft| Dn |Rig |  |   0   | . |   |
     * `-----------------------------------------------------------'   `-------------'  `---------------'
     */
     ...
     * ,-----------------------------------------------------------.  ,--------------.
     * |   |Play|Stop|Prev|Next| |Mute|Vol+|Vol-|   |  |  |  |  |  |  |    |    |Mute|
     * |-----------------------------------------------------------|  |--------------|  ,---------------.
     * |   |   |   |   |   |   |   |   |   |   |   |   |   |       |  |    |    |Vol+|  |   |   |   |   |
     * |-----------------------------------------------------------|  |--------------|  |---------------|
     * |     |   |   |   |   |   |   |   |   |   |   |   |   |     |  |    |    |Vol-|  |   |   |   |   |
     ...
     * |Shift| \|  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift     |       | Up |       | 1 | 2 | 3 |   |
     * |-----------------------------------------------------------|   ,-------------.  |-----------|Ent|
     * |Ctrl|Alt |Gui |      Space            |Gui |Alt|Func |Ctrl |   |Lft| Dn |Rig |  |   0   | . |   |
     * `-----------------------------------------------------------'   `-------------'  `---------------'
     */
     ...
     * ,-----------------------------------------------------------.  ,--------------.
     * |  |Bri-|Bri+|MCon|LPad| |  |  |Prv|Ply| |Nxt|Mute|Vol-|Vol+|  |TMed|    |Mute|
     * |-----------------------------------------------------------|  |--------------|  ,---------------.
     * |   |   |   |   |   |   |   |   |   |   |   |   |   |       |  |    |    |Vol+|  |   |   |   |   |
     * |-----------------------------------------------------------|  |--------------|  |---------------|
     * |     |   |   |   |   |   |   |   |   |   |   |   |   |     |  |    |    |Vol-|  |   |   |   |   |
