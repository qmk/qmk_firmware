...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_ansi_82(
        ...
        RM_TOGG,  RM_NEXT,  RM_VALU,  RM_HUEU,  RM_SAI,  RM_SPDU,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,
        _______,  RM_PREV,  RM_VALD,  RM_HUED,  RM_SAD,  RM_SPDD,  _______,  _______,  _______,  _______,  _______,  _______,              _______,            _______,
