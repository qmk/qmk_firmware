...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_fungo_split_num(
    ...
    KC_NO,      TT(SAM1), KC_NO,   KC_LALT,    KC_LSHIFT,      KC_SPC,   MO(F3LAY),           KC_ENT,  KC_ENT, TT(F3LAY),           KC_SPC,     KC_RSFT,     KC_RALT, KC_NO,   TT(SAM1),TG(F4LAY)
  ),
  ...
  [F3LAY] = LAYOUT_fungo_split_num(
    ...
    KC_NO,      KC_NO,      KC_NO,       KC_LALT,           KC_LSHIFT,        KC_SPC,   MO(F3LAY),           KC_ENT,  KC_ENT, TT(F3LAY),           KC_SPC,     KC_RSFT,       KC_RALT, KC_NO,    KC_NO,   TG(F4LAY)
  ),
  ...
  /*
    ...
    KC_NO,      KC_NO,  KC_NO,   KC_LALT,    KC_LSHIFT,      KC_SPC,   MO(F3LAY),      KC_ENT,  KC_ENT, TT(F3LAY),  KC_SPC,      KC_RSFT,       KC_RALT,   KC_NO,  KC_NO,   KC_NO
  ),
  */
