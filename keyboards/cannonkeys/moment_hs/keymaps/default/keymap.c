...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT_60_tsangan_hhkb(
        ...
        BL_BRTG, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______,          BL_UP,   BL_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
