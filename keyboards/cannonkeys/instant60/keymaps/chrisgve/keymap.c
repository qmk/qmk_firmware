...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MAC_NAV_1] = LAYOUT_60_tsangan_hhkb(
    ...
    _______, _______, S_SHIFT, _______, M_NAV_2, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,          _______, \
  ...
  [_LINUX_NAV_1] = LAYOUT_60_tsangan_hhkb(
    ...
    _______, _______, S_SHIFT, _______, L_NAV_2, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,          _______, \
  ...
  [_WIN_NAV_1] = LAYOUT_60_tsangan_hhkb(
    ...
    _______, _______, S_SHIFT, _______, W_NAV_2, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,          _______, \
