...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT_default(
		...
		_______, KC_MUTE, KC_VOLD, KC_VOLU, _______, AG_TOGG, AG_NORM, _______, _______, _______, _______, _______, _______, _______, _______,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		KC_RCTL, KC_RGUI, _______, _______, _______, _______, _______, _______, _______
    )
};
