...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_all(
    ...
    KC_F7, KC_F8,  KC_LSFT, KC_BSLS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,                 KC_M,    KC_COMM, KC_DOT,  KC_SLSH,           KC_RSFT, KC_UP, KC_PGDN,
    KC_F9, KC_F10, KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                                                   KC_RALT, MO(_FN1), KC_LEFT, KC_DOWN, KC_RIGHT
  ),

  [_FN1] = LAYOUT_all(
    _______, _______, QK_GESC, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL, _______, _______,
    ...
    _______, _______, KC_GRV,  _______, _______,                            _______,                            _______, _______, _______, _______, QK_BOOT
  )
};
