...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY_MAC] = LAYOUT_all(
    ...
    TAB_CTL, KC_A,    KC_S,    M_NAV_1, KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,  KC_ENT,            KC_PGDN,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, R_SHIFT,  KC_UP,             ADJ_M,
    KC_LCTL, KC_LALT, KC_LGUI, SPC_RSE, SPC_LWR, KC_RGUI, KC_RALT, KC_RCTL,                            KC_LEFT,  KC_DOWN, KC_RIGHT
  ),
  ...
  [_MAC_NAV_1] = LAYOUT_all(
    ...
    _______, _______, _______, _______, _______, _______, M_B_WRD, _______, _______, _______, _______, _______, _______,          _______,
  ...
  [_QWERTY_LINUX] = LAYOUT_all(
    KC_GESC, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,  KC_RBRC,  KC_BSPC, KC_PGUP,
    TAB_CTL, KC_A,    KC_S,    L_NAV_1, KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,  KC_ENT,            KC_PGDN,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, R_SHIFT,  KC_UP,             ADJ_L,
    KC_LCTL, KC_LGUI, KC_LALT, SPC_RSE, SPC_LWR, KC_RALT, KC_RGUI, KC_RCTL,                            KC_LEFT,  KC_DOWN, KC_RIGHT
  ),
  ...
  [_LINUX_NAV_1] = LAYOUT_all(
    ...
    _______, _______, _______, _______, _______, _______, L_B_WRD, _______, _______, _______, _______, _______, _______,          _______,
    _______, _______, _______, _______, _______, _______, _______, _______,                            _______, _______, _______
  ),
  ...
  [_QWERTY_WIN] = LAYOUT_all(
    KC_GESC, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,  KC_RBRC,  KC_BSPC, KC_PGUP,
    TAB_CTL, KC_A,    KC_S,    W_NAV_1, KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,  KC_ENT,            KC_PGDN,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, R_SHIFT,  KC_UP,             ADJ_W,
    KC_LCTL, KC_LGUI, KC_LALT, SPC_RSE, SPC_LWR, KC_RALT, KC_RGUI, KC_RCTL,                            KC_LEFT,  KC_DOWN, KC_RIGHT
  ),
  ...
  [_WIN_NAV_1] = LAYOUT_all(
    ...
    _______, _______, _______, _______, _______, _______, W_B_WRD, _______, _______, _______, _______, _______, _______,          _______,
    _______, _______, _______, _______, _______, _______, _______, _______,                            _______, _______, _______
  ),
  ...
  [_LOWER] = LAYOUT_all(
    ...
    KC_CAPS, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______, _______, _______, _______, _______, KC_UNDS, KC_PLUS,          _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
    _______, _______, _______, _______, _______, _______, _______, _______,                            _______, _______, _______
  ),
  ...
  [_RAISE] = LAYOUT_all(
    ...
    KC_CAPS, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, _______, _______, _______, _______, KC_MINS, KC_EQL,           _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
    _______, _______, _______, _______, _______, _______, _______, _______,                            _______, _______, _______
  ),
