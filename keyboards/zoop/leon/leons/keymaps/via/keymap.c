...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_all(
    ...
    KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             MO(1),    KC_RGUI,    KC_RALT,    KC_RCTL,    KC_LEFT, KC_DOWN, KC_RGHT
  ),


    /* Base Layer/Default Layer
      * .------------------------------------------------------------------------------------------------------------------.
      * | Esc |\\| F1 | F2 | F3 | F4|\\| F5 | F6 | F7 | F8|\\| F9 | F10 | F11 | F12 |\\| F13 |\\| Print | ScrLck | Pause |  |
      * | ----------------------------------------------------------------------------------------------------------------  |
      * | `~     | 1  | 2  | 3  |  4   |  5 |  6 |  7 |  8   |  9 |  0  |  _- |  +=    | SplBspL| Ins   | Home   | PgUp  |  |
      * | ----------------------------------------------------------------------------------------------------------------  |
      * | Tab    |  Q |  W |  E |  R   |  T |  Y |  U |  I   |  O |  P  |  [{ |  }]    |  \|    | Del   | End    | PgDn  |  |                     
      * | ----------------------------------------------------------------------------------------------------------------  |
      * | Caps   |  A |  S |  D |  F   |  G |  H |  J |  K   |  L |  ;: | '"  | AEnter | SplBspR|                           |
      * | ----------------------------------------------------------------------------------------------------------------  |
      * | LShift | \\ | Z  |  X |  C   |  V |  B |  N |  M   | ,< | .>  |  /? | RShift | RShiftR| \\    | Up     | \\    |  |
      * | ----------------------------------------------------------------------------------------------------------------  |
      * | Ctrl   | Alt| Win| \\ | \\   | \\ | Spa| \\ | \\   | \\ | Fn  | Win | Alt    | Ctrl   | Left  | Down   | Right |  |
      * '-------------------------------------------------------------------------------------------------------------------'
    */
  [1] = LAYOUT_all(
