...
[_BASE] = LAYOUT(
    TD_SCLN, KC_Y,    KC_O,    KC_U,    KC_Z,    CNTR_TL, CNTR_TR, KC_G,    KC_D,    KC_N,    KC_M,    KC_X   ,
...
[_LSHIFT] = LAYOUT(
    ...
    KC_Q,    KC_I,    KC_E,    KC_SPC,  TD_TILD, CNTR_HL, CNTR_HR, S(KC_C), S(KC_T), S(KC_R), S(KC_S), S(KC_W),
...
[_RSHIFT] = LAYOUT(
    ...
    S(KC_Q), S(KC_I), S(KC_E), S(KC_A), KC_QUES, CNTR_HL, CNTR_HR, KC_C,  KC_ENT,    KC_R,    KC_S,    KC_W   ,
