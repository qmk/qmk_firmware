...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        case ST_SPC:
            if (map_shift(record, KC_RSFT, NOSHIFT, KC_BSPC)) {
                return false;
            }
        case HOME_A:
        ...
        case TD_SPC:
            ...
            if (map_shift(record, KC_LSFT, NOSHIFT, KC_BSPC)) {
                return false;
            }
        ...
        case KC_COLN:
        case TD_COLM:
            if (map_shift(record, KC_LSFT, NOSHIFT, KC_SCLN)) {
                return false;
            }
            if (map_shift(record, KC_RSFT, NOSHIFT, KC_SCLN)) {
                return false;
            }
            break;

        case KC_COMM:
            if (map_shift(record, KC_LSFT, NOSHIFT, KC_SLSH)) {
                return false;
            }
