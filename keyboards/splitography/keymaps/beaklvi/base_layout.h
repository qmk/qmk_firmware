...
// cons uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
...
// .................................................................... BEAKL VI
  ...
  // |------+------+------+------+------+------+------+------+------+------+------+------|
  // |                           |  Esc |   I  | Space| Enter|                           |
  // | Ctrl |  GUI |  Alt |  Esc |   I  |  Ins | Left | Space| Enter| Down |  Up  | Right|
  // `-----------------------------------------------------------------------------------'
...
#ifdef SPLITOGRAPHY
    {_______, _______, _______, _______, LT_ESC,  LT_I,    TD_SPC,  TD_ENT,  _______, _______, _______, _______},
#else
    {OS_CTL,  OS_GUI,  OS_ALT,  LT_ESC,  LT_I,    LT_INS,  LT_LEFT, TD_SPC,  TD_ENT,  AT_DOWN, GT_UP,   CT_RGHT},
#endif
  },
...
#ifdef SPLITOGRAPHY
    {_______, _______, _______, _______, KC_ESC,  S(KC_I), KC_SPC,  KC_ENT,  _______, _______, _______, _______},
#else
    {OS_CTL,  OS_GUI,  OS_ALT,  KC_ESC,  S(KC_I), LT_INS,  LT_LEFT, KC_SPC,  KC_ENT,  AT_DOWN, GT_UP,   CT_RGHT},
#endif
  },
  ...
  // |------+------+------+------+------+------+------+------+------+------+------+------|
  // |                           |  Tab |  f() | Bksp |  Del |                           |
  // | Ctrl |  GUI |  Alt |  Tab |  f() |  Ins | Left | Bksp |  Del | Down |  Up  | Right|
  // `-----------------------------------------------------------------------------------'
...
#ifdef SPLITOGRAPHY
    {_______, _______, _______, _______, KC_TAB,  ___fn__, LT_BSPC, KC_DEL,  _______, _______, _______, _______},
#else
    {OS_CTL,  OS_GUI,  OS_ALT,  KC_TAB,  ___fn__, LT_INS,  S_LEFT,  KC_BSPC, LT_DEL,  S_DOWN,  S_UP,    S_RGHT },
#endif
  },
  ...
  // |------+------+------+------+------+------+------+------+------+------+------+------|
  // |                           |  Tab |   I  |  f() | Enter|                           |
  // | Ctrl |  GUI |  Alt |  Tab |   I  |  Ins | Left |  f() | Enter| Down |  Up  | Right|
  // `-----------------------------------------------------------------------------------'
  // thumb side lower case to ovoid triggering same hand upper case
...
#ifdef SPLITOGRAPHY
    {_______, _______, _______, _______, KC_TAB,  SL_I,   ___fn__, KC_ENT,  _______, _______, _______, _______},
#else
    {OS_CTL,  OS_GUI,  OS_ALT,  KC_TAB,  SL_I,   LT_INS,  S_LEFT,  ___fn__, KC_ENT,  S_DOWN,  S_UP,    S_RGHT },
#endif
  },
