...
// ................................................................... Dvorak MU
  ...
  [_LSHIFT] = {
    {TD_DQOT, KC_DLR,  KC_LCBR, KC_RCBR, S(KC_Y), CNTR_TL, CNTR_TR, S(KC_F), S(KC_G), S(KC_C), S(KC_R), S(KC_L)},
    {S(KC_A), KC_SLSH, TD_LT,   TD_GT,   TD_TILD, CNTR_HL, CNTR_HR, S(KC_D), S(KC_H), S(KC_T), S(KC_N), S(KC_S)},
    {KC_COLN, S(KC_Q), KC_EXLM, KC_EQL,  TD_GRV,  CNTR_BL, CNTR_BR, S(KC_B), S(KC_M), S(KC_W), S(KC_V), S(KC_Z)},
  ...
  [_RSHIFT] = {
    {TD_DQOT, KC_SLSH, KC_QUES, S(KC_P), S(KC_Y), CNTR_TL, CNTR_TR, S(KC_F), KC_LBRC, KC_RBRC, KC_CIRC, S(KC_L)},
