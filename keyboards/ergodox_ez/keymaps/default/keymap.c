...
[BASE] = LAYOUT_ergodox_pretty(
  ALT_TAB,         KC_1,               KC_2,                 KC_3,                KC_4,                  KC_5,    KC_TILD,                   LCTL(KC_H),     KC_6,                  KC_7,                  KC_8,                      KC_9,                 KC_0,                   KC_DELETE,
  KC_TAB,          KC_Q,               KC_W,                 KC_F,                KC_P,                  KC_B,    KC_SLASH,                  KC_DQT,         KC_J,                  KC_L,                  KC_U,                      KC_Y,                 KC_BACKSLASH,           KC_BSPC,
  KC_ESC,          KC_A,               KC_R,                 KC_S,                KC_T,                  KC_G,                                               KC_M,                  KC_N,                  KC_E,                      KC_I,                 KC_O,                   KC_ENT,
  KC_LSFT,         KC_Z,               KC_X,                 KC_C,                KC_D,                  KC_V,    KC_GRAVE,                  KC_COLON,       KC_K,                  KC_H,                  KC_COMMA,                  KC_DOT,               KC_MINUS,               KC_RSFT,
  KC_TRNS,         KC_LCBR,            KC_LBRC,              KC_SEMICOLON,        MO(SYMB),                                                                                         KC_BTN1,               KC_LGUI,                   KC_RBRC,              KC_RCBR,                KC_TRNS,
                                                             KC_LT,               KC_TRNS,                                                   KC_VOLU,        KC_GT,
                                                                                  KC_HOME,                                                   KC_VOLD,
                                                     KC_SPC, KC_LALT,             LALT(KC_X),                                                KC_QUOT,        KC_LALT,               KC_LCTL
),
