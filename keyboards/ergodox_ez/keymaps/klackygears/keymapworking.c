...
[DVRK] = LAYOUT_ergodox(  // layer 0 : default
        ...
        TD(TD_MCROTG2), MT(MOD_LGUI,KC_SCLN), MT(MOD_LALT,KC_Q), MT(MOD_LCTL,KC_J), MT(MOD_LSFT,KC_K), KC_X,     XXXXXXX,
        ...
        // right hand
             ...
             XXXXXXX,  KC_B,     MT(MOD_LSFT,KC_M), MT(MOD_LCTL,KC_W), MT(MOD_LALT,KC_V), LT(MDIA,KC_Z), TD(TD_MCROTOG),
                                 SH_MON,            KC_RCTL,           KC_RALT,           KC_RGUI,       MO(MDIA),
             XXXXXXX,  XXXXXXX,
             XXXXXXX,
...
[MACD] = LAYOUT_ergodox(  // layer  
        ...
        KC_LSFT,        KC_A,                 KC_O,              KC_E,              KC_U,              KC_I,
        TD(TD_MCROTG2), MT(MOD_LCTL,KC_SCLN), MT(MOD_LALT,KC_Q), MT(MOD_LGUI,KC_J), MT(MOD_LSFT,KC_K), KC_X,    XXXXXXX,
        ...
        // right hand
             ...
             XXXXXXX,  KC_B,    MT(MOD_LSFT,KC_M), MT(MOD_LGUI,KC_W), MT(MOD_LALT,KC_V), LT(MDIA,KC_Z),     TD(TD_MCROTOG),
                                SH_MON,            KC_RCMD,           KC_RALT,           KC_RCTL,           MO(MDIA),
             TD(TD_DNCE), XXXXXXX,
             XXXXXXX,
 ...
 * |---------+------+-------+-------+-------+------|      |           |      |------+------+------+------+------+--------|
 * | STRIKE  |LEFT  |DOWN   |UP     |RIGHT  |  PTSP|      |           |      | /  * |   4  |   5  |   6  |      |        |
 * |---------+------+-------+-------+-------+------|      |           |      |------+------+------+------+------+--------|
 * |         |      |       |       |       |      |------|           |------|      | SHIFT| CTRL |  ALT |  WIN |        |
