...
[NUMB] = LAYOUT_ergodox(
       ...
       KC_TRNS,   TD(TD_MINPLS), KC_7,              KC_8,              KC_9,              KC_PPLS,              KC_TRNS,
                  TD(TD_DIVMLT), KC_4,              KC_5,              KC_6,              KC_PAST,              KC_TRNS,
...
[SYMB] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       KC_TRNS,  KC_TRNS,  MT(MOD_LSFT,KC_F1), MT(MOD_LCTL,KC_F2), MT(MOD_LALT,KC_F3), MT(MOD_LGUI,KC_F4), KC_TRNS,
                           KC_TRNS,            KC_TRNS,            KC_TRNS,            KC_TRNS,            KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
...
[MCSM] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       KC_TRNS,  TO(MACD), KC_F9,              KC_F10,             KC_F11,             KC_F12,             KC_TRNS,
                 TO(DVRK), KC_F5,              KC_F6,              KC_F7,              KC_F8,              KC_TRNS,
       KC_TRNS,  KC_TRNS,  MT(MOD_LSFT,KC_F1), MT(MOD_LGUI,KC_F2), MT(MOD_LALT,KC_F3), MT(MOD_LCTL,KC_F4), KC_TRNS,
                           KC_TRNS,            KC_TRNS,            KC_TRNS,            KC_TRNS,            KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
