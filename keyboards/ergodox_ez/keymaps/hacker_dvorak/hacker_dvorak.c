...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [ARROWS] = LAYOUT_ergodox(
        ...
        XXXXXXX, KC_LCTRL,      KC_LSFT,      XXXXXXX,      _______,    XXXXXXX,
    ...
    [MOUSE] = LAYOUT_ergodox(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, ALL_T(KC_NO), MEH_T(KC_NO), SCMD_T(KC_NO), XXXXXXX,
                 XXXXXXX, _______, KC_MS_ACCEL1, KC_LSFT,      KC_LCTRL,      KC_MS_ACCEL2,
    ...
    [NUMPAD] = LAYOUT_ergodox(
        ...
        _______, KC_LCTRL, KC_LSFT,      _______, MEH_T(KC_NO),  XXXXXXX,
