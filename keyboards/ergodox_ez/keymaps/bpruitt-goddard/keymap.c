...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NUM] = LAYOUT_ergodox_pretty(
    ...
    ___,  ___,     KC_CIRC,  KC_LBRC,     KC_RBRACKET, KC_TILD,    ___,         ___, KC_0,    KC_1,   KC_2,   KC_3,       KC_KP_SLASH,  KC_BSLASH,
  ...
  [QWERTY] = LAYOUT_ergodox_pretty(
    ...
    KC_GRAVE,   KC_QUOTE, LALT(KC_TAB), KC_LEFT,  KC_RIGHT,                                                   KC_UP,  KC_DOWN,  KC_LBRC,      KC_RBRACKET,  TO(BASE),
