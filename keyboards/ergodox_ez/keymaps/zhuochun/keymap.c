 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | Grv    |   1  |   2  |   3  |   4  |   5  | Wake |           | L3   |   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  | L1   |           | L2   |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | Esc/Gui|   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  |Ent/Ctrl|
 * |--------+------+------+------+------+------| Hyper|           | =/Meh|------+------+------+------+------+--------|
 * | LSft/( |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  | //Gui| RSft/) |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *    |Hyper|  Up  |DwnAlt| Left | Right|                                       |   =  |   [  |   ]  |   '  | Meh |
 *    `---------------------------------'                                       `---------------------------------'
 *                                       ,--------------.       ,---------------.
 *                                       |Ent/Alt| Space|       | Up   |Down/Gui|
 *                               ,-------|-------|------|       |------+--------+-------.
 *                               |       |       | PgUp |       | Home |        |       |
 *                               |Backsps| LGui  |------|       |------| -/~L1  | Space |
 *                               |       |       | PgDn |       | End  |        |       |
 *                               `----------------------'       `-----------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        ALL_T(KC_NO), KC_UP,       ALT_T(KC_DOWN),KC_LEFT,KC_RGHT,
                                                    ALT_T(KC_ENT),  KC_SPC,
                                                                    KC_PGUP,
                                                    KC_BSPC,KC_LGUI,KC_PGDN,
        // right hand
        TG(CALC),     KC_6, KC_7,  KC_8,   KC_9,   KC_0,           KC_MINS,
        TG(MDIA),     KC_Y, KC_U,  KC_I,   KC_O,   KC_P,           KC_BSLS,
                      KC_H, KC_J,  KC_K,   KC_L,   KC_SCLN,        CTL_T(KC_ENT),
        MEH_T(KC_EQL),KC_N, KC_M,  KC_COMM,KC_DOT, GUI_T(KC_SLSH), KC_RSFT,
 ...
 *
 * ,--------------------------------------------------.           ,-------------------------------------------------.
 * |        |  F1  |  F2  |  F3  |  F4  |  F5  |      |           | XXXX |  F6  |  F7  |  F8  |  F9  |  F10 |  F11  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+-------|
 * |        |      |  Up  |      |      |      | XXXX |           | XXXX |      |   -  |   {  |   }  |   _  |  F12  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+-------|
 * |        | Left | Down | Rght |      |      |------|           |------|      |   =  |   [  |   ]  |   +  |       |
...
[SYMB] = KEYMAP(
        ...
        KC_TRNS,KC_TRNS,KC_MINS,KC_LCBR,KC_RCBR,KC_UNDS,KC_F12,
                KC_TRNS,KC_EQL, KC_LBRC,KC_RBRC,KC_PLUS,KC_TRNS,
        KC_TRNS,KC_TRNS,KC_QUOT,KC_LPRN,KC_RPRN,SFT_T(KC_QUOT),KC_TRNS,
                        KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
        KC_TRNS,KC_TRNS,
        KC_TRNS,
