...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_LSFT,         KC_Z,        KC_X,          KC_C,    KC_V,    KC_B,    KC_END,               KC_HOME,      KC_N,    KC_M,    KC_COMM, KC_DOT,  CTL_T(KC_SLSH),    KC_RSFT,
  KC_LCTRL,        KC_LALT,     KC_LGUI,       KC_LEFT, KC_RGHT,                                                       KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC,           TT(SYMB),
                                                                 KC_DEL,  KC_APP,                 KC_LALT, KC_EQL,
                                                                          KC_HOME,                KC_PGUP,
                                                         KC_SPC, KC_ENT,  MO(SYMB),               TG(SYMB), KC_TAB, KC_BSPC
),
...
[SYMB] = LAYOUT_ergodox_pretty(
  // left hand
  KC_CAPS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_TRNS,     KC_TRNS, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
  ...
  EEP_RST, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                         KC_0,    KC_DOT,  KC_0,    KC_EQL,  KC_TRNS,
