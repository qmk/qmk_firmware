...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LSHIFT,      LCTL_T(KC_Z),   LALT_T(KC_X),   LGUI_T(KC_C),   KC_V,           KC_B,           KC_ENTER,                                       LCTL(KC_GRAVE), KC_N,           KC_M,           RGUI_T(KC_COMMA),RALT_T(KC_DOT), RCTL_T(KC_SLASH),KC_RSHIFT,
    LT(1,KC_GRAVE), KC_UP,          KC_DOWN,        KC_LEFT,        SH_T(KC_RIGHT),                                                                                                       LT(1,KC_UP),    KC_DOWN,        KC_LEFT,        KC_RIGHT,       KC_CAPSLOCK,
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_WH_UP,        KC_MS_WH_DOWN,      KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_KP_0,        RALT_T(KC_KP_DOT),KC_KP_SLASH,    KC_RSHIFT,
