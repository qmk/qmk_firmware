...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    /* Swap Hands (Left becomes Right, Right stays the same)
    * *---------------------------------------------------------------------*                             *---------------------------------------------------------------------*
    * | Del     | 6       | 7       | 8       | 9       | 0       | =       |                             |         |         |         |         |         |         |         |
    * |---------+---------+---------+---------+---------+---------+---------|                             |---------+---------+---------+---------+---------+---------+---------|
    * | \       | Y       | U       | I       | O       | P       | ]       |                             |         |         |         |         |         |         |         |
...
const keypos_t PROGMEM hand_swap_config[MATRIX_ROWS][MATRIX_COLS] = {
      {{0, 13},  {0, 8},   {0, 9},   {0, 10},  {0, 11},  {0, 12},  {0, 7},                                 {0, 7},   {0, 8},   {0, 9},   {0, 10},  {0, 11},  {0, 12},  {0, 13}},
      {{1, 13},  {1, 8},   {1, 9},   {1, 10},  {1, 11},  {1, 12},  {1, 7},                                 {1, 7},   {1, 8},   {1, 9},   {1, 10},  {1, 11},  {1, 12},  {1, 13}},
      {{2, 13},  {2, 8},   {2, 9},   {2, 10},  {2, 11},  {2, 12},                                                    {2, 8},   {2, 9},   {2, 10},  {2, 11},  {2, 12},  {2, 13}},
      {{3, 0},   {3, 8},   {3, 9},   {3, 10},  {3, 11},  {3, 12},  {3, 7},                                 {3, 7},   {3, 8},   {3, 9},   {3, 10},  {3, 11},  {3, 12},  {3, 13}},
      {{4, 0},   {4, 1},   {4, 2},   {4, 3},   {4, 4},                                                                         {4, 9},   {4, 10},  {4, 11},  {4, 12},  {4, 13}},

                                                                  {{5, 8},   {5, 7},             {5, 7},   {5, 8},
                                                                             {5, 9},             {5, 9},
                                                         {5, 10},  {5, 2},   {5, 1},             {5, 12},  {5, 11},  {5, 10}},
};
*/

const keypos_t PROGMEM hand_swap_config[MATRIX_ROWS][MATRIX_COLS] = {
      {{13,0},{13,1},{13,2},{0,3},{0,4}},
      {{8,0},{8,1},{8,2},{8,3},{1,4},{1,5}},
      {{9,0},{9,1},{9,2},{9,3},{9,4},{2,5}},
      {{10,0},{10,1},{10,2},{10,3},{10,4},{10,5}},
      {{11,0},{11,1},{11,2},{11,3},{11,4},{9,5}},
      {{12,0},{12,1},{12,2},{12,3},{8,5}},
      {{6,0},{6,1},{3,2},{7,5}},
      {{7,0},{7,1},{7,3},{7,5}},
      {{8,0},{8,1},{8,2},{8,3},{8,5}},
