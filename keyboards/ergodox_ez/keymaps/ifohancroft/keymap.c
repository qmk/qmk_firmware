...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |---------+---------+---------+---------+---------+---------*                                                 *---------+---------+---------+---------+---------+---------|
    * | Ctrl    | Super   | Alt     |         | TT(2)   |                                                                     | TT(2)   | Left    | Down    | Up      | Right   |
    * *-------------------------------------------------*                                                                     *-------------------------------------------------*
    *
    *                                                             *-------------------*         *-------------------*
    *                                                             |         | TO(1)   |         |         |         |
    ...
    */
    ...
    LAYOUT_ergodox_pretty(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,  KC_NO,   TT(2),                                                                           TT(2),    KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,

                                                                    KC_NO,    TO(1),              KC_NO,    KC_NO,
                                                                              KC_NO,              KC_NO,
                                                          KC_BSPC,  KC_ENT,   KC_NO,              KC_NO,    KC_ENT,   KC_SPC
    ),
