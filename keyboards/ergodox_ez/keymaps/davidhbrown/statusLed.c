...
https://github.com/davidhbrown/qmk_firmware/tree/davidhbrown/keyboards/ergodox_ez/keymaps/davidhbrown
*/
...
/* Set the ergodox_right_led indicator LEDs according to USB Host LEDs (e.g., NumLock) and the current layer */
void statusLed(void) {
