...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_ergodox(
    ...
    KC_TRANSPARENT     ,KC_TRANSPARENT     ,KC_TRANSPARENT     ,IARROW             ,ARROW              ,KC_TRANSPARENT     ,KC_TRANSPARENT     ,
    ...
    LALT(LSFT(KC_DOWN)),KC_EXLM            ,KC_LBRACKET            ,KC_RBRACKET            ,ARROW              ,KC_BSLASH          ,KC_BSLASH          ,
    KC_TRANSPARENT     ,KC_TRANSPARENT     ,KC_TRANSPARENT     ,KC_TRANSPARENT     ,KC_TRANSPARENT     ,
