...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ergodox(
    ...
    LT(4,KC_ENTER)      ,KC_DOWN             ,KC_LBRC             ,KC_RBRACKET         ,OSL(2)              ,
  ...
  [2] = LAYOUT_ergodox(
    ...
    KC_TRANSPARENT,KC_PERC       ,KC_CIRC       ,KC_LBRC       ,KC_RBRACKET   ,KC_TILD       ,KC_TRANSPARENT,
    KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,KC_TRANSPARENT,
                                  RGB_HUI       ,
  ...
  [3] = LAYOUT_ergodox(
    ...
    KC_TRANSPARENT     ,KC_TRANSPARENT     ,KC_TRANSPARENT     ,KC_LBRC            ,KC_RBRACKET        ,KC_TRANSPARENT     ,KC_TRANSPARENT     ,
