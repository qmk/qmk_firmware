//pvazteixeira's ergodox (classic) layout
...
[SYMB] = LAYOUT_ergodox(
  ...
  EPRM,    KC_NO, KC_TRNS, KC_TRNS, KC_DEL,
                                               KC_NO, KC_NO,
                                                        KC_NO,
                                      KC_NO, KC_NO, KC_TRNS,
  // right hand
