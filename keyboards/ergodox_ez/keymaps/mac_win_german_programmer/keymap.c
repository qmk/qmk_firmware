...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [MACOS_ALPHA] = KEYMAP(
    ...
    KC_NO,KC_A,KC_S,KC_D,KC_F,KC_G,           /* 6 */
    KC_LSHIFT,CTL_T(DE_Y),KC_X,KC_C,KC_V,KC_B,NO_LPRN,  /* 7 */
  ...
  [MACOS_SPECIAL] =  KEYMAP(
    ...
    // BLOCK
    RGB_MOD,KC_NO,KC_NO,RGB_VAD,RGB_VAI,KC_NO,
    ...
    // BLOCK
    RGB_TOG,RGB_SLD,KC_NO,KC_NO,RGB_HUD,RGB_HUI
  ),
  ...
  [MACOS_UMLAUT] = KEYMAP(
    ...
    KC_NO,DE_AE,DE_SS,KC_NO,KC_NO,KC_NO, // 6
...
//
    ...
    [WIN_ALPHA] = KEYMAP(
      ...
      KC_LGUI,KC_A,KC_S,KC_D,KC_F,KC_G,           /* 6 */
      KC_LSHIFT,CTL_T(DE_Y),KC_X,KC_C,KC_V,KC_B,NO_LPRN,  /* 7 */
