...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_ergodox(
        ...
        KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    LGUI(KC_LALT),
        KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,
        KC_SPC,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    LGUI(KC_LSFT),
        ...
        // right hand
        _______,       _______, _______, _______, _______, _______,        _______,
        RGUI(KC_RALT), KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,           KC_BSPC,
                       KC_H,    KC_J,    KC_K,    KC_L,    SFT_T(KC_SCLN), KC_RGUI,
        RGUI(KC_LSFT), KC_N,    KC_M,    KC_RCTL, KC_DOT,  KC_RALT,        RGUI(KC_RSFT),
