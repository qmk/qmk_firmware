...
#define ERGODOX_BOARD_LED_PIN D6
#define ERGODOX_RIGHT_LED_1_PIN B5
#define ERGODOX_RIGHT_LED_2_PIN B6
#define ERGODOX_RIGHT_LED_3_PIN B7

inline void ergodox_board_led_on(void) {
    gpio_set_pin_output(ERGODOX_BOARD_LED_PIN);
    gpio_write_pin_high(ERGODOX_BOARD_LED_PIN);
}
inline void ergodox_right_led_1_on(void) {
    gpio_set_pin_output(ERGODOX_RIGHT_LED_1_PIN);
    gpio_write_pin_high(ERGODOX_RIGHT_LED_1_PIN);
}
inline void ergodox_right_led_2_on(void) {
    gpio_set_pin_output(ERGODOX_RIGHT_LED_2_PIN);
    gpio_write_pin_high(ERGODOX_RIGHT_LED_2_PIN);
}
inline void ergodox_right_led_3_on(void) {
    gpio_set_pin_output(ERGODOX_RIGHT_LED_3_PIN);
    gpio_write_pin_high(ERGODOX_RIGHT_LED_3_PIN);
}

inline void ergodox_board_led_off(void) {
    gpio_set_pin_input(ERGODOX_BOARD_LED_PIN);
}
inline void ergodox_right_led_1_off(void) {
    gpio_set_pin_input(ERGODOX_RIGHT_LED_1_PIN);
}
inline void ergodox_right_led_2_off(void) {
    gpio_set_pin_input(ERGODOX_RIGHT_LED_2_PIN);
}
inline void ergodox_right_led_3_off(void) {
    gpio_set_pin_input(ERGODOX_RIGHT_LED_3_PIN);
}
