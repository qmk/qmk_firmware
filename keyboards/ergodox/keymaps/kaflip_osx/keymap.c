...
#define FLIP 2 // flip the keyboard for one-handed typing (Fp modifier)
 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  |  L1  |           |  Fp  |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | LCtrl  |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L3|   '    |
 * |--------+------+------+------+------+------| Hyper|           | Meh  |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/Fp|   \  |AltShf| Left | Right|                                       |  Up  | Down |   [  |   ]  |Grv/Fp|
 *   `----------------------------------'                                       `----------------------------------'
 *                                      ,---------------.       ,---------------.
...
[BASE] = KEYMAP(  // layer 0 : default
    ...
    LT(FLIP,KC_GRV), KC_BSLS,      LALT(KC_LSFT), KC_LEFT, KC_RGHT,
    ...
    MEH_T(KC_NO), KC_N,    KC_M,    KC_COMM, KC_DOT,  CTL_T(KC_SLSH),    KC_RSFT,
                           KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC,           LT(FLIP,KC_GRV),
...
/* Keymap 2: Flipped layer
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |   -    |   0  |   9  |   8  |   7  |   6  | App  |           | LGUI |   5  |   4  |   3  |   2  |   1  |   =    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |   ]  |   [  | Down |  Up  |                                       |Right | Left |Alt/Sh|   \  |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                      ,---------------.       ,---------------.
 *                                      |Ctrl/Esc| Alt  |       | Alt  |Ctrl/Esc|
 *                               ,------|--------|------|       |------+--------+------.
 *                               |      |        | PgUp |       | Home |        |      |
 *                               | Space| Enter  |------|       |------|  Del   |BkSpce|
 *                               |      |        | PgDn |       | End  |        |      |
 *                               `----------------------'       `----------------------'
 */
[BASE] = KEYMAP(  // layer 2 : FLIPped
        // left hand
        KC_MINS, KC_0,    KC_9,    KC_8,    KC_7, KC_6, KC_APP,
        ...
        KC_TRNS, KC_RBRC, KC_LBRC, KC_DOWN, KC_UP,
                                            CTL_T(KC_ESC), KC_LALT,
                                                           KC_PGUP,
                                   KC_SPC,  KC_ENT,        KC_PGDN,
        // right hand
        KC_LGUI,         KC_5,    KC_4,          KC_3,    KC_2,          KC_1,    KC_EQL,
        KC_TRNS,         KC_T,    KC_R,          KC_E,    KC_W,          KC_Q,    KC_TAB,
                         KC_G,    KC_F,          KC_D,    KC_S,          KC_A,    KC_LCTL,
        ALL_T(KC_NO),    KC_B,    KC_V,          KC_C,    KC_X,          KC_Z,    KC_LSFT,
                                  KC_RIGHT,      KC_LEFT, LALT(KC_LSFT), KC_QUOT, KC_TRNS,
        ALT_T(KC_APP),   CTL_T(KC_ESC),
                         KC_HOME,
        KC_END,          KC_DEL,         KC_BSPC
    ),
