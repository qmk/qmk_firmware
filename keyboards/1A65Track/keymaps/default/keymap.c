...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  	...
  	[_DVORAK] = LAYOUT_65(
	KC_F15, KC_ESC, KC_CPI_1, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,       	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LGUI(KC_BSLASH), LALT(KC_END), UCFEMAIL, \
	KC_F16, KC_TAB, KC_SCOLON, KC_COMMA, KC_DOT, KC_P, KC_Y, 		 		   			KC_F, KC_G, KC_C, KC_R, KC_L, KC_BSLASH, KC_LBRC, KC_RBRC, GMAIL, \
	...
	TO(_QWERTY), KC_LCTRL, KC_LGUI, KC_LALT, MO(_FN), MO(_NUMBER), KC_TRNS,				KC_SPACE, MO(_ARROW), KC_MPLY, KC_VOLD, KC_VOLU, KC_LEFT, KC_DOWN, KC_RIGHT
	),

	[_QWERTY] = LAYOUT_65(
	KC_TRNS, KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, 							KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPACE, RGB_TOG, \
	KC_TRNS, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, 		 		   				    KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLASH, KC_LBRC, KC_RBRC, RGB_MOD, \
	KC_TRNS, KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, 		 						KC_H, KC_J, KC_K, KC_L, KC_SCOLON, KC_QUOTE, KC_ENT, TO(_DVORAK), \
	KC_TRNS, KC_LSHIFT, KC_Z, KC_X, KC_C, KC_V, KC_B, 								KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, KC_RSFT, KC_UP, \
	TO(_DVORAK), KC_LCTRL, KC_LGUI, KC_LALT, KC_SPACE, KC_SPACE, KC_TRNS,			 	KC_SPACE, MO(_ARROW), KC_MPLY, KC_VOLD, KC_VOLU, KC_LEFT, KC_DOWN, KC_RIGHT
	),
    ...
    KC_TRNS, KC_LCTRL, KC_LGUI, KC_LALT, MO(_FN), MO(_NUMBER), KC_TRNS,			 		 	KC_SPACE, KC_LGUI, KC_MPLY, KC_VOLD, KC_VOLU, KC_LEFT, KC_DOWN, KC_RIGHT
	),
	...
	KC_TRNS, KC_TRNS, KC_SCOLON, CBRC, SBRC, LALT(KC_F4), LCTL(KC_L), 		 		 		 LCTL(KC_F), KC_PGUP, KC_UP, LCTL(KC_T), LCTL(KC_N), LCTL(LSFT(KC_N)), RGB_TOG, RGB_MOD, KC_TRNS,
	...
	KC_TRNS, LSFT(KC_SLASH), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 					KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LSFT(KC_EQL), KC_TRNS,
	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,			 				KC_SPACE, LSFT(KC_SCOLON), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
	),

	[_ARROW] = LAYOUT_65(
	KC_TRNS, KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, 							KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, LGUI(LSFT(KC_S)), TO(_NUMBER),
	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 		 		   		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 		 				LCTL(KC_BTN1), KC_BTN1, KC_BTN2, KC_SCROLLY, KC_SCROLLX, KC_TRNS, KC_TRNS, KC_TRNS,
