...
[RAISE] = KEYMAP( \
  ...
  _______, _______, _______, S(KC_LBRC), KC_LBRC, S(KC_9), _______, /**/ _______, S(KC_0), KC_RBRC, S(KC_RBRC), _______, S(KC_BSLASH), S(KC_EQL), \
  _______, S(KC_1), S(KC_2), S(KC_3),    S(KC_4), S(KC_5), _______, /**/ _______, S(KC_6), S(KC_7), S(KC_8),    S(KC_9), S(KC_0),      KC_BSLASH, \
  _______, _______, _______, _______,    MO(CONTROL), _______, _______, /**/ _______, _______, _______, _______,    _______, _______,      _______    \
),
