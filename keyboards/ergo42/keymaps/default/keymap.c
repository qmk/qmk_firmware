...
[RAISE] = KEYMAP( \
  KC_BSPC, KC_1,    KC_2,    KC_3,       KC_4,    KC_5,    _______, /**/ _______, KC_6,    KC_7,    KC_8,       KC_9,    KC_0,         KC_EQL,    \
  _______, KC_LEFT, KC_DOWN, S(KC_LBRC), S(KC_9), KC_LBRC, _______, /**/ _______, KC_RBRC, S(KC_0), S(KC_RBRC), KC_UP,   KC_RIGHT,     S(KC_EQL), \
