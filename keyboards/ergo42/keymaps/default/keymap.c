 ...
 * |      |   !  |   @  |   #  |   $  |   %  |   [  |   |   ]  |   ^  |   &  |   *  |   (  |   )  |      |
 * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
 * |  BS  |  F1  |  F2  |  F3  |  F4  |  F5  |   {  |   |   }  |Left  |Down  |  Up  |Right | F10  | F11  |
 * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
...
[RAISE] = KEYMAP( \
  ...
  KC_BSPC, KC_F1,    KC_F2,  KC_F3,   KC_F4,   KC_F5,   S(KC_LBRC), /**/ S(KC_RBRC), KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_F10,  KC_F11,  \
  _______, _______, _______, _______, KC_LGUI, _______, _______,    /**/ _______,    _______, _______, KC_MNXT, KC_VOLD,  KC_VOLU, KC_MPLY  \
),
