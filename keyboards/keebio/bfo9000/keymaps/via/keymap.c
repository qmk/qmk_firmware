// Copyright 2022 John-Schreiber
// SPDX-License-Identifier: GPL-2.0-or-later

#include QMK_KEYBOARD_H


enum bfo9000_layers {_BASE,_BASE1,_BASE2,_BASE3};
...
[_BASE] = LAYOUT(
    ...
    KC_PGDN, KC_UP,   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,          KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_TRNS,
