...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_OSX] = LAYOUT(
        ...
        TO(_OSX),     MO(_OSXMACROS), KC_LCTL, LCTL(KC_B),   KC_LCTL,      KC_LALT,      KC_LGUI,      KC_SPC,  MO(_OSXMACROS),              MO(_SYMBOLS), KC_MS_BTN1,   KC_MS_BTN3,   KC_MS_BTN2,   JIGGLER,      LCTL(LSFT(LGUI(KC_4))), KC_LEFT,  KC_DOWN, KC_RGHT
    ),
    [_OSXMACROS] = LAYOUT(
    ...
    [_SYMBOLS] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                 KC_EQL,  S(KC_LBRC), S(KC_RBRC), _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                 KC_MINS, KC_LBRC,    KC_RBRC,    _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                 KC_BSLS, KC_QUOT,    S(KC_QUOT), _______, _______, _______, _______, _______, _______,
    ...
    [_WINDOWS] = LAYOUT(
        ...
        _______, MO(_WINDOWSMACROS), KC_LCTL, KC_LCTL,      KC_LALT,      KC_LGUI,      KC_LCTL,      KC_SPC,  MO(_WINDOWSMACROS),    MO(_SYMBOLS), KC_MPRV, KC_MPLY, KC_MNXT, KC_WSCH, KC_PSCR, _______, _______, _______
    ),
    [_WINDOWSMACROS] = LAYOUT(
        _______, _______, _______, _______,  _______,  _______,  _______,  _______,        _______,              _______, _______, _______, _______, _______,  _______, _______, _______, _______,
        _______, _______, _______, _______,  _______,  _______,  _______,  _______,        _______,              _______, _______, _______, _______, _______,  _______, _______, _______, _______,
        DM_REC1, DM_REC2, _______, _______,  _______,  A(KC_P6), A(KC_P7), A(KC_P3),       _______,              _______, _______, _______, _______, _______,  _______, _______, _______, _______,
    ...
    [_GAMING] = LAYOUT(
        ...
        _______, MO(_WINDOWSMACROS), KC_LCTL, KC_LCTL, KC_LCTL, KC_LALT, KC_SPC,  KC_SPC,   KC_SPC,              MO(_SYMBOLS), KC_MPRV, KC_MPLY, KC_MNXT, KC_WSCH, KC_PSCR, _______, _______, _______
    )
};
