...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_OSX] = LAYOUT(
        ...
        TO(_OSX),     MO(_OSXMACROS), KC_LCTL, _______,      KC_LCTL, KC_LALT,      KC_LGUI,      LGUI_T(KC_SPC), MO(_OSXMACROS),       KC_MRWD, KC_MPLY, KC_MFFD, _______, MOUSEJIGGLERMACRO, LCTL(LSFT(LGUI(KC_4))), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_OSXMACROS] = LAYOUT(
        ...
        DM_REC1,    DM_REC2, _______, _______,  _______,  A(KC_P6), A(KC_P7), A(KC_P3),       _______,           _______, _______,  _______,  KC_UP,   _______,  _______, _______, _______, _______,
        DM_RSTP,    DM_RSTP, _______, A(KC_P9), A(KC_P1), _______,  A(KC_P5), A(KC_KP_ENTER), KC_DEL,            _______, _______,  KC_LEFT,  KC_DOWN, KC_RIGHT, _______, _______, _______, _______,
    ...
    [_WINDOWS] = LAYOUT(
        ...
        KC_3,    KC_4,               _______, _______, _______, _______, _______, _______, _______,              _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______,            _______, _______, _______, _______, _______, _______, LGUI(KC_P),           _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, MO(_WINDOWSMACROS), KC_LCTL, KC_LCTL, KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  MO(_WINDOWSMACROS),   KC_MRWD, KC_MPLY, KC_MFFD, KC_MSEL, KC_WSCH, KC_PSCR, _______, _______, _______),
    ...
    [_GAMING] = LAYOUT(
        ...
        KC_5,    KC_6,    _______, _______, _______, _______, _______, _______,  A(KC_P0),         KC_PGUP, _______, _______, _______, _______, _______, _______, _______, _______,
        ...
        _______, _______, KC_LCTL, KC_LCTL, KC_LCTL, KC_LALT, KC_SPC,  KC_SPC,   KC_SPC,           KC_MRWD, KC_MPLY, KC_MFFD, KC_MSEL, KC_WSCH, KC_PSCR, _______, _______, _______)
};
