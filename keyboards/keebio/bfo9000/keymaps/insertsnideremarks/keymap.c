...
/* Colemak gaming/vanilla
  ...
  |-------+-------+-------+-------+-------+-------+-------+-------+-------|     |-------+-------+-------+-------+-------+-------+-------+-------+-------|
  |  Ctl  |   A   |   R   |   S   |   T   |   D   |   H   |   N   |  PgUp |     | ScrLck|       |       |   H   |   N   |   E   |   I   |   O   |   '   |
  |-------+-------+-------+-------+-------+-------+-------+-------+-------|     |-------+-------+-------+-------+-------+-------+-------+-------+-------|
  | Shift |   Z   |   X   |   C   |   V   |   B   |Esc/Ctl|App/Alt|  PgDn |     | PrtScr|  RAlt |  RCtl |   K   |   M   |   ,   |   .   |   /   | Shift |
  |-------+-------+-------+-------+-------+-------+-------+-------+-------|     |-------+-------+-------+-------+-------+-------+-------+-------+-------|
...
[_COLEMAKGM] = LAYOUT( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    CTLESC,  KC_LALT, KC_PGDN,     KC_PSCR, KC_RALT, KC_RCTL, KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,   
  KC_INS,  KC_GRV,  KC_LBRC, KC_RBRC, KC_LALT, KC_SPC,  KC_ENT,  BSPCFN,  KC_END,      _______, ENTNS,   KC_DEL,  KC_BSPC, KC_RGUI, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT 
),
...
/* QWERTY gaming/vanilla
  ...
  |-------+-------+-------+-------+-------+-------+-------+-------+-------|     |-------+-------+-------+-------+-------+-------+-------+-------+-------|
  |  Ctl  |   A   |   S   |   D   |   F   |   G   |   H   |   J   |  PgUp |     | ScrLck|       |       |   H   |   J   |   K   |   L   |   ;   |   '   |
  |-------+-------+-------+-------+-------+-------+-------+-------+-------|     |-------+-------+-------+-------+-------+-------+-------+-------+-------|
  | Shift |   Z   |   X   |   C   |   V   |   B   |Esc/Ctl|App/Alt|  PgDn |     | PrtScr|  RAlt |  RCtl |   N   |   M   |   ,   |   .   |   /   | Shift |
  |-------+-------+-------+-------+-------+-------+-------+-------+-------|     |-------+-------+-------+-------+-------+-------+-------+-------+-------|
  |  Ins  |   `   |   [   |   ]   |  LAlt | Space | Enter |  Bspc |  End  |     |       | Enter |Del/NS2|Bsp/Fn2|  RGUI |  Left |  Down |   Up  | Right |
  `-----------------------------------------------------------------------'     `-----------------------------------------------------------------------'
*/
[_QWERTYGM] = LAYOUT( \
  KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,       ADJUST,  _______, KC_F12,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    CTLESC,  ALTAPP,  KC_PGDN,     KC_PSCR, KC_RALT, KC_RCTL, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,   
  KC_INS,  KC_GRV,  KC_LBRC, KC_RBRC, KC_LALT, KC_SPC,  KC_ENT,  BSPCFN,  KC_END,      _______, ENTNS,   KC_DEL,  KC_BSPC, KC_RGUI, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT 
),
