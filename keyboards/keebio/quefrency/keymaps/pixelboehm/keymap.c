...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN1] = LAYOUT(
    ...
    _______, XP(UMLAUT_a, UMLAUT_A), _______, LALT(LSFT(KC_2)),   _______, _______, _______, LALT(KC_U), _______, LALT(KC_O), _______, _______, _______, _______, \
  ...
  [_FN2] = LAYOUT(
    RESET, DEBUG, _______, _______, _______, _______, _______, _______, _______,   _______, _______, QK_UNICODE_MODE_LINUX, QK_UNICODE_MODE_WINDOWS, QK_UNICODE_MODE_MACOS, _______, \
