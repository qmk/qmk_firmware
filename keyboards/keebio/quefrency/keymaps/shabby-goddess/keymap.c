...
// set macros for navigating gnome DE
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    MACRO_DESKDOWN,  KC_DEL,       KC_LCTL, KC_LGUI, KC_LALT, KC_SPC  ,MO(_FN1),         XXXXXXX,  KC_SPC, MACRO_LAUNCHER, KC_RCTL, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_FN1] = LAYOUT_65_with_macro(
    ...
    MACRO_MOVEUP,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MACRO_FILES, _______, _______, \
    MACRO_MOVEDOWN, _______, _______, _______, _______, RGB_TOG, _______,          _______, _______, _______, _______, _______, _______,     _______, _______
  )
};

//set encoder to volume control
