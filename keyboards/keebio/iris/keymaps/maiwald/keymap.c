...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EXTEND] = LAYOUT(
      ...
      _______, XXXXXXX, KC_1,    KC_2,    KC_3,    XXXXXXX,  _______, RESET,   KC_END,  KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  ...
  [_SYMBOLS] = LAYOUT(
      ...
      XXXXXXX, XXXXXXX, KC_COLN, KC_QUOT, KC_PLUS, KC_EUR,  _______, _______, KC_GRV,  KC_AMPR, KC_ASTR, KC_TILD, KC_QUES, XXXXXXX,
