...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYMB] = LAYOUT(
        _______, XP(IEX, SS1), UM(SS2), UM(SS3), XP(CUR, GBP), UM(EUR), UM(V14), UM(V12), UM(V34), XP(LSQ, LDQ), XP(RSQ, RDQ), _______,
        ...
        _______, XP(AEL, AEC), _______, XP(CPR, CNT), _______, _______, _______, _______, XP(N_T, NCT), UM(MCR), XP(C_C, CCC), _______, _______, _______,
