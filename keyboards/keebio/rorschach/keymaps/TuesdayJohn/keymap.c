...
,-----------------------------------------------------.                     ,-----------------------------------------------------.
|        |  KP 6  |  KP 7  |  KP 8  |  KP 9  |  KP 0  |                     | NumLock|  KP 7  |  KP 8  |  KP 9  |  KP /  |        |
|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
|        |  KP 1  |  KP 2  |  KP 3  |  KP 4  |  KP 5  |                     |   Tab  |  KP 4  |  KP 5  |  KP 6  |  KP *  |        |
|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
|        | NumLock|  KP .  | KP/KP* |  KP- _ |  KP+ = |                     |        |  KP 1  |  KP 2  |  KP 3  |  KP -  |        |
|--------+--------+--------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
|    (   |    )   |   [ {  |   ] }  |        |        |                     |        |  KP 0  |   =    |  KP .  |  KP +  |        |
`--------------------------------------------+--------+--------.   ,--------+--------+--------------------------------------------'
                                             |        |        |   | KP Ent |        |
...
[_NUMPAD] = LAYOUT(
  ...
  _______, KC_NLCK, KC_PDOT, TD_PSPA, TD_MNUN, TD_PPEQ,                       _______, KC_P1,   KC_P2,   KC_P3,   KC_PMNS, _______,
...
/* 
Adjust layer
(Press and hold Enter/Number + Delete/Number2 to access; Numpad and NKRO are on toggle)
,-----------------------------------------------------.                     ,-----------------------------------------------------.
