...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_PGUP,          KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,        KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(2),
    KC_PGDN,          MO(1), KC_LGUI, KC_LALT, KC_LEFT,   KC_SPC,  KC_RGHT,      KC_SPC,  KC_SPC,  KC_RALT, KC_RGUI, KC_MENU, KC_RCTL
  ),
  [1] = LAYOUT(
    ...
    _______,          _______, RGB_SAD, RGB_SAI, _______, _______, _______,     KC_7,    KC_8,    KC_9,    _______, _______, _______, _______, _______,
    BL_TOGG,          _______, RGB_VAD, RGB_VAI, _______, _______, _______,     KC_4,    KC_5,    KC_6,    _______,  _______, _______,          _______,
    BL_STEP,          _______, _______, _______, _______, _______, _______,     KC_1,    KC_2,    KC_3,    _______, _______, _______, _______,
    RGB_MOD,          _______, _______, _______, _______, _______, _______,     _______, KC_0,    _______, _______, _______, _______
  ),
  [2] = LAYOUT(
    _______, _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,       KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,  KC_DEL,
    KC_PSCR,          KC_CAPS, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, KC_UP,   _______, _______,
