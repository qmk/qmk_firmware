...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN2] = LAYOUT_ortho_4x12(
    _______, SPEAK1 , SPEAK2 , SPEAK3 , SPEAK4 , _______,    _______, _______, _______, _______, _______, TERM   ,
    _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, MAX    ,
  ...
  [_NUM] = LAYOUT_ortho_4x12(
    _______, KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,     KC_6   , KC_7   , KC_8   , KC_9   , KC_PERCENT,    KC_EQL, 
    KC_CAPS, _______,KC_DOLLAR,_______, _______, _______,     KC_MINS, KC_4   , KC_5   , KC_6   , KC_COLN, _______,
