...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    _______, KC_LGUI, KC_LALT,     FN1,   SPFN1,            BSFN2,                      KC_RCTL, KC_RGUI, FN2,     XXXXXXX
  ),

  [_FN1] = LAYOUT(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,       KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,
    _______,   RGB_HUI, RGB_SAI, RGB_VAI, KC_VOLU, KC_LBRC, KC_RBRC,    KC_4,    KC_5,    KC_6,    KC_SCLN,          _______,
  ...
  [_FN2] = LAYOUT(
    ...
    _______, _______, _______, KC_DEL,  KC_PGDN, KC_END,  _______,          _______, _______, _______, _______, _______,
      RESET, _______, _______, _______, KC_DEL,           _______,                   _______, _______, _______, _______
  )
