...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ALPHA] = LAYOUT_nyquist_wrapper( 
                        ...
                        KC_LCTL, KC_BSPC, KC_ENT, KC_LALT,  ____THUMB_L____, ____THUMB_R____, _______, KC_LEFT, KC_DOWN, _______),
    /* Lower
     * ,-----------------------------------------------------------------------------------.
     * |   `  |      |      |      |      |      |      |      |      |      |      |      |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
    ...
    [_RAISE] = LAYOUT_nyquist_wrapper(
                    ...
                    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, DF(_GAME)),
    ...
    [_GAME] = LAYOUT_nyquist_wrapper(
                    ...
                    KC_ESC, _________________QWERTY_L1_________________, _________________QWERTY_R1_________________, _______, 
                    KC_TAB, _________________QWERTY_L2_________________, _________________QWERTY_R2_________________, KC_BSLS, 
