...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  QK_BOOT,          KC_OLED_EDIT, _______, _______,
        _______, MS_BTN1, MS_UP,   MS_BTN2, MS_BTN3, _______, _______, _______, _______, RM_TOGG, RM_NEXT, RM_VALU, RM_VALD, _______,          _______,      _______, _______,
