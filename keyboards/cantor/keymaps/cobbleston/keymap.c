...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[BASE] = LAYOUT_split_3x6_3(
		...
		KC_PSCR,	KC_A,	KC_S,	KC_D,	KC_F,	KC_G,	/**/	KC_H,	KC_J,	KC_K,		KC_L,	KC_SCLN,	KC_QUOT,
	...
	[NAVIG] = LAYOUT_split_3x6_3( // ARROW + ÀÈÌÒÙ
		KC_NO, 	ULIT,	ALIT,	ELIT,	ILIT,	OLIT,	/**/	KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,
	  	KC_NO, 	KC_LGUI,KC_LALT,KC_LCTL,KC_LSFT,KC_ENT,	/**/	KC_LEFT, 	KC_DOWN,	KC_UP,		KC_RGHT,	KC_CAPS,	KC_NO,
	    KC_NO, 	UBIG,	ABIG,	EBIG,	IBIG,	OBIG,	/**/	KC_HOME, 	KC_PGDN,	KC_PGUP,	KC_END,		KC_INS,		KC_NO,
						KC_LCTL,	 KC_LGUI,	KC_TAB,	/**/	KC_NO,		KC_NO,		KC_NO
	),
	[SYMBOL] = LAYOUT_split_3x6_3(
		KC_NO,		KC_QUOT,	KC_LT,		KC_GT,		KC_DQUO,	KC_GRAVE,	/**/	KC_AMPR,	KC_UNDS,	KC_LBRC,	KC_RBRC,	KC_PERC,	KC_NO,
		KC_NO,		KC_EXLM,	KC_MINS,	KC_PLUS,	KC_EQL,		KC_HASH,	/**/	KC_PIPE,	KC_COLN,	KC_LPRN,	KC_RPRN,	KC_QUES,	KC_NO,
		KC_LALT,	KC_CIRC,	KC_SLSH,	KC_ASTR,	KC_BSLS,	UPDIR,		/**/	KC_TILD,	KC_DLR,		KC_LCBR,	KC_RCBR,	KC_AT,		KC_RALT,
											KC_LCTL,	KC_LGUI,	KC_TAB,		/**/	KC_NO,		KC_NO,		KC_NO
	)
};