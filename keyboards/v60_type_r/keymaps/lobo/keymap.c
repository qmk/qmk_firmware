...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------|
   * |Ctrl|Gui |Alt |      Space              |Fn0 |AltGR |App|Ctrl|
   * `-----------------------------------------------------------'
   */
  [0] = LAYOUT_60_ansi(
         ...
         * |-----------------------------------------------------------|
         * |     |   |Up |RGB_TOG |HUI|SAI|VAI| |Prt|Scl|Pau|Up| | Ins |
         * |-----------------------------------------------------------|
  ...
  [1] = LAYOUT_60_ansi(
	       ...
	       KC_TRNS,   BL_DEC,  BL_STEP,  BL_INC, KC_TRNS,  KC_VOLD,   KC_VOLU, KC_MUTE, KC_END,  KC_PGDN,  KC_DOWN,           KC_TRNS,  \
...
*/
         ...
         [2] = LAYOUT_60_ansi(
                ...
                KC_TRNS,   KC_BTN1,  KC_MS_U,    KC_BTN2,  KC_TRNS,  KC_TRNS,  KC_TRNS,   UC(0x20AC), UC(0x00AA), UC(0x00BA), KC_TRNS, KC_MPLY,    KC_TRNS,          KC_TRNS, \
                KC_TRNS,   KC_MS_L,  KC_MS_D,  KC_MS_R, KC_TRNS,  KC_TRNS,  KC_LEFT,   KC_DOWN, KC_UP, KC_RIGHT, KC_MPRV, KC_MNXT,          KC_TRNS,          \
