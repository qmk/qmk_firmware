...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_bs(
        ...
        KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_PER,  KC_SLSH, KC_RSFT,                         KC_UP,    MO(_FN),
        KC_LCTL,           KC_LALT,                            KC_SPC,                                      KC_RALT,              KC_LEFT,   KC_DOWN,  KC_RIGHT
    ),

    [1] = LAYOUT_split_bs(
        KC_TILD,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,    KC_F12,    KCF13,     KC_INS,   KC_End,
