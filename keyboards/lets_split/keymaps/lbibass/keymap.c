...
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTRL,KC_LGUI, KC_LALT, ADJUST,  LOWER,   KC_BSPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_GAME] = KEYMAP( \
  ...
  ADJUST,  KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_BSPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
