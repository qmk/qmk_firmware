...
[_QWERTY] = KEYMAP( \
  ...
  KC_ESC ,KC_CAPS, KC_LALT, KC_LCTL,  LOWER,   KC_BSPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_WINDOWS] = KEYMAP( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT , \
  KC_ESC ,KC_CAPS, KC_LGUI, KC_LALT,  LOWER,   KC_BSPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_GAME] = KEYMAP( \
  ...
  KC_ESC,  KC_CAPS, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_BSPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_LOWER] = KEYMAP( \
  ...
  KC_ESC, KC_CAPS, KC_LALT, KC_LCTL, LOWER, KC_BSPC, KC_SPC, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
),
