 ...
 */
    [_RAISE] = LAYOUT(
        ...
        KC_ESC, RGB_TOG, KC_LALT, KC_LCTL, LOWER, KC_SPC, KC_SPC, _______, (CT_media), KC_VOLD, KC_VOLU, KC_MFFD),
 ...
 */
    [_LOWER] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, CT_media, KC_VOLD, KC_VOLU, KC_MFFD),
