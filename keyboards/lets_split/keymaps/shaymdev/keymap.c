...
[_DVORAK] = LAYOUT( \
  ...
  ADJUST, KC_ENT,  KC_LALT, LOWER,  KC_LSFT, KC_LCTL,			KC_BSPC, KC_SPC, RAISE, KC_DEL, KC_LGUI, XXXXXXX  \
),
...
[_QWERTY] = LAYOUT( \
  ...
  _______, KC_ENT,  KC_LALT, LOWER,  KC_LSFT, KC_LCTL,			KC_BSPC, KC_SPC,  RAISE,   KC_DEL,  KC_LGUI, XXXXXXX  \
),
...
[_ADJUST] =  LAYOUT( \
  ...
  RGB_TOG, RGB_MOD, _______, AU_ON,   AU_OFF,  AG_NORM, 		AG_SWAP,  QWERTY,  DVORAK, _______, _______, _______, \
