...
//+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
   ADJUST,  KC_LCTL, KC_LALT, KC_LGUI, RAISE,   LOWER,   KC_SPC,  KC_ENT,  KC_DEL,  KC_DOWN, KC_UP,   KC_RGHT  \
),
...
//+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_BSLS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_TILD, \
//+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
