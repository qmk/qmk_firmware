...
[_QWERTY] = KEYMAP( \
  ...
  KC_ESC, KC_TAB, KC_LGUI,  KC_LSFT,  KC_NO,   KC_BSPC, KC_LALT, KC_SPC,  MO(_RAISE),  KC_MINS, KC_QUOT, KC_ENT   \
),
...
[_LOWER] = KEYMAP( \
  ...
  KC_TRNS, KC_VOLD, KC_LGUI, KC_LSFT, KC_NO,   KC_BSPC, KC_LALT, KC_SPC,  DF(_QWERTY), KC_PSCR, KC_SLCK, KC_PAUS \
),
...
[_RAISE] = KEYMAP( \
  ...
  TG(_LOWER), KC_INS,  KC_LGUI, KC_LSFT, KC_NO,   KC_BSPC, KC_LALT, KC_SPC,  KC_TRNS, KC_DOT, KC_0, KC_EQL   \
),
