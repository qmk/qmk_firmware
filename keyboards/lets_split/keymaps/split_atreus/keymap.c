...
[_L0] = KEYMAP( \
  ...
  KC_ESC, KC_TAB, KC_LGUI,  KC_LSFT,  KC_DLR,  KC_BSPC, KC_SPC,  KC_EQL,  MO(_L2),  KC_MINS, KC_QUOT, KC_ENT   \
),
...
[_L2] = KEYMAP( \
  ...
  KC_LBRC,  KC_RBRC, KC_LPRN, KC_RPRN, KC_AMPR, KC_LCTL, KC_LALT, KC_GRV,  KC_1,    KC_2,   KC_3, KC_BSLS, \
  TG(_L1),  KC_INS,  KC_LGUI, KC_LSFT, KC_NO,   KC_BSPC, KC_SPC,  KC_NO,  KC_TRNS, KC_DOT, KC_0, KC_EQL   \
),
...
[_L1] = KEYMAP( \
  ...
  KC_TRNS, KC_VOLU, KC_TRNS, KC_TRNS, RESET,   KC_LCTL, KC_LALT, KC_TRNS, KC_F1,    KC_F2,   KC_F3,   KC_F12, \
  KC_TRNS, KC_VOLD, KC_LGUI, KC_LSFT, KC_NO,   KC_BSPC, KC_SPC,  KC_NO,  DF(_L0),  KC_PSCR, KC_SLCK, KC_PAUS \
)
