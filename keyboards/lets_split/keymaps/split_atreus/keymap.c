...
[_L0] = KEYMAP( \
  ...
  KC_ESC, KC_TAB, KC_LGUI,  KC_LSFT,  KC_BSPC, KC_LCTL, KC_LALT, KC_SPC,  MO(_L2),  KC_MINS, KC_QUOT, KC_ENT   \
),
...
[_L2] = KEYMAP( \
  ...
  TG(_L1),  KC_INS,  KC_LGUI, KC_LSFT, KC_BSPC, KC_LCTL, KC_LALT, KC_SPC,  KC_TRNS, KC_DOT, KC_0, KC_EQL   \
),
...
[_L1] = KEYMAP( \
  ...
  KC_TRNS, KC_VOLD, KC_LGUI, KC_LSFT, KC_BSPC, KC_LCTL, KC_LALT, KC_SPC,  DF(_L0),  KC_PSCR, KC_SLCK, KC_PAUS \
)
