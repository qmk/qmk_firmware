...
[_RAISE_MAC] = LAYOUT_ortho_4x12(
    _______, SE_EXCL, SE_QSTM, AP_LCBR, AP_RCBR, SE_AMP,      SE_TAK,  AP_PIPE, SE_BTCK, SE_TCK,  _______, KC_BSPC,
...
[_RAISE_WIN] = LAYOUT_ortho_4x12(
    _______, SE_EXCL, SE_QSTM, MS_LCBR, MS_RCBR, SE_AMP,      SE_TAK,  MS_PIPE, SE_BTCK, SE_TCK,  _______, KC_BSPC,
...
[_LOWER] = LAYOUT_ortho_4x12(
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______,     _______, KC_1,    KC_2,    KC_3,    SE_AST,  KC_BSPC,
    _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______,     _______, KC_4,    KC_5,    KC_6,    SE_PLUS, _______,
    _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,     _______, KC_7,    KC_8,    KC_9,    SE_EQLS, _______,
...
SPECIAL
    This layer focuses on special functions, media controls and movement keys.
                             LEFT                                                     RIGHT
   ,-----------------------------------------------------.   ,-----------------------------------------------------.
   | Reset  |        |  WIN   | VolUp  |        |        |   |  Ins   |  Home  |   Up   |  End   |  PgUp  | Backspc|
   |--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
...
[_SPECIAL] = LAYOUT_ortho_4x12(
    RESET,   _______, TO_WIN,  MY_VOLU, _______, _______,     KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_PGUP, KC_BSPC,
