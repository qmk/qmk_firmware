...
DEFAULT - Mac
   ...
   `-----------------------------------------------------´   `-----------------------------------------------------'
*/
[_DEFAULT_MAC] = LAYOUT_ortho_4x12(
    _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,     _______, RAISE_M, _______, _______, _______, _______
),
...
[_SPECIAL] = LAYOUT_ortho_4x12(
    RESET,   TO_WIN,  _______, MY_VOLU, _______, _______,     KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_PGUP, KC_BSPC,
