...
[_LAYER4] =  LAYOUT_ortho_4x12( \
  ...
  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_LALT,  KC_LGUI,      KC_LGUI,      KC_TRANSPARENT,  KC_NO,           RAISE,  KC_UNDS,  KC_DOT,  KC_TILD,    KC_TRANSPARENT
),
...
[_LAYER5] =  LAYOUT_ortho_4x12( \
  ...
  KC_TRANSPARENT,  KC_TRANSPARENT,      KC_TRANSPARENT,   KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_NO,           KC_F12,          KC_TRANSPARENT,  KC_TRANSPARENT,  MO(6),           KC_TRANSPARENT
),
