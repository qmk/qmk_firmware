...
[_LAYER4] =  LAYOUT_ortho_4x12( \
  ...
  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_LALT,  KC_LGUI,      KC_LGUI,      KC_TRANSPARENT,  KC_NO,           RAISE2,  KC_UNDS,  KC_DOT,  KC_TILD,    KC_TRANSPARENT
),
...
[_LAYER6] =  LAYOUT_ortho_4x12( \
  ...
  KC_TRANSPARENT,  KC_TRANSPARENT,      KC_TRANSPARENT,   KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_NO,           KC_F12,          KC_TRANSPARENT,  KC_TRANSPARENT,  MO(7),           KC_TRANSPARENT
),
...
[_LAYER7] =  LAYOUT_ortho_4x12( \
  ...
  KC_TRANSPARENT,  KC_MS_LEFT,          KC_MS_LEFT,      KC_MS_DOWN,       KC_MS_RIGHT,     KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT, \
  KC_TRANSPARENT,  KC_TRANSPARENT,      KC_TRANSPARENT,  KC_TRANSPARENT,   KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT, \
  KC_TRANSPARENT,  KC_TRANSPARENT,      KC_TRANSPARENT,  KC_TRANSPARENT,   KC_MS_BTN2,      KC_MS_BTN1,      KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT
)
};
