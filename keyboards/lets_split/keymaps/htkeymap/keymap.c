...
[QWERTY_LAYER] = KEYMAP( \
  ...
  KC_LCTL,  MO(UNDERGLOW_LAYER),   KC_LALT,  KC_LGUI,  MO(LOWER_LAYER),    F(1),    F(2),     KC_LGUI,  KC_LALT, MO(UPPER_LAYER), KC_MINS,  KC_EQL \
),
...
[LOWER_LAYER] = KEYMAP( \
  ...
  KC_LSFT,         KC_F7,     KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,  KC_QUOTE, \
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [2] = ACTION_LAYER_TAP_KEY(LOWER_LAYER, KC_SPC),
    //
