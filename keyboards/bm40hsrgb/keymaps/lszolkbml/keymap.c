...
//layers
  [NAVR] = LAYOUT_planck_mit(
    ...
    TG(CODE),   RGB_VAD, RGB_SAD, RGB_HUD, RGB_RMOD, RGB_SPD, KC_NO,  KC_MS_L, KC_MS_D, KC_MS_R, KC_NO,   KC_NO,
    TG(COLORS), KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,   KC_INS, KC_HOME, KC_PGUP, KC_PGDN, KC_END,  KC_ENT,
