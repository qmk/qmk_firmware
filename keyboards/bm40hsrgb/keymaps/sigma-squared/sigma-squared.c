...
//layers
  [NAVR] = LAYOUT_sigma2(
    ...
    KC_LSFT,              G(S(C(KC_F1))),    KC_NA,             KC_NA,              G(S(C(KC_F2))),   KC_NA,             KC_CLCK,           KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,           KC_LSFT,
  ...
  [FUNL] = LAYOUT_sigma2(
    ...
    KC_LSFT,              KC_F11,            KC_F4,             KC_F5,              KC_F6,            KC_SLCK,           KC_NA,             KC_NA,             KC_NA,             KC_NA,             KC_NA,             KC_LSFT,
    KC_LCTL,              KC_F10,            KC_F1,             KC_F2,              KC_F3,            KC_PAUS,           KC_NA,             KC_NA,             KC_NA,             KC_NA,             KC_NA,             KC_LCTL,
  ...
  [NSL] = LAYOUT_sigma2(
    ...
    KC_NA,                KC_NA,             KC_NA,             KC_UNDS,            KC_0,                      KC_MINS,                     KC_NA,             KC_NA,             KC_NA,             KC_NA,             KC_NA
  ),
  [NSSL] = LAYOUT_sigma2(
