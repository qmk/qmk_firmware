...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ortho_4x6_3(
        ...
        KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                KC_N,    KC_M,    KC_COMM, KC_DOT,   ES_MINS, ES_HASH,
                                            KC_LALT, KC_BSPC, MO(1),              KC_ENT, KC_SPC,  KC_RCTL
    ),
    ...
    [1] = LAYOUT_ortho_4x6_3(
        ...
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                             XXXXXXX, ES_UNDS, ES_LABK, XXXXXXX,  XXXXXXX, KC_DEL,
    ...
    [2] = LAYOUT_ortho_4x6_3(
        RM_TOGG, RM_NEXT, RM_PREV, XXXXXXX, XXXXXXX, XXXXXXX,                             XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,
        XXXXXXX, RM_SPDU, RM_SPDD, XXXXXXX, XXXXXXX, XXXXXXX,                             XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,
