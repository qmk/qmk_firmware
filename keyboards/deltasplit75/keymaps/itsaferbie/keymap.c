...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {	
	...
	KEYMAP(
		...
		KC_GRV,  KC_1,    KC_2,    KC_3,   KC_4,  KC_5,   KC_6,             KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,  KC_TRNS, KC_HOME, //The KC_TRNS is the unneeded key in the split backspace.
