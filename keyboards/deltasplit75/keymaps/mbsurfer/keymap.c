...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
	LAYOUT_v2(
		...
		M(1), KC_LEFT, KC_DOWN, KC_RGHT, KC_PAUS, _______, _______, _______, _______, _______, KC_LEFT, KC_RIGHT, _______, _______, _______,
		_______, KC_VOLD, _______, M(0), KC_PSCR, _______, _______, _______, _______, _______, _______, _______, KC_DOWN, _______, _______, _______,
