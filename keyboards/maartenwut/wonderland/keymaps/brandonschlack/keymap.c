...
[_FN1] = LAYOUT( \
    ...
    KC_VOLU, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_UP,   MC_MSSN, KC_DELT, \
    KC_VOLD, RGB_TOG, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, _______, _______, _______, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT,          KC_MPLY, \
             _______, RGB_LYR, RGB_THM, _______, _______, _______, _______, _______, _______, KC_END,  KC_PGDN, KC_DOWN, _______, _______, \
