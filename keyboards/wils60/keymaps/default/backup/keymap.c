...
*/
    ...
    TT(_CL), KC_MPLY, KC_VOLU, KC_MUTE, _______, _______, KC_CALC, KC_HOME, KC_UP  , KC_END , KC_PGUP, _______, _______, KC_PSCR,         
 ...
 ____________________________________________________________________________________________________________________________________ 
|        |  RGB   |  RGB   |  RGB   |   RGB  |        |        |        |        |        |        |        |        |               |
| RESET  | TOGGLE | MODE   |DECREASE|INCREASE|        |        |        |        |        |        |        |        |   BACKSPACE   |
|________|________|________|________|________|________|________|________|________|________|________|________|________|_______________|
|            |   	  |        |     	|      	 |	      |  	   |   	    |        |	   	  |        |        |        |           |
|            |        |        |        |		 |   	  |	  /    |   7    |   8    |    9   |   -    |  DEL   |        |           |
|____________|________|________|________|________|________|________|________|________|________|________|________|________|___________|
...
*/
    ...
    RESET,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BSPC,
    ...
    _______, _______, _______, _______, _______, _______, KC_NO,   KC_1,    KC_2,    KC_3,    KC_NO, 				_______,         
    _______, _______, _______,                            KC_0,                               KC_DOT,  _______, _______, MO(_HL) 
	),	
...
|            |   	  |        |     	|      	 |	      |  	   |   	    |        |	   	  |        |        |        |             |
|            |        |        |        |		 |   	  |	       |        |        |        |        |        |        |             |
|____________|________|________|________|________|________|________|________|________|________|________|________|________|_____________|
|              |        |        |        |        |        |        |        |        |        |        |        |                    |
|              |        |        |        |        |        |        |        |        |        |        |        |                    |
|______________|________|________|________|________|________|________|________|________|________|________|________|____________________|
|         |        |        |        |        |        |        |        |        |        |        |        |                |        |
|         |        |        |        |        |        |        |        |        |        |        |        |                |        |
|_________|________|________|________|________|________|________|________|________|________|________|________|________________|________|
|          |          |          |                                                        |          |          |          |           |
|          |          |          |                                                        |          |          |          |           |
|__________|__________|__________|________________________________________________________|__________|__________|__________|___________|
*/
	[_HL] = LAYOUT(
    ...
    _______, RGB_TOG, RGB_MOD, RGB_VAD, RGB_VAI, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, _______, _______, 				_______,         
    _______, _______, _______,                            _______,                             _______,  _______, _______, _______
	),	
  ...
  if (prev!=_HL) {
	  switch (layer) {
		...
		case _HL:
		  ...
		  rgblight_sethsv_noeeprom   (330, 128, 255);
		  break;		  
	  }
  } else {
