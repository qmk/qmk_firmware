...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |---------------------------------------------------------------------------------------|
     * |LT(3|Z)|   X   |   C   |   V   |     SPACE     |   B   |   N   |   M   |  RSFT |LT(2|.)|
     * |---------------------------------------------------------------------------------------|
     */
    [0] = LAYOUT(
    ...
    [2] = LAYOUT(
        ...
        KC_LSFT, KC_LCTL, KC_L,    KC_T,          KC_TAB,        KC_N,    KC_TRNS, KC_TRNS, KC_RCTL, KC_TRNS
    ),
    /* Level 3: RGB Layer
     * ,---------------------------------------------------------------------------------------.
    ...
    [3] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_F7,       KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12
    )
};
