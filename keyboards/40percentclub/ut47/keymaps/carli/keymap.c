...
[_QWERTY] = LAYOUT(
  ...
  KC_LCTL, KC_LALT, MO(_SERVICE),  KC_LGUI, KC_LGUI, LT(_ACCENT, KC_SPC), LT(_NUMBER, KC_SPC),  IT_SCLN, KC_LEFT, KC_DOWN,   KC_RGHT
),
...
[_SHIFT] = LAYOUT(
    ...
    IT_UNDS, IT_EQL, S(IT_LBRC), S(IT_RBRC), MO(_ACCENT), S(KC_SPC), MO(_NUMBER),  IT_COLN, S(KC_LEFT), S(KC_DOWN), S(KC_RGHT)  \
),
...
[_NUMBER] = LAYOUT(
   ...
   IT_MINS, IT_PLUS, IT_LBRC, IT_RBRC, KC_CAPS,     _______,      _______, _______, KC_MUTE, KC_VOLD, KC_MUTE
 ),
 ...
 [_SYMBOL] = LAYOUT(
     ...
     S(IT_MINS), S(IT_EQL), S(IT_LBRC), S(IT_RBRC), LT(_ACCENT, KC_DEL), LT(_NUMBER, KC_SPC), _______,_______,S(KC_LEFT), S(KC_DOWN), S(KC_RGHT)
 ),
