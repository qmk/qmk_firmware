...
LAYOUT(
   ...
   * |      | F11 | F12 |     |     |     |     |  -  |  =  |  [  |  ]  |  \   |
   * |-------------------------------------------------------------------------+
   * |       | F 1 | F 2 | F 3 | F 4 | F 5 | F 6 | F 7 | F8  | F 9 | F10 |Caps |
   * |-------------------------------------------------------------------------+
   * |     |     |     |     |      |          |       | Home| PgDn| PgUp| End |
   * `-------------------------------------------------------------------------'
   */
...
LAYOUT( /* Left */
  ...
  _______, KC_F23, KC_F24, _______, _______, _______, _______, KC_UNDERSCORE, KC_PLUS, KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE, KC_PIPE,
...
LAYOUT( /* Tab */
  ...
  _______, LED_TOG, LED_CHG, _______, _______, _______, _______, _______, _______, KC_MS_BTN1, KC_MS_BTN2, _______,
