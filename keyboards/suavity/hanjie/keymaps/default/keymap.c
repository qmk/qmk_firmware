...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_default_split(
        KC_PMNS,  KC_PAST,  KC_PSLS,  KC_NLCK,    KC_SLCK,        KC_ESC,     KC_1,      KC_2,    KC_3,   KC_4,   KC_5,       KC_6,       KC_7,      KC_8,      KC_9,       KC_0,      KC_MINS,    KC_EQL,  KC_BSLS,
        KC_PPLS,    KC_P9,    KC_P8,     KC_P7,   KC_PGUP,        KC_TAB,     KC_Q,      KC_W,    KC_E,   KC_R,   KC_T,       KC_Y,       KC_U,      KC_I,      KC_O,       KC_P,      KC_LBRC,   KC_RBRC,  KC_BSPC,
        KC_PEQL,    KC_P6,    KC_P5,     KC_P4,   KC_PGDN,       KC_LCTL,     KC_A,      KC_S,    KC_D,   KC_F,   KC_G,       KC_H,       KC_J,      KC_K,      KC_L,    KC_SCLN,      KC_QUOT,    KC_ENT,
