...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     [WIN_BASE] = LAYOUT_fullsize_ansi(/* Base Layer */
     ...
     [WIN_FN] = LAYOUT_fullsize_ansi(/* Function Layer */
        ...
        _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, _______, _______, _______, _______, _______, _______,            _______,                                   KC_MS_L, KC_BTN3, KC_MS_R,
        _______,          KC_BTN4, KC_BTN3, KC_BTN5, _______, _______, _______, _______,  _______, _______, _______,           _______,            RGB_VAI,               KC_WH_L, KC_MS_D, KC_WH_R, KC_WH_D, 
        _______, KC_TGUI, _______,                             _______,                            _______,_______, _______,    KC_TPC,   RGB_SPD, RGB_VAD, RGB_SPI,      KC_BTN1,       KC_BTN2),

    [MAC_BASE] = LAYOUT_fullsize_ansi(/* Layer 3 */
                                                                                                                                                                            KC_PC1, KC_PC2, KC_MUTE,
    ...
    [MAC_FN]   = LAYOUT_fullsize_ansi(/* Layer 4 */
                                                                                                                                                                            KC_PC1, KC_PC2, RGB_MOD,
