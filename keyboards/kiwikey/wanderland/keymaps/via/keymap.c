...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_alice_split_bs(
        ...
        KC_VOLU,   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RGUI,
                   KC_LCTL,          KC_LALT,      KC_SPC,      MO(1),                        KC_SPC,           KC_MENU,                   KC_RCTRL
    ),
    [1] = LAYOUT_alice_split_bs(
        ...
        QK_BOOT,     _______, RGB_VAD, RGB_VAI, _______, _______, _______,             _______, _______, _______, _______, _______, _______, _______, _______,
