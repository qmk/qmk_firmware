...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_65_ansi_blocker(
      ...
      KC_TRNS, KC_TRNS, KC_UP,   KC_TRNS, UG_TOGG, UG_VALU, UG_HUEU, UG_SATU, KC_INS,  QK_BOOT, KC_PSCR, KC_SCRL, KC_PAUS, KC_BSLS, KC_SCRL,
      KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT,UG_NEXT, UG_VALD, UG_HUED, UG_SATD, KC_TRNS, KC_TRNS, KC_F14,  KC_F15,  KC_INS,           KC_HOME,
