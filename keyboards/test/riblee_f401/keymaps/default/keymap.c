...
[_QWERTY] = LAYOUT_ortho_5x12(
    RGB_TOG,  RGB_MOD,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    RGB_TOG,    KC_8,    KC_9,    KC_0,    KC_BSPC,
    KC_TAB,  KC_Q,   RGB_MOD,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_DEL,
...
layer_state_t layer_state_set_user(layer_state_t state) {
    switch (get_highest_layer(state)) {
		case _QWERTY:
			...
			/* rgblight_sethsv_master(180, 255, 180);
			rgblight_sethsv_slave(180, 255, 180); */
			rgblight_sethsv(HSV_RED);
            break;
		case _LOWER:
			rgblight_sethsv(HSV_GREEN);
			/* rgblight_sethsv_master(100, 255, 180);
			rgblight_sethsv_slave(100, 255, 180); */
			break;
		case _RAISE:
			//rgblight_sethsv_master(60, 255, 180);
			rgblight_sethsv(HSV_PURPLE);
        default:
			rgblight_sethsv(180, 255, 180);
            break;
    }
    return state;
}