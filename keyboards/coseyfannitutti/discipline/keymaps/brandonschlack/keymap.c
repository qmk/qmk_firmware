...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_65_ansi(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                          KC_SPC,                 MM_RGUI, MM_RALT, MM_FNPY,  KC_LEFT, KC_DOWN,  KC_RIGHT),
    /* Function Layer
     * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───────┬───┐
    ...
    [_FN] = LAYOUT_65_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, QM_MAKE, _______, _______, _______, _______,          KC_PGUP, KC_MUTE,
