...
enum custom_keycodes {
  ...
  [cm] = LAYOUT(
    ...
    _______, UK_Q,    UK_W,    UK_F,    UK_P,    UK_G,    RESET,                     RESET,   UK_J,    UK_L,    UK_U,    UK_Y,    UK_SCLN, _______, \
    _______, UK_A,    UK_R,    UK_S,    UK_T,    UK_D,    RESET,                     RESET,   UK_H,    UK_N,    UK_E,    UK_I,    UK_O   , _______, \
    _______, _Z_SFT,  _X_NB,   _C_SY,   _V_NAL,  UK_B,    RESET,                     RESET,   UK_K,    _M_NAR,  _COM_SY, _DOT_NB, _SLSH  , _______, \
    _______, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  KC_ENT,  RESET,   RESET,   KC_DEL,  KC_BSPC, KC_RGUI, KC_RALT, KC_RCTL, KC_RSFT, _______  \
  ),
  ...
  [nal] = LAYOUT( \
    _______, _______, DF(cm),  DF(dv),  DF(qw),  _______, _______,                   _______, _______, _______, _______, _______, _______, _______, \
