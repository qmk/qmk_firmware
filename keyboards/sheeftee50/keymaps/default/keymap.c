...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_all(
		...
		KC_PGUP, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_SLSH, 
		KC_PGDN, KC_LCTL, KC_LGUI, KC_LALT, MO(1), KC_SPACE, KC_SPACE, MO(2), KC_RALT, KC_RGUI, KC_RCTL
