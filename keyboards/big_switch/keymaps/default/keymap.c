...
//The "RESET" keycode doesn't work in TapDance, so I have to use the ProMicro 
//Bootloader workaround so KC_FN0 can be used instead
...
//PROGMEM fn_actions is used above already. commenting out...
/*
const uint16_t PROGMEM fn_actions[] = {
