...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LT(MEH,KC_ESC),	KC_A,	KC_S,	KC_D,	KC_F,	KC_G,	KC_LPRN,					KC_RPRN, KC_H,	KC_J,	KC_K,	KC_L,	KC_SCLN, KC_QUOT,
		KC_LSFT,	KC_Z,	KC_X,	KC_C,	KC_V,	KC_B,	KC_LCBR,					KC_RCBR, KC_N,	KC_M,	KC_COMM, KC_DOT,	KC_SLSH, KC_SFTENT,
		KC_LCTL,	MT(MOD_LGUI, KC_LBRC),	MT(MOD_LALT, KC_RBRC), LT(SYM,KC_DEL), NAV,	CMD_T(KC_BSPC),	KC_PGDN, KC_DEL,
												 KC_ENT,	KC_PGUP,	KC_SPC,	KC_LEFT, KC_DOWN,	MT(MOD_RALT, KC_MINS),	MT(MOD_LGUI, KC_EQL),KC_RCTL,
