 ...
 */
	...
	[_MAC] = LAYOUT(
	KC_GRV,	KC_1,	KC_2,	KC_3,	KC_4,	KC_5,	KC_MINS,			KC_NO,	KC_6,	KC_7,	KC_8,		KC_9,	KC_0,	KC_MINUS,
	KC_TAB,	KC_Q,	KC_W,	KC_E,	KC_R,	KC_T,	KC_EQL,			KC_NO,	KC_Y,	KC_U,	KC_I,		KC_O,	KC_P,	KC_BSLS,
	MEHESC,	KC_A,	KC_S,	KC_D,	KC_F,	KC_G,	KC_LPRN,			UP,		KC_H,	KC_J,	KC_K,		KC_L,	KC_SCLN,	KC_QUOT,
	KC_LSFT,	KC_Z,	KC_X,	KC_C,	KC_V,	KC_B,	KC_LBRC,			DOWN,	KC_N,	KC_M,	KC_COMM,		KC_DOT,	KC_SLSH,	KC_RSFT,

	KC_LCTL,	LBRC,	RBRC,	MO(_SYM),		MO(_NAV),
	CMD_T(KC_BSPC),	MT(MOD_LALT, KC_SPC),	MT(MOD_LCTL, KC_ENT),
	KC_ENT,	KC_LCTL,	KC_SPC,
																						KIWI,	CHERRY,	BLUE,	LEMON,	KC_RCTL,
	...
	CTL_T(KC_BSPC),	MT(MOD_LCTL, KC_ENT), MT(MOD_LALT, KC_SPC),
	...
	C(KC_TAB),	A(KC_BSPC),	A(KC_LEFT),	KC_UP,	A(KC_RGHT),	A(KC_DEL),	KC_F12,					_______,	KC_J,	KC_WH_R,	KC_MS_U,	KC_WH_L,	KC_SCLN,	_______,
	KC_MEH,		G(KC_LEFT),	KC_LEFT,		KC_DOWN,	KC_RGHT,		G(KC_RGHT),	KC_RPRN,					KC_VOLU,	KC_WH_U,	KC_MS_L,	KC_MS_D,	KC_MS_R,	KC_WH_U,	KC_WH_U,
	KC_LSFT,		KC_HOME,		G(KC_DOWN),	KC_PGDN,	A(KC_DOWN),	KC_END,		KC_RBRC,					KC_VOLD,	KC_WH_D,	KC_M,	KC_COMM,	KC_DOT,	KC_WH_D,	KC_WH_D,
	_______,		_______,		_______,		_______,	_______,
	...
	[_WINNAV] = LAYOUT(
	C(KC_GRV),	KC_F1,		KC_F2,		KC_F3,	KC_F4,		KC_F5,		KC_F11,					KC_NO,	KC_F6,	KC_F7,	KC_F8,	KC_F9,	KC_F10,	KC_DEL,
	C(KC_TAB),	C(KC_BSPC),	C(KC_LEFT),	KC_UP,	C(KC_RGHT),	C(KC_DEL),	KC_F12,					KC_NO,	KC_J,	KC_WH_R,	KC_MS_U,	KC_WH_L,	KC_SCLN,	_______,
	KC_MEH,		KC_HOME,		KC_LEFT,		KC_DOWN,	KC_RGHT,		KC_END,		KC_RPRN,					KC_F11,	KC_WH_U,	KC_MS_L,	KC_MS_D,	KC_MS_R,	KC_O,	_______,
	KC_LSFT,		KC_HOME,		C(KC_DOWN),	KC_PGDN,	A(KC_DOWN),	KC_END,		KC_RBRC,					KC_F12,	KC_WH_U,	KC_M,	KC_COMM,	KC_DOT,	KC_SLSH,	_______,
...
enum combo_events { RST, TOGWIN, TOGGAME, SEL_WORD, SEL_LINE, WINTGSYM, TGSYM, CTRLALTDEL, CTRLC, CTRLR, CUT, CPY, PST, CAL, DELWD, EML, PHONE, TWK, WINDELWD, COMBO_LENGTH };
...
const uint16_t PROGMEM twk_combo[]   = {KC_T, KC_W, KC_K, COMBO_END};
