 ...
 */
	...
	C(KC_TAB),	A(KC_BSPC),	A(KC_LEFT),	KC_UP,	A(KC_RGHT),	A(KC_DEL),	KC_F12,					_______,	KC_J,	KC_WH_R,	KC_MS_U,	KC_WH_L,	KC_NO,	_______,
	KC_MEH,		G(KC_LEFT),	KC_LEFT,		KC_DOWN,	KC_RGHT,		G(KC_RGHT),	KC_RPRN,					KC_VOLU,	KC_WH_U,	KC_MS_L,	KC_MS_D,	KC_MS_R,	KC_WH_U,	KC_WH_U,
	KC_LSFT,		KC_HOME,		G(KC_DOWN),	KC_PGDN,	A(KC_DOWN),	KC_END,		KC_RBRC,					KC_VOLD,	KC_WH_D,	KC_WH_D,	KC_WH_U,	KC_NO,	KC_WH_D,	KC_WH_D,
	_______,		_______,		_______,		_______,	_______,
