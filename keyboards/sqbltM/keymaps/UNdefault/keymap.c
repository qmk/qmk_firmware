...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = { /* Qwerty */
	    ...
	    {KC_ESC,        KC_LGUI, KC_LALT, LT(2,KC_DEL),  CTL_T(KC_BSPC),            SFT_T(KC_SPC), LT(1,KC_TAB),  TG(4),   KC_CAPS, KC_ENT}
    },
	[1] = { /* Layer 1 */
	...
	[2] = { /* Layer 2 */
        {KC_VOLU,       KC_HOME, KC_UP,   KC_END,        KC_PGUP,                   KC_LPRN,      KC_RPRN,       KC_NO,   KC_NO,   KC_WH_U},
	    {KC_VOLD,       KC_LEFT, KC_DOWN, KC_RGHT,       KC_PGDN,                   KC_LBRC,      KC_RBRC,       KC_NO,   KC_NO,   KC_WH_D},
	    {KC_MUTE,       KC_MYCM, KC_SLCK, KC_INS,        KC_PSCR,                   KC_LCBR,      KC_RCBR,       KC_NO,   KC_NO,   KC_NO},
