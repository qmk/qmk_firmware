...
[_QWERTY] = KEYMAP( \
  ...
  KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LEFT,KC_NO,  KC_DOWN,                            KC_UP,KC_NO,      KC_RIGHT, KC_H,    KC_J,      KC_K,    KC_L,    KC_SCLN,  KC_QUOT, \
  KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    LOWER,    KC_BSPC, KC_ENT,        KC_RCTL,  MT(MOD_LSFT, KC_SPC),   RAISE,     KC_N,     KC_M,    KC_COMM,   KC_DOT,  KC_SLSH, KC_ENT \
),
...
[_ADJUST] =  KEYMAP( \
  ...
  _______, _______, _______, AU_ON,   AU_OFF,  AG_NORM, _______,KC_NO,_______,                              _______,KC_NO, _______, AG_SWAP, QWERTY , COLEMAK, DVORAK,  _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______,           _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______  \
)
