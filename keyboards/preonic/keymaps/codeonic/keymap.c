 ...
 * |  Z   |   X  |   C  |   V  |   B  |   {  |   }  |   N  |   M  |   ,  |   .  |  /   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  |Symbol| Bksp |Enter | Tab  |Raise |VOL+  |VOL-  |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, NAVIG, KC_BSPC, KC_ENT ,  KC_TAB ,  KC_SPC, SYMBOLS, KC_VOLD, KC_VOLU, KC_ESC   \
),
...
[_SYMBOLS] = LAYOUT_preonic_grid( \
  ...
  KC_BSLS, KC_AT  , KC_HASH, KC_ASTR, _______, _______, _______, _______, _______, _______, _______, _______, \
  KC_EXLM, KC_PERC, KC_MINS, KC_EQL , KC_PLUS, KC_CIRC, KC_DLR , KC_PIPE, KC_AMPR, KC_GRV , KC_QUOT, KC_DQUO, \
  _______, _______, _______, KC_UNDS, _______, _______, _______, _______, _______, _______, _______, _______, \
