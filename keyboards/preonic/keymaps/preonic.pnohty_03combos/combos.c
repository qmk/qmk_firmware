// enum combos { _t1, COMBO_LENGTH };
// uint16_t COMBO_LEN = COMBO_LENGTH;
// const uint16_t PROGMEM test_combo1[] = {KC_A, KC_B, COMBO_END};
// combo_t key_combos[] = {
//     COMBO(test_combo1, KC_DOT)
// };
...
combo_t key_combos[] = {[_topl] = COMBO(cmbo_topl, KC_TAB), [_btml] = COMBO(cmbo_btml, KC_LCTL), [_thml] = COMBO(cmbo_thml, KC_LGUI), [_midd] = COMBO(cmbo_midd, KC_NO), [_topr] = COMBO(cmbo_topr, KC_NO), [_btmr] = COMBO(cmbo_btmr, KC_ENT), [_thmr] = COMBO(cmbo_thmr, KC_LALT)};
