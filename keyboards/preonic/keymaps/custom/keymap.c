...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  LT(_MOUSE, KC_ENT), KC_LCTL, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  KC_LOCK, RESET, CK_TOGG,    MU_MOD,  QWERTY, COLEMAK,  DVORAK, KC_WH_D, KC_MS_U, KC_WH_U, _______,  KC_DEL, \
 ...
 * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      | WHL_D| MS_U | WHL_U|      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Rclick|Lclick|      |      | MS_L | MS_D | MS_R |      | ACL0 |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_MOUSE] = LAYOUT_preonic_grid( \
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,      KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,   KC_F12,  \
  _______, _______, _______, _______, _______, _______, _______, KC_WH_D, KC_MS_U, KC_WH_U, _______,  KC_DEL, \
  _______, _______, _______, KC_BTN2, KC_BTN1, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, KC_ACL0, \
