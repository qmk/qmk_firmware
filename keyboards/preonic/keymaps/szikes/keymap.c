...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_TAB,   HU_Q,     HU_W,   TD(TD_E_EE),HU_R,    HU_T,    HU_Y,TD(TD_U_UU),TD(TD_I_II),TD(TD_O_OO),HU_P,    HU_BSLS, \
  KC_LCTL,TD(TD_A_AA),HU_S,     HU_D,     HU_F,    HU_G,    HU_H,    HU_J,    HU_K,    HU_L,    HU_SCLN, KC_ENT,  \
  SHIFT,    HU_Z,     HU_X,     HU_C,     HU_V,    HU_B,    HU_N,    HU_M,    HU_COMM, HU_DOT,  KC_UP,   HU_SLSH, \
...
S(KC_TAB),S(HU_Q), S(HU_W),TD(TD_S_E_EE),S(HU_R), S(HU_T), S(HU_Y),TD(TD_S_U_UU),TD(TD_S_I_II),TD(TD_S_O_OO), S(HU_P), HU_PIPE, \
 S(KC_LCTL),TD(TD_S_A_AA),S(HU_S), S(HU_D), S(HU_F), S(HU_G), S(HU_H), S(HU_J), S(HU_K), S(HU_L), HU_COLN, S(KC_ENT), \
  _______, S(HU_Z),   S(HU_X), S(HU_C), S(HU_V), S(HU_B), S(HU_N), S(HU_M), HU_LESS, HU_MORE, S(KC_UP), HU_QST,  \
  HU_PLUS, HU_DQOT,S(KC_LGUI), _______, _______, _______, _______, _______, HU_UNDS,S(KC_LEFT),S(KC_DOWN),S(KC_RGHT)  \
),
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  KC_LSHIFT,KC_F7,  KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS,S(KC_INSERT),KC_PGUP,KC_PSCREEN, \
