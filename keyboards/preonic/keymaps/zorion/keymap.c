...
/* Numpad + Function keys = NUMFUN!!!
  ...
  */
[_NUMFUN] = {
  {KC_GRV,  KC_QUOT, _______, _______, _______, _______, KC_HOME, KC_P7,   KC_P8,   KC_P9,   KC_PSLS, KC_BSPC},
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |  F5  |  F6  |  F7  |  F8  |      | WLeft| Left | Down |  Up  | Right|WRight|
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |  F9  |  F10 |  F11 |  F12 |      |      |      |      |      |      |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
...
[_LOWER] = {
  ...
  {_______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, LCTL(KC_LEFT), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, LCTL(KC_RGHT)},
