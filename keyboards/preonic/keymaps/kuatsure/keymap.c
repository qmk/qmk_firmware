...
[_ADJUST] = LAYOUT_preonic_grid_wrapper( \
  ...
  _______, RESET,   KB_MAKE, KB_FLSH, DEBUG,   _______, _______, _______, _______, _______, _______, KC_DEL,  \
  _______, KB_VRSN, _______, _______, _______, AU_ON,   AU_OFF,  _______, _______, _______, _______, _______, \
