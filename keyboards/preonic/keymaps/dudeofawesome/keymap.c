 ...
 * |      | Reset|      |      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|AudOff|AGnorm|AGswap|Qwerty|Workmn|Dvorak|Colemk|      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_ADJUST] = {
  ...
  {_______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  WORKMAN, DVORAK,  COLEMAK, _______},
...
[_NUMPAD] = {
  {KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12},
  {_______, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, _______, KC_KP_7,   KC_KP_8, KC_KP_9, KC_KP_ASTERISK, _______},
  {_______, KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_GRV,  _______, KC_KP_4,   KC_KP_5, KC_KP_6, KC_KP_PLUS,     _______},
  {_______, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD, _______, KC_KP_1,   KC_KP_2, KC_KP_3, KC_KP_SLASH,    _______},
  {_______, _______, _______, _______, _______, _______, _______, KC_KP_DOT, KC_KP_0, KC_KP_0, KC_KP_EQUAL,    _______}
}
