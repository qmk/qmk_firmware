...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ortho_5x12(
        ...
        KC_GRV,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,   KC_LCBR, KC_RCBR, KC_LBRC,       KC_RBRC,       KC_NO,
        KC_GRV,  KC_TILD, KC_AT,   KC_PERC, KC_AMPR, KC_ASTR,  KC_HASH, KC_LBRC, KC_RBRC, KC_LPRN,       KC_RPRN,       KC_NO,
        KC_TRNS, KC_UNDS, KC_PLUS, KC_MINS, KC_EQL,  KC_EXLM,  KC_CIRC, KC_DLR,  KC_QUES, KC_SLSH,       LCAG(KC_UP),   KC_TRNS,
        MO(15),  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,    KC_NO,   KC_TRNS, KC_TRNS, LGUI(KC_LBRC), LCAG(KC_DOWN), LGUI(KC_RBRC)
    ),
