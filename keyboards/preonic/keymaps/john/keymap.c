 ...
 * |SFENT |   *  |  &   |  /   |  $   |  ^   |   |  |   [  |   ]  |      |      | SFENT|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ex   |gui   | ctl  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_SYMB] = LAYOUT_preonic_1x2uC( \
	...
	_______,		KC_EXLM,	KC_MINS,		KC_EQL,			KC_PERC,	KC_AT,		KC_UNDS,	KC_LCBR,	KC_RCBR,	KC_SLSH,	KC_QUES,	KC_QUOT, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  COPY_ALL, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY  \
),
