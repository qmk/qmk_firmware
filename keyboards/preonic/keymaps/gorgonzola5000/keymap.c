...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_preonic_1x2uC(	KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS,
								KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC,
								KC_ESC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
								TO(1), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_ENT,
								TO(0), KC_LCTL, OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LSFT), KC_SPC, OSM(MOD_RALT), TO(2), KC_F13, TO(3), KC_DEL),
	[1] = LAYOUT_preonic_1x2uC(	KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS,
								...
								TO(0), OSM(MOD_LCTL), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LSFT), KC_SPC, KC_0, KC_COMM, KC_DOT, KC_NO, KC_DEL),
	[2] = LAYOUT_preonic_1x2uC(	KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS,
								...
								TO(0), OSM(MOD_LCTL), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LSFT), KC_SPC, KC_NO, KC_NO, KC_NO, KC_NO, KC_DEL),
	[3] = LAYOUT_preonic_1x2uC(	KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS,
								...
								TO(0), OSM(MOD_LCTL), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LSFT), KC_SPC, KC_F10, KC_F11, KC_F12, KC_NO, KC_DEL)
};
