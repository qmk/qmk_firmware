...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_all(
	   KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,     KC_PSCR, KC_SCRL, KC_PAUS, 
	   ...
	   KC_CAPS, KC_LGUI, KC_LALT,               KC_SPC,            _______,   KC_RALT,         KC_NUM, KC_RCTL,    KC_LEFT, KC_DOWN, KC_RGHT
	 ),
	[_FN1] = LAYOUT_all(
