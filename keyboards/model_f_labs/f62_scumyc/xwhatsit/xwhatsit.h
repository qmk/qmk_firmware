...
#define LAYOUT_all( \
    ...
    k_caps,    k_a, k_s, k_d, k_f, k_g, k_h, k_j, k_k, k_l, k_semicolon, k_singlequote, k_hashtag, k_return,     \
    k_lshift, k_nonusbs, k_z, k_x, k_c, k_v, k_b, k_n, k_m, k_cm,k_period, k_forwardslash, k_rshifthid, k_rshift,\
...
{ \
    ...
    { k_nonusbs,k_x,    k_d, k_g,     k_k, k_l,         k_forwardslash, k_rshifthid,  KC_NO},  \
    { k_lctrl,  k_fnl,  k_v, k_lalt,  k_m, k_cm,        k_space,        k_up,         k_right},\
    { k_lgui,   k_z,    k_c, k_b,     k_n, k_period,    k_left,         k_rshift,     k_down}, \
