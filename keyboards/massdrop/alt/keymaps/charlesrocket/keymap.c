...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT(
        ...
        _______, KC_QUES,   XP(27,28), XP(29,31), UM(32),   XP(33,34), UM(35),     UM(36),     XP(37,38), XP(39,40), XP(41,42), XP(43,44), XP(45,46), _______, _______,
        _______, XP(47,48), UM(49),     UM(50),     KC_UNDS, XP(52,5),  XP(53,54), XP(55,56), KC_QUOT,   XP(59,60), XP(61,62), XP(63,64), _______, _______,
        _______, XP(65,66), UM(67),     XP(68,69), UM(70),   UM(71),     UM(72),     UM(73),     KC_PIPE,   XP(75,76), UM(77),     XP(78,79), _______, _______,
