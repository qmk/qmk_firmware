...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAIN] = LAYOUT_65_ansi_blocker(
        ...
        KC_DEL,      KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    IT_SCLN, IT_APOS,          KC_ENT,  KC_PGUP, \
        MO(_SHIFT),   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    IT_COMM, IT_DOT,  IT_SLSH, MO(_SHIFT),       KC_UP,   KC_PGDN, \
