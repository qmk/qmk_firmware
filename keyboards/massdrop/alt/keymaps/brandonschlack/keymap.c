...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |      |   |   |   |   |   |   |   |   |   |   |   | TgMagic|VlU|
     * |---------------------------------------------------------------|
     * |        |RTO|   |   |   |   |   |MKE|Prv|Nxt|Ply|MutSft|PgU|VlD|
     * |---------------------------------------------------------------|
     * |    |    |    |                       |    |    |  |Hom|PgD|End|
     * `---------------------------------------------------------------'
     */
    [_MACFN] = LAYOUT(
        ...
        _______, RGB_TOG, _______, _______, _______, _______, _______, KC_MAKE, KC_MRWD, KC_MFFD, KC_MPLY, MM_RSFT,          KC_PGUP, KC_VOLD, \
    ...
    [_MAGIC] = LAYOUT(
        ...
        _______, RGB_TOG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG_NKRO, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,          XXXXXXX, XXXXXXX, \
