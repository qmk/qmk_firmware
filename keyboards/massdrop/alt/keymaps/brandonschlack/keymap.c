...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    /* Layer 1: Function Layer
      ...
      * |---------------------------------------------------------------|
      * |LBr  |LS-|LB+|LS+|   |   |   |UAT|GCR|   |F13|F14|F15|     |End|
      * |---------------------------------------------------------------|
      * |LPD   |LP-|LB-|LP+|   |   |   |   |   |   |   |   |        |VlU|
      * |---------------------------------------------------------------|
      * |        |LTM|LTO|   |   |DFU|KRO|   |   |   |   |      |PgU|VlD|
      * |---------------------------------------------------------------|
      * |    |    |    |                       |    |    |  |Hom|PgD|End|
      * `---------------------------------------------------------------'
      */
    [1] = LAYOUT(
        ...
        L_T_BR,  L_PSD,   L_BRI,   L_PSI,   KC_TRNS, KC_TRNS, KC_TRNS, U_T_AUTO,U_T_AGCR,KC_TRNS, KC_F13,  KC_F14,  KC_F15,  KC_TRNS, KC_END, \
