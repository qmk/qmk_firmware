...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |---------------------------------------------------------------|
    * |Ctrl|Alt |Gui |         Space         |Gui |Fn1 |  |Lef|Dow|Rig|
    * `---------------------------------------------------------------'
    */
    [BL] = LAYOUT(
    ...
    [FL] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MD_BOOT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F13,  KC_F14,  KC_F15,  MC_LHPD, KC_END,  \
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, MC_VOLU, \
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, DF(ML),  KC_TRNS, KC_TRNS, KC_MRWD, KC_MFFD, KC_MPLY, KC_TRNS,          KC_PGUP, MC_VOLD, \
    ...
    /* Layer 2: Magic Layer
      ...
      */
    [ML] = LAYOUT(
        DF(BL),  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
        L_T_BR,  L_PSD,   L_BRI,   L_PSI,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, U_T_AGCR,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
        L_T_PTD, L_PTP,   L_BRD,   L_PTN,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, \
        XXXXXXX, L_T_MD,  L_T_ONF, XXXXXXX, XXXXXXX, XXXXXXX, TG_NKRO, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, \
