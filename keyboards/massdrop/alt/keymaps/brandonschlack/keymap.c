...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LF_MAC] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          TG_MAGC, _______, \
    ...
    [LF_WIN] = LAYOUT(
        ...
        _______, _______, _______, _______, MD_BOOT, _______, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, KC_END,  \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          TG_MAGC, _______, \
        _______, L_T_MD,  _______, _______, _______, _______, _______, MD_MAKE, _______, _______, _______, MM_RSFT,          KC_VOLU, _______, \
