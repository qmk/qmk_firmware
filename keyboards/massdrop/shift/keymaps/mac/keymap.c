...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, RGB_TOG, _______, _______, _______, MD_BOOT, NK_TOGG, _______, _______, _______, _______, _______,                            _______, _______, _______,          \
                                                                                                                             _______,                                     _______, \
        _______, _______, _______,                   DBG_TOG,                            KC_APP,  _______,                                     _______, _______,                   \
