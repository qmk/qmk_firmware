...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_RGUI_ML] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_RGUI, _ML),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_KL] = LAYOUT(
        ...
        TD(TD_CTRL_TERM),   KC_LALT,    TD(TD_LGUI_ML),                  KC_SPC,                             TD(TD_RGUI_ML), TT(_FL), KC_RALT, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FL] = LAYOUT(
        ...
        _______, _______, _______,                    _______,                              _______, TG(_FL), TD(TD_APP_YL), _______,          _______, KC_BRID, _______
    ),
    [_ML] = LAYOUT(
