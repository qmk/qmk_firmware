...
led_config_t g_led_config = { {
  ...
  // 0_ESC, 1_F1, 2_F2, 3_F3, 4_F4, 5_F5, 6_F6, 7_F7, 16_F8, 17_F9, 18_F10, 19_F11, 20_F12, 21_PSCR, 22_SLCK, 23_PAUS
    {   7,   5 }, {  31,   5 }, {  43,   5 }, {  55,   5 }, {  67,   5 }, {  85,   5 }, {  97,   5 }, { 109,   5 },
    { 121,   5 }, { 139,   5 }, { 151,   5 }, { 163,   5 }, { 175,   5 }, { 193,   5 }, { 205,   5 }, { 217,   5 },
  // 33_GRV, 34_1, 35_2, 36_3, 37_4, 38_5, 39_6, 40_7, 50_8, 51_9, 52_0, 53_MINS, 54_EQL, 55_BSPC, 56_INS, 57_HOME, 63_PGUP
    {   7,  20 }, {  19,  20 }, {  31,  20 }, {  43,  20 }, {  55,  20 }, {  67,  20 }, {  79,  20 }, {  91,  20 },
    { 103,  20 }, { 115,  20 }, { 127,  20 }, { 139,  20 }, { 151,  20 }, { 169,  20 }, { 193,  20 }, { 205,  20 },
    { 217,  20 },
  // 64_TAB, 65_Q, 66_W, 67_E, 68_R, 69_T, 70_Y, 76_U, 77_I, 78_O, 79_P, 80_LBRC, 81_RBRC, 82_BSLS, 83_DEL, 8_END, 9_PGDN
    {  10,  30 }, {  25,  30 }, {  37,  30 }, {  49,  30 }, {  61,  30 }, {  73,  30 }, {  85,  30 }, {  97,  30 },
    { 109,  30 }, { 121,  30 }, { 133,  30 }, { 145,  30 }, { 157,  30 }, { 172,  30 }, { 193,  30 }, { 205,  30 },
    { 217,  30 },
  // 10_CAPS, 11_A, 12_S, 13_D, 14_F, 15_G, 24_H, 25_J, 26_K, 27_L, 28_SCLN, 29_QUOT, 30_ENT
    {  11,  39 }, {  28,  39 }, {  40,  39 }, {  52,  39 }, {  64,  39 }, {  76,  39 }, {  88,  39 }, { 100,  39 },
    { 112,  39 }, { 124,  39 }, { 136,  39 }, { 148,  39 }, { 168,  39 },
  // 31_LSFT, 41_Z, 42_X, 43_C, 44_V, 45_B, 46_N, 47_M, 48_COMM, 58_DOT, 59_SLSH, 60_RSFT, 61_UP
    {  14,  49 }, {  34,  49 }, {  46,  49 }, {  58,  49 }, {  70,  49 }, {  82,  49 }, {  94,  49 }, { 106,  49 },
    { 118,  49 }, { 130,  49 }, { 142,  49 }, { 165,  49 }, { 205,  49 },
  // 62_LCTL, 75_LGUI, 49_LALT, 32_SPC, 71_RALT, 72_MO(1), 73_APP, 74_RCTL, 84_LEFT, 85_DOWN, 86_RGHT
