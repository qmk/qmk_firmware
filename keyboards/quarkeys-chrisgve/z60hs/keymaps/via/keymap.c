...
const rgblight_segment_t PROGMEM my_arnumpad_layer[] = RGBLIGHT_LAYER_SEGMENTS({54, 2, HSV_WHITE});
const rgblight_segment_t PROGMEM my_symbol_layer[] = RGBLIGHT_LAYER_SEGMENTS({40, 2, HSV_WHITE});
const rgblight_segment_t PROGMEM my_game_layer[] = RGBLIGHT_LAYER_SEGMENTS({26, 2, HSV_WHITE});
const rgblight_segment_t PROGMEM my_macro_layer[] = RGBLIGHT_LAYER_SEGMENTS({ 13, 2, HSV_WHITE});
