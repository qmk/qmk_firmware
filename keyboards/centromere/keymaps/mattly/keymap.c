...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE_MAC] = LAYOUT_split_3x6_3_thumb(
  ...
  [_OVER_WIN] = LAYOUT_split_3x6_3_thumb(
  ...
  [_NAVNUM] = LAYOUT_split_3x6_3_thumb(
  ...
  [_NAVNUM_WIN] = LAYOUT_split_3x6_3_thumb(
  ...
  [_FUNCT] = LAYOUT_split_3x6_3_thumb(
  ...
  [_FUNCT_WIN] = LAYOUT_split_3x6_3_thumb(
    _______, _______, _______, _______, _______, _______,            _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,            _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,            _______, _______, _______, _______, _______, _______,
                                   _______, _______, _______,   _______, _______, _______
