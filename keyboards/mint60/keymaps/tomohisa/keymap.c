...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_LALT,    KC_LGUI,    KC_LCTL,    MO(1),    KC_SPC,        KC_RSFT, KC_BSPC,  LALT(KC_GRV),               KC_MS_L,KC_MS_D,KC_MS_R \
  ),
  [1] = LAYOUT( \
    ...
    _______,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ACL2,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, KC_WH_U, _______, \
    _______,   _______,    _______,    _______,    XXXXXXX,       _______, KC_DEL, LCTL(KC_F4),                   KC_WH_L, KC_WH_D, KC_WH_R \
  )
};
