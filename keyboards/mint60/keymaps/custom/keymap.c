...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MO(1),  KC_UP, KC_PSCR,     \
    KC_LGUI,  KC_LCTL,  KC_LALT,  KC_LSFT,  KC_SPC,      KC_ESC, KC_LANG5,  LALT(KC_GRV),      KC_LEFT,  KC_DOWN,  KC_RGHT \
  ),
  [1] = LAYOUT( \
