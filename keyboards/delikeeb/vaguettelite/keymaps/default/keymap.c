...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    _______,                UG_TOGG,    UG_PREV,    UG_NEXT,    UG_VALD,    UG_VALU,    _______,    _______,    _______,    _______,    _______,        _______,            _______,    _______,
    KC_CAPS,                _______,    UG_HUED,    UG_HUEU,    UG_SATD,    UG_SATU,    _______,    _______,    _______,    _______,    _______,        _______,            _______,    _______,
