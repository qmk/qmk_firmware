...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_center_space(
  KC_Q,    KC_W,    KC_E, KC_R,  KC_T, KC_Y, KC_U,  KC_I,         KC_O,    KC_P,
  KC_A,    KC_S,    KC_D, KC_SF, KC_G, KC_H, KC_SJ, KC_K,         KC_L,    KC_ENT,
  KC_Z,    KC_X,    KC_C, KC_V,  KC_B, KC_N, KC_M,  KC_COMM,      KC_DOT,  KC_SLSH,
  KC_LCTL, KC_LALT,        LT(_NAV, KC_SPC),        MO(_NUM_SYM), KC_BSPC, KC_RGUI
  ),

  [_NUM_SYM] = LAYOUT_center_space(
  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,     KC_0,
  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_EQUAL, KC_MINS,
  KC_LCBR, KC_LBRC, KC_LPRN, KC_UNDS, KC_RPRN, KC_RBRC, KC_RCBR, KC_SCLN, KC_QUOTE, KC_BSLASH,
  KC_TRNS, KC_TRNS,                   KC_TRNS,                   KC_TRNS, KC_TRNS,  KC_TRNS
  ),

  [_NAV] = LAYOUT_center_space(
