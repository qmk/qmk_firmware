...
[_FN1]=LAYOUT(    // FN1 (Num pad)
	_______	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,					KC_KP_SLASH	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	KC_MINS	,	KC_EQL	,	xxxx	,	TG(_FN1)	,	\
	_______	,	KC_PGDN	,	KC_UP	,	KC_PGUP	,	xxxx	,	xxxx	,					KC_KP_ASTERISK	,	KC_P7	,	KC_P8	,	KC_P9	,	xxxx	,	KC_LPRN	,	KC_RPRN	,			_______	,	\
	_______	,	KC_LEFT	,	KC_DOWN	,	KC_RIGHT	,	xxxx	,	xxxx	,					KC_KP_MINUS	,	KC_P4	,	KC_P5	,	KC_P6	,	KC_COMM	,	KC_QUOT	,					KC_KP_ENTER	,	\
...
[_FN3]=LAYOUT(  //FN3 (System utilz)
	...
	EEP_RST	,	xxxx	,	RGB_VAD	,	RGB_VAI	,	KC_ASON	,	KC_ASOFF	,					xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,			xxxx	,	\
	xxxx	,	xxxx	,	RGB_SAD	,	RGB_SAI	,	KC_ASUP	,	KC_ASDN	,					xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,					xxxx	,	\
	xxxx	,	xxxx	,	RGB_HUD	,	RGB_HUI	,	KC_ASRP	,	xxxx	,	DF(_QWERTY)	,	DF(_GAME)	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,							xxxx	,	\
