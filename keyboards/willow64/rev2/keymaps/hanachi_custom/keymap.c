...
[_QWERTY]=LAYOUT(   //QWERTY
	...
	KC_LSFT	,	KC_Z	,	KC_X	,	KC_C	,	KC_V	,	KC_B	,	KC_DEL	,	KC_LGUI	,	KC_N	,	KC_M	,	KC_COMM	,	KC_DOT	,	KC_SLSH	,							KC_RSFT	,	\
							LT(_FN1,KC_LEFT)	,	ALT_T(KC_RIGHT)	,	KC_SPC	,	CTL_T(KC_F13)	,	LSFT_T(KC_ENT)	,	LT(_FN2, KC_BSPC)	,	ALT_T(KC_DOWN)	,	LT(_FN3, KC_UP)														\
),
[_FN1]=LAYOUT(    // FN1 (Num pad)
	_______	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,					KC_NLCK	,	xxxx	,	xxxx	,	KC_LPRN	,	KC_RPRN	,	_______	,	_______	,	_______	,	TG(_FN1)	,	\
	_______	,	KC_PGDN	,	KC_UP	,	KC_PGUP	,	xxxx	,	xxxx	,					KC_P7	,	KC_P8	,	KC_P9	,	KC_MINUS	,	KC_EQL	,	_______	,	_______	,			_______	,	\
	_______	,	KC_LEFT	,	KC_DOWN	,	KC_RIGHT	,	xxxx	,	xxxx	,					KC_P4	,	KC_P5	,	KC_P6	,	KC_PLUS	,	KC_ASTR	,	KC_COMM	,					_______	,	\
	_______	,	KC_HOME	,	KC_DOWN	,	KC_END	,	C(LWIN(KC_LEFT))	,	C(LWIN(KC_RIGHT))	,	_______	,	KC_P0	,	KC_P1	,	KC_P2	,	KC_P3	,	KC_DOT	,	KC_SLSH	,							_______	,	\
...
[_FN2]=LAYOUT(    //FN2 (additional keys)
	...
	_______	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,					xxxx	,	KC_PGDN	,	KC_UP	,	KC_PGUP	,	xxxx	,	C(LWIN(KC_LEFT))	,	C(LWIN(KC_RIGHT))	,			KC_PSCR	,	\
	KC_CAPS	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,					xxxx	,	KC_LEFT	,	KC_DOWN	,	KC_RIGHT	,	xxxx	,	xxxx	,					_______	,	\
	_______	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	_______	,	xxxx	,	xxxx	,	KC_HOME	,	KC_DOWN	,	KC_END	,	xxxx	,							_______	,	\
...
[_FN3]=LAYOUT(  //FN3 (System utilz)
	...
	xxxx	,	VLK_TOG 	,	RGB_VAD	,	RGB_VAI	,	KC_ASON	,	KC_ASOFF	,					xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,	xxxx	,			xxxx	,	\
