...
led_config_t g_led_config = {
	{
		...
		{  0,      1,         2,        3,        4,        5,        6,        7,        8,         45,        46,         47,       48,        50,     52 },  /* R0 */
		{  9,     10,        11,       12,       13,       14,       15,       16,       17,         53,        54,         55,       56,        57,     58 },  /* R1 */
		{ 18,     19,        20,       21,       22,       23,       24,       25,       26,         59,        60,         61,       63,        NO_LED, 65 },  /* R2 */
		{ 28,     30,        31,       32,       33,       34,       35,       66,       67,         68,        69,         70,       71,        NO_LED, 72 },  /* R3 */
		{ 36,     37,        38,       NO_LED,   NO_LED,   40,       NO_LED,   NO_LED,   NO_LED,     42,        43,         44,       73,        74,     75 },  /* R4 */
    }, {
