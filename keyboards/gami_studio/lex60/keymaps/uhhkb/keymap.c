...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FUNCTION] = LAYOUT_uhhkb(
      ...
      KC_LSFT,                       XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, KC_MPRV,  KC_MNXT, KC_MPLY, XXXXXXX,
                                     KC_LALT, KC_LGUI,           KC_SPC,           LT(2, KC_ENT),          KC_RGUI,  KC_RALT, MO(3)),

  [_FIRMWARE] = LAYOUT_uhhkb(
