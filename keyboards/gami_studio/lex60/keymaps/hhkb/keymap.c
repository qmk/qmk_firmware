...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_hhkb(
      ...
      KC_LSFT,                       KC_Z,    KC_X,     KC_C,    KC_V,    KC_B,    KC_N,          KC_M,    KC_COMM,  KC_DOT,  KC_SLSH, KC_RSFT, MO(3),
                                     KC_LALT, KC_LGUI,           KC_SPC,  LT(2, KC_ENT),          KC_RGUI, KC_RALT),
  ...
  [_FUNCTION] = LAYOUT_hhkb(
      ...
      KC_LSFT,                       XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, KC_MPRV,  KC_MNXT, KC_MPLY, XXXXXXX, MO(3),
                                     KC_LALT, KC_LGUI,           KC_SPC,  LT(2, KC_ENT),          KC_RGUI, KC_RALT),
