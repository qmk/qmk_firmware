...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |Esc   |ADJUST| Alt  | GUI  |LOWER |Space |             | Enter| RAISE| Bksp | 6    |  9   | Ctrl+GUI+Space|
   * `-----------------------------------------'             `-----------------------------------------'
   */
    [_QWERTY] = LAYOUT(
      ...
      KC_ESC,  KC_ESC,  KC_LALT, KC_LGUI, LOWER,   KC_SPC,            KC_ENT,  RAISE,   KC_BSPC, KC_6,    KC_9,    RCTL(RGUI(KC_SPACE))
    ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
   ...
   */
    [_RAISE] = LAYOUT(
      ...
      KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,            KC_PLUS, KC_MINS, KC_EQL,  KC_UNDS, KC_PIPE, KC_BSLS, \
      _______, _______, _______, _______, _______, _______,           _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
    ),
