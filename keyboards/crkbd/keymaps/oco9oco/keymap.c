...
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
    KC_ESC,   KC_T,   KC_Q, KC_W, KC_E, KC_R,                                         __________________QWERTY_R1________________, _______,
    KC_TAB,   KC_LSFT,KC_A, KC_S, KC_D, KC_G,                                         __________________QWERTY_R2________________, _______,
    TG(_FACTORIO), KC_4,   KC_X, KC_4, KC_V, KC_ENT,                                  __________________QWERTY_HOME_R3___________, _______,
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
                                    KC_F, KC_SPC, KC_C,         KC_ENT, KC_SPC, TO(_BASE)
),
...
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
    ...
    KC_TAB,  __________________QWERTY_L2_SFTA___________,                                         __________________QWERTY_R2________________, _______,
    _______, __________________QWERTY_L3________________,                                         __________________QWERTY_HOME_R3___________, _______,
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
                                    KC_F, KC_BSPC, KC_C,         KC_ENT, KC_SPC, KC_LNG1
),
  [_IPC] = LAYOUT_crkbd_wrapper(
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
    XXXXXXX, XXXXXXX, XXXXXXX, CLASS_E, CLASS_A, KC_SLSH,                             KC_GRV,  _________NUM_789_________, XXXXXXX, _______,
    _______, IPC(A),  IPC(S),  IPC_MIN, IPC(F), KC_DOT,                               AT_IPC,  _________NUM_456_________, KC_COLN, KC_DQUO,
    KC_LNG1, IPC(Z),  HWP_CITE,IPC(C),  KC_EQL,  TO(_DOOM),                             XXXXXXX, _________NUM_123_________, _______, KC_PIPE,
...
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
    KC_ESC,  A(KC_F4), KC_WH_D, KC_MS_U, KC_WH_U, KC_F5,                           XXXXXXX, KC_ACL0, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT,
    C(KC_F1), XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, KC_F6,                           XXXXXXX, KC_ACL0, KC_BTN1, KC_BTN2, KC_BTN3, QK_MAKE,
    XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_F7,                           XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX,
                                        _______, _______, _______,          _______, _______, _______
    ),
