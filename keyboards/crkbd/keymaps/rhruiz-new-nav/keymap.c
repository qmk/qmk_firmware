...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------.                    ,-----------------------------------.
      TILD,    _____NUMBERS_LEFT_____   ,                        _____NUMBERS_RGHT_____    ,     ,
  //|-----+-----------------------------|                    |-----------------------------+-----|
          ,   ________L_LWR_3________   ,                        ________R_LWR_3________   ,     ,
  //|-----+-----------------------------|                    |-----------------------------+-----|
          ,    _____SYMBOLS_LEFT_____   ,                        _____SYMBOLS_RGHT_____    ,     ,
  //|-----+-----------------+-----+-----+-----|  |-----+-----+-----+-----+-----+-----+-----+-----|
                                  ,     ,     ,        ,     ,
                          //`-----------------'  `-----------------'
    ),
  ...
  //,-----------------------------------.                    ,-----------------------------------.
      GRV ,   ________L_RSE_2________   ,                          , _WL ,  UP , _WR ,     ,     ,
  //|-----+-----------------------------|                    |-----------------------------+-----|
          , LALT, LCTL, LSFT, LGUI,     ,                          , LEFT, DOWN,RIGHT,     ,     ,
  //|-----+-----------------------------|                    |-----------------------------+-----|
