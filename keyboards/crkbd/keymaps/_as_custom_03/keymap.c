...
//         // Set RGB for a specific key (e.g., KC_A) when the RGB layer is active
//         rgb_matrix_set_color(1, 0xFF, 0x00, 0x00); // Red color for key KC_A
//     } else {
//         // Set default RGB for the key when the RGB layer is not active
//         rgb_matrix_set_color(1, 0x00, 0x00, 0x00); // Turn off RGB for key KC_A
//     }
//     return false;
// }
// #endif