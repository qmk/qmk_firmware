...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAME] = LAYOUT_wrapper(
    ...
    _______,  __________________GAME_L3__________________,   _________________QWERTY_R3_________________, _______,
                                  KC_LALT, KC_SPC, GN_TAB,   KC_ENT, TG_GNAV, KC_DEL
  ),

  [_GAMENAV] = LAYOUT_crkbd_base_wrapper(
  ...
  [_GAMENUM] = LAYOUT_crkbd_base_wrapper(
    KC_NO,  KC_1, KC_2, KC_3, KC_NO,    TG_GAME,  KC_F1,  KC_F2,  KC_F3,  KC_F10,
  ...
  [_ADJUST] = LAYOUT_crkbd_base_wrapper(
    ...
    _________________ADJUST_L3_________________, MU_TOG,  RGB_SAD, RGB_VAD, RGB_HUD, RGBRST
  ),
