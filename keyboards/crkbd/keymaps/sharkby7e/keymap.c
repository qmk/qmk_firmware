...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // \--------------+-------+---------------+---------------+---------|   | ---------+---------------+---------------+--------+---------/
                              RCTL_T(KC_ESC),      MO(1),      KC_LSPO,      KC_SPC,       MO(2),        KC_TAB
//                          \---------------+---------------+---------|   |----------+---------------+---------------/
  ...
  // \---------+---------+---------+---------+----------|   |---------+--------------+--------------+--------+---------/
       XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_BSLS,      KC_SCLN,     KC_1,          KC_2,       KC_3,    KC_DQUO, 
  // \---------+---------+---------+---------+----------|   |---------+--------------+--------------+--------+---------/
  ...
  //,-----------------------------------------------------.            ,-----------------------------------------------------.
       KC_NO,   KC_ESC,  KC_NO, KC_COMM, KC_DOT,   KC_NO,                 KC_NO,   KC_NO,  KC_ENT,  KC_NO,   KC_DEL, KC_NO,
  //|--------+--------+--------+--------+--------+--------|            |--------+--------+--------+--------+--------+--------|
