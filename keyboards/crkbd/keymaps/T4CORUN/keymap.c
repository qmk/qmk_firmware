...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    ___x___, _______________MOUSE_KEYS_L3_______________, _______________MOUSE_KEYS_R3_______________, ___x___,
                               ______MOUSE_KEYS_L4______, ______MOUSE_KEYS_R4______ 
  ),
