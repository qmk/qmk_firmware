...
char saku_nami_r[2][21] = {
  { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 },
  { 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f, 0x8f }
};
...
void prepare_next_frame(void) {
    ...
    if (is_master) {
        ...
        matrix_write(&matrix, saku_nami_l[0]);
        matrix_return(&matrix);
        matrix_write_range(&matrix, saku_nami_l[1], animation_frame / 4, 120);
        ...
        matrix_return(&matrix);
        matrix_write(&matrix, saku_nami_r[0]);
        matrix_return(&matrix);
        matrix_write_range(&matrix, saku_nami_r[1], 6 - animation_frame / 4, 120);
        set_overwrite_mode(false);
    }
