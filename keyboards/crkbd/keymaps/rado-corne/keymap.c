...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[_QWERTY] = LAYOUT_split_3x6_3(
						KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, 						KC_Y, KC_U, KC_I, KC_O, TD(TD_PROGRAMMING), KC_BSPC, 
						LCTL_T(KC_ESC), KC_A, KC_S, KC_D, KC_F, TD(TD_GAMMING), 	KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, 
						KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, 						TD(TD_NUMPAD), KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, 
