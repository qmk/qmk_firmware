...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------.                ,-----------------------------------------.
        LGUI(KC_TAB),  LGUI(KC_1), LGUI(KC_2), LGUI(KC_3), LGUI(KC_4), LGUI(KC_5),                  LGUI(KC_6), LGUI(KC_7), LGUI(KC_8), LGUI(KC_9), LGUI(KC_0), KC_NO,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_NO, LGUI(KC_T),                  LGUI(KC_H), LGUI(KC_J), LGUI(KC_K), LGUI(KC_L), KC_NO, KC_NO,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
