...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TILD,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                       KC_F11,    KC_4,    KC_5,    KC_6, KC_MINS, KC_PLUS,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,                       KC_F12,    KC_1,    KC_2,    KC_3, _______, CT_ASTR,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  [_NAV] = LAYOUT( \
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
       KC_GRV, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                      KC_PGUP, KC_HOME,   KC_UP,  KC_END, XXXXXXX, _______,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TILD, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,                      KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_PIPE, XXXXXXX,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______,  KC_EUR, KC_MINS, KC_PLUS, KC_UNDS,  KC_EQL,                      KC_CAPS, KC_PSCR, KC_NLCK, XXXXXXX, KC_BSLS, _______,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+---------|
...
void rgb_matrix_disable_idle_anym(uint8_t mode, uint8_t speed) {
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (temp_keycode) {
    case KC_BSPC:
      ...
      case RGB_SPL:
        if (record->event.pressed) {
          rgb_matrix_disable_idle_anym(RGB_MATRIX_SPLASH, RGB_MATRIX_ANIMATION_SPEED_DEFAULT);
        }
        break;
      case RGB_CYC:
        if (record->event.pressed) {
          rgb_matrix_disable_idle_anym(RGB_MATRIX_CYCLE_ALL, RGB_MATRIX_ANIMATION_SPEED_SLOWER);
        }
        break;
      case RGB_DUO:
        if (record->event.pressed) {
          rgb_matrix_disable_idle_anym(RGB_MATRIX_DUAL_BEACON, RGB_MATRIX_ANIMATION_SPEED_SLOW);
        }
        break;
      case RGB_CHV:
        if (record->event.pressed) {
          rgb_matrix_disable_idle_anym(RGB_MATRIX_RAINBOW_MOVING_CHEVRON, RGB_MATRIX_ANIMATION_SPEED_SLOW);
        }
        break;
    #endif
  }
