...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAME_EXT] = LAYOUT_kc( \
  //,-----------------------------------------.                ,-----------------------------------------.
        GRV,  MINS,   EQL, _____,  LBRC,  RBRC,                   VOLU,  KP_7,  KP_8,  KP_9,  PSLS,  PAST,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
          1,     2, _____, _____, _____,  BSLS,                   VOLD,  KP_4,  KP_5,  KP_6,  PMNS,  PPLS,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
          3,     4,     5,     6,     7,     8,                   MUTE,  KP_1,  KP_2,  KP_3,  PEQL,  PENT,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
