...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[_QWERTY] = LAYOUT_split_3x6_3(
                                                              ...
                                                              [_LOWER] = LAYOUT_split_3x6_3(
                                                                  ...
                                                                  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                                                  LGUI_T(KC_DOWN), _______, KC_SPC, LALT(KC_BSPC), TG(3), RSFT_T(KC_UP)
                                                                  //`--------------------------'  `--------------------------'
                                                                  ),
                                                              ...
                                                              [_RAISE] = LAYOUT_split_3x6_3(
                                                                  ...
                                                                  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                                                  LGUI_T(KC_DOWN), TG(3), KC_SPC, KC_DEL, _______, RSFT_T(KC_UP)
                                                                  //`--------------------------'  `--------------------------'
                                                                  ),
...
void rgb_matrix_indicators_user(void) {
    ...
    switch (biton32(layer_state)) {
        case _QWERTY:
            ...
            rgb_matrix_set_color(13, 23, 181, 255);
            rgb_matrix_set_color(40, 255, 33, 0);
            break;
        ...
        case _RAISE:
            ...
            for (int i = 0; i < DRIVER_LED_TOTAL; i++) {
                switch (i) {
                    ...
                    case 48:
                    case 49:
                        rgb_matrix_set_color(i, 255, 214, 0);
                        break;

                    default:
                        rgb_matrix_set_color(i, 255, 33, 0);
                }
            }
            break;
        ...
        case _LOWER:
            ...
            for (int i = 0; i < DRIVER_LED_TOTAL; i++) {
                switch (i) {
                    ...
                    default:
                        rgb_matrix_set_color(i, 23, 181, 255);
                }
            }
        ...
        case _NUMP:
            ...
            for (int i = 0; i < DRIVER_LED_TOTAL; i++) {
                ...
                rgb_matrix_set_color(13, 23, 181, 255);
                rgb_matrix_set_color(40, 255, 33, 0);
                rgb_matrix_set_color(50, 0, 33, 255);
