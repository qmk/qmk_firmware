...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_split_3x6_3(
      KC_NO, KC_INS, KC_PGUP,  KC_UP,   KC_HOME, KC_VOLU,           KC_P7,  KC_P8,    KC_P9,   KC_PAST, KC_PSLS, KC_NO,
      KC_NO, KC_DEL, KC_LEFT,  KC_DOWN, KC_RGHT, KC_VOLD,           KC_P4,  KC_P5,    KC_P6,   KC_PPLS, KC_PMNS, KC_NO,
      KC_NO, KC_NO,  KC_PGDN,  KC_PSCR, KC_END,  KC_MUTE,           KC_P1,  KC_P2,    KC_P3,   KC_NO,   KC_NUM,  KC_NO,
                               KC_TRNS, KC_TRNS, KC_TRNS,           MO(3),  KC_P0,    KC_PDOT
  ),
