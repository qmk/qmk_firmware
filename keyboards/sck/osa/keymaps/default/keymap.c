...
/* Keymap BASE: (Base Layer) Default Layer
   * .--------.,----------------------------------------------------------------------.
   * |UG_TOGG || ~ | 1 |  2|  3|  4|  5|  6|          |  7|  8|  9|  0|  -|  =|Backsp |
   * |--------||----------------------------------------------------------------------|
   * |UG_NEXT ||Tab  |  Q|  W|  E|  R|  T|          |  Y|  U|  I|  O|  P| [ | ] |  \  |
   * |--------||----------------------------------------------------------------------|
   * |UG_PREV ||Ctrl   |  A|  S|  D|  F|  G|          |  H|  J|  K|  L|  ;|  '|Return |
   * `--------'|----------------------------------------------------------------------|
   *           |Shift   |  Z|  X|  C|  V|  B|     |  B|  N|  M|  ,|  .|  /|Shift      |
   *           |----------------------------------------------------------------------|
   *           |CAPS|    | Alt | Space | Fn |     | Space | Alt |               | Ctrl|
   ...
   */
	...
	UG_TOGG,   RGB_M_T,  UG_VALU,    UG_VALD,    KC_3,    KC_4,   KC_5,   KC_6,              KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,           KC_BSPC,
	UG_NEXT,   KC_TAB,   KC_Q,       KC_W,       KC_E,    KC_R,   KC_T,    					 KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
	UG_PREV,   KC_LCTL,  KC_A,       KC_S,       KC_D,    KC_F,   KC_G,    					 KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
	           KC_LSFT,  KC_Z,       KC_X,       KC_C,    KC_V,   KC_B,	                     KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,
