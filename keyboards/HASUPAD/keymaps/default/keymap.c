...
/*  原装 LOGO
    [0] = LAYOUT(RGB_TOG, RGB_MOD, KC_KP_9, KC_PMNS, 
				 ...
				 KC_P1, KC_P2, KC_P3, KC_NUMLOCK, 
				 KC_P0, KC_PDOT, KC_PENT, MO(1),
				  KC_1, KC_2, _______, _______),
    [1] = LAYOUT(RGB_TOG, RGB_MOD, RGB_M_K, RGB_M_X, 
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_hasu_5x4(KC_KP_7, KC_KP_8, KC_KP_9, MO(1), KC_KP_PLUS,KC_P6,KC_P5,KC_P4, KC_P7, KC_P2, KC_P3, KC_KP_MINUS, KC_KP_ENTER,KC_DELETE, KC_PDOT,KC_P0, KC_PGUP, KC_PGDOWN, _______, _______),
