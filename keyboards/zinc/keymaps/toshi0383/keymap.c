...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { \
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Tab  |   A  |   S  |   D  |   F  |   G  |             |   H  |   J  |   K  |   L  |Shift |  CG  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |Space |   Z  |   X  |   C  |   V  |   B  |             |   N  |   M  | Ctrl | GUI  | Alt  |  SG  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
  ...
  [_QWERTY] = LAYOUT_ortho_4x12(
   ...
   KC_TAB, KC_A,  KC_S,  KC_D,  KC_F,  KC_G,             KC_H,  KC_J,  KC_K, KC_L,   KC_RSFT, RGUI(KC_RCTL), \
   ...
   */
    [_LOWER] =  LAYOUT_ortho_4x12( \
      ...
      _______, KC_LT, KC_GT, KC_LPRN, KC_RPRN, KC_GRV,       KC_MINS, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_QUOT, \
      _______, _______, KC_COLN, KC_SCLN, KC_PIPE, KC_QUES,  KC_UNDS, KC_PLUS, KC_EQUAL, KC_DOT, KC_SLSH, KC_DQT, \
