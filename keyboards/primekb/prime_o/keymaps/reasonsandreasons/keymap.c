...
#define TDSE KC_SPC //TD(TD_SPC_ENT)
 ...
 */
  ...
  [0] = LAYOUT(
    ...
    ALLM,     KC_LCTL,  KC_LALT,  KC_LGUI,  L1BS,  L1BS,  TDSE,  TDSE,  KC_RGUI,  KC_RALT,  CTLL,     KC_DOWN,  KC_RIGHT,  KC_0,     KC_PDOT,  KC_ENT
  ),
 ...
 */
	...
	[2] = LAYOUT(
    KC_F1,   KC_F2,   KC_F3,   KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,  ______,  ______,  ______,  ______,
    ______,  ______,  ______,  KC_HASH,  KC_LBRC,  KC_LT,    KC_GT,    KC_RBRC,  KC_UNDS,  KC_PIPE,  ______,   ______,  ______,  ______,  ______,  ______,
    ______,  ______,  ______,  KC_TILD,  KC_LPRN,  KC_LCBR,  KC_RCBR,  KC_RPRN,  KC_AT,    KC_MINS,  ______,   ______,  ______,  ______,  ______,  ______,
    ______,  ______,  ______,  ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,  ______,  ______,  ______,  ______,
    ______,  ______,  ______,  ______,   ______,   ______,   KC_ENT,   KC_ENT,   ______,   ______,   ______,   ______,  ______,  ______,  ______,  ______
  ),
 ...
 */
	...
	[3] = LAYOUT(
    ______,  ______,   ______,   ______,   ______,  ______,  ______,  ______,       ______,     ______,    ______,  ______,  ______,  ______,  ______,   ______,
    ______,  KC_PGUP,  KC_HOME,  KC_UP,    KC_END,  ______,  ______,  KC__VOLDOWN,  KC__VOLUP,  KC__MUTE,  ______,  ______,  ______,  ______,  ______,   ______,
    ______,  KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RGHT, ______,  ______,  KC_MPLY,      KC_MRWD,    KC_MFFD,   ______,  ______,  ______,  ______,  ______,   RESET,
    ______,  ______,   ______,   ______,   ______,  ______,  ______,  ______,       ______,     ______,    ______,  ______,  ______,  ______,  ______,   BL_TOGG,
    DF(1),   ______,   ______,   ______,   ______,  ______,  ______,  ______,       ______,     ______,    ______,  ______,  ______,  ______,  BL_STEP,  BL_TOGG
  ),
