...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    LCTRL(LALT(KC_DEL)),        KC_1,   KC_2,   KC_3,   KC_4,     KC_5,   KC_END,  KC_PGDN,  KC_PGUP,  KC_HOME,  KC_6,   KC_7,     KC_8,   KC_9,   KC_0,   KC_DEL,
    ...
    MT_WSFT_CAPS,   KC_LGUI,KC_LALT,LGUI(KC_TAB),MO(_LOWER),LT_NBSP,KC_LEFT, KC_DOWN,  KC_UP,    KC_RIGHT, KC_SPC, MO(RAISE),LCTL(KC_LALT),  KC_RALT,KC_RGUI,LCTL(KC_LSFT)
  ),
  ...
  [NAV] = LAYOUT(
    ...
    _______,_______,_______,LSFT(KC_HOME),LSFT(KC_END),_______,_______,_______,_______,_______,      KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,LALT(KC_LEFT),LALT(KC_RIGHT),
    _______,_______,_______,_______,_______,LCTL(KC_LEFT),_______,_______,_______,_______,LCTL(LSFT(KC_LEFT)),_______,_______,LCTL(LSFT(KC_RIGHT)),_______,_______,
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,      _______,_______,_______,_______,_______,_______
  ),
};
