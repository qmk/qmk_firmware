...
[0] = LAYOUT_tkl_ansi_tsangan_split_bs_rshift(
  ...
  KC_TAB,        KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,       KC_Y,      KC_U,      KC_I,      KC_O,       KC_P,         KC_LBRC,  KC_RBRC,          KC_BACKSLASH,       		 KC_DELETE ,       KC_END,            KC_PAGE_DOWN,
  KC_CAPS_LOCK,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,       KC_H,      KC_J,      KC_K,      KC_L,       KC_SEMICOLON, KC_QUOTE,                   KC_ENTER,  
  KC_LSFT,                 KC_Z,     KC_X,     KC_C,     KC_V,       KC_B,      KC_N,      KC_M,      KC_COMMA,   KC_DOT,       KC_SLSH,  KC_RIGHT_SHIFT,   MO(1),            		                       KC_UP,
