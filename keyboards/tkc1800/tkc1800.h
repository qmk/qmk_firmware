...
/***************************************************************************
** If someone more knowledgeable than me wants to split this layout into  **
** its variants, here's some matrix info I was able to work out by        **
** comparing the default keymap to the key matrix below. I'm 95% sure     **
** everything listed is accurate.                                         **
**                                                                        **
**                                                          - noroadsleft **
**                                                           May 16, 2018 **
** ---------------------------------------------------------------------- **
**                       ANSI Enter  K4D                                  **
**                        ISO Enter  K4D (remove K3D)                     **
**                  ANSI Left Shift  K50                                  **
**                   ISO Left Shift  K50                                  **
**       ISO Non-US Backslash (\ |)  K51                                  **
**            ISO Non-US Hash (# ~)  K4C                                  **
**                     2u Backspace  K2D                                  **
**                  Split Backspace  K2D (left), K2E (right)              **
**                   2u Numpad Plus  K3I (top), K4I (bottom)              **
**                Split Numpad Plus  K3I (top), K4I (bottom)              **
**                  2u Numpad Enter  K6I                                  **
**               Split Numpad Enter  K5I (top), K6I (bottom)              **
***************************************************************************/
