...
/*
 * Same as the LAYOUT_all macro for non-hotswap boards but with the ENTER (K093) and \| (K084) keys
 * switched.
 */
#define LAYOUT_all( \
  ...
  K030, K031, K032, K033, K034, K035, K036, K037, K038, K098, K097, K095, K094,       K093, K096, K092, K091, K090, \
...
/*
 * The layout macro for YMDK layout B with illustrative grid of a typical assignment.
 * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┐
...
#define LAYOUT_b( \
  ...
  K000, K001, K002,                   K006,                   K008, /***/ K005, K004, K003, K066, K062, K061, K060  \
) { \
...
/*
 * The layout macro for 96_ansi (YMDK layout C) with illustrative grid of a typical assignment.
 * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┐
 * │Esc│F1 │F2 │F3 │F4 │F5 │F6 │F7 │F8 │F9 │F10│F11│F12│PSc│Scr│Pse│Vo-│Vo+│Mut│
 * ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┴───┼───┼───┼───┼───┤
 * │ ` │ 1 │ 2 │ 3 │ 4 │ 5 │ 6 │ 7 │ 8 │ 9 │ 0 │ - │ = │ Backsp│Num│ / │ * │ - │
