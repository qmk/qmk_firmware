 ...
 */
    ...
    const uint8_t LED_LIST_NUMPAD[] = { // Numpad for the _NUM layer
        LED_7, LED_8, LED_9,
        LED_U, LED_I, LED_O,
        LED_J, LED_K, LED_L,
    ...
    const uint8_t LED_LIST_NUMPAD_ACTIONS[] = { // Numpad actions (*, +, -, etc) for the _NUM layer
        LED_MINS, LED_EQL,
        LED_P,
        LED_QUOT, LED_ENT,
        LED_RSFT
    ...
    const uint8_t LED_LIST_NUM_OTHERS[] = { // Other stuff for the _NUM layer
        LED_Q, LED_W, LED_E, LED_R,        LED_Y,
        LED_A, LED_S, LED_D, LED_D,
               LED_X, LED_C,
                                           LED_SPC
    };
