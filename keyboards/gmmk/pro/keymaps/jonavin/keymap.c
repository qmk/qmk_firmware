...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_FN1] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SCLN, KC_PAUS, _______, _______, _______, RESET,            _______,
        KC_CAPS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          KC_HOME,
        _______,          _______, _______, _______, _______, KC_NLCK, _______, _______, _______, _______, _______,          _______, _______, KC_END,
    ...
    [_MO2] = LAYOUT(
        ...
        _______, KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______, KC_TAB,  KC_P4,   KC_P5,   KC_P6,   KC_PDOT, _______, _______, _______,          _______,
        _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_NO,   KC_PAST,          KC_PENT,           KC_HOME,
        _______,          KC_NO,   KC_DEL,  KC_INS,  KC_NO,   KC_NO,   KC_NLCK, KC_P0, DOUBLEZERO, KC_PDOT, KC_PSLS,         _______, RCTL(KC_PGUP), KC_END,
