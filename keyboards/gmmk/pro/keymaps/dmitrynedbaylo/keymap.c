...
enum custom_keycodes {
    ...
    STR_UKR_I,              // 
    STR_URK_II,             //
    GT_FOOD,                // GTA: Food menu 
    GT_ARMS,       
    GT_LSTR,                // GTA: Call Lester
    GT_MECH,                // GTA: Call Mechanic
};
...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            LCTL_T(KC_SPC),                     MO(2),   KC_RALT, MO(3),   KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [2] = LAYOUT(
        ...
        _______, _______, KC_HOME, KC_END,  _______, _______, _______, _______, _______, _______, _______, _______, _______, RESET,            _______,
        _______, _______, _______, _______, DF(6),   DF(4),   _______, _______, _______, _______, _______, _______,          _______,          _______,
    ...
    [4] = LAYOUT(
        ...
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_UP,   KC_END,
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             MO(5),   KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [5] = LAYOUT(
        ...
        _______, _______, _______, KC_DEL,  _______, DF(0),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,          _______,          _______,
        _______,          _______, STR_TLD, STR_GRV, _______, _______, KC_MNXT, _______, _______, _______, _______,          _______, _______, _______,
        _______, _______, _______,                            _______,                            _______, _______, _______, _______, _______, _______
    ),
    ...
    // GTA layout
    [6] = LAYOUT(
        KC_ESC,  GT_FOOD, GT_ARMS, GT_LSTR, GT_MECH, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_LOCK,          KC_MUTE,
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,          KC_HOME,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,          KC_PGUP,
        ...
        KC_LCTL, KC_LCTL, KC_LSFT,                            KC_SPC,                             MO(7),   KC_LALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case GT_LSTR:
        if (record->event.pressed) {
            SEND_STRING(
                SS_DOWN(X_UP)SS_DELAY(50)SS_UP(X_UP)SS_DELAY(1500)
                SS_DOWN(X_RGHT)SS_DELAY(50)SS_UP(X_RGHT)SS_DELAY(100)
                SS_DOWN(X_UP)SS_DELAY(50)SS_UP(X_UP)SS_DELAY(100)
                SS_DOWN(X_ENT)SS_DELAY(50)SS_UP(X_ENT)SS_DELAY(1300)
                SS_DOWN(X_LEFT)SS_DELAY(50)SS_UP(X_LEFT)SS_DELAY(100)
                SS_DOWN(X_LEFT)SS_DELAY(50)SS_UP(X_LEFT)SS_DELAY(100)
                SS_DOWN(X_LEFT)SS_DELAY(50)SS_UP(X_LEFT)SS_DELAY(100)
            );
        }
    ...
    case GT_FOOD:
        if (record->event.pressed) {
            SEND_STRING(
                SS_DOWN(X_M)SS_DELAY(50)SS_UP(X_M)SS_DELAY(500)
                SS_DOWN(X_DOWN)SS_DELAY(50)SS_UP(X_DOWN)SS_DELAY(100)
                SS_DOWN(X_DOWN)SS_DELAY(50)SS_UP(X_DOWN)SS_DELAY(100)
                SS_DOWN(X_DOWN)SS_DELAY(50)SS_UP(X_DOWN)SS_DELAY(100)
                SS_DOWN(X_DOWN)SS_DELAY(50)SS_UP(X_DOWN)SS_DELAY(100)
                SS_DOWN(X_DOWN)SS_DELAY(50)SS_UP(X_DOWN)SS_DELAY(100)
                SS_DOWN(X_ENT)SS_DELAY(50)SS_UP(X_ENT)SS_DELAY(500)
                SS_DOWN(X_DOWN)SS_DELAY(50)SS_UP(X_DOWN)SS_DELAY(100)
                SS_DOWN(X_DOWN)SS_DELAY(50)SS_UP(X_DOWN)SS_DELAY(100)
                SS_DOWN(X_ENT)SS_DELAY(50)SS_UP(X_ENT)
            );
        }
        break;
    case GT_ARMS:
