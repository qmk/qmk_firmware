...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, KC_MO(1), KC_APP, KC_LEFT, KC_DOWN, KC_RGHT
    )
    ...
    [1] = LAYOUT(
        ...
        KC_TRNS,             KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_MPRV,   KC_MNXT,  KC_TRNS,           KC_TRNS, KC_TRNS, KC_TRNS,
