...
const aw20216s_led_t PROGMEM g_aw20216s_leds[AW20216S_LED_COUNT] = {
    ...
    {0, SW4_CS16, SW4_CS17, SW4_CS18},     // 58 (\)
    {0, SW2_CS13, SW2_CS14, SW2_CS15},     // 59 Z
    {0, SW3_CS13, SW3_CS14, SW3_CS15},     // 60 X
    {0, SW4_CS13, SW4_CS14, SW4_CS15},     // 61 C
    {0, SW5_CS13, SW5_CS14, SW5_CS15},     // 62 V
    {0, SW6_CS13, SW6_CS14, SW6_CS15},     // 63 B
    {0, SW7_CS13, SW7_CS14, SW7_CS15},     // 64 N
    {0, SW8_CS13, SW8_CS14, SW8_CS15},     // 65 M
    {0, SW9_CS13, SW9_CS14, SW9_CS15},     // 66 ,
    {0, SW10_CS13, SW10_CS14, SW10_CS15},  // 67 .
    {0, SW11_CS13, SW11_CS14, SW11_CS15},  // 68 /
    {1, SW8_CS4, SW8_CS5, SW8_CS6},        // 69 R_SHIFT
    {1, SW9_CS4, SW9_CS5, SW9_CS6},        // 70 UP
    {1, SW2_CS1, SW2_CS2, SW2_CS3},        // 71 End

    {0, SW1_CS16, SW1_CS17, SW1_CS18},     // 72 L_CTRL
    {0, SW2_CS16, SW2_CS17, SW2_CS18},     // 73 L_WIN
    {0, SW3_CS16, SW3_CS17, SW3_CS18},     // 74 L_ALT
    {0, SW6_CS16, SW6_CS17, SW6_CS18},     // 75 SPACE
    {0, SW9_CS16, SW9_CS17, SW9_CS18},     // 76 R_ALT
    {0, SW10_CS16, SW10_CS17, SW10_CS18},  // 77 FN
    {1, SW10_CS4, SW10_CS5, SW10_CS6},     // 78 LEFT
    {1, SW11_CS4, SW11_CS5, SW11_CS6},     // 79 DOWN
    {1, SW5_CS10, SW5_CS11, SW5_CS12},     // 80 RIGHT

    {1, SW1_CS13, SW1_CS14, SW1_CS15},     // 81 SLED1
    {1, SW2_CS13, SW2_CS14, SW2_CS15},     // 82 SLED2
    {1, SW3_CS13, SW3_CS14, SW3_CS15},     // 83 SLED3
    {1, SW4_CS13, SW4_CS14, SW4_CS15},     // 84 SLED4
    {1, SW5_CS13, SW5_CS14, SW5_CS15},     // 85 SLED5
    {1, SW6_CS13, SW6_CS14, SW6_CS15},     // 86 SLED6
    {1, SW7_CS13, SW7_CS14, SW7_CS15},     // 87 SLED7
    {1, SW8_CS13, SW8_CS14, SW8_CS15},     // 88 SLED8
    {1, SW9_CS13, SW9_CS14, SW9_CS15},     // 89 SLED9
    {1, SW10_CS13, SW10_CS14, SW10_CS15},  // 90 SLED10

    {1, SW1_CS16, SW1_CS17, SW1_CS18},     // 91 SLED11
    {1, SW2_CS16, SW2_CS17, SW2_CS18},     // 92 SLED12
    {1, SW3_CS16, SW3_CS17, SW3_CS18},     // 93 SLED13
    {1, SW4_CS16, SW4_CS17, SW4_CS18},     // 94 SLED14
    {1, SW5_CS16, SW5_CS17, SW5_CS18},     // 95 SLED15
    {1, SW6_CS16, SW6_CS17, SW6_CS18},     // 96 SLED16
    {1, SW7_CS16, SW7_CS17, SW7_CS18},     // 97 SLED17
    {1, SW8_CS16, SW8_CS17, SW8_CS18},     // 98 SLED18
    {1, SW9_CS16, SW9_CS17, SW9_CS18},     // 99 SLED19
    {1, SW10_CS16, SW10_CS17, SW10_CS18},  // 100 SLED20

    {1, SW10_CS1, SW10_CS2, SW10_CS3},     // 101 LOGO
};
