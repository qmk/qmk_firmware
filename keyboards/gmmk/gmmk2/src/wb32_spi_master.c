...
static SPIConfig spiConfig = {false, NULL, 0, 0, 0, 0};
 ...
 void wb32_spi_init(void) {
    ...
    if (!is_initialised) {
        ...
        palSetPadMode(PAL_PORT(WB32_SPI_SCK_PIN), PAL_PAD(WB32_SPI_SCK_PIN), PAL_MODE_ALTERNATE(WB32_SPI_SCK_PAL_MODE) | PAL_OUTPUT_TYPE_PUSHPULL | PAL_OUTPUT_SPEED_HIGHEST | PAL_WB32_CURRENT_LEVEL3);
