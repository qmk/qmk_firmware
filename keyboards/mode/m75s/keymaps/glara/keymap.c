...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_iso(
        KC_ESC , KC_BRIGHTNESS_DOWN  , KC_BRIGHTNESS_UP  , KC_MISSION_CONTROL  , KC_LAUNCHPAD  ,          MO(1)  , KC_F6  , KC_MEDIA_PREV_TRACK  , KC_MEDIA_PLAY_PAUSE  , KC_MEDIA_NEXT_TRACK  , KC_KB_MUTE , KC_AUDIO_VOL_DOWN , KC_AUDIO_VOL_UP ,          KC_DEL ,
