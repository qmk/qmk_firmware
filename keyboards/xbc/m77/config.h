...
#define KJ_RGB_BLINK_INDEX_SPI              67
#define KJ_RGB_BLINK_INDEX_SPD              65
...
#define EECONFIG_RGBREC_USE_SIZE   (MATRIX_ROWS * MATRIX_COLS * 2)
#define EECONFIG_USER_DATA_SIZE    (EECONFIG_RGBREC_USE_SIZE + EECONFIG_CONFINFO_USE_SIZE)
#define CONFINFO_EECONFIG_ADDR     (uint32_t *)((uint32_t)EECONFIG_RGBREC_USE_SIZE)