...
[_QWERTY] = LAYOUT( \
  ...
  KC_ESC, RGB_TOG, KC_LALT, KC_LCTL,LOWER, KC_SPC, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_WINDOWS] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT , \
  KC_ESC ,RGB_TOG, KC_LGUI, KC_LALT,  LOWER,     KC_SPC,        RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_RAISE] = LAYOUT( \
  ...
  KC_ESC, RGB_TOG, KC_LALT, KC_LCTL, LOWER,     KC_SPC,         _______, TD(CT_media), KC_VOLD, KC_VOLU, KC_MFFD \
),
...
[_MOUSE] = LAYOUT(\
  KC_ESC,  KC_MS_BTN1, KC_MS_U, KC_MS_BTN2, KC_MS_WH_UP, _______, _______, _______, _______, _______, KC_PSCR, _______,\
  _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_MS_WH_DOWN, _______, _______, _______, _______, _______, _______, _______,\
  _______, KC_MS_ACCEL0, KC_MS_ACCEL1, KC_MS_ACCEL2, _______, _______, _______, _______, _______, _______, _______, _______,\
