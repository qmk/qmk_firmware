...
KEYMAP( \
	  KC_PSCR, KC_SLCK, KC_PAUS,       KC_F1,   KC_F2,   KC_F3,   KC_F4,   XXXXXXX, KC_F5,   KC_F6,   KC_F7,   KC_F8,   XXXXXXX, KC_F9,   KC_F10,  KC_F11,  KC_F12,        KC_VOLD, KC_MUTE, KC_VOLU, M_BACKL, \
	  KC_INS,  KC_HOME, KC_PGUP,       KC_ESC,  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_EQL,  KC_BSPC,       KC_NLCK, KC_PSLS, KC_PAST, KC_PMNS, \
	  KC_DEL,  KC_END,  KC_PGDN,       KC_TAB,  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_MINS, KC_BSLS,       KC_KP_7, KC_KP_8, KC_KP_9, KC_PPLS, \
	  XXXXXXX, XXXXXXX, XXXXXXX,       KC_CAPS, KC_BSPC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,        KC_KP_4, KC_KP_5, KC_KP_6, KC_PPLS, \
	  XXXXXXX, KC_UP,   XXXXXXX,       KC_LSFT, KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RSFT,       KC_KP_1, KC_KP_2, KC_KP_3, KC_PENT, \
	  KC_LEFT, KC_DOWN, KC_RGHT,       KC_LCTL, KC_LCTL, XXXXXXX, KC_LALT, KC_LGUI, XXXXXXX, KC_SPC,  KC_SPC,  XXXXXXX, OS_SHFT, KC_RALT, KC_APP,  KC_RCTL, KC_RCTL,       KC_KP_0, KC_KP_0, KC_PDOT, KC_PENT  \
)
