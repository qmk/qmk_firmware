...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|         |-------|--------+--------+--------+--------+---------+----------+-----------|    +--------+--------+---------|
       KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                     KC_Y,     KC_U,   KC_I,   KC_O,     KC_P,   KC_LBRC,   KC_RBRC,  KC_BSLASH,      KC_DEL, KC_END, KC_PGDOWN,
  //|--------+--------+--------+--------+--------+--------|                  |-------|--------+--------+--------+--------+---------+----------+-----------|    `---------------------------.
  ...
  [_MEDIA] = LAYOUT_split(
  //,--------------------------------------------------------------.                 ,--------------------------------------------------------------------.    ,---------------------------.
      TD(TD_GRAVE_ESC),  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,          KC_F7,   KC_F8,   KC_F9,  KC_F10,   KC_F11,    KC_F12,    XXXXXXX,       KC_MSEL, KC_MPLY, KC_VOLU,
  //|--------+--------+--------+--------+--------+--------+--------|         |-------|--------+--------+--------+--------+---------+----------+-----------|    +--------+--------+---------|
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,   XXXXXXX,     KC_EJCT, KC_MSTP, KC_VOLD,
  //|--------+--------+--------+--------+--------+--------|                  |-------|--------+--------+--------+--------+---------+----------+-----------|    `---------------------------.
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      XXXXXXX,
  //|-----------+--------+--------+--------+--------+--------+--------|              |--------+--------+--------+--------+--------+--------+--------------|             ,--------.
         KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,               XXXXXXX,               XXXXXXX,
