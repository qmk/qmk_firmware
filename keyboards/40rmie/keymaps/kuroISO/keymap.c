...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = KEYMAP(
		...
		KC_TRNS, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_SCLN, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_DQUO, KC_BSPC, KC_BSPC, KC_BSPC, 
	...
	[2] = KEYMAP(
		...
		KC_TRNS, KC_END,  KC_PGDN, KC_PGUP, KC_HOME, KC_COLN, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_TRNS, KC_DEL, KC_DEL, KC_DEL, 
