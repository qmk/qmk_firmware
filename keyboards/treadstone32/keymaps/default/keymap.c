...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
       KC_F6SF,    KC_F7,    KC_F8,    KC_F9,   KC_F10, KC_XXXXX, KC_XXXXX, KC_XXXXX,  KC_SCLN,  KC_QUOT,\
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
       KC_11CT,  KC_12AL,   KC_ESC,   KC_TAB, KC_KANJI,   KC_DEL, KC_XXXXX, KC_XXXXX, KC_XXXXX,   KC_GRV,\
  //`---------+---------+---------+---------+---------+---------+---------+---------+---------+---------'
                                              KC______,  KC_MLAD \
  //                                        `---------|---------'
  ),
