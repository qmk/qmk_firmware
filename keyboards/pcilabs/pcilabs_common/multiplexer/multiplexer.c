...
const mux_t mux_index[MUXES][MUX_CHANNELS] =
{
    ...
    {NC, NC, {3, 2}, {2, 3}, {3, 4}, {2, 4}, {3, 3}, {3, 5}, {1, 6}, {0, 5}, {2, 6}, {1, 5}, {0, 6}, {2, 5}, {1, 4}, {0, 4}},
    {NC, {3, 7}, {3, 6}, {2, 7}, {4, 5}, {3, 9}, {4, 4}, {3, 8}, {2, 9}, {0, 9}, {1, 9}, {0, 8}, {1, 7}, {2, 8}, {0, 7}, {1, 8}},
    {{4, 5}, {3, 10}, {4, 6}, {0, 10}, {4, 5}, {1, 13}, {3, 11}, {2, 12}, {0, 13}, {0, 12}, {1, 12}, {0, 11}, {2, 10}, {2, 11}, {1, 10}, {1, 11}}
};
