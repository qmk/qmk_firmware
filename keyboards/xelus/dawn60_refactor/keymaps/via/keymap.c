...
// This is the default layer. Pressing an empty keycode on another layer will take you here.
    [0] = LAYOUT_60_all(
        KC_ESC,  RGB_TOG, RGB_MOD, KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL , KC_BSLS, KC_DEL,
    ...
    [1] = LAYOUT_60_all(
        ...
        KC_TRNS, RGB_TOG, RGB_MOD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_RSFT, KC_PGUP, KC_TRNS,
