...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_2U_SPACE(
        ...
        MO(_LAYER2),   KC_LGUI, KC_LALT, XXXXXXX,       XXXXXXX, LT(_LAYER1, KC_SPC),                KC_LEFT, KC_RGHT, KC_DOWN
    ),
    ...
    [_LAYER1] = LAYOUT_2U_SPACE(
        ...
        _______, KC_LGUI, KC_LALT, XXXXXXX,          XXXXXXX, KC_SPC,                    KC_0, KC_PDOT, XXXXXXX
    ),
    ...
    [_LAYER2] = LAYOUT_2U_SPACE(
        ...
        _______, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, TOXIC
    ),
};
    ...
    switch (keycode) {
        case TOXIC:
            if (record->event.pressed) {
                // when keycode TOXIC is pressed
                SEND_STRING("40% TOXIC");
            } else {
                // when keycode TOXIC is released
            }
            break;
        case VAN:
            if (record->event.pressed) {
                // when keycode VAN is pressed
                SEND_STRING("C4N'T S4Y V4N");
            } else {
                // when keycode VAN is released
            }
            break;
    }
    return true;
