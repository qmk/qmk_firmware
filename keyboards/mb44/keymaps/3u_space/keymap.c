...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_3U_SPACE(
        ...
        MO(_LAYER2),   KC_LGUI, KC_LALT, LT(_LAYER1, KC_SPC),             LT(_LAYER3, KC_SPC),                KC_LEFT, KC_RGHT, KC_DOWN
    ),
    ...
    [_LAYER2] = LAYOUT_3U_SPACE(
        ...
        _______, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX,                   XXXXXXX, XXXXXXX, TOXIC
    ),
    ...
    [_LAYER3] = LAYOUT_3U_SPACE(
        ...
        KC_HYPR, XXXXXXX, XXXXXXX, XXXXXXX,                   _______,                   XXXXXXX, XXXXXXX, VAN
    ),
};
