...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_QWERTY_MAC] = LAYOUT_hhkb(
      KC_HOME,  KC_GESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_DEL,
      KC_PGUP,  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC,
      KC_PGDN,  CPS_CTL,  A_MOUSE, KC_S,    M_NAV_1, KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
      KC_END,   SFT_MSE,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  ADJ_M,
   ...
   [_MAC_NAV_1] = LAYOUT_hhkb(
      ...
      _______,  _______, _______, _______, _______, _______, M_B_WRD,  M_B_WRD, KC_HOME, KC_END,  _______, _______, _______, _______, _______,
   ...
   [_QWERTY_LINUX] = LAYOUT_hhkb(
      KC_HOME,  KC_GESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_DEL,
      KC_PGUP,  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC,
      KC_PGDN,  CPS_CTL,  A_MOUSE, KC_S,    L_NAV_1, KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
      KC_END,   SFT_MSE,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  ADJ_L,
   ...
   [_LINUX_NAV_1] = LAYOUT_hhkb(
      ...
      _______,  _______, _______, _______, _______, _______, L_B_WRD,  L_B_WRD, KC_HOME, KC_END,  _______, _______, _______, _______, _______,
                         _______, _______,          _______,                    _______,          _______, _______
    ),
   ...
   [_QWERTY_WIN] = LAYOUT_hhkb(
      KC_HOME,  KC_GESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_DEL,
      KC_PGUP,  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC,
      KC_PGDN,  CPS_CTL,  A_MOUSE, KC_S,    W_NAV_1, KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
      KC_END,   SFT_MSE,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  ADJ_W,
                          KC_LGUI, KC_LALT,          SPC_RSE,                   SPC_RSE,          KC_RALT, KC_RGUI
    ),
   ...
   [_WIN_NAV_1] = LAYOUT_hhkb(
      ...
      _______,  _______, _______, _______, _______, _______, W_B_WRD,  W_B_WRD, KC_HOME, KC_END,  _______, _______, _______, _______, _______,
                         _______, _______,          _______,                    _______,          _______, _______
    ),
   ...
   [_RAISE] = LAYOUT_hhkb(
      _______,  _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______,
      _______,  _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,  KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_UNDS, KC_PLUS, _______,
      _______,  KC_CAPS, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,
      _______,  _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______,
                         _______, _______,          _______,                    _______,          _______, _______
    ),

   [_ADJUST_MAC] = LAYOUT_hhkb(
      ...
      _______,  DF_MAC,  DF_LNX,  DF_WIN,  _______, _______, _______,  _______, _______, KC_MUTE, _______, _______, _______, KC_APFN, _______,
                         _______, _______,          KC_MPLY,                    KC_MPLY,          _______, _______
    ),

   [_ADJUST_LINUX] = LAYOUT_hhkb(
	  _______,  KC_GRV,  KC_WF1,  KC_WF2,  KC_WF3,  KC_WF4,  KC_WF5,   KC_WF6,  KC_WF7,  KC_WF8,  KC_WF9,  KC_WF10, KC_WF11, KC_WF12, _______, _______,
      _______,  RESET,   MAC_SWT, _______, WIN_SWT, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______,
      _______,  _______, DF_M_P,  DF_L_P,  DF_W_P,  _______, _______,  KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______, _______, _______, 
      _______,  DF_MAC,  DF_LNX,  DF_WIN,  _______, _______, _______,  _______, _______, KC_MUTE, _______, _______, _______, INV_AFN, _______,
                         _______, _______,          KC_MPLY,                    KC_MPLY,          _______, _______
    ),

   [_ADJUST_WIN] = LAYOUT_hhkb(
	  _______,  KC_GRV,  KC_WF1,  KC_WF2,  KC_WF3,  KC_WF4,  KC_WF5,   KC_WF6,  KC_WF7,  KC_WF8,  KC_WF9,  KC_WF10, KC_WF11, KC_WF12, _______, _______,
      _______,  RESET,   MAC_SWT, _______, WIN_SWT, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______,
      _______,  _______, DF_M_P,  DF_L_P,  DF_W_P,  _______, _______,  KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______, _______, _______, 
      _______,  DF_MAC,  DF_LNX,  DF_WIN,  _______, _______, _______,  _______, _______, KC_MUTE, _______, _______, _______, INV_AFN, _______,
   ...
   [_MOUSE] = LAYOUT_hhkb(
      ...
      _______,  _______, _______, _______, _______, _______, _______,  _______, KC_WH_U, KC_WH_D, _______, _______, _______, _______, _______,
   ...
   [_EX_MOUSE] = LAYOUT_hhkb(
      ...
      XXXXXXX,  TG_MSE,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, KC_WH_U, KC_WH_D, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                         XXXXXXX, XXXXXXX,          KC_BTN1,                    KC_BTN1,          XXXXXXX, XXXXXXX
    ),
