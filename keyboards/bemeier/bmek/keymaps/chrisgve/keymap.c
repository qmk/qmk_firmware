...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_ADJUST_MAC] = LAYOUT_hhkb(
      ...
      _______,  _______, DF_MAC,  DF_LNX,  DF_WIN,  _______, _______,  _______, _______, KC_MUTE, _______, _______, _______, KC_APFN, _______,
   ...
   [_ADJUST_LINUX] = LAYOUT_hhkb(
      ...
      _______,  RESET,   MAC_SWT, _______, WIN_SWT, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______,
      _______,  _______, DF_M_P,  DF_L_P,  DF_W_P,  _______, _______,  KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______, _______, _______, 
      _______,  _______, DF_MAC,  DF_LNX,  DF_WIN,  _______, _______,  _______, _______, KC_MUTE, _______, _______, _______, INV_AFN, _______,
                         _______, _______,          KC_MPLY,                    KC_MPLY,          _______, _______
    ),
