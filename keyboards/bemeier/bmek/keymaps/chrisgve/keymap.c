...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_QWERTY_MAC] = LAYOUT_hhkb(
      ...
      KC_PGUP,  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, CU_BSPC,
      KC_PGDN,  CPS_CTL,  A_MOUSE, KC_S,    M_NAV_1, M_F_NAV, KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
   ...
   [_MAC_NAV_1] = LAYOUT_hhkb(
      ...
      _______,  _______, _______, M_DEL,   _______, _______, M_B_WRD,  M_B_WRD, KC_HOME, KC_END,  _______, _______, _______, _______, _______,
   ...
   [_QWERTY_LINUX] = LAYOUT_hhkb(
      KC_HOME,  KC_ESC,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,
      KC_PGUP,  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, CU_BSPC,
      KC_PGDN,  CPS_CTL,  A_MOUSE, KC_S,    L_NAV_1, L_F_NAV, KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
   ...
   [_LINUX_NAV_1] = LAYOUT_hhkb(
      ...
      _______,  _______, _______, L_DEL,   _______, _______, L_B_WRD,  L_B_WRD, KC_HOME, KC_END,  _______, _______, _______, _______, _______,
                         _______, _______,          _______,                    _______,          _______, _______
    ),
   ...
   [_QWERTY_WIN] = LAYOUT_hhkb(
      KC_HOME,  KC_ESC,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,
      KC_PGUP,  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, CU_BSPC,
      KC_PGDN,  CPS_CTL,  A_MOUSE, KC_S,    W_NAV_1, W_F_NAV, KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
   ...
   [_WIN_NAV_1] = LAYOUT_hhkb(
      ...
      _______,  _______, _______, W_DEL,   _______, _______, W_B_WRD,  W_B_WRD, KC_HOME, KC_END,  _______, _______, _______, _______, _______,
                         _______, _______,          _______,                    _______,          _______, _______
    ),
