...
#define PRODUCT         m60 split

/* key matrix size */
#define MATRIX_ROWS 10 // Rows are doubled-up
#define MATRIX_COLS 6

#define MATRIX_COL_PINS { B5, B7, B8, A0, A7, B10 }
#define MATRIX_ROW_PINS { B11, B0, B1, A2, A3 }
#define MATRIX_COL_PINS_RIGHT { B14, A10, A15, B3, B4, B5 }
#define MATRIX_ROW_PINS_RIGHT { B1, B0, B10, B11, A7 }
