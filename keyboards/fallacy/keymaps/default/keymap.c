...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_default(
        ...
        KC_PGDN,    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B,                                 KC_RGUI, KC_N, KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(1), 
                    KC_LCTL,            KC_LALT, KC_SPC, KC_LGUI,                                   KC_SPC,     KC_RALT,                            KC_RCTL),

    [1] = LAYOUT_default(
                            RESET,    KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_F5, KC_F6,              KC_F7,   KC_F8,   KC_F9,   KC_F11,  KC_F12,  KC_TRNS,          KC_TRNS, 
