...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_all(
        ...
        S(KC_ESC), C(KC_F9),   KC_GRV, KC_1,  KC_2,  KC_3,  KC_4,  KC_5,  KC_6,  KC_7,  KC_8,  KC_9,  KC_0,  KC_MINS, KC_EQL,        KC_BSPC,  C(KC_F8),  KC_PGUP, KC_PGDN,  KC_ESC,  KC_NUM,  KC_PAST, KC_PSLS,
        ...
        KC_SCRL,   C(KC_F7),   KC_LCTRL,           KC_LALT,                         KC_SPC,                        KC_RALT,         KC_RCTRL,             KC_DOWN,           KC_P0,            KC_PDOT
    )
};
