...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    RGB_MOD, RGB_RMOD, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP, KC_RSFT , \
      KC_LCTL,  KC_LGUI,  KC_LALT, RGB_TOG, KC_CALC,    KC_SPC,   KC_SPC,  KC_SPC,  KC_SPC,   KC_RGUI,    KC_RCTL, KC_LEFT, KC_DOWN,   KC_RGHT \
      ),
