...
#define RGBLED_BREATHING_INTERVAL_DEFAULT 0
#define RGBLED_RAINBOW_MOOD_INTERVAL_COUNT 1
#define RGBLED_RAINBOW_MOOD_INTERVAL_DEFAULT 0
#define RGBLED_RAINBOW_SWIRL_INTERVAL_COUNT 1
#define RGBLED_RAINBOW_SWIRL_INTERVAL_DEFAULT 0
#define RGBLED_SNAKE_INTERVAL_COUNT 1
#define RGBLED_SNAKE_INTERVAL_DEFAULT 0
#define RGBLED_KNIGHT_INTERVAL_COUNT 1
#define RGBLED_KNIGHT_INTERVAL_DEFAULT 0
...
extern const uint16_t RGBLED_BREATHING_INTERVALS[RGBLED_BREATHING_INTERVAL_COUNT][4] PROGMEM; //modify for led_test
