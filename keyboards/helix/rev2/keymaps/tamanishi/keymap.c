...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Ctrl | Alt  | Lower| GUI  |Space |Space |Space |Space | GUI  | Raise|      |      |      |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST, KC_LCTRL, KC_LALT, LOWER,   KC_LGUI, KC_SPC,  KC_SPC,  KC_SPC,  KC_SPC,  KC_RGUI, RAISE,   _______, _______, _______ \
      ),
