...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Esc  | Alt  | GUI  |Lang1 |Lower |Space |Space |Raise |Lang2 | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, KC_LANG1,LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LANG2,KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |RGB Tg|RGB Md|Sat Dn|Sat Up|      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      |Hue Dn|Val Dn|Val Up|Hue Up|
   * `-------------------------------------------------------------------------------------------------'
   */
  [_ADJUST] =  KEYMAP( \
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG, RGB_MOD, RGB_SAD, RGB_SAI, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_HUD, RGB_VAD, RGB_VAI, RGB_HUI \
      )
};
