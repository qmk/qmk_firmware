...
KC_KP_EQUAL,    KC_7,           KC_8,           KC_9,            KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,  \
KC_KP_MINUS,    KC_4,           KC_5,           KC_6,            KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
KC_KP_PLUS,     KC_1,           KC_2,           KC_3,            KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,S(KC_NUHS),S(KC_NUBS),KC_HOME, KC_END, _______, \
KC_KP_SLASH,    KC_KP_ASTERISK, KC_KP_DOT,      KC_0,            _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
),
 ...
 */
[_FN] = LAYOUT_ss_6x12( \
KC_KP_EQUAL,    KC_7,           KC_8,           KC_9,           RESET  , RGB_TOG, RGB_MOD, RGB_HUI, RGB_VAI, RGB_VAD, RGB_SAI, RGB_SAD, _______,TERM_ON, TERM_OFF, KC_DEL,  \
KC_KP_MINUS,    KC_4,           KC_5,           KC_6,           _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, _______, _______, _______, _______, _______, \
KC_KP_PLUS,     KC_1,           KC_2,           KC_3,           _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  _______, _______, _______, _______, _______, \
