...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    _______,    KC_EQL ,    KC_7   ,    KC_8   ,    KC_9   ,    KC_BSPC,                    KC_CIRC,    KC_LBRC,    KC_RBRC,    KC_AT  ,    KC_EXLM,    KC_BSLS,
    _______,    KC_0   ,    KC_4   ,    KC_5   ,    KC_6   ,    KC_MINS,     KC_LEFT,       KC_UNDS,    KC_LPRN,    KC_RPRN,    KC_AMPR,    KC_QUOT,    _______,
    _______,    KC_NUHS,    KC_1   ,    KC_2   ,    KC_3   ,    KC_PPLS,     KC_RGHT,       KC_PAST,    KC_LCBR,    KC_RCBR,    KC_PERC,    KC_DLR ,    _______,
    ...
    _______,    RGB_TOG,    RGB_MOD,    RGB_RMOD,   RGB_VAI,    RGB_VAD,                    _______,    _______,    _______,    _______,    _______,    _______,
    KC_CAPS,    _______,    RGB_HUI,    RGB_HUD,    RGB_SAD,    RGB_SAI,    KC_VOLU,        _______,    _______,    _______,    _______,    _______,    _______,
