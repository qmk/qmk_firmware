...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    _______,    _______,    _______,    _______,    KC_BSLS,    KC_0,       KC_4,       KC_5,       KC_6,       KC_MINS,    KC_UNDS,    KC_LPRN,    KC_RPRN,    KC_AMPR,    KC_QUOT,    _______,
    _______,    _______,    _______,    _______,    KC_ENT ,    KC_PAST,    KC_1,       KC_2,       KC_3,       KC_PPLS,    LSFT(KC_3), KC_LCBR,    KC_RCBR,    KC_PERC,    KC_DLR ,    _______,
