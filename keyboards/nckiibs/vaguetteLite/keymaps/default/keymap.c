...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    _______,                KC_EQL ,    KC_7   ,    KC_8   ,    KC_9   ,    KC_BSPC,    KC_CIRC,    KC_LBRC,    KC_RBRC,    KC_AT  ,    KC_EXLM,    KC_BSLS,    _______,    _______,
    _______,                KC_0   ,    KC_4   ,    KC_5   ,    KC_6   ,    KC_MINS,    KC_UNDS,    KC_LPRN,    KC_RPRN,    KC_AMPR,    KC_QUOT,    _______,    _______,    _______,
    _______,    _______,    KC_1   ,    KC_2   ,    KC_3   ,    KC_MINS,    KC_PLUS,    _______,    KC_LCBR,    KC_RCBR,    _______,    _______,    _______,    _______,
