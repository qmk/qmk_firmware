...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_NO,      KC_LSFT,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT,    KC_SLSH,
    ...
    _______,                KC_EQL ,    KC_7   ,    KC_8   ,    KC_9   ,    KC_SLSH,    KC_CIRC,    KC_LBRC,    KC_RBRC,    KC_AT  ,    KC_EXLM,    KC_BSLS,    _______,    _______,
    KC_BSPC,                KC_0   ,    KC_4   ,    KC_5   ,    KC_6   ,    KC_MINS,    KC_UNDS,    KC_LPRN,    KC_RPRN,    KC_AMPR,    KC_QUOT,    _______,    _______,    _______,
    KC_ENT ,    KC_ENT ,    KC_PAST,    KC_1   ,    KC_2   ,    KC_3   ,    KC_PPLS,    LSFT(KC_3), KC_LCBR,    KC_RCBR,    _______,    _______,    _______,    _______,
    ...
    _______,                _______,    _______,    _______,    _______,    _______,    KC_LEFT,    KC_DOWN,    KC_UP,      KC_RGHT,    KC_DQT ,    _______,    _______,    _______,
    ...
    _______,                RGB_TOG,    RGB_MOD,    RGB_RMOD,   RGB_VAI,    RGB_VAD,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,
    KC_CAPS,                _______,    RGB_HUI,    RGB_HUD,    RGB_SAD,    RGB_SAI,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,
    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,
    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______
    )
};
