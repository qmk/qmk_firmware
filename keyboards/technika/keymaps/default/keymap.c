...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [1] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, ____ , 
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, ____ , 
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, ____ , 
        _______, _______, _______         , _______, _______, _______, _______, _______, _______, _______, _______, _______, ____ )
};
