...
* **Bootmagic reset**: Hold down the key at top left of the left half (0,0) and plug in the keyboard. With `EE_HANDS` configured, hold down the top right key on the right half.
