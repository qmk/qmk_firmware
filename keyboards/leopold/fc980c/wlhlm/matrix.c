...
static inline void KEY_ENABLE_on(void) {
    writePinLow(MATRIX_KEY_ENABLE_PIN);
}
static inline void KEY_ENABLE_off(void) {
    writePinHigh(MATRIX_KEY_ENABLE_PIN);
}
static inline void KEY_HYS_on(void) {
    writePinHigh(MATRIX_KEY_HYS_PIN);
}
static inline void KEY_HYS_off(void) {
    writePinLow(MATRIX_KEY_HYS_PIN);
}
