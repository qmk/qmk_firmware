...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                     KC_NO,   KC_NO,   KC_NO,   KC_MINS, KC_EQL,  KC_RBRC,
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_NO,   KC_NUHS,
  ...
  KC_TRNS,    KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,                              KC_NO,         KC_NO,         KC_NO,         KC_MINS,       KC_EQL,        KC_RBRC,
  KC_ESC,     KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,                              KC_LEFT,       KC_DOWN,       KC_UP,         KC_RGHT,       KC_NO,         KC_NUHS,
