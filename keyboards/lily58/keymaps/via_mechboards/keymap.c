...
[_RAISE] = LAYOUT(
  ...
  UG_TOGG, UG_HUEU, UG_SATU, UG_VALU, _______, _______,                     XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX,
  UG_NEXT, UG_HUED, UG_SATD, UG_VALD, _______, _______,   _______, _______, KC_PLUS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, _______,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
