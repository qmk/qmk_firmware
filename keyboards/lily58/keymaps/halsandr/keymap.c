...
[_LOWER] = LAYOUT(
  ...
  _______, UK_QUES, UK_EXLM, UK_LCBR, UK_RCBR, UK_DQUO,                   UK_4, UK_5, UK_6, UK_EQL,  UK_RABK, _______,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                     S(C(KC_LEFT)), S(KC_DOWN), S(KC_UP), S(C(KC_RGHT)), _______, _______,
  _______, _______, _______, _______, _______, _______,                     KC_LEFT,       KC_DOWN,    KC_UP,    KC_RGHT,       G(C(KC_LEFT)), G(C(KC_RIGHT)),
  _______, _______, _______, _______, _______, _______,  _______, _______,  C(KC_LEFT),    _______,    _______,  C(KC_RGHT),    _______, _______,
