 ...
 */
 ...
 [QWERTY] = LAYOUT( \
  ...
  KC_LCTRL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                       KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_PIPE, \
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,   KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                            MO(LOWER),KC_LGUI, KC_LALT, KC_SPC,   LT(MO(RAISE), KC_ENT),  KC_BSPC, KC_RGUI, MO(RAISE) \
),
/*
 LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 *                   `-------------------''-------'           '------''--------------------'
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, TAP_ANIM, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, RGB_MOD, RGB_HUI, RGB_SAD, RGB_VAD, RGB_RST, \
