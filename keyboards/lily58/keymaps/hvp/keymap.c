 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,     TD(TD1), TD(TD2), \
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, MT(MOD_LCTL,KC_LBRC),  MT(MOD_LALT,KC_RBRC),  KC_N,    KC_M,    KC_COMM, KC_DOT,  TD(TD3),  MT(MOD_RSFT,KC_ENT), \
                             KC_LALT, KC_LGUI, LOWER,MT(MOD_LSFT,KC_SPC),   LT(_RAISE,KC_ENTER),   KC_ENTER,   KC_BSPC, KC_RGUI \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT( \
  ...
  RESET, _______, _______, _______, _______, _______, _______, _______, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
 ...
 */
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,\
                             _______, _______, _______, _______, KC_MEDIA_PLAY_PAUSE,  _______, _______, _______ \
  )
};
