 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGui | Alt  |LOWER | /Space  /       \Enter \  |RAISE |BackSP|   \  |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `-------------------''-------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                      KC_LGUI,  KC_LALT, LOWER, KC_SPC,   KC_ENT,   RAISE, KC_BSPC,  KC_BSLS
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |   \  |
 ...
 * |      |      |      |      |      |      |-------|    |-------|   |  |   `  |   +  |   {  |   }  |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGui | Alt  |LOWER | /Space  /       \Enter \  |RAISE | DEL  | RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `-------------------''-------'           '------''--------------------'
 */
[_LOWER] = LAYOUT(
 ...
 */
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_HUI,                   RGB_SAI, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_HUD, RGB_RMOD, RGB_MOD, RGB_SAD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT,
                             _______, _______, _______, RGB_VAD, RGB_VAI,  _______, _______, _______
  )
};
