 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_NUBS,  KC_DEL,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
 ...
 * |LCTRL |  c+c |  c+v |  Up  | home | end  |-------.    ,-------|   /  |   1  |   2  |   3  |   <  |  >   |
 * |------+------+------+------+------+------|   Ê   |    |SUPPR  |------+------+------+------+------+------|
 * |LShift|  c+x | Left | Down | Right| VMAJ |-------|    |-------|   *  |   0  |   (  |   )  |   {  |   }  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | pscr | LGUI |LOWER | /Space  /       \Enter \  |RAISE |BackSP| AltGr|
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 */
  [_ADJUST] = LAYOUT(
  KC_NUHS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_NUHS, MT(KC_NUHS, KC_H), XXXXXXX, XXXXXXX, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD,
                             _______, _______, _______, _______, _______,  _______, _______, _______
  )
};
	...
	switch (keycode) {
        case MT(KC_CAPS, KC_ESC):
            if (!record->tap.count && record->event.pressed) {
                tap_code16(KC_CAPS); // Intercept hold function to send Ctrl-X
                return false;
            }
            return true;             // Return true for normal processing of tap keycode
        case MT(KC_NUHS, KC_H):
            if (!record->tap.count && record->event.pressed) {
                tap_code16(KC_NUHS); // Intercept hold function to send Ctrl-X
                return false;
            }
            return true;             // Return true for normal processing of tap keycode			
    }
