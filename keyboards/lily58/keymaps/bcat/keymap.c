...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_LOWER] = LAYOUT(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,                      KC_TILD,  KC_LCBR,  KC_RCBR,  KC_PIPE,  _______,  _______,
        _______,  _______,  KC_CAPS,  KC_PSCR,  KC_SLCK,  KC_PAUS,  _______,  _______,  KC_GRV,   KC_LBRC,  KC_RBRC,  KC_BSLS,  _______,  _______,
