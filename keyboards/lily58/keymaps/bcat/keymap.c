...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_LOWER] = LAYOUT(
        ...
        _______,  KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   _______,  _______,  KC_LCBR,  KC_RCBR,  KC_TILD,  KC_PIPE,  _______,  _______,
    ...
    [LAYER_RAISE] = LAYOUT(
        ...
        _______,  _______,  KC_CAPS,  KC_PSCR,  KC_SLCK,  KC_PAUS,  _______,  _______,  KC_LBRC,  KC_RBRC,  KC_GRV,   KC_BSLS,  KC_END,   KC_PGDN,
                                      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______
    ),
