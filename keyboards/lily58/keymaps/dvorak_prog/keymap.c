 ...
 */
 [_DWORAK] = LAYOUT(
  ...
  KC_LSFT,  KC_QUOTE,       KC_Q,       KC_J,       KC_K,    KC_X,  KC_DELETE,  KC_BACKSPACE,   KC_B,    KC_M,    KC_W,     KC_V,   KC_Z,   KC_RSFT,
                            KC_LALT,    KC_LGUI,    MO(_LOWER),     KC_SPC,     KC_ENT,         MO(_RAISE),     KC_BSPC, KC_RLALT
),
//================================================================================================================
...
[_RAISE] = LAYOUT(
  ...
  KC_QUOTE,  	_______, 	 _______,    	      KC_7,    		    KC_8,    	   KC_9,                        _______, _______, KC_UP,   _______,  _______, KC_CIRCUMFLEX,
  _______,  	_______,    	 _______,   	      KC_4,   		    KC_5,   	   KC_6,                       	_______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______,
  _______,   	_______,   	 KC_0,   	      KC_1,  		    KC_2,  	   KC_3,    _______,  _______, 	KC_PLUS, KC_MINS, KC_EQL,  KC_LBRC,  KC_RBRC, KC_BSLS,
