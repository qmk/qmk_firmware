...
enum custom_keycodes {
    ...
    KC_ESC_TOG,              // ESC ripple effect toggle
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case KC_ESC:
            ...
            return true; // Continue normal ESC processing
        ...
        case KC_ESC_TOG:
            if (record->event.pressed) {
                toggle_esc_ripple_effect();   // Toggle ESC ripple effect on/off
            }
            return false;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Function Layer */
    [FN] = LAYOUT(
        _______, _______, _______,  _______,  KC_NO  ,  KC_NO  , KC_NO  , _______,   _______, _______,   KC_ESC_TOG, _______, _______, _______,   _______, _______, _______, _______, _______, _______, _______,
        ...
        _______, _______, _______,  RM_VALU,  _______,  _______, KC_NO  , KC_CPSWRD, _______, _______,   _______,    _______, _______, _______,   _______, _______, _______, _______, _______, KC_NO  , _______,
        _______, _______, _______,  KC_NO  ,  KC_NO  ,  RM_HUEU, KC_NO  , _______,   _______, _______,   _______,    _______, _______, _______,   _______, _______, _______, _______, _______, _______, KC_NO  ,
