...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT( \
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   RGB_TOG, BL_ON  , KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL, \
      KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,   RGB_MOD, BL_STEP, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC, \
      ADJUST,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,   RGB_VAI,   RESET, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   RGB_VAD, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT , \
      KC_LCTL, KC_LGUI, KC_LALT, RGB_SAI, RGB_SAD, LOWER,  KC_SPC,  KC_SPC,  RAISE,   KANA,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, \
   ...
   */
  [_COLEMAK] = LAYOUT( \
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   RGB_TOG, RGB_TOG, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL, \
      KC_TAB,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,   RGB_MOD, RGB_MOD, KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_BSPC, \
   ...
   */
  [_DVORAK] = LAYOUT( \
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    RGB_TOG, RGB_TOG, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, _______, _______, AU_ON,   AU_OFF,  AG_NORM, _______, _______, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  _______, _______, \
