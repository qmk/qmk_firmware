...
// Define your non-alpha grouping in this define's LAYOUT, and all your BASE_LAYERS will share the same mod/macro columns
   ...
   * |Shift |      |      |      |      |      |   {  |  |   }  |      |      |      |      |      |Shift |
   * |------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
   * | Ctrl |  Win |  Alt | ADJ  | Win  | Space| Fn   |  | Enter| Space|  FN  | Left | Down | Up   |Right |
   * |------+------+------+------+------+------+------|  |------+------+------+------+------+------+------'
...
LAYOUT( \
      ...
      KC_LCTL, KC_LGUI, KC_LALT, ADJ,     KC_LGUI, KC_SPC, FN,       KC_ENT,  KC_SPC,  FN,      KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT, \
                        KC_VOLU, KC_VOLD,          KC_SPC, FN,       KC_ENT,  KC_SPC,           KC_VOLU, KC_VOLD \
)
