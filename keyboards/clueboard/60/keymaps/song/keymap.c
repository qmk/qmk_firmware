...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_BL] = KEYMAP(
      S_BSKTC,S_ODEJY,S_RCKBY,S_DOEDR,S_SCALE,S_ONEUP,S_COIN,S_SONIC,S_ZELDA,KC_9,  KC_0,   KC_MINS,KC_EQL, KC_GRV, KC_BSPC,\
      ...
      MU_ON,  MU_OFF,  MU_MOD,                        KC_SPC,                      KC_RALT,  KC_RGUI,  MO(_FL),   KC_RCTL),
    [_FL] = KEYMAP(
