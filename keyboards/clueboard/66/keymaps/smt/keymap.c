...
[_COLEMAK] = LAYOUT(
   ...
   */
[_DVORAK] = LAYOUT(
  QK_GESC, KC_1,    KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,    KC_0,     KC_LBRC,  KC_RBRC,  KC_BSLS, KC_GRV,           KC_PGUP,
...
[_FL] = LAYOUT(
  ...
  _______, _______, _______,_______,_______,_______,_______,_______,KC_PSCR,KC_SCRL, KC_PAUS,  _______,  _______,  KC_DEL,                    _______,
