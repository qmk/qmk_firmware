...
[_QWERTY] = LAYOUT_all(
   ...
   ADJUST,  KC_LCTL, KC_LALT, KC_LGUI, TL_LOWR, KC_SPC, KC_ENT,  KC_SPC,  TL_UPPR, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_COLEMAK] = LAYOUT_all(
  ...
  ADJUST,  KC_LCTL, KC_LALT, KC_LGUI, TL_LOWR, KC_SPC, _______,  KC_SPC,  TL_UPPR, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
