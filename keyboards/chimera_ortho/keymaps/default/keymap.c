...
#define KC_NMPE TG(_NUMPAD_ERGO)
#define KC_SYME TG(_SYMBOLS_ERGO)
#define KC_SPFE LT(_NAV_ERGO,KC_MINS)
#define KC_SWTC TG(_QWERTY_ERGO)
...
#define KC_MESE LT(_MACROS_ERGO, KC_ESC)
#define KC_INCL M(0)
#define KC_PULL M(1)
#define KC_PUSH M(2)
#define KC_SCAP M(3)
