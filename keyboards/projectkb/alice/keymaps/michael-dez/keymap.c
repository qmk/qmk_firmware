...
<<<<<<< HEAD
    ...
    DYN_REC_STOP,    LCTL_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,    KC_QUOT, KC_ENT,
                     ...
                     LCG_SWP,        KC_LALT,                   LT(1, KC_BSPC),  KC_LGUI,                      LT(2, KC_SPC),  KC_RALT,                        LCG_NRM),
	[1] = LAYOUT_alice_split_bs(
            ...
            DYN_REC_START2, KC_TRNS, KC_TRNS, LCTL(KC_RGHT), KC_TRNS, KC_TRNS, KC_TRNS,    KC_COPY, KC_PAGE_UP, KC_HOME, NEW_L, KC_PSTE, KC_TRNS, KC_TRNS, KC_TRNS,
            KC_TRNS, KC_TRNS, KC_END, KC_TRNS, KC_PAGE_DOWN, KC_TRNS, KC_TRNS,           KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS,
	...
	[2] = LAYOUT_alice_split_bs(
            ...
            KC_TRNS, KC_TRNS, KC_TRNS, RGB_VAI, RGB_VAD, RGB_SPI, RGB_SPD,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
...
>>>>>>> 3cf4ad53641f34d1da1089a9de0f07075b8f2220
