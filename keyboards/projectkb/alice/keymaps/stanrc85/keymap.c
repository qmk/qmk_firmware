...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_default(
    KC_ESC,  TD_TESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,   KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_DEL,  KC_BSPC,
  ...
  [_FN1_60] = LAYOUT_default(
    ...
    _______, _______,  _______, CA_QUOT, KC_VOLU, CA_SCLN, _______,          KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_PSCR, _______, _______,  KC_INS,
    _______, KC_CAPS,  _______, KC_MUTE, KC_VOLD, KC_MPLY, _______,          KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,          _______,
  ...
  [_FN2_60] = LAYOUT_default(
    _______,  RGB_TOG, RGB_MOD, RGB_VAD, RGB_VAI, RGB_SAI, RGB_HUD,  RGB_HUI, _______, _______, _______, _______, _______, _______, _______, _______,
