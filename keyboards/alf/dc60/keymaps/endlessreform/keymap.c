...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [PUNC] = LAYOUT_all(
      ...
      _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, KC_LPRN, KC_RPRN, KC_DOWN, KC_UP,   KC_RIGHT, _______, _______, _______,
      _______, KC_LSFT, _______, _______, BL_DEC,  BL_TOGG, TASK,  LCTL(LSFT(KC_LEFT)), _______, _______, LCTL(LSFT(KC_RIGHT)), _______, _______, _______, _______,
