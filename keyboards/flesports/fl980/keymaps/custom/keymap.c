...
tap_dance_action_t tap_dance_actions[] = {
  [0]  = ACTION_TAP_DANCE_DOUBLE(KC_HOME, KC_PGUP),
  [1]  = ACTION_TAP_DANCE_DOUBLE(KC_END, KC_PGDN),
};


const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_default(   KC_ESC,     KC_F1,      KC_F2,      KC_F3,   KC_F4,      KC_F5,   KC_F6,   KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12,                 TD(0),     TD(1),    KC_INS,     KC_PSCR,
                            ...
                            KC_LSFT,                KC_Z,       KC_X,    KC_C,       KC_V,    KC_B,    KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,                KC_RSFT,    KC_P1,     KC_P2,     KC_P3,      KC_PDOT,
                            KC_LCTL,    KC_LGUI,    KC_LALT,                                 KC_SPC,                                       KC_RALT,    MO(1),      KC_RCTL,    KC_UP,      KC_LEFT,   KC_DOWN,   KC_RIGHT,   KC_P0
        ),
    [1] = LAYOUT_default(   QK_BOOT,    KC_BRID,    KC_BRIU,    KC_TRNS, KC_TRNS,    KC_TRNS, KC_TRNS, KC_MPRV,    KC_MNXT,    KC_MPLY,    KC_MPLY,    KC_VOLD,    KC_VOLU,                KC_PGUP,    KC_PGDN,    KC_TRNS,    KC_TRNS,
                            QK_RBT,     KC_TRNS,    KC_TRNS,    KC_TRNS, KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    RGB_SPD,    RGB_SPI,    KC_TRNS,    KC_NUM,     KC_TRNS,    KC_TRNS,    EE_CLR,
