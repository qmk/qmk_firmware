...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  { XXXXXXX, KC_LALT, KC_LGUI, XXXXXXX,  XXXXXXX,  XXXXXXX, FNSPC,  XXXXXXX, XXXXXXX, MO(_FUNCTION),  MO(_ADJUST),   XXXXXXX }
},
[_QWERTYNUMMODS] = {
{  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  { _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  {  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  {XXXXXXX, _______, _______, XXXXXXX,  XXXXXXX,  XXXXXXX,_______, XXXXXXX, XXXXXXX, _______, _______, XXXXXXX }
},
[_NUMSYM] = {
...
{XXXXXXX, __MOD__, __MOD__, XXXXXXX,  XXXXXXX,  XXXXXXX, _______, XXXXXXX, XXXXXXX, __MOD__, __MOD__, XXXXXXX}
},
[_FUNCTION] = {
...
{XXXXXXX, _______, _______, XXXXXXX,  XXXXXXX,  XXXXXXX, _______, XXXXXXX, XXXXXXX, __MOD__, KC_PAUS, XXXXXXX }
},
[_ADJUST] = {
  ...
  {XXXXXXX, _______, _______,XXXXXXX,  XXXXXXX,  XXXXXXX, _______, XXXXXXX, XXXXXXX, __MOD__, __MOD__, XXXXXXX}
 }
};
