...
uint32_t processQwerty(bool lookup) {
	...
	P( MEDIA |LA  | LO  | RE  | RU,			SEND(KC_CAPS));
	P( MEDIA |LA  | LO  | RE  | RU,			SEND(KC_CAPS));
	P( MEDIA |LA  | LO  | RE  | RU,			SEND(KC_CAPS));
	P( MEDIA |LA  | LO  | RE  | RU,			SEND(KC_CAPS));
	P( MEDIA |LA  | LO  | RE  | RU,			SEND(KC_CAPS));
	...
	P( MEDIA |LA  | LO  | RE  | RU,			SEND(KC_CAPS));
	P( MEDIA |LA  | LO  | RE  | RU,			SEND(KC_CAPS));
	P( MEDIA |LA  | RU,						SEND(KC_ESC));
	P( MEDIA |LO  | RE,						SEND(KC_LCTL));
	P( MEDIA |LNO | RNO | LA | RU,				SEND(KC_LCTL); SEND(KC_LSFT));
	P( MEDIA |LNO | LA  | RE,					SEND(KC_LCTL); SEND(KC_LSFT); SEND(KC_LALT));
	P( MEDIA |LA  | LO  | RE  | RU,			SEND(KC_CAPS));
	P( MEDIA |LA  | RU,						SEND(KC_ESC));
	P( MEDIA |LO  | RE,						SEND(KC_LCTL));
	P( MEDIA |LNO | RNO | LA | RU,				SEND(KC_LCTL); SEND(KC_LSFT));
