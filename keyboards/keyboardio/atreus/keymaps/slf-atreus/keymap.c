...
const uint16_t PROGMEM escalt[] = {KC_LCTRL, KC_NO, COMBO_END};
combo_t key_combos[COMBO_COUNT] = {
    COMBO(escalt, KC_LALT), // keycodes with modifiers are possible too!
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_NUBS, KC_SLSH, KC_N, KC_M, KC_COMM, KC_DOT, KC_ENT, LCTL_T(KC_ESC), KC_NO, KC_LGUI, KC_LSFT, MO(1), KC_SPC, KC_SPC, MO(2), KC_LSFT, TD(QUOTS), KC_NO, LCTL_T(KC_TAB)),
