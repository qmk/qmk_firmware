...
#define LT_REISU LT(_RS, KC_LANG2) // Eisū (英数) on macOS
#define LT_LKANA LT(_LW, KC_LANG1) // Kana (かな) on macOS
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RS] = LAYOUT( /* [> RAISE <] */
            ...
            _______, _______, _______, _______, _______, SSC,     SL,      _______, KC_DEL,  _______, _______, RESET),
