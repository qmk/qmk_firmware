...
// https://github.com/qmk/qmk_firmware/pull/19102
#ifdef I2C_KEYSCAN_INTERVAL
#undef I2C_KEYSCAN_INTERVAL
#endif
#define I2C_KEYSCAN_INTERVAL 50  // default 2 on this board, which is bouncy AF
