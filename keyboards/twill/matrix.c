...
static bool read_cols_on_row(matrix_row_t current_matrix[], uint8_t current_row)
{
    ...
    for(uint8_t col_index = 0; col_index < MATRIX_COLS; col_index++) {
        ...
        switch (col_index) {
            ...
            case 2 :
                i2c_readReg((PORT_EXPANDER_ADDRESS << 1), 0x09, &pin_state, 1, 20);
                pin_state = pin_state & (1 << 6); // Shifting 5 to the left to get us to I/O pin 6 as per modified schematic
                break;
            case 7 :
                i2c_readReg((PORT_EXPANDER_ADDRESS << 1), 0x09, &pin_state, 1, 20);
                pin_state = pin_state & (1 << 5); // Shifting 5 to the left to get us to I/O pin 6 as per modified schematic
                break;
            case 12 :
                i2c_readReg((PORT_EXPANDER_ADDRESS << 1), 0x09, &pin_state, 1, 20);
