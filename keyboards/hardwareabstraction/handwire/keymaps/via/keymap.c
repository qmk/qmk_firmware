...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_60_ansi_arrow(
        ...
        _______,  _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,  KC_BZDWLD, KC_BZDWLI,  KC_BZTOG,
        _______,   _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_HPTDWLD, KC_HPTDWLI,          KC_HPTTOG,
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,   _______,     _______,    _______,      _______,
        _______, _______, _______,                                 _______,                           _______,     _______,     _______,     _______,     KC_TRNS
    ),
};
