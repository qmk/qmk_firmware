...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 // 0: Base Layer
	[0] = LAYOUT(
	   ...
	   KC_LSFT , KC_Z    , KC_X    , KC_C , KC_V , KC_B , KC_N , KC_M , KC_COMM , KC_DOT , KC_SLSH , KC_RSFT , KC_UP   , FN_MO23 ,\
	   KC_LCTL , KC_LGUI , KC_LALT ,                        KC_SPC  ,             KC_RALT, FN_MO13   , KC_LEFT , KC_DOWN , KC_RGHT ),
  // 1: Function Layer
	[1] = LAYOUT(
	   ...
	   KC_NO  , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO , KC_PGUP , KC_PGDN , KC_END , KC_NO  , KC_NO, KC_NO ,\
  ...
  // 2: Function Layer
	[2] = LAYOUT(
	   ...
	   KC_NO  , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO    , KC_NO    , KC_NO   , RGB_MOD   , RGB_RMOD  , RGB_M_R  , KC_NO   , RGB_VAI	  , KC_NO ,\
  ...
  // 3: Function Layer
	[3] = LAYOUT(
	   ...
	   KC_NO  , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO , KC_MPRV , KC_MNXT , KC_MPLY   , KC_NO  , KC_NO ,\
	   KC_NO  , KC_NO , KC_NO ,KC_NO  , KC_NO , KC_NO , KC_MUTE , KC_NO , KC_MPLY  ),
