...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_BASE] = LAYOUT_arrow(
      ...
      TD(TD_SFT_CPS), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_UP, KC_DOT,   KC_SLSH,
      KC_LCTL, KC_LGUI, KC_LALT, SPC_LOW, KC_SPC,  TD(KC_LFT_NUM_F), KC_DOWN, KC_RIGHT, MO(_FKEY)
    ),
