...
This file details the compile version `#define BASES_QWERTY_DVORAK` which has a
Qwerty layout on the default (on startup), which can be switched to Dvorak.

To switch to Dvorak: go to the `_RAR` layer, and hit what is spacebar on the BASE
layer. To return to Qwerty, do the same. Notice LED colors indicating layer.
...
![Minivan layout Image BASEalt](http://socialism.nl/misc/minivan/minivan_base_layer_dvorak_va.jpg)
Layer: `ALT_BASE`

![Minivan layout Image BASEalt](http://socialism.nl/misc/minivan/minivan_nsy_layer_dvorak_va.jpg)
Layer: `ALT_NSY`
...
![Minivan layout Image associations](http://socialism.nl/misc/minivan/minivan-relationships_qwertydvorak_1500_va.jpg)

Key placement associations between layers for Dvorak.

![Minivan layout Image associations](http://socialism.nl/misc/minivan/minivan-relationships_dvorakqwerty_1500_va.jpg)
