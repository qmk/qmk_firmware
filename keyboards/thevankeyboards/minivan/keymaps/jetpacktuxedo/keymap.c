...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_arrow_command( /* Qwerty */
    MT(KC_TAB, KC_ESC),       KC_Q,    KC_W,    KC_E,  KC_R, KC_T,    KC_Y,   KC_U,  KC_I,    KC_O,    KC_P,    KC_BSPC,
    LT(2,KC_BSPC), KC_A,    KC_S,    KC_D,  KC_F, KC_G,    KC_H,   KC_J,  KC_K,    KC_L,    TD_COL, LT(2, KC_ENT),
    KC_LSPO,       KC_Z,    KC_X,    KC_C,  KC_V, KC_B,    KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH,   KC_RSPC,
    KC_LCTL, MO(4),       KC_LGUI, KC_LALT, LT(1, KC_SPC), LT(1, KC_SPC), KC_RGUI, KC_RALT, MO(3), KC_RCTRL
  ),
