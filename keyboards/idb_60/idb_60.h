...
inline void _idb_60_caps_led_on(void)      { DDRC |=  (1<<5); PORTC &= ~(1<<5); }
inline void _idb_60_esc_led_on(void)    	{ DDRC |=  (1<<4); PORTC &= ~(1<<4); }

inline void _idb_60_caps_led_off(void)     { DDRC &= ~(1<<5); PORTC &= ~(1<<5); }
inline void _idb_60_esc_led_off(void)   	{ DDRC &= ~(1<<4); PORTC &= ~(1<<4); }
