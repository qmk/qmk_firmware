...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QW] = LAYOUT_60_ansi_split_rshift( /* Layer 0: Qwerty */
   ...
   * `-----------------------------------------------------------'
   */
  [_FL] = LAYOUT_60_ansi_split_rshift( /* Layer 1: Functions */
    ...
    KC_CAPS    , KC_MS_LEFT ,KC_MS_DOWN ,KC_MS_RIGHT, KC_MS_WH_DOWN, _______, _______, _______, _______, _______, _______ , _______,            KC_TILDE,
    _______    ,              _______   , _______   , _______      , _______, _______, _______, _______, _______, _______ , _______, KC_PGUP  , _______, 
    _______    , _______    , _______   ,                            _______,                                     KC_RCTRL, KC_HOME, KC_PGDOWN, KC_END
  ),
   ...
   */
  [_MC] = LAYOUT_60_ansi_split_rshift( /* Layer 2: Macros (Git & Multimedia) */
    ...
    XXXXXXX,          XXXXXXX, XXXXXXX, G_COM  , XXXXXXX, G_BRN  , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, A_MUTE , A_PLPA , A_VOUP,
