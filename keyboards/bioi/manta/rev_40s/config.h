...
#define BLE_NAME "BIOI MANTA 40s BLE"
#define BIOI_MANTA
#define NO_BAT_LEVEL

#define USB_POLLING_INTERVAL_MS 1

#define MATRIX_ROW_PINS { B0, D0, F7, B6 }
#define MATRIX_COL_PINS { F5, F4, F1, F0, C7, D5, D1, D4, D6, B1, B2, B3, D7, B4 }

#define LED_CAPS_LOCK_PIN F6
#define BLE_CONTROL_PIN E6
#define RGB_UG_CONTROL_PIN E2
