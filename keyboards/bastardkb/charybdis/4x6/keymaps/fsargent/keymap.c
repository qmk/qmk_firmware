...
//  qmk flash -kb bastardkb/charybdis/4x6/v1/elitec -km fsargent
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	MT(MOD_MEH,KC_ESC),	LGUI_T(KC_A),	LALT_T(KC_S),	LCTL_T(KC_D),	LSFT_T(KC_F),		KC_G,					KC_H,		LSFT_T(KC_J),	LCTL_T(KC_K),	LALT_T(KC_L),	LGUI_T(KC_SCLN),	KC_QUOT,
