...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //_______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _________________FUNCPAD_L1________________, _________________CONFIG_R1_________________,
    _________________FUNCPAD_L2________________, _________________CONFIG_R2_________________,
    _________________FUNCPAD_L3________________, _________________CONFIG_R3_________________,
