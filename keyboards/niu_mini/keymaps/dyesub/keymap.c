...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_planck_mit(
        ...
        _______, ______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, ______, _______, _______, _______,     _______,      _______, _______, _______, _______, RESET
    ),
