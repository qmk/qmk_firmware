...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT(
    ...
    _______,BL_ON,BL_OFF,RGB_TOG,_______,_______,_______,_______,_______,_______,_______,XXXXXXX
  ),
  [_NAV] = LAYOUT(
    _______,_______,LCTL(KC_RIGHT),_______,_______,_______,KC_END, KC_PGDN,KC_PGUP,KC_HOME,_______,_______,
    _______,_______,_______,LSFT(KC_HOME),LSFT(KC_END),_______,KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,LALT(KC_LEFT),LALT(KC_RIGHT),
    _______,_______,_______,_______,_______,LCTL(KC_LEFT),LCTL(LSFT(KC_LEFT)),_______,_______,LCTL(LSFT(KC_RIGHT)),_______,_______,
