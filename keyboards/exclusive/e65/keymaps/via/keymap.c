...
// Keymap for the E6.5 layout containg all keys
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_65_ansi_noblocker(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS,                  KC_TRNS,                             KC_TRNS,   LT(1, KC_RGUI), RGB_SAI, RGB_VAD, RGB_SAD),


    [2] = LAYOUT_65_ansi_noblocker(
