...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_75_ansi_splitbs(
	...
	[1] = LAYOUT_75_ansi_splitbs(
		...
		UG_TOGG, UG_NEXT, UG_HUEU, UG_HUED, UG_SATU, UG_SATD, _______, _______, _______, _______, _______, _______, _______,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, UG_VALU,
		_______, _______, _______,                  _______,                             _______,   MO(1), UG_NEXT, UG_VALD, UG_HUED),
