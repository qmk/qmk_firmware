...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
	...
	[1] = LAYOUT(
		...
		BL_TOGG, BL_DOWN,BL_UP,  BL_BRTG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		...
		_______, _______, AG_TOGG,                  _______,                             _______,   MO(1), UG_NEXT, UG_VALD, UG_HUED),
};
