...
#define LINE_COL3                   PAL_LINE(IOPORTB, 15)
#define LINE_COL4                   PAL_LINE(IOPORTC,  0)
#define LINE_COL5                   PAL_LINE(IOPORTC, 11)
#define LINE_COL6                   PAL_LINE(IOPORTC, 10)
#define LINE_COL7                   PAL_LINE(IOPORTC, 12)
#define LINE_COL8                   PAL_LINE(IOPORTC, 13)
#define LINE_COL9                   PAL_LINE(IOPORTA,  8)
#define LINE_COL10                  PAL_LINE(IOPORTA,  9)
#define LINE_COL11                  PAL_LINE(IOPORTA, 10)
#define LINE_COL12                  PAL_LINE(IOPORTA, 11)
