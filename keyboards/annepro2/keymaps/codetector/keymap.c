...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN_LAYER] = KEYMAP( /* Base */
    ...
    KC_AP2_BT_UNPAIR, KC_AP2_BT_SCAN1, KC_AP2_BT_SCAN2, KC_AP2_BT_SCAN3, KC_AP2_BT_SCAN4, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_END,  KC_AP_LED_ON,
    KC_CAPS, KC_AP2_BT_CONN1, KC_AP2_BT_CONN2, KC_AP2_BT_CONN3, KC_AP2_BT_CONN4, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_PGUP, KC_PGDN,         KC_AP_LED_OFF,
    KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INSERT, KC_DELETE, KC_TRNS,
