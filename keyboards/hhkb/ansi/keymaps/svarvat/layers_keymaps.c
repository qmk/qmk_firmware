...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [LA_LPINKY] = LAYOUT(
        MA_NONE, MA_F1, MA_F2, MA_F3, MA_F4, MA_F5, MA_F6, MA_F7, MA_F8, MA_F9, MA_F10, MA_F11, MA_F12, MA_NONE, MA_NONE,
        MA_NONE, G(KC_Q), G(KC_W), G(KC_E), G(KC_R), G(KC_T), MA_NONE, MA_7, MA_8, MA_9, MA_EQL, MA_ASTR, MA_NONE, MA_NONE,
        MA_NONE, G(KC_A), G(KC_S), G(KC_D), G(KC_F), G(KC_G), MA_DOT, MA_4, MA_5, MA_6, MA_MINS, MA_PLUS, MA_ENT,
        MA_NONE, G(KC_Z), G(KC_X), G(KC_C), G(KC_V), MA_NONE, MA_0, MA_1, MA_2, MA_3, MA_SLSH, MA_NONE, MA_NONE,
        MA_CAPSLOCK, MA_NONE, MA_SPC, MA_NONE, MA_NONE
    ),
    [LA_RTHUMB] = LAYOUT(
