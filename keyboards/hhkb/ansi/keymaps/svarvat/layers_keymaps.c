...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [LA_LPINKY] = LAYOUT(
        ...
        KC_TRNS, C(KC_Q), C(KC_W), KC_DEL, C(KC_R), MA_LTHUMBT, MA_LTHUMBY, MA_7, MA_8, MA_9, MA_EQL, MA_ASTR, KC_TRNS, KC_TRNS,
        KC_TRNS, MA_ESC, C(KC_S), KC_ENT, MA_DELLINE, MA_LTHUMBG, MA_DOT, MA_4, MA_5, MA_6, MA_MINS, MA_PLUS, MA_ENT,
        KC_LSFT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MA_LTHUMBB, MA_0, MA_1, MA_2, MA_3, MA_SLSH, KC_TRNS, KC_TRNS,
    ...
    [LA_LTHUMB] = LAYOUT(
        ...
        KC_TRNS, MA_LTHUMBQ, MA_LTHUMBW, MA_LTHUMBE, C(KC_R), KC_TRNS, KC_TRNS, KC_HOME, KC_UP, KC_END, MA_DOUBLEARROW, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_LCTL, C(KC_Z), KC_UP, MA_LTHUMBD, C(KC_F), KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, MA_SIMPLEARROW, KC_TRNS, KC_PENT,
        KC_TRNS, C(KC_A), C(KC_X), C(KC_C), C(KC_V), KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_PGDN, KC_TRNS, KC_TRNS, KC_TRNS,
