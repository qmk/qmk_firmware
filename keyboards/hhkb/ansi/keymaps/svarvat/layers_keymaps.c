...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [LA_LPINKY] = LAYOUT(
        KC_LGUI, KC_F1, KC_F1, KC_F1, KC_F1, KC_F1, KC_F1, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_TRNS, KC_TRNS,
        G(KC_TAB), MA_Q, MA_W, MA_E, MA_R, MA_T, KC_TRNS, MA_7, MA_8, MA_9, MA_EQL, MA_ASTR, KC_TRNS, KC_TRNS,
        ...
        MA_CAPSLOCK, KC_TRNS, G(KC_SPC), KC_TRNS, KC_TRNS
    ),
    [LA_RTHUMB] = LAYOUT(
    ...
    [LA_LTHUMB] = LAYOUT(
        ...
        KC_TRNS, MA_LTHUMBQ, MA_LTHUMBW, MA_LTHUMBE, G(KC_E), KC_TRNS, KC_TRNS, KC_HOME, KC_UP, KC_END, MA_DOUBLEARROW, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_LCTL, C(KC_Z), MA_ESC, MA_LTHUMBD, G(KC_D), KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, MA_SIMPLEARROW, KC_TRNS, KC_PENT,
    ...
    [LA_LTHUMBDMO] = LAYOUT(
        RSG(KC_ESC), MA_JUMPDETAB, MA_JUMPTAB, RSG(KC_3), RSG(KC_4), RSG(KC_5), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        RSG(KC_TAB), MA_BSPC, MA_DEL, KC_TRNS, RSG(KC_R), RSG(KC_T), RSG(KC_Y), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_SPC, C(KC_S), MA_ENT, MA_DELLINE, RSG(KC_G), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, RSG(KC_Z), C(KC_W), KC_UP, RSG(KC_V), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
