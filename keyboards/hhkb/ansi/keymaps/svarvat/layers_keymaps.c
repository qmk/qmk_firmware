...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [LA_LTHUMBDMO] = LAYOUT(
        RSG(KC_ESC), RSG(KC_1), RSG(KC_2), KC_UP, RSG(KC_4), RSG(KC_5), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        MA_DELLINE, KC_BSPC, KC_DEL, KC_TRNS, KC_SPC, RSG(KC_T), RSG(KC_Y), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
