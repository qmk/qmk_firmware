...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [LA_LPINKY] = LAYOUT(
        ...
        MA_CAPSLOCK, KC_TRNS, KC_SPC, KC_TRNS, KC_TRNS
    ),
    [LA_RTHUMB] = LAYOUT(
        ...
        MA_CAPSWORD, FR_DEG, FR_SUP2, FR_DLR, FR_PERC, FR_PND, KC_PPLS, KC_PMNS, KC_MEDIA_PLAY_PAUSE, KC_TRNS, KC_TRNS, KC_RSFT, KC_TRNS,
    ...
    [LA_LTHUMB] = LAYOUT(
        ...
        KC_LCTL, MA_ESC, KC_LGUI, MA_LTHUMBD, G(KC_D), KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, MA_SIMPLEARROW, KC_TRNS, KC_TRNS,
        KC_LSFT, C(KC_A), C(KC_Z), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MA_PGUP, KC_TRNS, MA_PGDN, KC_TRNS, MA_CAPSWORD, KC_TRNS,
    ...
    [LA_LTHUMBMS] = LAYOUT(
        ...
        MA_NONE, MA_ESC, KC_LGUI, MA_LTHUMBD, G(KC_D), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    [LA_LTHUMBEMO] = LAYOUT(
        ...
        C(KC_V), C(KC_C), C(KC_X), MA_NONE, C(KC_R), LSG(KC_T), LSG(KC_Y), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, LSG(KC_A), LSG(KC_D), KC_TRNS, C(KC_F), LSG(KC_G), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    [LA_LTHUMBDMO] = LAYOUT(
        ...
        KC_ENT, KC_BSPC, KC_DEL, KC_TRNS, KC_SPC, RSG(KC_T), RSG(KC_Y), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, MA_DELLINE, C(KC_S), MA_NONE, RSG(KC_F), RSG(KC_G), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
