...
[0] = 	LAYOUT(
      ...
      KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, LT(1,KC_QUOT), KC_ENT, \
      KC_LSFT, KC_NUHS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLSH, KC_RSFT, \
      KC_LALT, KC_LCTL,           KC_SPC,                         KC_LWIN, KC_RALT
    ),
[1] = LAYOUT(
      ...
      KC_TRNS, KC_TRNS,                          KC_TRNS,                               NK_TOGG, KC_TRNS
    ),
