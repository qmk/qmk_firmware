...
[0] =	LAYOUT(
      KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC,     KC_NLCK, RESET, KC_PSLS, KC_PAST,
      ...
      KC_LALT, KC_LCTL,           KC_SPC,                         KC_BSLS, KC_LEFT, KC_RGHT, KC_DOWN,   KC_P0,        KC_PDOT, KC_PENT
    ),
