...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        MO(3),   KC_LCTL, KC_LGUI, KC_LALT, MO(2),   KC_SPC,  KC_SPC,  TO(1),   KC_GRV,  KC_DEL,  KC_PSCR, MO(3)
    ),
    [_NUM] = LAYOUT(
    ...
    [_FN] = LAYOUT(
        RESET,   XXXXXXX, KC_F1,   KC_F2,   KC_F3,   XXXXXXX, XXXXXXX, KC_F7,   KC_F8,   KC_F9,   XXXXXXX, _______,
