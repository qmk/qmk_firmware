...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        LT(MO(_QWERTY), KC_TAB),  KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,    QK_LAYER_LOCK, QK_LAYER_LOCK, KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN,    KC_SLSH,
    ...
    [_SYM] = LAYOUT(
        ...
        _______, LGUI_T(KC_GRV),  LALT_T(KC_LBRC), LCTL_T(KC_LCBR), LSFT_T(KC_LPRN), KC_MINS, _______, _______, KC_EQL,  RSFT_T(KC_RPRN), RCTL_T(KC_RCBR), RALT_T(KC_RBRC), RGUI_T(KC_BSLS), _______,
