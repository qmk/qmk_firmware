...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        MEH_T(KC_ESC), LGUI_T(KC_A), LGUI_T(KC_R),LCTL_T(KC_S),LSFT_T(KC_T), HYPR_T(KC_G),    XXXXXXX, XXXXXXX, HYPR_T(KC_M), RSHFT_T(KC_N), RCTL_T(KC_E), RALT_T(KC_I), RGUI_(KC_O), KC_QUOT,
        KC_LSFT, KC_X,    KC_C,    KC_D,    KC_V,    KC_Z,    XXXXXXX, XXXXXXX, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
                                   KC_LGUI, KC_LALT, MO(1),   KC_BSPC,  KC_SPC,  MO(2),   KC_TAB,  KC_DEL
    ),
