 ...
 *                        `----------------------------------'  `----------------------------------'
 */
    // TODO: i3, kitty keys, = somewhere on layer, what on the raise/lower taps, mod on sysreq?
    [_QWERTY] = LAYOUT(
      KC_GRV,    KC_Q,   KC_W,   KC_E,       KC_R,    KC_T,                                                      KC_Y,    KC_U,       KC_I,    KC_O,    KC_P,    KC_PIPE,
      KC_TAB,   KC_A,   KC_S,   KC_D,       KC_F,    KC_G,                                                       KC_H,    KC_J,       KC_K,    KC_L,    KC_SCLN, KC_QUOT,
      KC_LSPO,   KC_Z,   KC_X,   KC_C,       KC_V,    KC_B,      KC_LSPO, KC_LALT,       KC_RALT,       KC_RSPC, KC_N,    KC_M,       KC_COMM, KC_DOT,  KC_SLSH, KC_MINS,
                                 S(KC_LGUI), S(KC_LCTL), LT(_RAISE, KC_TAB), KC_SPC,  MT(MOD_LCTL, KC_ESC), MT(MOD_LGUI, KC_BSPC), KC_ENT,  LT(_LOWER, KC_TAB), KC_SPC, KC_SYSREQ
    ),
/*
 * Lower Layer: Symbols
 *
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    switch (get_highest_layer(new_state)) {
        ...
        case _LOWER:
            ...
            //rgblight_sethsv_noeeprom(255, 0, 0);
            break;
        case _RAISE:
