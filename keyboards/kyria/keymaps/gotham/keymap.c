...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAME] = LAYOUT_wrapper(
      ...
      _______, __________________GAME_L3__________________, _______, _______,  _______, _______, _________________QWERTY_R3_________________, _______,
    ...
    [_GAMENAV] = LAYOUT_wrapper(
      ...
      _______, ___________________BLANK___________________, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT,_______, _______,
    ...
    [_GAMENUM] = LAYOUT_wrapper(
      ...
      _______, KC_NO,  KC_7, KC_8, KC_9, KC_NO, _______, _______, _______, _______,   KC_NO,    KC_F7,  KC_F8,  KC_F9,  KC_F12, _______,
                     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
