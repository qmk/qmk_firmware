 ...
 */
    [SYMBOLS] = LAYOUT(
      ...
      KC_TAB, _______, KC_DOWN, KC_LPRN, KC_RPRN, KC_GRV,                                      KC_EQL, KC_DLR, KC_PERC, KC_CIRC, _______, KC_QUOT,
      _______, KC_LGUI, _______, KC_LBRC, KC_RBRC, KC_TILD, _______, _______, _______, _______, KC_MINS, KC_EXLM,  KC_AT, KC_HASH,  _______, KC_MINS,
...
#define ANIM_FRAME_DURATION 425 // base value for how long each animation will last in ms
...
uint32_t curr_anim_duration = 425; // variable tracks dynamic animation duration
