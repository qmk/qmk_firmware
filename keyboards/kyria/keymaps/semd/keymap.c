...
*/
    [_QWERTY] = LAYOUT(
      ...
      KC_LCTL,      KC_Z,   KC_X,   KC_C,   KC_V,   KC_B, KC_RGUI, KC_SPC,     KC_ENT, ENC_SHIFT, KC_N, KC_M,    KC_COMM, KC_DOT,  KC_DOWN, KC_RGHT,
 ...
 */
    [_LOWER] = LAYOUT(
      ...
      KC_LCTL,  KC_GRV,   KC_TILD, SC_AMP,  SC_PIPE, SC_DOLL, KC_RGUI, _______, _______, ENC_END, KC_SCLN, KC_PGDN, KC_END, _______,  _______,  _______,
