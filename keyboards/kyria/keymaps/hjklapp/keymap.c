 ...
 */
    ...
    [_BASE] = LAYOUT(KC_TAB, KC_X, KC_F, KC_O, KC_G, KC_Q, KC_Y, KC_M, KC_U, KC_B, KC_SCLN, KC_BSPC, KC_ESC, LCTL_T(KC_D), LALT_T(KC_T), LGUI_T(KC_E), LSFT_T(KC_R), SGUI_T(KC_COMM), SGUI_T(KC_DOT), RSFT_T(KC_N), RGUI_T(KC_I), RALT_T(KC_S), RCTL_T(KC_A), KC_QUOT, KC_P0, KC_Z, KC_W, KC_C, KC_H, KC_ESC, KC_NO, KC_NO, KC_NO, KC_NO, KC_J, KC_L, KC_K, KC_P, KC_V, DF(1), KC_RCTL, KC_LGUI, KC_SLSH, LT(3,KC_ENT), LT(5,KC_TAB), LT(6,KC_BSPC), LT(4,KC_SPC), KC_ESC, KC_LALT, KC_RSFT),
 ...
 */
    ...
    [_ALT] = LAYOUT(KC_TAB, KC_TAB, KC_W, KC_B, KC_G, KC_Q, KC_SLSH, KC_L, KC_K, KC_O, KC_SCLN, KC_BSPC, KC_ESC, LCTL_T(KC_D), LALT_T(KC_S), LGUI_T(KC_T), LSFT_T(KC_R), SGUI_T(KC_Y), SGUI_T(KC_Z), RSFT_T(KC_N), RGUI_T(KC_I), RALT_T(KC_A), RCTL_T(KC_U), KC_QUOT, KC_P0, KC_COMM, KC_F, KC_C, KC_H, KC_X, KC_NO, KC_NO, KC_NO, KC_NO, KC_J, KC_M, KC_V, KC_P, KC_DOT, DF(0), KC_LALT, KC_LGUI, KC_ESC, LT(3,KC_E), LT(5,KC_ENT), LT(6,KC_BSPC), LT(4,KC_SPC), KC_ESC, KC_RCTL, KC_RSFT),
 ...
 */
    ...
    [_SYMBOLS] = LAYOUT(KC_AMPR, KC_AT, KC_SLSH, KC_LBRC, KC_RBRC, KC_HASH, KC_PERC, KC_7, KC_8, KC_9, KC_PSLS, KC_BSPC, KC_UNDS, KC_DLR, KC_EXLM, KC_LPRN, KC_RPRN, KC_GRV, KC_PPLS, KC_1, KC_2, KC_3, KC_0, KC_COLN, KC_NO, KC_CIRC, KC_QUES, KC_LCBR, KC_RCBR, KC_BSLS, KC_NO, KC_NO, KC_NO, KC_NO, KC_PDOT, KC_4, KC_5, KC_6, KC_PAST, KC_TILD, LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), KC_NO, TG(3), KC_PEQL, KC_PMNS, KC_RGUI, KC_RALT, KC_RCTL),
 ...
 */
    ...
    [_FUNCTIONKEYS] = LAYOUT(KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F5, KC_F6, KC_F7, KC_F8, KC_NO, KC_NO, KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL, KC_NO, KC_NO, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
