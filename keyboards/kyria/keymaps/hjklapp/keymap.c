 ...
 */
    ...
    [_BASE] = LAYOUT(KC_TAB, KC_Q, KC_W, KC_O, KC_L, KC_P, KC_Y, KC_U, KC_G, KC_M, KC_J, KC_BSPC, KC_ESC, LCTL_T(KC_D), LALT_T(KC_R), LGUI_T(KC_E), LSFT_T(KC_N), SGUI_T(KC_F), SGUI_T(KC_SCLN), RSFT_T(KC_I), RGUI_T(KC_S), RALT_T(KC_T), RCTL_T(KC_A), KC_QUOT, KC_P0, KC_Z, KC_C, KC_X, KC_H, KC_V, KC_NO, KC_NO, KC_NO, KC_NO, KC_K, KC_B, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LALT, KC_LGUI, KC_ESC, LT(3,KC_ENT), LT(5,KC_TAB), LT(6,KC_BSPC), LT(4,KC_SPC), KC_ESC, KC_RGUI, KC_RCTL),
