 ...
 */
    ...
    [_BASE] = LAYOUT(KC_TAB, KC_SLSH, KC_F, KC_O, KC_G, KC_Q, KC_Y, KC_M, KC_U, KC_B, KC_SCLN, KC_BSPC, KC_ESC, LCTL_T(KC_D), LALT_T(KC_T), LGUI_T(KC_E), LSFT_T(KC_R), SGUI_T(KC_COMM), SGUI_T(KC_DOT), RSFT_T(KC_N), RGUI_T(KC_I), RALT_T(KC_S), RCTL_T(KC_A), KC_QUOT, KC_P0, KC_Z, KC_W, KC_C, KC_H, KC_X, KC_NO, KC_NO, KC_NO, KC_NO, KC_J, KC_L, KC_K, KC_P, KC_V, DF(1), KC_LALT, KC_LGUI, KC_ESC, LT(3,KC_ENT), LT(5,KC_TAB), LT(6,KC_BSPC), LT(4,KC_SPC), KC_ESC, KC_RCTL, KC_RSFT),
