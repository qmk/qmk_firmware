 ...
 */
    ...
    [_BASE] = LAYOUT(KC_MPLY, KC_Q, KC_F, KC_O, KC_G, KC_J, KC_Y, KC_M, KC_U, KC_B, KC_X, KC_VOLU, KC_MUTE, LCTL_T(KC_D), LALT_T(KC_T), LGUI_T(KC_E), LSFT_T(KC_R), SGUI_T(KC_COMM), SGUI_T(KC_DOT), RSFT_T(KC_N), RGUI_T(KC_I), RALT_T(KC_S), RCTL_T(KC_A), KC_VOLD, KC_P0, KC_Z, KC_W, KC_C, KC_H, KC_ESC, LT(3,KC_ENT), LT(5,KC_TAB), LT(6,KC_BSPC), LT(4,KC_SPC), KC_ESC, KC_L, KC_K, KC_P, KC_V, TO(1), KC_LCTL, KC_LGUI, LSFT_T(OSM(MOD_LSFT)), KC_LALT, KC_BSPC, KC_NO, OSM(MOD_RSFT), RSFT_T(OSM(MOD_RSFT)), KC_LALT, KC_RSFT),
