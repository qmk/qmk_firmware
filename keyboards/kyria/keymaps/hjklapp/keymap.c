 ...
 */
    ...
    [_BASE] = LAYOUT(KC_TAB, KC_Q, KC_W, KC_O, KC_L, KC_P, KC_Y, KC_U, KC_G, KC_M, KC_J, KC_BSPC, KC_ESC, LSFT_T(KC_D), LCTL_T(KC_R), LALT_T(KC_E), LGUI_T(KC_N), SGUI_T(KC_F), SGUI_T(KC_SCLN), RGUI_T(KC_I), RALT_T(KC_S), RCTL_T(KC_T), RSFT_T(KC_A), KC_QUOT, KC_P0, KC_Z, KC_C, KC_X, KC_H, KC_V, KC_NO, KC_NO, KC_NO, KC_NO, KC_K, KC_B, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LALT, KC_LGUI, KC_ESC, LT(3,KC_ENT), LT(5,KC_TAB), LT(6,KC_BSPC), LT(4,KC_SPC), KC_ESC, KC_RGUI, KC_RCTL),
 ...
 */
    ...
    // #todo: format base layer
    [_ALT] = LAYOUT(KC_TRNS, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_TRNS, KC_TRNS, LSFT_T(KC_A), LCTL_T(KC_S), LALT_T(KC_D), LGUI_T(KC_F), SGUI_T(KC_G), SGUI_T(KC_H), RGUI_T(KC_J), RALT_T(KC_K), RCTL_T(KC_L), RSFT_T(KC_SCLN), KC_QUOT, KC_TRNS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
 ...
 */
    ...
    // #todo: format base layer
    [_VISUALSTUDIO] = LAYOUT(KC_NO, KC_NO, LCTL(KC_K), LCTL(KC_F9), KC_F9, LALT(KC_G), KC_NO, LCTL(KC_LEFT), LCTL(KC_RGHT), KC_NO, KC_NO, KC_NO, KC_NO, KC_TAB, KC_NO, KC_F11, KC_F10, KC_F5, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LSFT(KC_F11), LCTL(KC_F10), KC_I, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LALT(KC_LEFT), LALT(KC_RGHT), KC_NO, KC_NO, KC_NO, TG(5), KC_NO, KC_LALT, KC_ENT, KC_NO, MO(7), KC_ENT, KC_NO, KC_NO, KC_NO),
