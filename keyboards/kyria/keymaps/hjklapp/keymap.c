 ...
 */
    ...
    [_BASE] = LAYOUT(KC_TAB, KC_TAB, KC_W, KC_B, KC_G, KC_Q, KC_SLSH, KC_L, KC_K, KC_O, KC_SCLN, KC_BSPC, KC_ESC, LCTL_T(KC_D), LALT_T(KC_S), LGUI_T(KC_T), LSFT_T(KC_R), SGUI_T(KC_Y), SGUI_T(KC_Z), RSFT_T(KC_N), RGUI_T(KC_I), RALT_T(KC_A), RCTL_T(KC_U), KC_QUOT, KC_P0, KC_COMM, KC_F, KC_C, KC_H, KC_X, KC_NO, KC_NO, KC_NO, KC_NO, KC_J, KC_M, KC_P, KC_V, KC_DOT, DF(1), KC_LALT, KC_LGUI, KC_ESC, LT(3,KC_E), LT(5,KC_ENT), LT(6,KC_BSPC), LT(4,KC_SPC), KC_ESC, KC_RCTL, KC_RSFT),
