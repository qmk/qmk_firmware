 ...
 */
    ...
    // #todo: format base layer
    [_ALT] = LAYOUT(KC_TRNS, KC_TAB, KC_K, KC_B, KC_G, KC_Q, KC_COMM, KC_L, KC_O, KC_Y, KC_SCLN, KC_TRNS, KC_TRNS, LCTL_T(KC_D), LALT_T(KC_S), LGUI_T(KC_T), LSFT_T(KC_R), SGUI_T(KC_W), SGUI_T(KC_DOT), RSFT_T(KC_N), RGUI_T(KC_I), RALT_T(KC_A), RCTL_T(KC_U), KC_QUOT, KC_TRNS, KC_Z, KC_V, KC_C, KC_H, KC_X, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_J, KC_M, KC_F, KC_P, KC_SLSH, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LT(3,KC_E), LT(5,KC_ENT), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
