 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |LShift|      |      |      | WH up| Pg up|-------.    ,-------| left | down |  up  | right|      |  del |
 * |------+------+------+------+------+------|  MUTE |    |MEH UP |------+------+------+------+------+------|
 * | LCTR |      |      |      | WH dn| Pg dn|-------|    |-------|      |      |      |      |      |LShift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | Bspc | WIN  |LOWER | Space| /Enter  /       \Space \  |Enter |RAISE | RCTR | RAlt |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `-----------------------------------'           '------''---------------------------'
 ...
 * |QK_BOOT|     |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |UG_TOGG|hue^ |sat ^ | bri ^|col_dh| cole |-------.    ,-------|desk <|      |      |desk >|      |      |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * | mode | hue dn|sat d|bri dn|      | qwer |-------|    |-------|      | PREV | PLAY | NEXT |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | Bspc | WIN  |LOWER | Space| /Enter  /       \Space \  |Enter |RAISE | RCTR | RAlt |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `-----------------------------------'           '------''---------------------------'
 ...
 * |      |      |      |      |      |      |-------|    |-------|   +  |   1  |   2  |   3  |   /  |LShift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | Bspc | MEH  |LOWER | Space| /Enter  /       \Space \  |Enter | 0    |  .   | RAlt |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `-----------------------------------'           '------''---------------------------'
 */
[_NUMPAD] = LAYOUT(
