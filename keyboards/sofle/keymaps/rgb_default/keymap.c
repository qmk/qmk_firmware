...
enum custom_keycodes { KC_QWERTY = SAFE_RANGE, COLEMAKDH, COLEMAK, KC_LOWER, KC_RAISE, KC_ADJUST, KC_D_MUTE };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        ...
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
        /**/ _______, KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, /*            */ KC_LBRC, KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS, KC_RSFT,
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
        /*           */ _______, _______, _______, _______, _______, _______, /**/ _________, _______, _______, _______, _______, _______
        //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
        ),
    /* RAISE
     * ,----------------------------------------.                    ,-----------------------------------------.
     ...
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * | Caps | LAt  | LCtl |LShift|      | Caps |-------.    ,-------|      | Left | Down | Rigth|  Del | Bspc |
     * |------+------+------+------+------+------|  MUTE |    | PLAY  |------+------+------+------+------+------|
    ...
    [_RAISE] = LAYOUT(
        ...
        //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
        /**/ _______, KC_INS, KC_PSCR, KC_APP, KC_NO, KC_NO, /*                 */ KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
        //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
        /**/ _______, KC_LALT, KC_LCTL, KC_LSFT, KC_NO, KC_CAPS, /*             */ KC_MINS, KC_EQL, KC_LCBR, KC_RCBR, KC_PIPE, KC_GRV,
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
        /**/ _______, KC_UNDO, KC_CUT, KC_COPY, KC_PASTE, XXXXXXX, _______, /**/ KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS, KC_TILD,
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
     ...
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            | LGUI | LAlt  |LCTR | LOWER| / Enter /       \Space \  |RAISE | 0    |  .   |EQUALS|
     *            |      |      |      |      |/       /         \      \ |      |      |      |(entr)|
     *            `----------------------------------'           '------''---------------------------'
     */
    [_NUMPAD] = LAYOUT(
        //,------------------------------------------------.                    ,---------------------------------------------------.
        /**/ _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, LT(_NUMPAD, KC_P7), LT(_NUMPAD, KC_P8), LT(_NUMPAD, KC_P9), LT(_NUMPAD, KC_ASTR), XXXXXXX,
        //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
        /**/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, LT(_NUMPAD, KC_CIRC), LT(_NUMPAD, KC_P4), LT(_NUMPAD, KC_P5), LT(_NUMPAD, KC_P6), LT(_NUMPAD, KC_EQL), XXXXXXX,
        //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
        /**/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, LT(_NUMPAD, KC_MINS), LT(_NUMPAD, KC_P1), LT(_NUMPAD, KC_P2), LT(_NUMPAD, KC_P3), LT(_NUMPAD, KC_SLSH), LT(_NUMPAD, KC_PIPE),
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
        /**/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, LT(_NUMPAD, KC_PLUS), LT(_NUMPAD, KC_P0), LT(_NUMPAD, KC_PDOT), LT(_NUMPAD, KC_ENT), _______, /**/ _______,
        //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
