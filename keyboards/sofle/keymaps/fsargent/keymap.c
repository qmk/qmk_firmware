...
enum custom_keycodes {
  ALT_TAB = SAFE_RANGE, ENCODER_SWAP
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	MT(MOD_MEH,KC_ESC),	KC_A,		KC_S,		KC_D,		KC_F,		KC_G,							KC_H,		KC_J,		KC_K,		KC_L,		KC_SCLN,	MT(MOD_LALT,KC_QUOT),
		KC_LSFT,	KC_Z,		KC_X,		KC_C,		KC_V,		KC_B,		ENCODER_SWAP,		TO(WIN),	KC_N,		KC_M,		KC_COMM,	KC_DOT,		KC_SLSH,	MT(MOD_LSFT,KC_BSLS),
	...
	[WIN] = LAYOUT(
		...
		_______,_______,_______,_______,_______,_______,ENCODER_SWAP,		TO(GAME),	_______,_______,_______,_______,_______,_______,
	...
	[GAME] = LAYOUT(
		...
		KC_LSFT,	_______,	_______,	_______,	_______,	_______,	ENCODER_SWAP,	TO(SHFT),_______,_______,_______,_______,_______,KC_RSFT,
	...
	MT(MOD_MEH,KC_ESC),	KC_G,		KC_A,		KC_S,		KC_D,		KC_F,							KC_H,		KC_J,		KC_K,		KC_L,		KC_SCLN,	MT(MOD_LALT,KC_QUOT),
		KC_LSFT,	KC_B,		KC_Z,		KC_X,		KC_C,		KC_V,		ENCODER_SWAP,		TO(BASE),	KC_N,		KC_M,		KC_COMM,	KC_DOT,		KC_SLSH,	MT(MOD_LSFT,KC_BSLS),
		MT(MOD_LCTL, KC_LBRC),	MT(MOD_LALT, KC_RBRC),	LT(SYM,KC_DEL), KC_LCTL,	KC_SPC,					KC_BSPC,		LT(SYM, KC_ENT),	MT(MOD_LGUI, KC_DEL),	MT(MOD_LALT, KC_MINS), 	MT(MOD_LCTL, KC_EQL)
	),
	[SYM] = LAYOUT(
		// C(G(KC_SPC)) is the OS X Emoji Editor
		C(G(KC_SPC)),	KC_F1,		KC_F2,		KC_F3,		KC_F4,		KC_F5,							KC_F6,		KC_F7,		KC_F8,		KC_F9,		KC_F10,		KC_F11,
		_______,	KC_EQL,		KC_7,		KC_8,		KC_9,		KC_MINUS,						KC_NO,		KC_NO,		KC_INS,		KC_NO,		KC_PSCR,	KC_F12,
		_______,	KC_0, 		KC_4,		KC_5,		KC_6,		KC_PLUS,						KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NLCK,
		_______,	KC_DOT,		KC_1,		KC_2,		KC_3,		KC_ENT,		ENCODER_SWAP,		TG(SYM),	KC_NLCK,	KC_SLCK,	KC_NO,		KC_NO,		KC_NO,		KC_SLCK,
	...
	[NAV]=LAYOUT(
		...
		KC_LSFT,	KC_HOME,	G(KC_LEFT),	KC_ENT,		G(KC_RGHT),	KC_END,		ENCODER_SWAP,		TO(GAME),	KC_WH_D,	KC_WH_D,	KC_LCBR,	KC_RCBR,	KC_BSLS,	KC_DEL,
						_______,	KC_PGDN,	_______,	_______,	_______,		KC_BTN1,	KC_BTN2,	KC_BTN3,	RGB_RMOD,	RGB_MOD
	),
	[WINNAV]=LAYOUT(
		...
		KC_LSFT,	KC_HOME,	A(KC_LEFT),	KC_ENT,		A(KC_RGHT),	KC_END,		ENCODER_SWAP,		TG(GAME),	KC_WH_D,	KC_NO,		KC_LCBR,	KC_RCBR,	KC_BSLS,	KC_DEL,
