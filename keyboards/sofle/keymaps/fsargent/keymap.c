...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[GAME] = LAYOUT(
		...
		KC_LSFT,	_______,	_______,	_______,	_______,	_______,	ENCODER_SWAP,	TO(SHFT),	_______,_______,_______,_______,_______,KC_BSLS,
		KC_LCTL,	KC_LALT,	MO(WINNAV),	KC_LCTL,	KC_BSPC,						_______,_______,_______,_______,_______
	),
	[SHFT] = LAYOUT(
		KC_GRV,		KC_5,		KC_1,		KC_2,		KC_3,		KC_4,							KC_6,		KC_7,		KC_8,		KC_9,		KC_0,		MT(MOD_LGUI,KC_MINS),
