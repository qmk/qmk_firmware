...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[GAME] = LAYOUT(
		...
		KC_LSFT,	_______,	_______,	_______,	_______,	_______,	ENCODER_SWAP,	TO(BASE),	_______,_______,_______,_______,_______,KC_BSLS,
	...
	[SYM] = LAYOUT(
		...
		_______,	KC_DOT,		KC_1,		KC_2,		KC_3,		KC_ENT,		ENCODER_SWAP,		TG(SYM),	KC_MINS,	KC_EQL,		KC_LBRC,	KC_RBRC,	KC_BSLS,	KC_NLCK,
