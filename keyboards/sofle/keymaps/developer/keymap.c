...
[_QWERTY] = LAYOUT(
  ...
  KC_LGUI,  KC_LALT,KC_LCTRL, KC_LOWER,        KC_SWAP_SPACE,             HOME_ENTER,  KC_RAISE, KC_RCTRL, KC_RALT, KC_RGUI
),
...
[_COLEMAK] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,      XXXXXXX,KC_K,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LGUI,KC_LALT,KC_LCTRL,KC_LOWER, KC_SWAP_SPACE,      KC_SWAP_ENTER,  KC_RAISE, KC_RCTRL, KC_RALT, KC_RGUI
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | /Space  /       \ALT   \  |RAISE | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_LOWER] = LAYOUT(
  ...
  _______,  KC_EQL, KC_MINS, KC_COPY, KC_PASTE, KC_RCBR, _______,       _______, KC_PLUS, KC_LBRC, KC_RBRC, KC_RBRC, KC_BSLS, _______,
                    _______, _______, _______, _______, _______,       KC_LALT, _______, _______, _______, _______
),
