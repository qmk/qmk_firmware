...
[_COLEMAK] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_C,    KC_D,    KC_V,     KC_X,    KC_MUTE,    RGB_TOG, KC_K,     KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                      XXXXXXX, XXXXXXX,  KC_LCTL, KC_LOWER, KC_SPC,     KC_ENT, KC_RAISE, KC_RALT, XXXXXXX, XXXXXXX
),
...
[_LOWER] = LAYOUT(
    ...
    KC_LSFT,    KC_UNDO,    KC_COPY,       KC_DEL,     KC_PASTE,      KC_CUT,     _______,    _______, KC_1,    KC_2,    KC_3,    KC_PPLS,    KC_QUOT,       KC_BSLS,
                            XXXXXXX,       XXXXXXX,    KC_LCTL,       _______,    KC_SPC,     KC_0,    _______, KC_NUBS, XXXXXXX, XXXXXXX
),
...
[_RAISE] = LAYOUT(
    ...
    KC_LSFT, XXXXXXX, XXXXXXX, KC_EXEC, KC_APP,  KC_LGUI, _______,   _______,                 KC_FIND, KC_END,  XXXXXXX, KC_PGDN, XXXXXXX, XXXXXXX,
                      XXXXXXX, XXXXXXX, KC_LCTL, _______, KC_SCRL,   KC_CAPS, _______, KC_RALT, XXXXXXX, XXXXXXX
),
