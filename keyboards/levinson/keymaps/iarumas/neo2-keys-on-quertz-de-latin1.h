#ifndef NEO2_KEYS_ON_QUERTZ_DE_LATIN1_H
#define NEO2_KEYS_ON_QUERTZ_DE_LATIN1_H


/*
This file defines the desired NEO2 keys if you use a software (operating sysetm)
