...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN0] = LAYOUT_ortho_4x12( \
     ...
     KC_X1,    KC_X2,     KC_LGUI,    KC_BSLS,    KC_SPC,     KC_SPC,     KC_SPC,     KC_SPC,     KC_COMM,    KC_DOT,     KC_MINS,    KC_SLSH \
  ),
  ...
  [_FN1] = LAYOUT_ortho_4x12( \
    ...
    _______,    UC(L'Ä'),   UC(L'Ö'),   UC(L'Ü'),   UC(L'€'),   _______,    _______,    KC_LPRN,    KC_RPRN,    _______,    _______,    _______, \
    _______,    _______,    KC_LALT,    _______,    KC_SPC,     KC_SPC,     KC_SPC,     KC_SPC,     _______,    _______,    _______,    _______ \
  ),
