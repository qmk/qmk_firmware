...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_BL] = KEYMAP(
        ...
        KC_LCTL, KC_LGUI,          KC_LALT, KC_SPC,           KC_SPC,           KC_SPC,           MO(_FL), _______, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    */
    [_FL] = KEYMAP(
        ...
        _______, _______,          KC_MENU, _______,          _______,          _______,          _______, _______, MO(_CL), KC_WBAK, KC_VOLD, KC_WFWD
    ),
