...
Modification of the Model-M 101 membrane adapter (converter/modelm101) to work with Amiga 1200 keyboard (and possibly Amiga 500/600 too). A small PCB adapter needs to be used to make the necessary connections between the membrane and the Teensy 2.0 board.
