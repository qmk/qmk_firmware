...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    MO(1),   KC_LALT, KC_LGUI, KC_MHEN, KC_HANJ,          KC_SPC,           KC_HAEN, KC_HENK, KC_KANA, KC_BSPC, KC_RGUI, KC_APP,  KC_MO(1),    KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0,            KC_PDOT, KC_PENT,    KC_FIND, KC_CUT),

    // Fn1 layer
    [1] = LAYOUT_all(
                      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,               KC_TRNS, KC_TRNS, KC_TRNS,    KC_VOLD, KC_VOLU, KC_MUTE, KC_PWR,    KC_HELP,
    KC_TRNS, EF_DEC,  EF_INC,  H1_DEC,  H1_INC,  H2_DEC,  H2_INC,  KC_P7,   KC_P8,   KC_P9,   KC_TRNS, KC_PMNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS,    KC_NLCK, KC_PSLS, KC_PAST, KC_PMNS,   KC_STOP, KC_AGIN,
    KC_CAPS,          KC_TRNS, S1_DEC,  S1_INC,  S2_DEC,  S2_INC,  KC_P4,   KC_P5,   KC_P6,   KC_TRNS, KC_PENT, KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS,    KC_P7,   KC_P8,   KC_P9,   KC_PPLS,   KC_MENU, KC_UNDO,
    KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P1,   KC_P2,   KC_P3,   KC_PPLS, KC_PAST, KC_TRNS, KC_TRNS, KC_TRNS,                                    KC_P4,   KC_P5,   KC_P6,   KC_PCMM,   KC_SLCT, KC_COPY,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P0,   KC_TRNS, KC_PDOT, KC_PSLS, KC_TRNS, KC_TRNS,          KC_TRNS,               KC_VOLU,             KC_P1,   KC_P2,   KC_P3,   KC_PEQL,   KC_EXEC, KC_PSTE,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          TG(2),            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_MRWD, KC_VOLD, KC_MFFD,    KC_P0,            KC_PDOT, KC_PENT,   KC_FIND, KC_CUT),
    ...
    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NO,   KC_NO,                 KC_UP,               KC_NO,  KC_NO,  KC_NO, KC_NO,    KC_NO, KC_NO,
