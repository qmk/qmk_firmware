...
[1] = LAYOUT_all(
    ...
    ______,   ______,  ______,  ______, ______,  ______, ______, KC_P7,  KC_P8,   KC_P9,   ______,  ______,  ______,  ______,  ______,     ______,  ______,  ______,     ______,  ______,  ______,  ______,     ______,  ______,
    KC_CAPS,  ______,  ______,  ______, ______,  ______, ______, KC_P4,  KC_P5,   KC_P6,   ______,  KC_PENT, ______,           ______,     ______,  ______,  ______,     ______,  ______,  ______,  ______,     ______,  ______,
    ______,   ______,  ______,  ______, ______,  ______, ______, KC_P1,  KC_P2,   KC_P3,   KC_PPLS, KC_PMNS,          ______,  ______,                                   ______,  ______,  ______,  ______,     ______,  ______,
    ______,   ______,  ______,  ______, ______,  ______, ______, ______, KC_P0,   ______,  KC_PDOT, KC_PSLS,          ______,  ______,              KC_VOLU,             ______,  ______,  ______,  ______,     ______,  ______,
    ______,   ______,  ______,  ______, ______,          ______,         ______,  ______,  ______,  ______,  ______,  ______,  ______,     KC_MRWD, KC_VOLD, KC_MFFD,    ______,           ______,  ______,     ______,  ______
    ),
