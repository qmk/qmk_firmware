...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_INT5, KC_HANJ,         KC_SPC,         KC_LNG1, KC_INT4, KC_INT2, KC_RALT, KC_RGUI, KC_APP,  KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0,            KC_PDOT, KC_PENT,    KC_FIND, KC_CUT
    ),
    LAYOUT_all(
