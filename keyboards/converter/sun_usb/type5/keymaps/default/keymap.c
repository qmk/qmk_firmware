...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_jp_unix(
      KC_HELP,              KC_NO,   KC_F1,KC_F2,KC_F3,KC_F4, KC_F5,KC_F6,KC_F7,KC_F8, KC_F9,KC_F10,KC_F11,KC_F12,   KC_PSCR,KC_SCRL,KC_PAUS,  KC_MUTE,KC_VOLD,KC_VOLU,KC_PWR,
      ...
      KC_FIND,   KC_CUT,    KC_CAPS,KC_LALT,KC_LGUI,KC_INT4,    KC_SPC,     KC_INT5,KC_INT2,KC_RGUI,KC_APP,KC_RALT,  KC_LEFT,KC_DOWN,KC_RGHT,      KC_P0,     KC_PDOT
                 ),
};
