...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TILDE, KC_BRIU,  KC_BRID,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_MRWD,  KC_MPLY,  KC_MFFD,  KC_MUTE, KC_VOLD, KC_VOLU,           KC_PSCR,KC_SLCK,KC_BRK,
    KC_ESC, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL, KC_BSPC,     KC_INS, KC_HOME,KC_PGUP,    num1,KC_PSLS,KC_PAST,KC_PMNS,
    ...
    GUI_T(KC_ESC),KC_LGUI,KC_LALT,          KC_SPC,                     KC_RALT,KC_RGUI,KC_APP, KC_RCTL,     KC_LEFT,KC_DOWN,KC_RGHT,    KC_P0,       KC_PDOT,KC_PENT
        ...
        LAYOUT_fullsize_ansi(
    KC_TILDE, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12,           KC_PSCR,KC_SLCK,KC_BRK,
    KC_ESC, KC_BRIU,  KC_BRID,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_MRWD,  KC_MPLY,  KC_MFFD,  KC_MUTE, KC_VOLD, KC_VOLU, KC_DEL,     KC_INS, KC_HOME,KC_PGUP,    num1,KC_PSLS,KC_PAST,KC_PMNS,
    ...
    LAYOUT_fullsize_ansi(
    KC_TILDE, KC_BRIU,  KC_BRID,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_MRWD,  KC_MPLY,  KC_MFFD,  KC_MUTE, KC_VOLD, KC_VOLU,           KC_PSCR,KC_SLCK,KC_BRK,
    KC_ESC, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL, KC_BSPC,     KC_INS, KC_HOME,KC_PGUP,    num2,KC_PSLS,KC_PAST,KC_PMNS,
    ...
    LAYOUT_fullsize_ansi(
    KC_TILDE, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12,           KC_PSCR,KC_SLCK,KC_BRK,
    KC_ESC, KC_BRIU,  KC_BRID,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_MRWD,  KC_MPLY,  KC_MFFD,  KC_MUTE, KC_VOLD, KC_VOLU, KC_DEL,     KC_INS, KC_HOME,KC_PGUP,    num2,KC_PSLS,KC_PAST,KC_PMNS,
