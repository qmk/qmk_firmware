...
#define LAYOUT_105_iso( \
    ...
    { KC_NO, KC_NO, K52,   KC_NO, K54,   K55,   KC_NO, KC_NO }, \
    { K58,   K59,   K5A,   K5B,   KC_NO, K5D,   KC_NO, KC_NO }, \
    { KC_NO, K61,   KC_NO, KC_NO, KC_NO, KC_NO, K66,   KC_NO }, \
    { KC_NO, K69,   KC_NO, K6B,   K6C,   KC_NO, KC_NO, KC_NO }, \
    { K70,   K71,   K72,   K73,   K74,   K75,   K76,   K77   }, \
    { K78,   K79,   K7A,   K7B,   K7C,   K7D,   K7E,   KC_NO }, \
    { KC_NO, KC_NO, KC_NO, K83,   KC_NO, KC_NO, KC_NO, KC_NO }, \
...
5C: pad under top part of Enter key (ANSI mod)
53: pad under left part of Enter key (ANSI mod)
13: pad under right part of Left Shift key
51: pad under left part of Right Shift key
19: pad for Left Alt key (ANSI mod)
39: pad for Left Alt key (ANSI mod)
68: pad under left part of numpad Zero key
78: pad under bottom part of numpad Plus key
*/
#define LAYOUT_ibm_f_at( \
    ...
    { KC_NO, K01,   KC_NO, K03,   K04,   K05,   K06,   KC_NO }, \
    { KC_NO, K09,   K0A,   K0B,   K0C,   K0D,   K0E,   KC_NO }, \
    { KC_NO, KC_NO, K12,   K13,   K14,   K15,   K16,   KC_NO }, \
    { KC_NO, K19,   K1A,   K1B,   K1C,   K1D,   K1E,   KC_NO }, \
    { KC_NO, K21,   K22,   K23,   K24,   K25,   K26,   KC_NO }, \
    { KC_NO, K29,   K2A,   K2B,   K2C,   K2D,   K2E,   KC_NO }, \
    { KC_NO, K31,   K32,   K33,   K34,   K35,   K36,   KC_NO }, \
    { KC_NO, K39,   K3A,   K3B,   K3C,   K3D,   K3E,   KC_NO }, \
    { KC_NO, K41,   K42,   K43,   K44,   K45,   K46,   KC_NO }, \
    { KC_NO, K49,   K4A,   K4B,   K4C,   K4D,   K4E,   KC_NO }, \
    { KC_NO, K51,   K52,   K53,   K54,   K55,   KC_NO, KC_NO }, \
    { K58,   K59,   K5A,   K5B,   K5C,   K5D,   KC_NO, KC_NO }, \
    { KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, K66,   KC_NO }, \
    { K68,   K69,   KC_NO, K6B,   K6C,   KC_NO, KC_NO, KC_NO }, \
    { K70,   K71,   K72,   K73,   K74,   K75,   K76,   K77   }, \
    { K78,   K79,   K7A,   K7B,   K7C,   K7D,   K7E,   KC_NO }, \
