...
const uint8_t map_cs1[MATRIX_ROWS][MATRIX_COLS] = {
    ...
    { 0x22, 0x23, 0x24, 0x25,     KC_MINUS, KC_EQUAL, KC_BSPACE,KC_TAB   }, /* 08-0F */
...
const uint8_t map_cs2[MATRIX_ROWS][MATRIX_COLS] = {
    ...
    { 0x08, 0x69, 0x52, 0x3B, 0x3D, 0x25, 0x24, 0x6f }, /* 40-47 */
    { 0x09, 0x68, 0x6a, 0x53, 0x54, 0x3C, 0x26, 0x58 }, /* 48-4F */
...
const uint8_t map_cs3[MATRIX_ROWS][MATRIX_COLS] = {
    { KC_KANA,  KC_LGUI,  KC_PSCR,  KC_VOLD,  KC_VOLU,  KC_MUTE,  KC_HENK,  KC_F1    }, /* 00-07 */
