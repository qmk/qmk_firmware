...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    RESET  ,KC_ESC,     KC_GRV,  KC_1,        KC_2,         KC_3,         KC_4,         KC_5,    KC_6,    KC_7,         KC_8,         KC_9,         KC_0,         KC_MINS, KC_EQL,  KC_NUHS, KC_BSPC,    KC_INS,  KC_HOME,KC_PGUP,    KC_NLCK,   KC_PSLS,KC_PAST,KC_PMNS,
    KC_SLCK,KC_MPLY,    KC_TAB,  ALL_T(KC_K), KC_U,         KC_Q,         KC_DOT,       KC_J,    KC_V,    KC_G,         KC_C,         KC_L,         KC_F,         KC_LBRC, KC_RBRC,          KC_SYSREQ,  KC_DEL,  KC_END, KC_PGDN,    KC_P7,     KC_P8,  KC_P9,  KC_PPLS,
