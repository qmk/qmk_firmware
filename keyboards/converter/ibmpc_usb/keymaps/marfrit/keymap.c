...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    RESET,  KC_MPLY,    KC_TAB,  ALL_T(KC_K), KC_U,         KC_Q,         KC_DOT,       KC_J,    KC_V,    KC_G,         KC_C,         KC_L,         KC_F,         KC_LBRC, KC_RBRC,          KC_SYSREQ,  KC_DEL,  KC_END, KC_PGDN,    KC_P7,     KC_P8,  KC_P9,  KC_PPLS,
