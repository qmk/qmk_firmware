...
#define RSHIFT_SL  RSFT_T(KC_SLSH)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_reviung34(
    ...
    LSHIFT_Z, KC_X,     KC_C,     KC_V,     KC_B,               KC_N,     KC_M,     KC_COMM,  KC_DOT,   RSHIFT_SL,
                        LCTL_TAB, LALT_ESC, LOWER_ENT,          RAISE_SPC
  ),
  
  /*
  [_PUSH] = LAYOUT_reviung34(
    KC_TAB,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            KC_PSCR,  XXXXXXX,  XXXXXXX,  KC_DEL,   KC_BSPC,
  ...
  */
  ...
  [_LOWER] = LAYOUT_reviung34(
    ...
    KC_LSFT,  KC_LGUI,  KC_LALT,  KC_CAPS,  KC_DQUO,            KC_HOME,  KC_END,   KC_PGUP,  KC_PGDN,  KC_RSFT,
                        KC_GRV,   KC_DEL,   _______,            _______
  ),
	
	[_RAISE] = LAYOUT_reviung34(
    KC_1,     KC_2,     KC_3,     KC_4,     KC_5,               KC_6,     KC_7,     KC_8,     KC_9,     KC_0,  
    KC_MINS,  KC_EQL,   KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_1,     KC_2,     KC_3,     KC_4,     KC_5,
    KC_LSFT,  KC_RGUI,  KC_RALT,  KC_CAPS,  KC_QUOT,            KC_EQL,  KC_PPLS,  KC_PMNS,  KC_PAST,  KC_PSLS,
                        KC_TILD,  KC_BSPC,  _______,            _______
  ),
