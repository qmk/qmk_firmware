...
inline void ergodox_right_led_1_off(void) { DDRB &= ~(1<<PB4); PORTB &= ~(1<<PB4); }
inline void ergodox_right_led_1_on(void)  { DDRB |=  (1<<PB4); PORTB &= ~(1<<PB4); }

inline void ergodox_right_led_2_off(void) { DDRB &= ~(1<<PB5); PORTB &= ~(1<<PB5); }
inline void ergodox_right_led_2_on(void)  { DDRB |=  (1<<PB5); PORTB |=  (1<<PB5); }

inline void ergodox_right_led_3_off(void) { DDRB &= ~(1<<PB6); PORTB &= ~(1<<PB6); }
inline void ergodox_right_led_3_on(void)  { DDRB |=  (1<<PB6); PORTB |=  (1<<PB6); }
