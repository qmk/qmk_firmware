...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_CLASSIC] = LAYOUT_Classic(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_END,            KC_PGDN, KC_N,	   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
                 KC_LGUI, KC_DEL,  KC_GRV,  KC_LALT, KC_SPC,  KC_SPC,  MO(_FN),  KC_SPC,  KC_SPC,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
	...
	/*Bizarre ANSI Base Layer
	* .--------.   .-------------------------------------------------------------.                 .--------------------------------------------------------------------------------.
	* | F2     |  | ESC    | ~`     | 1      | 2      | 3      | 4      | 5      |                 | 6      | 7      | 8      | 9      | 0      | -      | =      |  BACKSPACE      |
	* |--------|  '-----.--+--------+--------+--------+--------+--------+--------|                 |--------+--------+--------+--------+--------+--------+--------+--------------.-'
	* | DEL    |       |    TAB     | Q      | W      | E      | R      | T      |                 | Y      | U      | I      | O      | P      | [      | ]      |      |\      |
	* '--------'     ..'------------+--------+--------+--------+--------+--------|                 |--------+--------+--------+--------+--------+--------+-----------------------|
	*               |     LCTRL     | A      | S      | D      | F      | G      |                 | H      | J      | K      | L      | ;      | '      |         ENTER         |
	*          .----'---------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+------------------.---'
	*         |        LSHIFT       | Z      | X      | C      | V      | B      | LGUI   | FN     | N      | M      | ,      | .      | /      |      RSHIFT      | UP     |
	*         '----------.----------+--------+--------+------.-+--------+--------+--------+--------+--------+--------+--------+--------+--------+------------------+--------+--------.
	*                   |   LCTRL   |                       |    LALT   |      SPACE      |           SPACE        |                        |    RCTRL    | LEFT   | DOWN   | RIGHT  |
	*                   '----------'                        '-----------------------------------------------------'                         '---------------------------------------'
	*/
	
	[_BIZARRE] = LAYOUT_Bizarre_ANSI(
	  KC_F2,      KC_ESC,  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                       KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,
	  KC_DEL,              KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                       KC_Y,	 KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
	                       KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                       KC_H,	 KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
						   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LGUI,  MO(_FN), KC_N,	 KC_M,    KC_COMM, KC_DOT,  KC_SLSH,      KC_RSFT, 	   KC_UP,
						   KC_LCTL,                           KC_LALT,       KC_SPC,                KC_SPC,                                   KC_RCTL,    KC_LEFT, KC_DOWN, KC_RGHT
	), 
	
	/*Bizarre ANSI Function Layer
	* .--------.   .-------------------------------------------------------------.                 .--------------------------------------------------------------------------------.
	...
	*/
	...
	[_FN] = LAYOUT_Bizarre_ANSI(
	  RESET,      _______, _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                      KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,
