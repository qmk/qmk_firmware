...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_all(
		...
		KC_VC_HAND,  KC_VC_MUTE, KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                                      MO_FN,            KC_LEFT, KC_DOWN, KC_RGHT),
  ...
  // operations. The accent marks are placed by analogy with Mac OS.
	[_FUNCTION] = LAYOUT_all(
		RESET,    KC_TRNS,    KC_CGRV, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  XXXXXXX,          XXXXXXX,
