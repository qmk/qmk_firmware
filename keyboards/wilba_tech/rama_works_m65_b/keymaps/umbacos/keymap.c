...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MAIN] = LAYOUT_all(
      KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    IT_MINS, IT_EQL,  KC_BSPC, KC_DEL,    KC_HOME,
      KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    IT_LBRC, IT_RBRC, IT_LESS,            KC_END,
      MT(MOD_LCTL, KC_TAB),     KC_A,    KC_S,    LT(_NAVIGATE, KC_D),    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    IT_SCLN, IT_QUOT, KC_SFTENT, KC_PGUP,
      LT(_SHIFT, KC_DEL),        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    IT_COMM, IT_DOT,  IT_SLSH, MO(_SHIFT), KC_UP,  KC_PGDN,
      KC_LCTL, KC_LALT, KC_LGUI,          LT(_ACCENT, KC_SPC),                                               MO(_SERVICE), KC_LEFT,   KC_DOWN, KC_RGHT
  ),

  [_SHIFT] = LAYOUT_all(
      KC_ESC,     IT_EXLM,    IT_AT,   IT_SHRP, IT_DLR,  IT_PERC, IT_CRC,  IT_AMPR, IT_ASTR, IT_LPRN, IT_RPRN, IT_UNDS, IT_PLUS, S(KC_BSPC), S(KC_DEL), S(KC_HOME),
      ...
      S(KC_LCTL), S(KC_LALT), S(KC_LGUI),                         LT(_ACCENT, KC_SPC),                       MO(_SERVICE),   S(KC_LEFT), S(KC_DOWN), S(KC_RGHT)
  ),
  ...
  [_NAVIGATE] = LAYOUT_all(
      ...
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LSFT, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RIGHT,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_END,  KC_END, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
      XXXXXXX, XXXXXXX, XXXXXXX, KC_BSPC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
