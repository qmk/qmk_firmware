...
/* |--L1---+--L2---+--L3---+--L4---+--L5---+--L6---+--L7-----| |--R1---+--R2---+--R3---+--R4---+--R5---+--R6---+--R7---+--R8---+---R9--+--R10-- | */
	...
	xxxx,	xxxx,	RGB_VAD, RGB_VAI, xxxx,	xxxx,					    xxxx,	xxxx,	xxxx,	xxxx,	xxxx,	xxxx,	xxxx,			xxxx,
	xxxx,	xxxx,	RGB_SAD, RGB_SAI, xxxx,	xxxx,				    	xxxx,	xxxx,	xxxx,	xxxx,	xxxx,	xxxx,					xxxx,
	xxxx,	xxxx,	RGB_HUD, RGB_HUI, xxxx,	xxxx,	xxxx,   	xxxx,	xxxx,	xxxx,	xxxx,	xxxx,	xxxx,							xxxx,
							_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______
/* |-------+-------+-------+-------+-------+-------+---------| |--------+-------+-------+-------+-------+-------+-------+-------+-------+-------| */
)
