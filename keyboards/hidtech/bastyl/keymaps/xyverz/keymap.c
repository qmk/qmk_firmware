...
[_WINDOWS] = LAYOUT(
  ...
  KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,        KC_B,    KC_M,    KC_W,    VEEALT,  ZEDCTL,  KC_RSFT, \
...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, KC_UP,   _______, _______,     _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______, \
