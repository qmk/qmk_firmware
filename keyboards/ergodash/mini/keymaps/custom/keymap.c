...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  | GUI  |                    | Enter|   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | ESC |  ALT  |  ALt | Raise|||||||| Lower| GUI  |ESC   |||||||| BKSP| Enter| space|||||||| Left | Down |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_ESC, KC_LALT, KC_LALT, RAISE,             LOWER,   KC_LGUI, KC_ESC,        KC_BSPC, KC_ENT , KC_SPC,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   6  |   7  |   8  |   9  |   0  | GUI  |                    | ENTER|   N  |   M  |   <  |   >  |   ?  |Shiht |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | ESC |  ALT  |  ALt | Raise ||||||| Lower| GUI  |ESC   |||||||| Bksp | ENTER|space |||||||| Left | Down |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_LOWER] = LAYOUT(
    ...
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_LGUI,                        KC_ENT, KC_N,    KC_M,    KC_LT,   KC_GT,   KC_QUES, KC_RSFT, \
    KC_ESC, KC_LALT, KC_LALT, RAISE,             LOWER,   KC_LGUI, KC_ESC,        KC_BSPC, KC_ENT , KC_SPC,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
