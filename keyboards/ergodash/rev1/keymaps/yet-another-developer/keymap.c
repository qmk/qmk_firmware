...
#define LAYOUT_ergodash_pretty_base( \
  ...
  LAYOUT_ergodash_pretty_wrapper( \
      ...
      KC_TAB,  K11,     K12,     K13,     K14,     K15,     KC_DEL,                         KC_BSPC, K16,    K17,    K18,    K19,    K1A,         KC_QUOT, \
...
// Otherwise, it needs KC_*
  ...
  [_LOWER] = LAYOUT_ergodash_pretty_wrapper(
             KC_F11,  _________________FUNC_LEFT_________________, KC_RST ,                 _______, _________________FUNC_RIGHT________________, KC_F12,
             KC_TILD, _________________LOWER_L1__________________, _______,                 _______, _________________LOWER_R1__________________, KC_PIPE,
             _______, ___________________BLANK___________________, _______,                 _______, _________________LOWER_R2__________________, KC_DQUO,
             _______, ___________________BLANK___________________,                                   _________________LOWER_R3__________________, KC_PSCR,
  ...
  [_RAISE] = LAYOUT_ergodash_pretty_wrapper(
             KC_F12,  _________________FUNC_LEFT_________________, _______,                 KC_RST , _________________FUNC_RIGHT________________, KC_F11,
  ...
  [_ADJUST] = LAYOUT_ergodash_pretty_wrapper(
             ...
             VRSN,    _________________ADJUST_L1_________________, _______,                 _______, _________________ADJUST_R1_________________, KC_RST,
             _______, _________________ADJUST_L2_________________, _______,                 _______, _________________ADJUST_R2_________________, KC_RST,
