...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WINDOWS] = LAYOUT( \
    ...
    KC_DEL,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_ESC,                             KC_ENT,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    RAISE,                              KC_DEL,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SFT_ENT, \
    KC_LCTL, KC_LGUI, NUMPAD,  KC_LALT,          KC_LCTL, LOWER,   KC_SPC,           KC_ENT,  KC_LALT, KC_BSPC,          KC_RGUI, KC_APP,  KC_RALT, KC_RCTL  \
  ),
  ...
  [_LOWER] = LAYOUT( \
    ...
    KC_CAPS, KC_PGUP, KC_HOME, KC_UP,   KC_END,  _______, _______,                            _______, _______, KC_HOME, _______, KC_END,  KC_PGUP, KC_INS,  \
    _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,                            _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PGDN, _______, \
    _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, RAISE,                              _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, \
    _______, _______, _______, _______,          _______, LOWER,   _______,          _______, _______, _______,          _______, KC_PSCR, _______, _______  \
  ),
  ...
  [_ADJUST] = LAYOUT( \
    ...
    BL_BRTG, XXXXXXX, RGB_M_X, XXXXXXX, XXXXXXX, RGB_M_B, RAISE,                              XXXXXXX, RGB_M_SN,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, LOWER,   XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX  \
  )
};
