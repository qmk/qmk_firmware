...
#define CTLLTN LCTL_T(KC_LANG2)
#define CTLJPN RCTL_T(KC_LANG1)
#define SFTESC LSFT_T(KC_ESC)
#define SFTENT RSFT_T(KC_ENT)
#define OPTSPC LOPT_T(KC_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |Adjust| Hyper|  Opt |  CMD ||||||||CTLLTN|SFTESC|OPTSPC||||||||OPTSPC|SFTENT|CTLJPN|||||||| Left | Down |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_EQL ,                        KC_MINS, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS, \
    ...
    ADJUST , KC_HYPR, KC_LOPT, KC_LCMD,          CTLLTN,  SFTESC ,OPTSPC,          OPTSPC,SFTENT , CTLJPN,           KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
  ),
...
combo_t key_combos[COMBO_COUNT] = {
  [ER_LBRACKET] = COMBO(er_combo, KC_LBRC),
  [UI_RBRACKET] = COMBO(ui_combo, KC_RBRC),
  [WE_MINUS] = COMBO(we_combo, KC_MINS),
