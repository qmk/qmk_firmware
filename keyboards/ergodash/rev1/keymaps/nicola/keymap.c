...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    EISU ,                          NICOLA , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             LOWER,   KC_LSFT ,KC_SPC,         KC_ENT,KC_RSFT , RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
...
// 親指シフト
  [_NICOLA] = LAYOUT( \
    ...
    KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_DEL ,                        KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    EISU ,                          NICOLA , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             LOWER,   NLSHFT ,KC_SPC,          KC_ENT,NRSHFT , RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
// 親指シフト
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    EISU ,                          NICOLA , KC_N,    KC_M,    KC_LT,   KC_GT,   KC_QUES, KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             LOWER,   KC_LSFT ,KC_SPC,         KC_ENT,KC_RSFT , RAISE,            KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
  ),
