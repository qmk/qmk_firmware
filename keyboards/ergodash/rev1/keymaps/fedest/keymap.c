...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |  ~   |   !  |   @  |   #  |   $  |   %  |   {  |                    |   }  |   ^  |   &  |   *  |   (  |   )  |  |   |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | Tab  |   1  |   2  |   3  |   4  |   5  |PageUp|                    |PageDn|   H  |   J  |   K  |   L  |   :  |  "   |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
  ...
  [_LOWER] = LAYOUT( \
    ...
    ADJUST,  KC_LGUI, KC_LALT, KC_LGUI,          LOWER,   KC_SPC ,             KC_ENT , RGUI(KC_SPC),         CG_SWAP, KC_DOWN, KC_UP,   CG_NORM  \
  ),

  /* Raise NOT USED, LEFT FOR COMPATIBILITY
   * ,----------------------------------------------------------------------------------------------------------------------.
