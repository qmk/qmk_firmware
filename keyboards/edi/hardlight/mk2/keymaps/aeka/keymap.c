 ...
 */
  ...
  _______,   _______,  _______,  _______,  _______,  _______,  _______,  KC_UNDS, KC_EQL,  KC_LCBR, KC_RCBR, KC_BSLS, _______,    _______,   _______,   _______,
 ...
 */
  ...
  _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MINS, KC_PLUS, KC_LBRC, KC_RBRC, KC_PIPE,  _______,  _______,  _______, _______,
 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | Reset! | Aud IO | Clicky | CReset |        |        |        |  Hue+  |  Sat+  |  Val+  | Larsen |        | Reset  |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        | Click+ | Click- |        |        |        |  Hue-  |  Sat-  |  Val-  | Rswirl |        |        |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |
 * '-----------------------------------------------------------------------------------------------------------------------------------------------'
 */
  ...
  _______, AU_TOG,  CK_TOGG, CK_RST,  _______, _______, _______, RGB_HUI, RGB_SAI, RGB_VAI, RGB_M_SW,_______, RESET,   _______, _______, _______,
  _______, _______, CK_DOWN, CK_UP,   _______, _______, _______, RGB_HUD, RGB_SAD, RGB_VAD, RGB_M_K, _______, _______, _______, _______, _______, 
