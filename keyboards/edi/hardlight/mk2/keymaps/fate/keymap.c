 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | LCtrl  |  Lock  |   GUI  |   Alt  | Lower  | Space  |  Space | Raise  | Leader | RShift | Left   | Down   | Right  |   0    |   .    |  Enter |
 * '-----------------------------------------------------------------------------------------------------------------------------------------------'
 */
  ...
  KC_LCTL, KC_LOCK, KC_LGUI, KC_LALT, LOWER,   KC_SPC, KC_SPC, RAISE, KC_LEAD, KC_RSFT, KC_LEFT, KC_DOWN, KC_RGHT, KC_KP_0, KC_KP_DOT, KC_PENT
  ),
...
void matrix_scan_user(void) {
  LEADER_DICTIONARY() {
    ...
    SEQ_THREE_KEYS(KC_A, KC_S, KC_D) {
      SEND_STRING("inhaler345,dehumanization"SS_TAP(X_ENTER));
    }
    SEQ_THREE_KEYS(KC_K, KC_L, KC_SCLN) {
      SEND_STRING("rbedel"SS_TAP(X_TAB));
      SEND_STRING("Inhaler345,dehumanization"SS_TAP(X_ENTER));
    }
    SEQ_THREE_KEYS(KC_I, KC_O, KC_P) {
      SEND_STRING("Inhaler345,dehumanization"SS_TAP(X_ENTER));
    }
    ...
    SEQ_THREE_KEYS(KC_D, KC_I, KC_M) {
      SEND_STRING("https://destinyitemmanager.com/"SS_TAP(X_ENTER));
    }
  }
}