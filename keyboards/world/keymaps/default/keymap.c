...
[_BASE] = LAYOUT(
  ...
  _______, _______, TH_MED, TH_NAV, TH_MOU,       TH_SYM, TH_NUM, TH_FUN , _______, _______
),
...
[_MED] =  LAYOUT(
  ...
  _______, _______, _______, _______, _______,      KC_MSTP, KC_MPLY          , KC_KB_MUTE     , _______, _______
),
/* 
 * FUN
 */
