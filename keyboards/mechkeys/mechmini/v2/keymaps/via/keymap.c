...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_ortho(
		...
		KC_TRNS, BL_TOGG, BL_STEP, BL_UP,  BL_DOWN,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL,
		KC_TRNS, UG_TOGG, UG_NEXT, UG_VALU, UG_VALD, UG_HUEU, UG_HUED, UG_SATU, UG_SATD, KC_HOME, KC_END, KC_TRNS,
