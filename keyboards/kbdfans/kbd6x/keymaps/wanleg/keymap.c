...
[_QW] = LAYOUT_wrapper(
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,     KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, ONEHAND,
	  KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPACE,                 KC_RGUI, KC_RALT, KC_RCTL
      ),

[ONE] = LAYOUT_wrapper(
      RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,    KC_F6,  KC_F7,  KC_F8,   KC_F9,   KC_F10,  KC_MINS, KC_EQL,  KC_BSPC, KC_DEL,
      KC_TAB,  BL_BRTG, BL_DEC,  BL_INC,  BL_TOGG, BL_STEP,  BL_ON,  KC_U,   KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
      KC_CAPS, RGB_M_B, RGB_VAD, RGB_VAI, RGB_TOG, RGB_MOD,  KC_LEFT,KC_DOWN,KC_UP,   KC_RGHT, gGHERKIN,KC_QUOT, KC_ENT,
      KC_LSFT, RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, KC_B,     KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, _______,
	  KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPACE,                 KC_RGUI, KC_RALT, KC_RCTL
      ),	  
};