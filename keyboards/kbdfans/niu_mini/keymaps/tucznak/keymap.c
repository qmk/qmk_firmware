...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_ortho_4x12(
        _______, BL_STEP, _______,  KC_SLEP, _______, _______,     _______,     DM_REC1, DYN_MACRO_PLAY1, DYN_REC_STOP, _______, KC_VOLU,
        _______, VK_TOGG, RGB_MOD,  RGB_HUI, RGB_SAI, RGB_VAI,     _______,     DM_REC2, DYN_MACRO_PLAY2, _______,      _______, KC_VOLD,
