/*
2021 Anh Nguyen <anhnguyen97utc@gmail.com>
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_ESC, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12, KC_INS,KC_PSCR,KC_HOME,
        ...
        KC_LALT,KC_LGUI,KC_LCTL,                KC_SPC,                                 KC_RALT,KC_RALT,KC_RCTL,KC_LEFT,KC_DOWN,KC_RGHT
    ),
    [1] = LAYOUT(
        ...
        KC_CAPS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,        KC_INS,
