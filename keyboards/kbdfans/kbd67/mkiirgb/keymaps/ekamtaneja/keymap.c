...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[_DEF] = LAYOUT_65_ansi_blocker( /* Base */
			...
			MO(_FN), KC_A,    KC_S,          KC_D,          KC_F,          KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_TRNS,
		...
		[_ENG] = LAYOUT_65_ansi_blocker( /* Engrammer */
			...
			MO(_FN), KC_C,    KC_I,          KC_E,          KC_A,          KC_COMM, KC_DOT,  KC_H,    KC_T,    KC_S,    KC_N,    KC_Q,             KC_ENT,  KC_TRNS,
