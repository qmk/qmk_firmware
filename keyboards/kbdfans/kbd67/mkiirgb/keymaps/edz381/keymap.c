...
// Define LED segments. Light LEDs 6 to 9 and 12 to 15 red when caps lock is active.
...
const rgblight_segment_t PROGMEM FN1_active_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {9,2, HSV_CYAN}
);
