...
// KC_TRNS or _______ uses the next lowest non-transparent key
// XXXXXXX will ignore the key (KC_NOOP)

// Compile in qmk_firmware with this command:
// make kbdfans/kbd67/rev2:droxx
...
[_DRXXMAIN] = LAYOUT_65_ansi(
   ...
   * 
   * ,-----------------------------------------------------------------------------------------------------------------------------------------------------.
   * |KC_GRV,| KC_F1,|   KC_F2,|   KC_F3,|   KC_F4,|   KC_F5,|   KC_F6,|   KC_F7,|   KC_F8,|   KC_F9,|   KC_F0,|      DRXX,|    DRXX,|KC_DEL,     |KC_INS, |
   * |-----------------------------------------------------------------------------------------------------------------------------------------------------|
   * |DRXX,    |RGB_RMOD,|RGB_VAI,|RGB_MOD,|    DRXX,|    DRXX,|    DRXX,|    DRXX,|    DRXX,|    DRXX,|    DRXX,|       DRXX,|   DRXX, |  DRXX,  |KC_PAUS,|
   * |-----------------------------------------------------------------------------------------------------------------------------------------------------|
   * |DRXX,       |RGB_SPD,|RGB_VAD,|RGB_SPI,|    DRXX,|    DRXX,|    DRXX,|    DRXX,|    DRXX,|    DRXX,|    DRXX,   |  DRXX,  |DRXX,            |KC_SLCK,|
   * |-----------------------------------------------------------------------------------------------------------------------------------------------------|
   * |DRXX,         | DRXX,| GUI_OFF,|  GUI_ON,|    DRXX,|    DRXX,|    DRXX,|    DRXX,|       DRXX,|   DRXX,|    DRXX, |    DRXX,  |   BL_STEP?, |KC_PSCR,|
   * |-----------------------------------------------------------------------------------------------------------------------------------------------------|
   * |   DRXX,|    DRXX,|    DRXX,|                    DRXX,                         |   DRXX,|        DRXX,       |   DRXX,| BL_DEC?,| BL_TOGG?,|BL_INC?),|
   * `-----------------------------------------------------------------------------------------------------------------------------------------------------'
   */
