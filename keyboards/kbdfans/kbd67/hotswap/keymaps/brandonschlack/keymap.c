...
[LF_MAC] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, KC_MRWD, KC_MFFD, MC_PLYR, MM_RSFT,                   KC_PGUP, KC_VOLD, \
...
[LF_WIN] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          TG_MAGC,          KC_VOLU, \
  _______, _______, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MSTP, MM_RSFT,                   KC_PGUP, KC_VOLD, \
  _______, _______, _______,                   _______,                            _______, _______,                   KC_HOME, KC_PGDN, KC_END ),
