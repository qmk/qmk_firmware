...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_LCTL,    KC_LGUI,  KC_LALT,                  KC_SPC,  KC_SPC,  KC_SPC,                    KC_RALT,  TT(2),    TT(1),    KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
  ...
  [1] = LAYOUT(
    ...
    _______,       KC_MYCM,  _______,                      TD(TD_LD),  TD(TD_LD),  TD(TD_LD),                        _______,  _______,  _______,  _______,  _______,  _______
  ),
