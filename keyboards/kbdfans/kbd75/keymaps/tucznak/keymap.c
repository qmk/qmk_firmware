...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNC] = LAYOUT_ansi_1u(
        ...
        KC_TRNS, VK_TOGG, RGB_RMOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, KC_TRNS, KC_TRNS, KC_TRNS, DM_REC2, DYN_MACRO_PLAY2, KC_TRNS, KC_TRNS,
        KC_TRNS, BL_TOGG, BL_DEC, BL_INC, BL_BRTG, KC_TRNS, KC_TRNS, KC_TRNS, DYN_REC_STOP, DM_REC1, DYN_MACRO_PLAY1, KC_TRNS, KC_TRNS, KC_TRNS,
