...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1]	= LAYOUT_75_ansi(
		...
		_______,	RGB_M_P,	RGB_M_B,	RGB_M_R,	RGB_M_SW,	RGB_M_SN,	RGB_M_K,	RGB_M_G,	RGB_M_T,	_______,	_______,	_______,							_______,	KC_VOLD,	
		_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	X(LARR),	X(RARR),	DEBUG,		_______,							KC_BRIU,	KC_MUTE,
