...
[_WORKMAN] = LAYOUT_planck_grid(
    ...
    KC_TAB, LGUI_T(KC_A), LALT_T(KC_S), LCTL_T(KC_H), LSFT_T(KC_T), KC_G, KC_H, RSFT_T(KC_N), RCTL_T(KC_E), RALT_T(KC_O), RGUI_T(KC_I), KC_QUOT,
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |EEPROM|MUSmod|Aud on|Audoff|AGnorm|AGswap| DF0  | DF1  | DF2  |      |      | <EEPROM = 
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJ] = LAYOUT_planck_grid(
    ...
    XXXXXXX, EE_CLR, MU_NEXT, AU_ON, AU_OFF, AG_NORM, AG_SWAP, DF0, DF1, DF2, XXXXXXX, XXXXXXX,
