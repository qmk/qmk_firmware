...
, KC_Z,            KC_X,    KC_C,        KC_V,          KC_B,               ALT_T(KC_TAB), ALT_T(KC_INS),  KC_N,               KC_M,    KC_COMM,   KC_DOT,  SFT_T(KC_SLSH)
, KC_LCTRL,        KC_LGUI, KC_LALT,     KC_TAB,        LT(_SYMB_L,KC_ESC),          KC_LSFT,              LT(_SYMB_R,KC_SPC), KC_BSPC, KC_RALT,   KC_RGUI, KC_ENT
),
