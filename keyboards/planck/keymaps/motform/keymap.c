...
/* ABOUT THIS LAYOUT
 * 
 * Implements colemak-se: github.com/motform/colemak-se
 * Optimized for use with Emacs and Evil-mode
 * Only vetted for the MacOS implementation of Swedish QWERTY
 * Don’t forget to turn of dead keys!
 */
...
#define NO_EUR_MAC_V  ALGR(LSFT(KC_4))
...
(
 _______, NO_PIPE_MAC, NO_APOS, NO_AT_MAC_V, NO_EUR_MAC_V,  NO_AMPR, KC_DOWN, KC_NO,       KC_RGHT,     NO_GRV,  NO_GRV,  NO_TILD,
 ...
 * |      | Reset| Debug|      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|Audoff|AGnorm|AGswap|Colmak|      |      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
(
 ...
 _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, COLEMAK, _______,  _______, _______, _______,
