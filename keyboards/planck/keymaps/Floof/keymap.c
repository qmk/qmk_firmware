...
[_mainLayer] = LAYOUT_planck_grid(
    ...
    KC_LCTL,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, LT(_FN1, KC_QUOT),
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   LT(_FN2, KC_SLSH),
    KC_TRNS,  KC_CAPS, KC_LGUI, KC_LALT,MO(_FN2), KC_SPC,  KC_SPC,  KC_ENT,  MO(_FN1),KC_LEFT, KC_DOWN, KC_RGHT
),
