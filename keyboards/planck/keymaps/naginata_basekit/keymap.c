...
*/
  [_SRLBY] = LAYOUT_planck_grid(
    KC_ESC        ,KC_U          ,KC_I          ,KC_E          ,KC_R          ,KC_W          ,KC_P          ,KC_BSPC       ,KC_T          ,KC_O          ,KC_Y          ,KC_Q          , \
    CTL_T(KC_TAB) ,KC_K          ,KC_D          ,KC_G          ,KC_S          ,KC_QUOT       ,KC_F          ,KC_H          ,KC_L          ,KC_A          ,KC_J          ,KC_SCLN       , \
    KC_LSFT       ,KC_B          ,KC_Z          ,KC_X          ,KC_M          ,KC_C          ,KC_COMM       ,KC_N          ,KC_V          ,KC_DOT        ,KC_SLSH       ,KC_UP         , \
