 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI | Alt  | VIM  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {KC_LCTL, KC_LGUI, KC_LALT, VIM , LOWER,   KC_SPC,  KC_SPC,  RAISE,  BACKLIT, BL_DEC, BL_INC,  KC_DEL}
},
...
[_RAISE] = {
  ...
  {_______, _______, _______, _______, _______, _______, _______, _______, BL_TOGG, BL_DEC, BL_INC, KC_MPLY}
},
