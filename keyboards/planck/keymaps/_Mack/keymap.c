...
[_LOWER] = LAYOUT_planck_grid(
  ...
  {_______, LCTL(LGUI(KC_LEFT)), LCTL(LGUI(KC_RGHT)), _______, _______, KC_PGUP, KC_HOME, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE},
  {_______,             _______,             _______, _______, _______, KC_PGDN,  KC_END, _______, KC_COMM,  KC_DOT, _______, _______},
...
[_RAISE] = LAYOUT_planck_grid(
  ...
  {_______,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______, KC_COMM,  KC_DOT, _______, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT}
),
