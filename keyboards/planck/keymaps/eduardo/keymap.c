...
#define KC_SS LGUI(KC_SPC)  // Send Command + Space (for Spotlight search).
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | SS   | Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 * - Right Shift: Tap for Enter, hold for shift.
 * - Escape: Tap for Esc, hold for Ctrl.
 * - SS: Spotlight Search (i.e. Command + Space)
 */
[_QWERTY] = {
  ...
  {KC_SS,   KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
