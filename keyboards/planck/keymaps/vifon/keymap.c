...
[_PPG] = { /* Pure Pro: Gaming */
    ...
    {_______, _______, KM_LW  , _______, KM_RS  , _______, _______, KM_RS  , _______, _______, _______, _______},
},
[_NM] = { /* Numeric */
...
[_DYN]= { /* special */
    ...
    {_______,  _______,        _______,         _______, KM_PP_GAME, DF(_QW), DF(_QW), DF(_PP), _______, _______, _______, _______}
},
};
