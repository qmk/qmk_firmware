 ...
 */
        [_QWERTY] = {
            ...
            {LCTL(KC_TILDE), KC_LCTL, KC_LALT, KC_LGUI, LOWER, KC_SPC, KC_SPC, RAISE, KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT}},
 ...
 */
        [_LOWER] = {
            ...
            {KC_VOLD, KC_F7, KC_F8, KC_F9, _______, KC_PIPE, KC_BSLASH, _______, KC_KP_0, KC_KP_1, KC_KP_3, KC_KP_4},
 ...
 */
        [_RAISE] = {
            ...
            {KC_MS_ACCEL0, KC_BTN2, KC_MS_UP, KC_BTN1, KC_MS_WH_UP, _______, _______, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS},
            {KC_MS_ACCEL1, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_MS_WH_DOWN, _______, _______, KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, _______},
