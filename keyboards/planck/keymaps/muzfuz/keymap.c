 ...
 */
    ...
    [_LOWER] = LAYOUT_planck_grid(
        ...
        ESC_CTL, CLNEQLS, _______, KC_LCBR, KC_RCBR, KC_LPRN, KC_RPRN, KC_MINS, KC_EQL, KC_BSLS, KC_TILD, KC_GRV,
 ...
 */
    [_RAISE] = LAYOUT_planck_grid(
        ...
        ESC_CTL, _______, _______, _______, _______, _______, _______, KC_4, KC_5, KC_6, _______, _______,
