 ...
 */
[_QWERT__Y] = {
  {KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_BSPC, KC_ESC,  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P},
  ...
  {BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, KC_ENT,  LOWER,   RAISE,   KC_SPC,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
...
[_ADJUST] = {
  ...
  {_______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERT__Y, PLOVER,  _______, _______, _______},
  ...
  switch (keycode) {
    case QWERT__Y:
      if (record->event.pressed) {
        ...
        set_single_persistent_default_layer(_QWERT__Y);
      }
      return false;
      break;
    case LOWER:
