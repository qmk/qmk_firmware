...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, XXXXXXX, _______, _______, _______, KC_SPC,  KC_SPC,   _______,  KC_0,    KC_DOT,   KC_COMM,  XXXXXXX
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX,  KC_MINS,  KC_PLUS,  KC_TILD, KC_HASH, KC_LBRC, KC_RBRC, KC_PIPE, 
    _______,  XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX,  KC_UNDS,  KC_EQL,   KC_SLSH, KC_BSLS, KC_LCBR, KC_RCBR, MT(MOD_LSFT, KC_ENT), 
