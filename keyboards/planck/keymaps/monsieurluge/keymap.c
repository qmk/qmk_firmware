...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYMB] = {
    ...
    {_______, KC_GRV,  KC_LCBR, KC_RCBR, KC_EQUAL, KC_PLUS, KC_MINS, KC_UNDS, KC_LBRC, KC_RBRC, KC_PIPE, _______},
   ...
   * │     │     │     │     │     │     │     │     │     │play │vol+ │▒▒▒▒▒│
   * ├─────┼─────┼─────┼─────┼─────┴─────┼─────┴─────┼─────┼─────┼─────┼─────┤
   * │reset│QWERT│CUSTM│GAME │           │ print-scr │     │prev │vol- │next │
   * └─────┴─────┴─────┴─────┴───────────┴───────────┴─────┴─────┴─────┴─────┘
   */
  [_MEDIA] = {
    ...
    {RESET,   QWERTY,  CUSTOM,  GAMING,  _______, _______, SP_PSCR, SP_PSCR, _______, KC_MPRV, KC_VOLD, KC_MNXT}
  }
};
