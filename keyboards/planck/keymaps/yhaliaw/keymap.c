...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Lower
     * ,-----------------------------------------------------------------------------------.
     * | Caps |      | Ms 5 | Ms U | Ms 4 | Wh Up| MS 1 | Ms 2 | Acl 0| Acl 1| Acl 2|      |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      | Ms L | Ms D | Ms R | Ms 3 | Left | Down |  Up  | Right|  App | Enter|
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |      |      |      | Wh Dn| Pr Sc| Home |  End | Pg Up| Pg Dn|      |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |      |      |      |      |      |      |      |      |      |      |
     * `-----------------------------------------------------------------------------------'
     */
    [_LOWER] = LAYOUT_planck_grid(
        KC_CAPS, XXXXXXX, KC_BTN5, KC_MS_U, KC_BTN4, KC_WH_U, KC_BTN1, KC_BTN2, KC_ACL0, KC_ACL1, KC_ACL2, _______,
        _______, XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN3, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_APP,  KC_ENT,
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_D, KC_PSCR, KC_HOME, KC_END,  KC_PGUP, KC_PGDN, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
