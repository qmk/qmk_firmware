 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Hotkey| Ctrl | Alt  | GUI  |Lower |    Space    |Raise | GUI  | Alt  |Ctrl  |@     |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    HOTKEYS, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RGUI, KC_RALT, KC_RCTL,   NO_QUOT
),
...
[_RAISE] = LAYOUT_planck_grid(
    _______, NO_TILD, NO_DIAE, NO_GRV,  NO_BSLS, NO_CIRC, _______, KC_BRMD, KC_UP,   KC_BRMU,  KC_MNXT, _______,
    _______, _______, KC_LSFT, KC_LALT, KC_LGUI, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, KC_MPLY, _______,
    _______, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_MUTE, KC_VOLU,  KC_MPRV, _______,
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_HOTKEYS] = LAYOUT_planck_grid(
    _______, G(KC_5), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, G(KC_4), G(KC_3), G(KC_2), G(KC_1), _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
)
