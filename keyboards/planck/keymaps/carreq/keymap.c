...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______,  KC_TILD, _______, KC_SLSH, KC_LCBR,  KC_LBRC,  KC_RBRC,  KC_RCBR, KC_BSLS, KC_MINS, KC_EQL,  KC_PIPE,
...
[_FN] = LAYOUT_planck_grid(
    ...
    XXXXXXX,        KC_F11,  KC_F12,  _______, _______,  _______,  _______,  _______, _______, _______, _______, _______,
...
/* Adjust (Lower + Raise)
 * ,-----------------------------------------------------------------------------------.
 * | Reset|Qwerty|Workman|      |      |      |      |      |      |MIDIof|MIDIon|  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
    RESET,   QWERTY,  WORKMAN,   XXXXXXX,   XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   MI_OFF,   MI_ON,   KC_DEL,
