...
#define _MENT 0 // fn _MENTR Tap for enter, hold for _RS
 ...
 * |-----------------------------------------------------------------------|
 * | led | ctl | alt | ctl | lw  | spc | spc |mspc |left |down | up  |right|
 * `-----------------------------------------------------------------------'
 */
[_QW] = { /* Qwerty */
  ...
  {M(0),    KC_LALT, KC_LCTL, KC_LGUI, FUNC(_MENT), KC_SPC,  KC_SPC,  MO(_RS), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
...
const uint16_t PROGMEM fn_actions[] = {
  [_MENT] = ACTION_LAYER_TAP_KEY(_LW, KC_ENT), // Tap for enter, hold for _LW
};
