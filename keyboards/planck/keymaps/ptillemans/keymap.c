 ...
 * |   Z  |   X  |   C  |   V  |   B  |   [  |   ]  |   N  |   M  |   ,  |   .  |   /  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Raise| Tab  | super| Alt  |  BS  |   Ctrl/Esc  |Space | Lower| Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T, KC_UNDS, KC_PLUS,    KC_Y,    KC_U,   KC_I,    KC_O,    KC_P,
    ...
    LOWER, KC_TAB, KC_LGUI, KC_LSFT, KC_BSPC,    F(2),    F(2),  F(3),   RAISE, KC_QUOT, KC_LBRC,  F(1)
),
...
[_DVORAK] = LAYOUT_planck_grid(
    ...
    F(2)   ,    KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_SLSH,
    KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    F(1) ,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_VOLD, _______, _______, KC_MNXT, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_MPLY
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_DOT,     KC_0,  KC_RBRC
),
