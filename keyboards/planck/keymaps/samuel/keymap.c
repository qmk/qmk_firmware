 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | LGUI | Tab  | Alt  |Raise |Lower |Space |Symbol| Alt  | Tab  | RGUI | Ctrl |
 * `-----------------------------------------------------------------------------------'
 */
[_DVORAK] = {
...
[_LOWER] = {
	    ...
	    {_______,  KC_INS, LCTRL(KC_C), LCTRL(KC_X), LCTRL(KC_V), _______, _______,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______},
 ...
 */
[_RAISE] = {
	    {_______, KC_CIRC,    KC_1,    KC_2,     KC_3,  KC_EQL, _______, _______, _______, _______, _______, _______},
	    {_______,    KC_0,    KC_4,    KC_5,     KC_6, KC_ASTR, _______, _______, _______, _______, _______, _______},
	    {_______, KC_PLUS,    KC_7,    KC_8,     KC_9, KC_SLSH, _______, _______, _______, _______, _______, _______},
	    {_______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______}
},
