...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_TILD, TD(T_BR), TD(T_CU), TD(T_PA), TD(T_DL), KC_SLSH, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, KC_FORMAT,
...
[_META] = LAYOUT_planck_grid(
    ...
    XXXXXXX,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9, KC_RNME, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
