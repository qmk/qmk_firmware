 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Super| Alt  |Lower | Esc  | Ret  | Space| Bspc |Raise |AltGr |   *  |  ¨   |
 * `-----------------------------------------------------------------------------------'
 */
[_DEFAULT] = LAYOUT_planck_grid(
    KC_TAB        , KC_Q   , KC_W   , KC_E  , KC_R   , KC_T   ,  KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , NO_AA           ,
    UTILITY       , KC_A   , KC_S   , KC_D  , KC_F   , KC_G   ,  KC_H   , KC_J   , KC_K   , KC_L   , NO_OSLH, LT(_RAISE, NO_AE),
    KC_LSPO       , KC_Z   , KC_X   , KC_C  , KC_V   , KC_B   ,  KC_N   , KC_M   , KC_COMM, KC_DOT , NO_MINS, KC_RSPC         ,
    CTL_T(NO_APOS), KC_LALT, KC_LGUI, LOWER , KC_ESC , KC_ENT ,  KC_SPC , KC_BSPC, RAISE  , NO_ALGR, NO_ASTR, CTL_T(NO_TILD)
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_LSPO, NO_LESS, _______, _______, _______, NO_TILD, _______, _______, _______, KC_HOME, KC_END , KC_RSPC,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, NO_ALGR, _______, _______
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_LSPO, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_PGDN, KC_RSPC,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, NO_ALGR, _______, _______
),
 ...
 * |      | Reset|      |      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|Audoff|AGnorm|AGswap|Qwerty|      |      |Utilit|      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, DEFAULT,  XXXXXXX, XXXXXXX,  UTILITY,  _______,
