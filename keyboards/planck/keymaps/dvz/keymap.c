 ...
 * |      |   1  |   2  |   3  |   +  |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |   ,  |   .  |   0  |NumOFF| Lower|    Enter    |Raise |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_NUMPD] = LAYOUT_planck_grid(
LSFT_T(KC_PASTE),KC_P7,  KC_P8, KC_P9,  DE_SLSH, _______, _______, _______, _______, _______, _______,  _______,
...
LCTL_T(KC_COPY),KC_PDOT, KC_P0, KC_COMMA, NUMPD, KC_ENT, KC_ENT,  _______, KC_LEFT, KC_DOWN, KC_UP,    KC_RGHT
),
