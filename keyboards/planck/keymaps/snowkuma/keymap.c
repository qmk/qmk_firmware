...
[_REGEX] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, ___f___, _______, _______,  _______, KC_ENT,  _______, _______, _______
),
...
[_NUMBER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, ___f___, _______, _______, _______, _______, _______, _______, _______, _______
),
