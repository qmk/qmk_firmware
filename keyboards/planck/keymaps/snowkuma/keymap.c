...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_NUMBER] = LAYOUT_planck_wrapper(
     ...
     _______, _______, _______, _______, _______, _______, ________NUM_R4___________, _______, _______, _______
  ),
	...
	[_FUNCTION] = LAYOUT_planck_wrapper(
     ...
     _________________FUN_L1____________________, POWERDN, _______, _________________FUN_R1____________________, 
