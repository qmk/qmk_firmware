...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [ATRD] =  ACTION_TAP_DANCE_DOUBLE( KC_LALT, MO(TRD) )
    ,[ATRQ] = ACTION_TAP_DANCE_DOUBLE( KC_LALT, MO(TRQ) )
};
...
[_DVO] = {
  ...
  {KC_TAB , KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,  MO(MO)  },
  {KC_LSFT, KC_LCTL,TD(TD),   KC_LGUI, MO(SY),  KC_ENT,  KC_SPC,  MO(FN),  KC_LEFT, KC_DOWN, KC_UP, KC_RGHT }
},
[_TRD] = {
...
[_QWE] = {
  ...
  {_______,_______,TD(TQ),_______,_______,_______,_______,_______,_______,_______,_______,_______}
},
[_TRD] = {
...
// Game layer
[_GAM] = {
  { TG(GM),    KC_Q,    KC_W,    KC_E,    KC_R,   KC_T,    KC_UP,    KC_GRAVE, KC_7,    KC_8, KC_9,    KC_ESC  },
...
// Mouse control layer
[_MOU] = {
  { TG(MO),  XXX,           KC_MS_BTN1,    KC_MS_UP,   KC_MS_BTN2,  XXX,            XXX, XXX,     XXX, XXX,          XXX,          XXX        },
...
// Symbols layer
[_SYM] = {
  {TG(SY), KC_QUES,KC_LCBR,KC_LBRC,KC_LPRN,KC_BSLS,KC_SLSH,KC_RPRN,KC_RBRC,KC_RCBR,KC_PIPE,TUR_TL },
...
// Function layer
[_FUN] = {
  {TG(FN), TG(QW),TG(GM),MU_ON,  _______,_______,_______,   UTF_LI, UTF_WN ,KC_WAKE,KC_SLEP,KC_PWR },
