...
[_NUMBER] = LAYOUT_planck_grid(
    ...
    KC_LSFT, KC_UNDS, KC_MINS, KC_PLUS, KC_EQL,  KC_PIPE, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_SLSH, KC_SFTENT,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, -------, KC_RCTL, KC_SPC,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_ARROWS] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX,    XXXXXXX, KC_RCTL,    KC_SPC,  -------, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_CURSOR] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ACL1, KC_SPC,  XXXXXXX, -------, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_SYSTEM] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, -------, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KBOARD,  XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_KBOARD] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, -------, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, -------, XXXXXXX, XXXXXXX,  FMWare
),
