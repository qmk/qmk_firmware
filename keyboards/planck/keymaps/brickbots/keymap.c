/* Copyright 2015-2017 Jack Humbert - Modified by brickbots 2019
 *
...
[_QWERTY] = LAYOUT_planck_grid(
  ...
  _______, _______, _______, KC_LCTL, MO(_MOVE), KC_ENT, KC_SPC,  MO(_SYMB),  KC_RCTL, _______, _______, _______
),
...
uint32_t layer_state_set_user(uint32_t state) {
  return update_tri_layer_state(state, _MOVE, _SYMB, _ADJUST);
}
