 ...
 * |----------+------+------+------+------+------+------+------+------+------+------+--------|
 * | Brite    | Ctrl | Alt  | GUI  |Lower |  TC/Space   |Raise | Next | Vol- | Vol+ |  Play  |
 * `-----------------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   LT_TC,   LT_TC,   RAISE,   KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},
...
[_LOWER] = {
  ...
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MSTP, KC_MSEL, KC_MUTE}
},
...
[_RAISE] = {
  ...
  {KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_4,    KC_5,    KC_6, _______,    _______},
