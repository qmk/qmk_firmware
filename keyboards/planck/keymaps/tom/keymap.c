...
// SSRCB - screenshot region to clipboard - an alias for ctrl + cmd + shift + 4
...
[_ADJUST] = LAYOUT_planck_grid(
    SSRCB,   RESET,   DEBUG,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD,  RGB_VAI, RGB_VAD, KC_DEL ,
