...
[_BASE] = LAYOUT_ortho_4x12(
  ...
  KC_LCTL,  XXXXXXX,  KC_LGUI,  KC_LALT,  LOWER,    KC_SPC,   CU_ENT,   RAISE,    KC_RALT,  KC_RGUI,  KC_APP,   KC_RCTL
),
...
[_NAV] = LAYOUT_ortho_4x12(
  ...
  RESET,    CU_ESCT,  _______,  _______,  _______,  KC_SPC,   CU_ENT,   _______,  _______,  _______,  _______,  CU_GAME
)
