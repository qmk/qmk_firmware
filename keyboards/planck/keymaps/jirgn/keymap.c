 ...
 *              |------+------+------+------+------+-------------+------+------+------+------+------|
 * Tab for Esc--| Ctrl |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |   ;  | Ctrl |--Tab for "
 *              |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_LOWER] = {
  ...
  {CTL_T(KC_DEL), KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS,    KC_PLUS,    KC_LCBR, KC_RCBR, KC_PIPE},
...
[_RAISE] = {
  ...
  {CTL_T(KC_DEL), KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS},
