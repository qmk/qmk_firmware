...
[_HRQWERTY] = LAYOUT_planck_grid(
		...
		KC_TRNS, LGUI_T(KC_A), LALT_T(KC_S), LSFT_T(KC_D), LCTL_T(KC_F), KC_G, KC_H, RCTL_T(KC_J), RSFT_T(KC_K), LALT_T(KC_L), RGUI_T(KC_SCLN), KC_TRNS, 
...
[_HRCOLEMAK] = LAYOUT_planck_grid(
		KC_TRNS,	KC_Q,	KC_W,	KC_F,	KC_P,	KC_B,	KC_J,	KC_L,		KC_U,		KC_Y,		KC_SCLN,	KC_TRNS, 
		KC_TRNS, LGUI_T(KC_A), LALT_T(KC_R), LSFT_T(KC_S), LCTL_T(KC_T), KC_G, KC_M, RCTL_T(KC_N), RSFT_T(KC_E), LALT_T(KC_I), RGUI_T(KC_O), KC_TRNS, 
		KC_TRNS, KC_Z,	KC_X,	KC_C,	KC_D,	KC_V,	KC_K,	KC_H,	KC_COMM, KC_DOT,	KC_SLSH,	KC_TRNS, 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
...
[_ADJUST] = LAYOUT_planck_grid(
		...
		LALT(KC_GRV), EEP_RST, MU_MOD, AU_ON, AU_OFF, AG_NORM, AG_SWAP, QWERTY, COLEMAK, WIDEQWERTY, WIDECOLEMAK, GAMING, 
		KC_TRNS, MUV_DE, MUV_IN, MU_ON, MU_OFF, MI_ON, MI_OFF, HRQWERTY, HRCOLEMAK, TERM_ON, TERM_OFF, KC_TRNS, 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),

[_NAV] = LAYOUT_planck_grid(
		LALT(KC_LSFT), KC_NO, LCTL(KC_RGHT), LCTL(KC_RGHT), LCTL(KC_Y), KC_NO, LCTL(KC_C), LCTL(KC_Z), KC_PGUP, KC_NO, LCTL(KC_V), KC_NO, 
		LALT(KC_GRV), KC_NO, KC_NO, LCTL(KC_X), KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, 
		MO(_NAV2), KC_NO, LCTL(KC_X), LCTL(KC_X), KC_NO, LCTL(KC_LEFT), KC_NO, KC_PGDN, KC_NO, KC_NO, LCTL(KC_F), KC_TRNS, 
  ...
  switch (keycode) {
    ...
    case WIDECOLEMAK:
      ...
      break;
		case HRQWERTY:
      if (record->event.pressed) {
        set_single_persistent_default_layer(_HRQWERTY);
      }
      return false;
      break;
		case HRCOLEMAK:
...
// Light LEDs 1 to 9 in orange when WIDEQWERTY is active
const rgblight_segment_t PROGMEM my_layer1_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {1, 9, HSV_CYAN}
);
// Light LEDs 1 to 9 in yellow when WIDECOLEMAK is active
const rgblight_segment_t PROGMEM my_layer2_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {1, 9, HSV_WHITE}
);
// Light LEDs 1 to 9 in red when HRQWERTY is active
const rgblight_segment_t PROGMEM my_layer3_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {1, 9, HSV_GREEN}
);
// Light LEDs 1 to 9 in red when HRCOLEMAK is active
...
const rgblight_segment_t* const PROGMEM my_rgb_layers[] = RGBLIGHT_LAYERS_LIST(
    my_layer0_layer, 		// colemak
		my_layer1_layer, 		// wideqwerty
    my_layer2_layer,    // widecolemak
		my_layer3_layer,    // hrqwerty
		my_layer4_layer,    // hrcolemak
		my_layer5_layer,    // gaming
...
layer_state_t default_layer_state_set_user(layer_state_t state) {
    rgblight_set_layer_state(0, layer_state_cmp(state, _COLEMAK));
		rgblight_set_layer_state(1, layer_state_cmp(state, _WIDEQWERTY));
		rgblight_set_layer_state(2, layer_state_cmp(state, _WIDECOLEMAK));
		rgblight_set_layer_state(3, layer_state_cmp(state, _HRQWERTY));
		rgblight_set_layer_state(4, layer_state_cmp(state, _HRCOLEMAK));
    return state;
}
