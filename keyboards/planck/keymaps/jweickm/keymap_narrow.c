...
[_QWERTY] = LAYOUT_planck_grid(
		...
		LCTL_T(KC_ESC),		KC_A,	KC_S,	KC_D,	KC_F,	KC_G,	KC_H,  KC_J,	KC_K,	KC_L,		KC_SCLN,	TD(TD_QUO_BRC),	
...
[_WIDECOLEMAK] = LAYOUT_planck_grid(
		KC_Q, KC_W, KC_F, KC_P, KC_B, KC_LBRC,  KC_J, KC_L, KC_U, 	 KC_Y,	 KC_SCLN, KC_LBRC,
		KC_A, KC_R, KC_S, KC_T, KC_G, KC_GRV,	 KC_M, KC_N, KC_E, 	 KC_I,	 KC_O, KC_QUOT,
		KC_Z, KC_X, KC_C, KC_D, KC_V, KC_LPRN,  KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, KC_MINS, 
      KC_TRNS, KC_TRNS, LCTL_T(KC_ESC), OSM(MOD_LSFT), LT(_LOWER, KC_BSPC), KC_TRNS, KC_TRNS, LT(_RAISE, KC_TAB), RCTL_T(KC_SPC), RSFT_T(KC_ENT), KC_LEFT, KC_RIGHT
),
...
[_HRWIDECOLEMAK] = LAYOUT_planck_grid(
		...
		KC_TRNS, KC_TRNS, LCTL_T(KC_ESC), OSM(MOD_LSFT), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LSFT_T(KC_SPC), LCTL_T(KC_TAB), KC_TRNS, HRCOLEMAK
),
...
[_ADJUST] = LAYOUT_planck_grid(
		...
		LALT(KC_GRV), EEP_RST, MU_MOD, AU_ON, AU_OFF, AG_NORM, AG_SWAP, QWERTY, COLEMAK, WIDECOLEMAK, HRWIDECOLEMAK, GAMING, 
		KC_TRNS, MUV_DE, MUV_IN, MU_ON, MU_OFF, MI_ON, MI_OFF, KC_NO, HRCOLEMAK, KC_TRNS, TERM_OFF, KC_TRNS, 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
...
[_NAV] = LAYOUT_planck_grid(
		...
		MO(_NAV2), KC_NO, LCTL(KC_X), LCTL(KC_X), KC_BTN2, VIM_V, KC_NO, KC_PGDN, TG(_NAV), KC_NO, LCTL(KC_F), KC_TRNS, 
...
[_MOUSE] = LAYOUT_planck_grid(
		...
		KC_TRNS, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_ACL2, KC_ACL2, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO
),
