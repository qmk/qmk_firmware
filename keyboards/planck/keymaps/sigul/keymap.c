...
[_NUMPAD] = LAYOUT_ortho_4x12(
    _______, _______, _______, _______, _______, _______, _______, _______, IT_7,    IT_8, IT_9,    IT_MINS,
    _______, _______, _______, _______, _______, _______, _______, _______, IT_4,    IT_5, IT_6,    IT_PLUS,
    _______, _______, _______, _______, _______, _______, NUMPAD,  _______, IT_1,    IT_2, IT_3,    IT_EQL,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, IT_0, IT_SLSH, IT_ASTR
),
...
[_ADJUST] = LAYOUT_ortho_4x12(
    ...
    _______, _______,    DEBUG,   _______, _______, _______, _______, _______, _______, _______, _______, _______,
 ...
 * |      |      |      |      |      |      |      |      |      |Scr Up|Scr Do|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | MOUSE|      |      |      |But1  |      |      |But2  | Left | Down | Up   |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_MOUSE] = LAYOUT_ortho_4x12(
    ...
    _______, _______, _______, _______, _______,    _______, _______, _______,    _______,    _______,       _______,     _______,
    _______, _______, _______, _______, _______,    _______, _______, _______,    _______,    KC_MS_WH_DOWN, KC_MS_WH_UP, _______,
    MOUSE,   _______, _______, _______, KC_MS_BTN1, _______, _______, KC_MS_BTN2, KC_MS_LEFT, KC_MS_DOWN,    KC_MS_UP,    KC_MS_RIGHT
)
