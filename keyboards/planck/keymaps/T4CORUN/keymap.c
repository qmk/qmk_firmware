...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOUSEKEYS] = LAYOUT_ortho_4x12_wrapper(
      //_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
        ...
        _______________MOUSE_KEYS_L3_______________, _____NONE_2_____, _______________MOUSE_KEYS_R3_______________,
        _____NONE_2_____, ______MOUSE_KEYS_L4______, _____NONE_2_____, ______MOUSE_KEYS_R4______, ___x___, KC_ESC
    ),
