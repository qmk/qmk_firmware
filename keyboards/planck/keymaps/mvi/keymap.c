...
/* Numpad
 *,-----------------------------------------------------------------------------------------------------------.
 *| Tab    | F1     | F2     | F3     | F4     | -      | Up     | VerN   | 7      | 8      | 9      | BSpc   |
 *|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 *| Esc    | F5     | F6     | F7     | F8     | +      | Left   | Right  | 4      | 5      | 6      | /      |
 *|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 *| CapsLck| F9     | F10    | F11    | F12    | =      | Down   | .      | 1      | 2      | 3      | =      |
 *|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 *| Ctrl   | Cut    | Copy   | Paste  | Lower  | Enter  | Space  | Raise  | *      | .      | 0      | Enter  |
 *`-----------------------------------------------------------------------------------------------------------'
 */
[_NUMPAD] = LAYOUT_planck_grid(
    KC_TAB,  KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_PMNS, KC_UP,   KC_NLCK, KC_P7,   KC_P8,   KC_P9, KC_BSPC,
    KC_ESC,  GUI_F5,  ALT_F6,  SFT_F7,  CTL_F8, KC_PPLS, KC_LEFT, KC_RGHT, KC_P4,   KC_P5,   KC_P6, KC_PSLS,
    KC_CAPS, KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_PEQL, KC_DOWN, KC_PDOT, KC_P1,   KC_P2,   KC_P3, KC_PEQL,
    KC_LCTL, MVI_CUT, MVI_CPY, MVI_PST, LOWER,  TC_PENT, TC_SPC,  RAISE,   KC_PAST, KC_PDOT, KC_P0, KC_PENT
),
 ...
 *,-----------------------------------------------------------------------------------------------------------.
 *| Tab    |Wh.Up   | Wh.L   | Ms.Up  | Wh.R   |Butt.1  |Insert  | Home   |  Up    | PgUp   |Butt.1  |Accl 2  |
 *|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 *| Esc    |Wh.Do   | Ms.L   | Ms.Do  | Ms.R   |Butt.2  | Del    | Left   | Down   |Right   |Butt.2  |Accl 1  |
 *|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 *| CapsLck|        |        |        |Butt.4  |Butt.3  |Butt.5  | End    | Down   | PgDo   |Butt.3  |Accl 0  |
 *|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 *|        |        |Accl 1  |Accl 1  |Accl 0  |        |        |        |        |        |        |        |
 *`-----------------------------------------------------------------------------------------------------------'
 *
 */
[_TOUCHCURSOR] = LAYOUT_planck_grid(
    ...
    KC_ESC,  KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN2, KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT, KC_BTN2, KC_ACL1,
    KC_CAPS, _______, _______, _______, KC_BTN4, KC_BTN3, KC_BTN5, KC_END,  KC_DOWN, KC_PGDN, KC_BTN3, KC_ACL0,
    _______, _______, KC_ACL2, KC_ACL1, KC_ACL0, _______, _______, _______, _______, _______, _______, _______
),

/* Adjust (Lower + Raise)
 *,-----------------------------------------------------------------------------------------------------------.
 *| Reset  | ClrKbd |        |        |        |        |        | TermOn | TermOff|        |        | Del    |
 *|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 *| ClrKbd |        | MusMod |Aud on  |Audoff  |AGnorm  |AGswap  | Bepo   |Numpad  |        |Plover  | Debug  |
 *|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
