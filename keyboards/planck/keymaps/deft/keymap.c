 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |Paste |      |             |  NO  | NumE | Home | Pgdn | End  |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_planck_grid(
     KC_DEL, A(KC_1), A(KC_2), A(KC_3), A(KC_4), S(KC_9), S(KC_0),   KC_P7,   KC_P8,   KC_P9,   KC_P0, _______,
    _______,  KC_GRV,S(KC_BSLS),KC_EQL, KC_MINS,S(KC_COMM),S(KC_DOT),KC_P4,   KC_P5,   KC_P6, KC_PDOT, KC_NLCK,
    _______, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, KC_LBRC, KC_RBRC,   KC_P1,   KC_P2,   KC_P3, KC_PGUP, KC_PEQL,
    _______, _______, _______, C(KC_V), _______, _______, _______,   KC_NO, KC_PENT, KC_HOME,KC_PGDOWN, KC_END
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, C(KC_X),   KC_NO, _______, _______, _______, _______, KC_MPLY, KC_VOLD, KC_MNXT
),
