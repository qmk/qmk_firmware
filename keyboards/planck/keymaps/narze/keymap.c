...
[_QWERTY] = {
  ...
  {RAISE,   KC_LCTL, KC_LALT, LGUI_T(KC_UNDS), LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
...
[_COLEMAK] = {
  ...
  {BACKLIT, KC_LCTL, KC_LALT, LGUI_T(KC_UNDS), LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
