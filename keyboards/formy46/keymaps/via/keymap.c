...
void joystick_task(){
	switch (joystickMode) {
	case 0: // gamepad
		joystick_status.axes[0] = analogReadPin(F5)/4 - 128;
    ...
    case 2: // mouse
        ...
        currentReport.x = (analogReadPin(F5) - 512) / joystickResolution;
        currentReport.y = (analogReadPin(F4) - 512) / joystickResolution;
