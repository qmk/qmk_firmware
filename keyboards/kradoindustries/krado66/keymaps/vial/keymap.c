...
*/
    ...
    [_FUNCTION] = LAYOUT(
        RESET,   QWERTYX, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  RESET,   \
                 QWERTY,  KC_HOME, KC_UP,   KC_END,  KC_PGUP, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS,  KC_TRNS, KC_PSCR, KC_TRNS, KC_TRNS, KC_BSLS,          \
        ...
        KC_TRNS, KC_TRNS, KC_TRNS,                   KC_TRNS, KC_ENT,  EXTRA,                   KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_END   \
        ), 
 ...
 *  |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |  
 *  +--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
 *       |  QWERTY    | HOME   | UP     | END    | PGUP   |        |        |        | INS    |        | Print  |        |        |  PIPE \     |
 *       |            |        |        |        |        |        |        |        |        |        | Screen |        |        |             |  
 *    +---------------+--------+--------+--------+--------+------- +--------+--------+--------+--------+--------+--------|--------+-------------+
 ...
 * |                  |        |        |        |        |        |        |        |        |        |        |                |        |        |
 * |----------+----------+----------+---------------------------------------------------------+--------+--------+----------------+--------+--------+
 * |          |          |          |        Fn         |   ENTER     |     EXTRA            |        |        |        | HOME   | PAGEDN | END    |
 * |          |          |          |                   |             |                      |        |        |        |        |        |        |  
 * '--------------------------------------------------------------------------------------------------------------------------------------+--------+
 */

    [_EXTRA] = LAYOUT(
        RESET,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PMNS, KC_PPLS, KC_BSPC, KC_TRNS, \
                 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P7,   KC_P8,   KC_P9,   KC_TRNS, KC_TRNS, KC_DEL,           \
                 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P4,   KC_P5,   KC_P6,   KC_TRNS, KC_PENT,                   \
                 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P1,   KC_P2,   KC_P3,   KC_PPLS,          KC_TRNS, KC_TRNS, \
        KC_TRNS, KC_TRNS, KC_TRNS,                   EXTRA,   KC_TAB,  KC_P0,                     KC_PDOT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS   \
        ), 
