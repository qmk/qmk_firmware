...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    * | CAPS   |   a    |   s    |   d    |   f    |   g    |   6    |   h    |   j    |   k    |   l    |   ;    |   '    | ENTER  |
    * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    * | SHIFT  |   z    |   x    |   c    |   v    |   b    |   7    |   n    |   m    |   ,    |   .    |   /    |  UP    | SHIFT  |
    * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    * | CTRL   |  GUI   |  ALT   | SPACE  | SPACE  | SPACE  | LOWER  | RAISE  |   =    |   \    |  CTRL  |  LEFT  |  DOWN  | RIGHT  |
    * `-----------------------------------------------------------------------------------------------------------------------------'
    */
    [_DEFAULT] = LAYOUT(
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,                                            KC_8,    KC_9,    KC_0,    KC_MINS, KC_BSPC,
      KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,   KC_5,       KC_Y,       KC_U,   KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,
      KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,   KC_6,       KC_H,       KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_7,       KC_N,       KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_UP,   KC_RSFT,
      KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_SPC,  KC_SPC, FN_MO23,    FN_MO13,    KC_EQL, KC_BSLS, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
   /* RAISE
    * ,--------------------------------------------.                                   .--------------------------------------------.
    * |  ESC   |        |        |        |        |                                   |        |        |        |        |  DEL   |
