...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    * | SHIFT  |   z    |   x    |   c    |   v    |   b    |   7    |   n    |   m    |   ,    |   .    |   /    |  ª    | SHIFT  |
    * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    * | CTRL   |  GUI   |  ALT   |        | MUHEN  | SPACE  | LOWER  | RAISE  |   =    |   \    |  CTRL  |  ©    |  «    |  ¨    |
    * `-----------------------------------------------------------------------------------------------------------------------------'
    */
    [_DEFAULT] = LAYOUT(
      ...
      KC_LCTL, KC_LGUI, KC_LALT, _______, KC_MHEN, KC_SPC, MO(_LOWER), MO(_RAISE), KC_EQL, KC_BSLS, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
   /* RAISE
    * ,--------------------------------------------.                                   .--------------------------------------------.
    * |  ESC   |        |        |        |        |                                   |        |        |        |        |  DEL   |
