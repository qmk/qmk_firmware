...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
      ...
      KC_LSFT, KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, MO(_RAISE), MO(_LOWER), KC_RCTL, KC_RSFT, KC_ENT
    ),
   /* RAISE
    * ,--------------------------.                                   .--------------------------.
    * |        |        |        |                                   |        |        |  DEL   |
    ...
    */
    [_LOWER] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
      _______, _______, _______, _______, _______, RGB_TOG, _______, RGB_VAI, RGB_HUI, RGB_SAI
    )
};
