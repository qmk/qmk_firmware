...
#define RGB_MATRIX_BAT_VAL 150 // LED brightness for battery indicator
/* Battery Indicator Thresholds and Colors*/
#define IM_BAT_REQ_LEVEL1_VAL 51
#define IM_BAT_REQ_LEVEL1_COLOR 0x00, RGB_MATRIX_BAT_VAL, 0x00

#define IM_BAT_REQ_LEVEL2_VAL 21
