...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LNG2,                            KC_UNDS, KC_PLUS, KC_PIPE, KC_LCBR, KC_RCBR, KC_TILD,
    ...
    [2] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, KC_LALT,    KC_1,    KC_2,    KC_3,    KC_0,                            KC_LNG1, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                            _______, _______,  _______,         _______,  _______, _______
    ),
