...
[_ADJUST] = {
  ...
  {_______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  TERM_ON, TERM_OFF, _______, _______, RGB_TOG},
  {_______, _______, _______, _______, _______, _______, _______, _______, RGB_RMOD, RGB_MOD, RGB_SLOWER,RGB_FASTER}
}
