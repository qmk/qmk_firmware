...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_BL] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                         KC_SPC,                             KC_RALT, KC_RGUI, MO(_FL1),          KC_RCTL,   KC_LEFT,  KC_DOWN,  KC_RGHT
        ),
    ...
    */
    [_FL1] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, BL_DOWN, BL_UP,   _______, KC_MUTE,          _______,          KC_VOLU,
