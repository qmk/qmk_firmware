...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_FL1] = LAYOUT_65_ansi_blocker(
        ...
        UG_TOGG, UG_VALU, UG_SATU, UG_HUEU, QK_BOOT, _______, _______, _______, _______, _______, _______, _______, _______,          _______, KC_INS,
        _______, UG_VALD, UG_SATD, UG_HUED, _______, _______, _______, _______, _______, _______, _______, _______,                   _______, KC_HOME,
