...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_5x15(
        ...
        KC_QUOT, KC_A,    KC_S,    KC_D,    KC_F,         KC_G,         LGUI(KC_LBRC),  LGUI(KC_RBRC),  KC_H,         KC_J,         KC_K,    KC_L,    KC_SCLN, KC_QUOT,    KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,         KC_B,         LGUI(KC_QUES),  LGUI(KC_SLSH),  KC_N,         KC_M,         KC_COMM, KC_DOT,  KC_SLSH, KC_UP,      KC_RSFT,
        MO(2),   KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,       LT(1,KC_SPC), LGUI(KC_SPC),   KC_NO,          LT(1,KC_SPC), KC_SPC,       KC_RGUI, KC_RALT,   KC_LEFT, KC_DOWN,    KC_RGHT
    ),

    [1] = LAYOUT_ortho_5x15(
        KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_MINS, KC_EQL,  KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,       LGUI(KC_1),    KC_DEL,
        KC_GRV,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_LCBR, KC_RCBR, KC_NO,   KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC,       KC_NO,         KC_NO,
        KC_GRV,  KC_TILD, KC_AT,   KC_PERC, KC_AMPR, KC_ASTR, KC_LBRC, KC_RBRC, KC_HASH, KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN,       KC_NO,         KC_PENT,
    ...
    [2] = LAYOUT_ortho_5x15(
        ...
        KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, MO(15),   KC_NO,      KC_NO,     MO(15), KC_NO, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_END
    ),
    ...
    [3] = LAYOUT_ortho_5x15(
        ...
        MO(15), KC_LCTL,  KC_LALT,  KC_LGUI,  MI_BENDD, MI_SUS,   MI_SUS,   KC_NO,   MI_SUS,   MI_BENDU, KC_NO,    KC_NO,    MI_MODSD, MI_MODSU, MI_OCTD
    ),
    ...
    [15] = LAYOUT_ortho_5x15(
        ...
        KC_TRNS,  KC_NO,   KC_NO,   KC_TRNS,  KC_TRNS,   DF(0),   DF(0),  DF(0),   DF(0), KC_TRNS, KC_TRNS,  KC_TRNS,KC_NO,  KC_NO,  KC_NO
    )
};
