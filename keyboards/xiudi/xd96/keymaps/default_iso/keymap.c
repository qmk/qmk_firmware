...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_96_iso(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             L1_RALT, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT, KC_P0,   KC_PDOT, KC_PENT
    ),
    ...
    [1] = LAYOUT_96_iso(
        ...
        _______, UG_TOGG, UG_NEXT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______,
