...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_split_spacebar(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,         MO(1),    KC_SPC,     KC_RCTL, MO(2),   KC_LEFT,  KC_DOWN, KC_UP,   KC_RGHT),
    ...
    LAYOUT_split_spacebar(
        ...
        KC_LSFT, KC_NO, KC_F12, LCTL(LGUI(KC_LEFT)), LCTL(LGUI(KC_RIGHT)), KC_NO, KC_NO, KC_NO, KC_DEL, KC_NO, KC_NO, KC_NO, KC_NO, KC_RSFT, KC_DEL,
        KC_LCTL, KC_LGUI, KC_LALT,       KC_TRNS, KC_SPC,         KC_RCTL, KC_NO,  KC_LEFT,  KC_DOWN, KC_UP, TD(TD_RIGHT_GAMINGPROFILE)),
    ...
    LAYOUT_split_spacebar(
        ...
        KC_CAPS, KC_A,    KC_S,     KC_D,  KC_F, KC_G, KC_H, KC_J, KC_K, KC_L,    KC_SCLN, KC_QUOT,  KC_NO,   KC_ENT,
        KC_LSFT, KC_NO,   KC_Z,     KC_X,  KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT,  KC_SLSH,  KC_NO,   KC_RSFT, KC_DEL,
        KC_LCTL, KC_LGUI, KC_LALT,         KC_SPC,    KC_SPC,     KC_RCTL, KC_RALT,   KC_LEFT,  KC_DOWN, KC_UP,   TD(TD_RIGHT_GAMINGPROFILE)),
};
