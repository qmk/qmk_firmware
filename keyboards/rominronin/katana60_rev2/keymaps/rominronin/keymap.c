...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(/* Base */
  KC_ESC,  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_ESC,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_PLUS,
  ...
  MO(2),   KC_LCTL, KC_LALT, KC_LGUI,                   KC_BSPC, KC_ENT,  K_SPCFN,          KC_RGUI, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT
        ),
[NUMB] = LAYOUT(
  ...
  _______, _______, _______, _______,                            KC_BTN1, KC_P0,   _______,          KC_PDOT, KC_PENT, _______, _______, _______
    ),
[SYMB] = LAYOUT(
