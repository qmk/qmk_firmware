...
Hardware Supported: Katana60 PCB v1
Hardware Availability: the v1 is no longer available, the v2 can be found at [candykeys.com](https://candykeys.com/product/katana60-pcb-V2)

Make example for this keyboard (after setting up your build environment):

    make rominronin/katana60:default
