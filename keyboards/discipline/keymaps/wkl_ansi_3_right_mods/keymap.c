...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT_wkl_ansi_3_right_mods(
      ...
      KC_LCTL, KC_NO,   KC_LALT,                          KC_SPC,                 KC_RALT, MO(_FL), KC_RCTL,  KC_LEFT, KC_DOWN,  KC_RIGHT),
  ...
  [_FL] = LAYOUT_wkl_ansi_3_right_mods(
     ...
     /* ctrl              alt                              space                    alt      fn       ctrl      left     down     right*/
      KC_LCTL, KC_NO,   KC_LALT,                          KC_TRNS,                KC_RALT, KC_TRNS, KC_RCTL,  KC_TRNS, KC_VOLD,  KC_TRNS)
};
