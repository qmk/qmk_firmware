...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT_67_ansi(
      ...
      KC_LCTL, KC_LGUI, KC_LALT,                          KC_SPC,                 KC_RALT, MO(_FL), KC_NO,    KC_LEFT, KC_DOWN,  KC_RIGHT),
  ...
  [_FL] = LAYOUT_67_ansi(
     ...
     /* ctrl     win      alt                              space                    alt      fn       ctrl      left     down     right*/
      KC_LCTL, KC_LGUI, KC_LALT,                          KC_TRNS,                KC_RALT, KC_TRNS,  KC_NO,    KC_TRNS, KC_VOLD,  KC_TRNS)
};
