 ...
 * |------+------+------+------+------+------+   +------+------+------+------+------+------|
 * |'/Ctrl|  ´   | Alt  |  Bsp |Space |  Win |   | Entr | Space| Bsb  | AlGr |   *  |   ¨  |
 * `-----------------------------------------'   '-----------------------------------------'
 */
[BASE] = LAYOUT( \
...
[SYMB] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______,     _______, _______, KC_DOT,  KC_0,    NO_EQL,  _______  \
),
 ...
 */
[ARRW] = LAYOUT( \
  NO_HALF,  _______,  _______,  _______ ,  _______,  _______,      _______,  _______,  _______,  _______,  _______,  _______, \
