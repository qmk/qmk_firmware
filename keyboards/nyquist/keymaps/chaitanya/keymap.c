...
[_QWERTY] = LAYOUT( \
  ...
  KC_LCTL,             KC_LGUI, KC_LALT, KC_LCBR, _______,   KC_SPC,  KC_SPC,  _______,   KC_RCBR, KC_MINUS, KC_EQUAL, KC_RSFT  \
),
...
[_QWERTY2] = LAYOUT( \
  ...
  KC_LCTL,             KC_LGUI, KC_LALT, _______, _______,   KC_SPC,  KC_SPC, _______, KC_LCBR, KC_RCBR, KC_MINUS, KC_EQUAL  \
),
