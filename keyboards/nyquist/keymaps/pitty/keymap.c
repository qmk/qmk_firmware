 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  GUI |  Alt |LOWER |  Spc |  Spc | Bksp | Ent  |  Alt | Ó(=) | RAISE| Del  |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTL,               KC_LGUI,   KC_LALT, TG(_LOWER),  KC_SPC,         KC_SPC, KC_BSPC,  KC_ENT,  KC_RALT, KC_EQL, TG(_RAISE),    KC_DEL \
),
...
[_LOWER] = KEYMAP( \
  ...
  _______,   _______, KC_UP,   _______, _______, _______, _______,  _______, KC_7,  KC_8,      KC_9,    KC_KP_ASTERISK, \
  _______,   KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______,  _______, KC_4,  KC_5,      KC_6,    KC_KP_PLUS, \
  KC_LSFT,   _______, _______, _______, _______, _______, _______,  _______, KC_1,  KC_2,      KC_3,    KC_KP_MINUS, \
  _______,   _______, _______, _______, _______, _______, _______,  _______, KC_0,  KC_KP_DOT, KC_KP_EQUAL,  KC_BSLS \
),
...
[_RAISE] = KEYMAP( \
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7, KC_F8,  KC_F9,  KC_F10,  KC_F11,  KC_F12, \
  _______, KC_EXLM, KC_AT,   KC_LPRN, KC_RPRN, KC_PIPE, KC_7,  KC_8,   KC_9,   KC_ASTR, KC_RPRN, KC_CAPS, \
  _______, KC_HASH, KC_DLR,  KC_LCBR, KC_RCBR, KC_GRV,  KC_4,  KC_5,   KC_6,   KC_PLUS, KC_RCBR, KC_PIPE, \
  _______, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD, KC_1,  KC_2,   KC_3,   KC_BSLS, KC_VOLD, KC_VOLU, \
  KC_PSCR, _______, _______, KC_LABK, KC_RABK, _______, KC_0,  KC_DOT, KC_EQL, _______, _______, TG(_GAME) \
),
 ...
 */
[_VIM] =  KEYMAP( \
  RGB_MOD, RGB_TOG,  _______,   _______, _______, _______, _______, _______, _______, _______, RGB_MOD, RGB_TOG, \
  _______, _______,  _______,   _______, _______, _______, _______, _______, _______, _______, RGB_HUI, RGB_HUD, \
  _______, M(DLEFT), M(DRIGHT), KC_LCTL, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, RGB_SAI, RGB_SAD, \
  _______, _______,  _______,   _______, _______, _______, _______, _______, _______, _______, RGB_VAI, RGB_VAD, \
