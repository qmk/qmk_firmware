...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_wrapper(
     ...
     KC_MLSF, _________________QWERTY_L3_________________, ALT_APP,     OS_LGUI, _________________QWERTY_R3_________________, KC_MRSF,
  ...
  [_COLEMAK] = LAYOUT_wrapper(
     ...
     KC_MLSF, _________________COLEMAK_L3________________, ALT_APP,     OS_LGUI, _________________COLEMAK_R3________________, KC_MRSF,
                             LT(_LOWER,KC_GRV), KC_SPC,  KC_BSPC,         KC_DEL,  KC_ENT,  RAISE
  ),
  [_DVORAK] = LAYOUT_wrapper(
     ...
     KC_MLSF, _________________DVORAK_L3_________________, ALT_APP,     OS_LGUI, _________________DVORAK_R3_________________, KC_MRSF,
                             LT(_LOWER,KC_GRV), KC_SPC,  KC_BSPC,         KC_DEL,  KC_ENT,  RAISE
  ),
  [_WORKMAN] = LAYOUT_wrapper(
     ...
     KC_MLSF, _________________WORKMAN_L3________________, ALT_APP,     OS_LGUI, _________________WORKMAN_R3________________, KC_MRSF,
                             LT(_LOWER,KC_GRV), KC_SPC,  KC_BSPC,         KC_DEL,  KC_ENT,  RAISE
  ),
