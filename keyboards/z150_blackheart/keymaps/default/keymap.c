...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_F5, 	KC_F6,  KC_LCTRL,KC_A,    KC_S, 	KC_D,    KC_F, 	KC_G, 	KC_H, KC_J, KC_K, 	 KC_L,   KC_SCLN, KC_QUOT, KC_ENT, 	KC_P4, 	 KC_P5,   KC_P6, 	KC_PMNS,
	...
	LAYOUT(
		______, ______, RESET,  ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, 
...
/* Not sure how to setup dual layout support so for now the code is commented out.
	Z150_TKL(
		...
		KC_F7, 	KC_F8, 	KC_LSFT, KC_Z, 	  KC_X, 	KC_C, 	 KC_V, 	KC_B, 	KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, MO(1), 			 	XXXXXXX, KC_UP,   XXXXXXX, 
		KC_F9, 	KC_F10,	KC_LCTL, KC_LGUI, KC_LALT, 	KC_LSFT, 		KC_SPC, 							 KC_RALT, KC_RGUI, KC_MENU, KC_RCTL, 	KC_LEFT, KC_DOWN, KC_RGHT
		),

	Z150_TKL(
		______, ______, RESET,  ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, 
