...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] =  LAYOUT(
        ...
        MI_OCTD, MI_OCTU,     L_BASE,    XXXXXXX,     XXXXXXX,     XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, VERSION, XXXXXXX, XXXXXXX,
            MI_VELD,            L_RESERVE1, L_RESERVE2, L_RESERVE3, L_RESERVE4, L_RESERVE5, L_RESERVE6, L_RESERVE7, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, EEP_RST, XXXXXXX, XXXXXXX
    ),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [_RESERVE1] = { ENCODER_CCW_CW(_______, _______) },
    [_RESERVE2] = { ENCODER_CCW_CW(_______, _______) },
    [_RESERVE3] = { ENCODER_CCW_CW(_______, _______) },
    [_RESERVE4] = { ENCODER_CCW_CW(_______, _______) },
    [_RESERVE5] = { ENCODER_CCW_CW(_______, _______) },
    [_RESERVE6] = { ENCODER_CCW_CW(_______, _______) },
    [_RESERVE7] = { ENCODER_CCW_CW(_______, _______) },
    [_RESERVE8] = { ENCODER_CCW_CW(_______, _______) },
    [_RESERVE9] = { ENCODER_CCW_CW(_______, _______) },
};
#endif
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case L_BASE:
            ...
            case L_RESERVE1:
            reset_scale_indicator();
            default_layer_set(1UL << _RESERVE1);
            break;

            case L_RESERVE2:
            reset_scale_indicator();
            default_layer_set(1UL << _RESERVE2);
            break;

            case L_RESERVE3:
            reset_scale_indicator();
            default_layer_set(1UL << _RESERVE3);
            break;

            case L_RESERVE4:
            reset_scale_indicator();
            default_layer_set(1UL << _RESERVE4);
            break;

            case L_RESERVE5:
            reset_scale_indicator();
            default_layer_set(1UL << _RESERVE5);
            break;

            case L_RESERVE6:
            reset_scale_indicator();
            default_layer_set(1UL << _RESERVE6);
            break;

            case L_RESERVE7:
            reset_scale_indicator();
            default_layer_set(1UL << _RESERVE7);
            break;
        }
    return true;
}
