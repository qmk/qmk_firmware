...
[_LOWER] = KEYMAP( \
  ...
  KC_CAPS, _______, KC_UP,   _______, KC_HOME,    KC_PGUP, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, \
...
[_RAISE] = KEYMAP( \
  ...
  KC_CAPS, _______, KC_UP,   _______, KC_HOME,    KC_PGUP, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, \
