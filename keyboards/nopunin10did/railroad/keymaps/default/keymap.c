...
KEYMAP(
/* Left Block */
   KC_SLCK,KC_PAUS,KC_ESC, KC_GRV, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,  
   ...
   KC_COPY,KC_PSTE,  KC_LCTL,    KC_LGUI,  KC_LALT,    KC_NUHS,  KC_SPC,     LSHFDEL,
/* Center Block */
   KC_F1,  KC_F5,  KC_F9,  
   KC_F2,  KC_F6,  KC_F10,  
   KC_F3,  KC_F7,  KC_F11,  
...
/* Right Block */
 ...
 LSACALC,  KC_SPC,     KC_NUBS,  RALTHOM,    RCTLEND,       KC_LEFT,KC_DOWN,KC_RGHT 
  )
