...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_TKL(
    ...
    LT_CAPS,  KC_A,    KC_S,    KC_D,    KC_F,   KC_G,   KC_H,    KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT,  KC_NUHS, KC_ENT,
    KC_LSFT,  KC_NUBS, KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,    KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, MO(1),                     KC_UP,
    KC_LCTL,  KC_LGUI, KC_LALT, KC_NO,   KC_SPC,         KC_SPC,  KC_SPC,  KC_RALT, KC_RGUI,  KC_APP,   KC_NO,    KC_RCTL, KC_NO,            KC_LEFT, KC_DOWN, KC_RGHT),
  ...
  [1] = LAYOUT_TKL(
     ...
     ______,  ______,  ______,  ______,  ______, ______, ______,  ______,  ______,  ______,   ______,   KC_VOLD, KC_VOLU,  ______,          ______,  ______,  ______,
