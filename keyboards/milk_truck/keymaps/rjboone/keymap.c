...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
      KC_TRNS,   KC_TRNS,   KC_TRNS,            KC_ESC,    KC_Q,    KC_W,    KC_E,    KC_R,  KC_T,  KC_Y,  KC_U,  KC_I,     KC_O,    KC_P,    KC_BSPC,
      KC_TRNS,   KC_TRNS,   KC_TRNS,            KC_TAB,    KC_A,    KC_S,    KC_D,    KC_F,  KC_G,  KC_H,  KC_J,  KC_K,     KC_L,    KC_SCLN, KC_QUOT,
      KC_MPRV,   KC_MPLY,   KC_MNXT,  KC_TRNS,  KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,  KC_B,  KC_N,  KC_M,  KC_COMM,  KC_DOT,  KC_SLSH, KC_RSFT,
      KC_VOLD,   KC_TRNS,   KC_VOLU,  KC_TRNS,  KC_LCTRL,  KC_LALT, KC_LGUI, LT(_NUM_SYM, KC_ENT), KC_SPC, MO(_NAV), KC_RALT, MO(_FKEY_RGB), KC_RCTL
    ),

    [_NUM_SYM] = LAYOUT(
      KC_TRNS, KC_TRNS, KC_TRNS,          KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_TRNS,
      KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MINS, KC_LBRC, KC_RBRC,  KC_EQL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BSLS, KC_TRNS,
