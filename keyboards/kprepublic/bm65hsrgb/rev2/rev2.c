...
led_config_t g_led_config = { {
    ...
    { 0,  0}, {15,  0}, {30,  0}, {45,  0}, {60,  0}, {75,  0}, { 90,  0}, {105,  0}, {120,  0}, {135,  0}, {150,  0}, {165,  0}, {180,  0}, {203,  0}, {225,  0}, 
	{ 4, 16}, {23, 16}, {38, 16}, {53, 16}, {68, 16}, {83, 16}, { 98, 16}, {113, 16}, {128, 16}, {143, 16}, {158, 16}, {173, 16}, {188, 16}, {206, 16}, {225, 16}, 
	{ 6, 32}, {26, 32}, {41, 32}, {56, 32}, {71, 32}, {86, 32}, {101, 32}, {116, 32}, {131, 32}, {146, 32}, {161, 32}, {176, 32},            {201, 32}, {225, 32}, 
	{ 9, 48},           {34, 48}, {49, 48}, {64, 48}, {79, 48}, { 94, 48}, {109, 48}, {124, 48}, {139, 48}, {154, 48}, {169, 48}, {190, 48}, {210, 48}, {225, 48}, 
    { 3, 64}, {21, 64}, {39, 64},                               { 96, 64},                                  {153, 64}, {170, 64}, {195, 64}, {210, 64}, {225, 64}
...
// ==========================================================================
// Credit to bm60v2 code, 
// bm60 uses matrix driver IS31FL3733 
// bm65 uses IS31FL3741 and we're good.  
#    if WS2812_LED_TOTAL > 0
