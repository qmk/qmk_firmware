 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Left | Down | Up   |Right |Ctrl+/| PRSC |   {  |   }  |   )  |   :  |  "   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|   [  |   ]  | Home | End  | PGDN | PGUP |   (  |   <  |   >  |   ?  |Return|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_LEFTFN] = LAYOUT_planck_mit(
    ...
    KC_LSFT, KC_LBRC, KC_RBRC, KC_HOME, KC_END,   KC_PGDN,       KC_PGUP, KC_LPRN, KC_LT,   KC_GT,   KC_QUES, KC_ENT,
