...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY]     = LAYOUT(
        ...
        KC_LCTL,  KC_RALT, KC_LGUI, LT_SPACE,         LT_SPACE,          LT_FUNC, KC_DOWN, KC_UP,   KC_RGHT
    ),
    [_MOVE]       = LAYOUT(
        KC_GRV,   VS_STEP, VS_INTO, VS_OUT,  VS_RUN,  VS_STOP,  VS_MVUP, WD_BACK, KC_HOME, KC_END,  WD_FRWD, WD_DELE,
        _______,  MM_LH,   MM_MAX,  MM_RH,   IJ_FIND, VS_LINE,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,
        _______,  MM_UH,   MM_BH,   MAC_CPY, MAC_PST, _______,  VS_MVDN, IJ_REN,  IJ_BACK, IJ_FWD,  _______,
        _______,  _______, _______, KC_BSPC,          _______,           _______, _______, _______, _______
    ),
    [_MACRO]      = LAYOUT(
        KC_GRV,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS,
        _______,  _______, _______, _______, _______, KC_SCLN,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_QUOT,
        _______,  _______, _______, _______, _______, _______,  _______, _______, KC_SCLN, KC_QUOT, _______,
        _______,  _______, _______, _______,          _______,           _______, _______, _______, _______
    ),
    [_FUNCTION]   = LAYOUT(
        KC_TILD,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,  KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE,
        _______,  KC_4,    KC_5,    KC_6,    KC_MINS, KC_COLN,  KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_DQUO,
        KC_0,     KC_7,    KC_2,    KC_3,    KC_PLUS, _______,  _______, _______, KC_COLN, KC_DQUO, CONFIG,
        _______,  _______, _______, _______,          _______,           _______, _______, _______, _______
    ),
    [_CONFIG]     = LAYOUT(
