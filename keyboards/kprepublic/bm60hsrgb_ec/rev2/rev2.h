...
/* Encoder button is located at the K2C location on the third row. As the matrix is defined
 as 5x14, and top row would have 15 buttons, will leave on third row */
