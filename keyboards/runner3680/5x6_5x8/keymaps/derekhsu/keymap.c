...
[_MEDIA] = LAYOUT(
    ...
    KC_NO,   RGB_M_P,  RGB_M_B, RGB_M_SW, RGB_M_G, KC_NO,           KC_NO,   KC__MUTE, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC__VOLUP,   KC_NO,
    KC_NO,   KC_NO,    KC_NO,   KC_TRNS,  KC_TRNS, KC_NO,           KC_NO,   KC_TRNS,  KC_TRNS, KC_NO,   KC_NO,   KC_MRWD, KC__VOLDOWN, KC_MFFD
)
