...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_reviung39(
    ...
    _______,  KC_UNDS,  KC_PLUS,  KC_LCBR,  KC_RCBR,   KC_PIPE,            KC_PGUP,  KC_HOME,  KC_UP,    KC_END,    KC_GRV,  RSFT_T(KC_TILD),
    _______,  KC_LALT,  KC_LGUI,  KC_VOLD,  KC_VOLU,   KC_DQUO,            KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_PSCR,  RCTL_T(KC_SPC),
  ...
  [_RAISE] = LAYOUT_reviung39(
    ...
    _______,  KC_RALT,  KC_RGUI,  _______,  _______,   KC_QUOT,            KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,
                                                       _______,  KC_BSPC,  _______
  ),
  
  [_ADJUST] = LAYOUT_reviung39(
    XXXXXXX,   RGB_SAI, RGB_HUI,  RGB_VAI,  RGB_MOD,   RGB_TOG,             MU_TOG,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,   RGB_SAD, RGB_HUD,  RGB_VAD,  RGB_RMOD,  XXXXXXX,             MU_MOD,  KC_SONG,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,   XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,   RESET,               AU_TOG,  CK_TOGG,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
