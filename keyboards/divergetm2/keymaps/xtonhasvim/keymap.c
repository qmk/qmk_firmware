...
[_QWERTY] = LAYOUT_ortho_4x12_2x2u( \
  ...
  LSFT(KC_LALT), MO(_MOVE),  KC_LALT, KC_LGUI, LOWER,                 RAISE,   KC_RGUI, KC_RALT, MO(_MOVE), VIM_START \
),
...
[_LOWER] = LAYOUT_ortho_4x12_2x2u( \
  ...
  RESET, TO(_QWERTY), _______, _______, _______,              _______,    _______,    _______, TO(_QWERTY), X_____X \
),
...
[_RAISE] = LAYOUT_ortho_4x12_2x2u( \
  ...
  X_____X, TO(_QWERTY), _______, _______, _______,                        _______, _______, _______, TO(_QWERTY), RESET \
),
