...
For Elite-C or Pro micro controllers with `Atmel DFU` booatloader, add `BOOTLOADER = atmel-dfu` into the user keymap `rules.mk` file and use the following make commands for setting handedness:
