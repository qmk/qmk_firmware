...
enum tap_dance_codes {
 ...
 [_MOUSE] = LAYOUT(KC_ESC, LCTL(KC_W), KC_MS_UP, KC_NO, LCTL(KC_T),                         KC_MEDIA_NEXT_TRACK, KC_MS_WH_LEFT, KC_MS_WH_UP, KC_MS_WH_RIGHT,NO_ARNG,
		  KC_TRANSPARENT, KC_MS_LEFT, KC_MS_DOWN,  KC_MS_RIGHT, KC_TRANSPARENT,     KC_MEDIA_PLAY_PAUSE, KC_MS_BTN1, KC_MS_BTN3, KC_MS_BTN2, NO_AE,
		  KC_ESC, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,   KC_MEDIA_PREV_TRACK, KC_DOWN, KC_MS_WH_DOWN, KC_NO, KC_TRANSPARENT,
