...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RSYM] = LAYOUT(
    _______, _______, _______, _______, _______, 	  _______, KC_TILD, KC_SLSH, KC_QUOT, _______, 
  ...
  [_NAV_MED] = LAYOUT(
    _______, _______, _______, _______, _______,	   _______, KC_PGDN, KC_PGUP, _______, KC_DEL,
  ...
  [_NUM_FUN] = LAYOUT(
    _______, KC_7,    KC_8,    KC_9,    _______, 	  _______, KC_F7,   KC_F8,   KC_F9,   KC_F12,
  ...
  [_ALWAYS] = LAYOUT(
    _______, _______, KC_COLN, KC_ESC,  _______,	  _______, _______, _______, _______, RESET,
