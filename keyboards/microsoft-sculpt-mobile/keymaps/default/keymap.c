...
[0] = KEYMAP( \
   KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, RSFT(KC_2), RSFT(KC_3), RSFT(KC_4),\
   ...
   KC_LCTL, KC_LGUI, KC_LALT, KC_SPACE, KC_RALT, RSFT(KC_A), KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT
)
