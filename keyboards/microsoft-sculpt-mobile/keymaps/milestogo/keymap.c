...
#define TT_SYM   ACTION_LAYER_TAP_TOGGLE(_SYM) // on when held, toggle with taps
...
[_QWR] = KEYMAP( \
   KC_ESC,   KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8,   KC_9, KC_0,    KC_F11,   KC_F12, KC_VOLD, KC_VOLU, KC_MUTE,\
...
[_CDH] = KEYMAP (\
  ...
  ____,____,____,____,TT_SYM,TT_SYM,____,____,____,____
