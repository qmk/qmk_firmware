 ...
 * |      |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |CAPSL |   Q  |   W  |   E  |   R  |   T  |                    |   Y  |   U  |   I  |   O  |   P  | BSPC |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | LSFT |   A  |   S  |   D  |   F  |   G  |-------.    ,-------|   H  |   J  |   K  |   L  |   ;  |RSFT/"|
 * |------+------+------+------+------+------|  TAB  |    | MUTE  |------+------+------+------+------+------|
 * |LCTL/T|   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |RCTRL |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  LCTL_T(KC_TAB), KC_Z, KC_X, KC_C,    KC_V,    KC_B, KC_TAB,   KC_MUTE,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTRL, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, KC_1,    KC_2,    KC_3,    KC_DOT,   _______, RGB_TOG,  _______, _______, _______, _______, KC_BRID, _______, \
                             _______, _______, _______,  _______, _______,  _______, _______, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
