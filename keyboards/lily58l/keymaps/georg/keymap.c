 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_TAB,   KC_MUTE,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTRL, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_TAB,  KC_7,    KC_8,    KC_9,    _______,                     _______, ALGR(KC_Y), _______, ALGR(KC_P), _______, _______, \
  _______, ALGR(KC_Q), KC_4, KC_5,    KC_6,    KC_0,                        KC_MPRV, KC_MSEL, KC_MPLY, KC_MNXT, KC_BRIU, _______, \
  _______, _______, KC_1,    KC_2,    KC_3,    _______,  _______, RGB_TOG,  _______, _______, _______, _______, KC_BRID, _______, \
                             _______, _______, _______,  _______, _______,  _______, _______, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
