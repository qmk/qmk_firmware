 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_ESC,   KC_MUTE,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTRL, \
...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_PERC, KC_BSLS, KC_SLSH, KC_PIPE, KC_AMPR,                   KC_CIRC, KC_PLUS, KC_MINS, KC_ASTR, KC_SLSH, _______, \
