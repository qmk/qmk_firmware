...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_ortho_4x12(
            KC_TAB,  TD(TD_COLN_SCLN),    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    ...
    [_LOW] = LAYOUT_ortho_4x12(
            ...
            KC_LCTL,  KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
    ...
    [_LOWEST] = LAYOUT_ortho_4x12(
        ...
        _______, _______,  _______,  _______,   _______,  _______,   _______, STabLeft, STabRight, _______,  _______, _______,  
