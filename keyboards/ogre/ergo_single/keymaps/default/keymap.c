...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    RESET,  RGB_TOG, KC_F1,   KC_F2,   KC_F3,   KC_F4,    KC_F5,  KC_INS,  KC_HOME, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, KC_F12,
            RGB_MOD, RGB_HUI, RGB_SAI, KC_PGDN, KC_PGUP, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,
            RGB_M_P, RGB_HUD, RGB_SAD, _______, _______, _______, KC_END,  _______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______, _______,
            _______, RGB_VAI, RGB_VAD, _______, _______, _______,                   _______, _______, KC_LBRC, KC_RBRC, _______, _______,
