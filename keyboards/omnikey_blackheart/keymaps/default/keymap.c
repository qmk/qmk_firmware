...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_F7	, 	KC_F8  , 	KC_LSFT	, 	KC_Z	, 	KC_X	, 	KC_C	, 	KC_V	, 	KC_B	, 	KC_N	, 	KC_M	, 	KC_COMM	, 	KC_DOT	, 	KC_SLSH	,	KC_LSFT	, 				MO(1)	,	XXXXXX	, 	KC_UP	, 	XXXXXX	, 	KC_P1	, KC_P2	 , KC_P3  ,	KC_PENT, 
	KC_F9 	, 	KC_F10 ,	KC_LCTL	,   KC_LGUI	, 	KC_LALT	, 	XXXXXX	,		 		KC_SPC	, 										KC_LALT	, 	KC_LGUI	, 	KC_LCTL	, 				XXXXXX 	,	KC_LEFT	, 	KC_DOWN	, 	KC_RIGHT, 		  KC_P0		 , KC_PDOT
	),
	...
	KC_F3	, 	KC_F4  , 	KC_TAB	, 	KC_Q	, 	KC_W	, 	KC_E	, 	KC_R	, 	KC_T	,	KC_Y	, 	KC_U	,	KC_I	, 	KC_O	, 	KC_P	, 	KC_LBRC	, 	KC_RBRC	, 	KC_BSLS	,	KC_DEL	, 	KC_END	, 	KC_PGDN	, 	KC_P7	, KC_P8	 , KC_P9  , KC_PPLS, 
	KC_F5	, 	KC_F6  , 	KC_CAPS	, 	KC_A	, 	KC_S	, 	KC_D	, 	KC_F	, 	KC_G	, 	KC_H	,	KC_J	, 	KC_K	, 	KC_L	, 	KC_SCLN	, 	KC_QUOT	, 				KC_ENT 	,	XXXXXX	, 	XXXXXX	, 	XXXXXX	, 	KC_P4	, KC_P5	 , KC_P6  ,	KC_EQL, 
	KC_F7	, 	KC_F8  , 	KC_LSFT	, 	KC_Z	, 	KC_X	, 	KC_C	, 	KC_V	, 	KC_B	, 	KC_N	, 	KC_M	, 	KC_COMM	, 	KC_DOT	, 	KC_SLSH	,	KC_LSFT	, 				______	,	XXXXXX	, 	KC_UP	, 	XXXXXX	, 	KC_P1	, KC_P2	 , KC_P3  ,	KC_PENT, 
	KC_F9 	, 	KC_F10 ,	KC_LCTL	,   KC_LGUI	, 	KC_LALT	, 	XXXXXX	,		 		KC_SPC	, 										KC_LALT	, 	KC_LGUI	, 	KC_LCTL	, 				XXXXXX 	,	KC_LEFT	, 	KC_DOWN	, 	KC_RIGHT, 	KC_P0	, KC_PDOT
	),
};
