...
#define ENCODER_MODE_CHANGE_DELAY 30000 //30 seconds, effectively removing the delay feature
...
encoder_mode_t encoder_modes[] = {
	{ .indicator_color = {0xFF,0x00,0x00} , .clockwise_key = {KC_VOLU, ENCMUP , KC_VOLU, ENCMUP}, .counterclockwise_key = {KC_VOLD, ENCMDN , KC_VOLD , ENCMDN}, .clicked_key = {ENCMUP , ENCMUP , ENCMUP , ENCMUP }, .hold_key = KC_NO },
	{ .indicator_color = {0x00,0xFF,0x00} , .clockwise_key = {KC_WH_U, ENCMUP , KC_WH_U, ENCMUP}, .counterclockwise_key = {KC_WH_D, ENCMDN , KC_WH_D , ENCMDN}, .clicked_key = {ENCMUP , ENCMUP , ENCMUP , ENCMUP }, .hold_key = KC_NO },
	{ .indicator_color = {0x00,0x00,0xFF} , .clockwise_key = {ALTTABF, ENCMUP , ALTTABF, ENCMUP}, .counterclockwise_key = {ALTTABB, ENCMDN , ALTTABB , ENCMDN}, .clicked_key = {ENCMUP , ENCMUP , ENCMUP , ENCMUP }, .hold_key = KC_NO }
