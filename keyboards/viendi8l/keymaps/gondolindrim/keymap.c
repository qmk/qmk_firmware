...
#define ENCODER_MODE_CHANGE_DELAY 1000
...
encoder_mode_t encoder_modes[] = {
	{ .indicator_color = {0xFF,0x00,0x00} , .clockwise_key = {KC_VOLU, KC_VOLU, ENCMUP , KC_VOLU }, .counterclockwise_key = {KC_VOLD, KC_VOLD, ENCMDN , KC_VOLD } , .clicked_key = {KC_MUTE, KC_MUTE, KC_MUTE, KC_MUTE }, .hold_key = ENCMUP },
	{ .indicator_color = {0x00,0xFF,0x00} , .clockwise_key = {KC_WH_U, KC_WH_U, ENCMUP , KC_WH_U }, .counterclockwise_key = {KC_WH_D, KC_WH_D, ENCMDN , KC_WH_D } , .clicked_key = {KC_BTN1, KC_BTN1, KC_BTN1, KC_BTN1 }, .hold_key = ENCMUP },
	{ .indicator_color = {0x00,0x00,0xFF} , .clockwise_key = {ALTTABF, ALTTABF, ENCMUP , ALTTABF }, .counterclockwise_key = {ALTTABB, ALTTABB, ENCMDN , ALTTABB } , .clicked_key = {ALTTABC, ALTTABC, ALTTABC, ALTTABC }, .hold_key = ENCMUP }
