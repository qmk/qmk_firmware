...
#define LAYOUT( \
    ...
    { enc, down, left, right, up,  k01, k02 }, \
...
//  partial flip group
#define FLIPH_LAYER_COLOR RGB_DARKGREEN
#define FLIPL_LAYER_COLOR RGB_DARKGREEN
#define FLIP2_LAYER_COLOR RGB_DARKGREEN

//  channel separation group
#define SEPALEFT_LAYER_COLOR RGB_DARKBLUE
#define SEPAHALF_LAYER_COLOR RGB_DARKBLUE
#define SEPARIGHT_LAYER_COLOR RGB_DARKBLUE
