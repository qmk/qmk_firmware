...
led_config_t g_led_config = {
    {
        ...
        { 40, 6,  39, 7,  38, 8,  37 },
        { 9,  36, 10, 35, 11, 34, 12 },
        { 33, 13, 32, 14, 31, 15, 30 },
        { 16, 29, 17, 28, 18, 27, 19 },
        { 26, 20, 25, 21, 24, 22, 23 }

        // register middle two rows
        { 0,  4,  3,  2,  1,  78, 42 },
        { 77, 43, 76, 44, 75, 45, 74 },
        { 46, 73, 47, 72, 48, 71, 49 },
        { 70, 50, 69, 51, 68, 52, 67 },
        { 53, 66, 54, 65, 55, 64, 56 },
        { 63, 57, 62, 58, 61, 59, 60 }

        // register top and bottom rows
        { 0,     4,   3,   2,   1, 115,   5 },
        { 114,   6, 113,   7, 112,   8, 111 },
        { 9,   110,  10, 109,  11, 108,  12 },
        { 107,  13, 106,  14, 105,  15, 104 },
        {  16, 103,  17, 102,  18, 101,  19 },
        { 100,  20,  99,  21,  98,  22,  97 }
#else
        // register top two rows
        { 0,     4,   3,   2,   1, 115,  79 },
        { 114,  80, 113,  81, 112,  82, 111 },
        { 83,  110,  84, 109,  85, 108,  86 },
        { 107,  87, 106,  88, 105,  89, 104 },
        {  90, 103,  91, 102,  92, 101,  93 },
        { 100,  94,  99,  95,  98,  96,  97 }
#endif
    },  {
        { 14,  12 },
        { 14,  36 },
