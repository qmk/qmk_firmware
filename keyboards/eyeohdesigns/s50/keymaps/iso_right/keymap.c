...
KC_MUTE,                                                                                                          KC_ENT,
                  LT(NUMBRS,KC_TAB),  KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K,   KC_L,   KC_SCLN, KC_QUOT,          KC_ASON,
               KC_BSLS,SFT_T(KC_CAPS),KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM,KC_DOT, KC_SLSH, KC_RSFT, KC_UP,   KC_ASOFF,
               KC_LGUI,  KC_LALT,KC_LCTL,      MO(RAISE),           LT(NUMBRS,KC_SPC),           KC_RCTL,KC_LEFT, KC_DOWN, KC_RIGHT
),

[RAISE] = LAYOUT_iso_right(
    /* Layer 3
     * ,____.      ,---------------------------------------------------------------------.
     * |Knob|      | `  |    |PgUp|    |    |  [ | ]  |    | Up |    |    |    | E  |Del |
     * `----'     ,-----+----+----+----+----+----+----+----+----+----+----|----+ n  |----|
     ...
     *      `----------------------------------------------------------------------------'
     */
                      KC_GRAVE,KC_TRNS,KC_TRNS,KC_PGUP, KC_TRNS,  KC_LBRC,KC_RBRC,KC_TRNS,KC_UP,KC_TRNS,KC_TRNS,KC_DEL,         KC_PSCR,
RESET,                                                                                                            KC_ENT,
                   KC_TRNS,KC_TRNS,KC_HOME,KC_PGDN,KC_END,KC_MINS,KC_EQL, KC_LEFT,KC_DOWN,KC_RIGHT,KC_TRNS,KC_TRNS,          KC_ASUP,
                 KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,KC_RSFT,    KC_UP,  KC_ASDN,
               KC_LGUI,  KC_LALT,KC_LCTL,                 KC_TRNS,                     KC_TRNS,  KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT
),
[NUMBRS] = LAYOUT_iso_right(
    /* Layer 3
     * ,____.      ,---------------------------------------------------------------------.
...
RESET,                                                                                                                         KC_ENT,
                 ...
                 KC_BSLS,KC_TRNS,KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,KC_TRNS, KC_UP,  KC_TRNS,
               KC_LGUI,  KC_LALT,KC_LCTL,                 KC_TRNS,                    KC_TRNS,  KC_RCTL,             KC_LEFT, KC_DOWN, KC_RIGHT
)
};
