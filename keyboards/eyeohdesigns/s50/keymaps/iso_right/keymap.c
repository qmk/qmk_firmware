...
KC_MUTE,                                                                                                          KC_ENT,           \
     ...
     *      `----------------------------------------------------------------------------'
     */
                      KC_GRAVE,______,______,KC_PGUP, ______,  KC_LBRC,KC_RBRC,______,KC_UP,______,______,KC_DEL,         KC_PSCR,\
RESET,                                                                                                            KC_ENT,         \
				   ______,______,KC_HOME,KC_PGDN,KC_END,KC_MINS,KC_EQL, KC_LEFT,KC_DOWN,KC_RIGHT,______,_______,          KC_ASUP,\
                                                                                                                                  \
