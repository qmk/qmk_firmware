...
KC_MUTE,                                                                                                          KC_ENT,
        ...
        KC_BSLS,MT(MOD_LSFT, KC_CAPS),KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM,KC_DOT, KC_SLSH, KC_RSFT, KC_UP,   KC_ASOFF,
      KC_LGUI,       KC_LCTL,           KC_LALT,MO(RAISE),  MO(NUMBRS), KC_SPC,        MO(RAISE),KC_RCTL,KC_LEFT, KC_DOWN, KC_RIGHT
),

[RAISE] = LAYOUT_iso_split(
    /* Layer 1
     * ,____.      ,---------------------------------------------------------------------.
     * |Knob|      | `  |    |PgUp|    |    |  [ | ]  |    | Up |    |    |    | E  |Del |
     * `----'     ,-----+----+----+----+----+----+----+----+----+----+----|----+ n  |----|
...
RESET,                                                                                                            KC_ENT,
                   KC_TAB,KC_HOME,KC_PGDN,KC_END,KC_TRNS,KC_MINS,KC_EQL, KC_LEFT,KC_DOWN,KC_RIGHT,KC_TRNS,KC_TRNS,          KC_ASUP,
                 KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,KC_RSFT,    KC_UP,  KC_ASDN,
               KC_LGUI,  KC_LCTL,KC_LALT,KC_TRNS,KC_TRNS   ,           KC_SPC,          KC_TRNS,  KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT
),
[NUMBRS] = LAYOUT_iso_split(
    /* Layer 2
     * ,____.      ,---------------------------------------------------------------------.
...
RESET,                                                                                                                         KC_ENT,
                     KC_TAB,    KC_1,    KC_2 , KC_3 ,   KC_4 ,  KC_5 ,   KC_6 ,   KC_7 ,   KC_8 ,   KC_9 ,   KC_0 ,  KC_TRNS,         KC_TRNS,
