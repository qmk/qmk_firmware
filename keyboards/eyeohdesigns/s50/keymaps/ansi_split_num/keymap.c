...
KC_MUTE,                                                                                                                   \
		        ...
		        MT(MOD_LSFT, KC_CAPS),KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM,KC_DOT, KC_SLSH, KC_1, KC_2, KC_3, \
                                                                                                                           \
      KC_LGUI,KC_LCTL,           KC_LALT,MO(RAISE),  KC_ENT, LT(NUMBRS,KC_SPC),        MO(RAISE),KC_RCTL,KC_BSPC,  KC_0    \
),

	[RAISE] = ANSI_Split_Num(
	/* Layer 1
     * ,____.      ,---------------------------------------------------------------------.
     * |Knob|      | `  |    |    |PgUp|    |  - |  = |    | Up |    |PSCR|    |    |    |
     * `----'     ,-----+----+----+----+----+----+----+----+----+----+----|----+----|----|
...
RESET,                                                                                                                          \
				   ______,______,KC_HOME,KC_PGDN,KC_END,KC_MINS,KC_EQL, KC_LEFT,KC_DOWN,KC_RIGHT,KC_QUOT,______,KC_ASON,KC_ASUP,\
                                                                                                                                \
				 ______,      ______,______,______,______,______,______,______, ______,______,KC_BSLS,  ______,KC_ASOFF, KC_ASDN,\
                                                                                                                                \
             KC_LGUI,KC_LCTL,           KC_LALT,______,       ______, ______,        ______,KC_RCTL, KC_DEL,      BL_STEP    \
),
	[NUMBRS] = ANSI_Split_Num(
	/* Layer 2
     * ,____.      ,---------------------------------------------------------------------.
...
RESET,                                                                                                                                     \
				     KC_TAB,    KC_1,    KC_2 , KC_3 ,   KC_4 ,  KC_5 ,   KC_6 ,   KC_7 ,   KC_8 ,   KC_9 ,   KC_0 ,  ______,______,______,\
                                                                                                                                           \
				   ______,      KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,______,______,______,\
                                                                                                                                           \
             KC_LGUI,KC_LCTL,           KC_LALT,______,       ______, ______,        ______,KC_RCTL,      ______,    ______    \
)
};
