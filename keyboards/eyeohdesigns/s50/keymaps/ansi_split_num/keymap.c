...
RESET,
             ...
             KC_LGUI,KC_LCTL,           KC_LALT,KC_TRNS,       KC_TRNS, KC_TRNS,        KC_TRNS,KC_RCTL, KC_DEL,      BL_STEP
),
[NUMBRS] = LAYOUT_ansi_split_num(
    /* Layer 2
     * ,____.      ,---------------------------------------------------------------------.
...
RESET,
             ...
             KC_LGUI,KC_LCTL,           KC_LALT,KC_TRNS,       KC_TRNS, KC_TRNS,        KC_TRNS,KC_RCTL,      KC_TRNS,    KC_TRNS
)
};
