...
[RAISE] = LAYOUT_iso_left(
     ...
     *      `----------------------------------------------------------------------------'
     */
                      KC_GRAVE,KC_TRNS,KC_TRNS,KC_PGUP, KC_TRNS,KC_MINS  ,KC_EQL,KC_TRNS,KC_UP,KC_TRNS,KC_TRNS,KC_DEL,         KC_PSCR,
RESET,                                                                                                            KC_ENT,
                  KC_TRNS,KC_TRNS,KC_HOME,KC_PGDN,KC_END,KC_LBRC,KC_RBRC, KC_LEFT,KC_DOWN,KC_RIGHT,KC_TRNS,KC_TRNS,          KC_ASUP,
