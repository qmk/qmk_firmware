...
KC_MUTE,
               ...
               KC_LGUI,  KC_LALT,KC_LCTL,                 LT(NUMBRS,KC_SPC),           MO(RAISE),KC_RCTL,KC_BSPC,  KC_0
),

[RAISE] = LAYOUT_iso_left_num(
    /* Layer 1
     * ,____.      ,---------------------------------------------------------------------.
     * |Knob|      | `  |    |    |PgUp|    |  - |  = |    | Up |    |PSCR|    |    |    |
     * `----'     ,-----+----+----+----+----+----+----+----+----+----+----|----+----|----|
...
RESET,
               ...
               KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS,KC_TRNS,KC_BSLS,  KC_TRNS,KC_ASOFF, KC_ASDN,
               KC_LGUI,  KC_LALT,KC_LCTL,                      KC_TRNS,          KC_TRNS,        KC_RCTL, KC_DEL,      BL_STEP
),
[NUMBRS] = LAYOUT_iso_left_num(
    /* Layer 2
     * ,____.      ,---------------------------------------------------------------------.
