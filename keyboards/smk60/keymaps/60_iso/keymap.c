...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_iso(
      ...
      KC_LSFT,     KC_BSLS, KC_Z,  KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,  KC_RSFT, TG(1),\
    ...
    [1] = LAYOUT_60_iso(
      ...
      _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,TG(0),\
