...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL,                          KC_LALT,  KC_SPC,  KC_LGUI,           KC_RGUI,  KC_SPC,  KC_RALT,                                           KC_RCTL
    ),
    [1] = LAYOUT(
        _______,  _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,    KC_F12,    _______,  _______,
        KC_HOME,  _______,  _______,  KC_UP,    _______,  _______,  _______,            _______,  _______,  KC_PSCR,  KC_SCRL,  KC_PAUSE,  KC_UP,     _______,  _______,
        KC_END,   _______,  KC_VOLD,  KC_VOLU,  KC_MUTE,  _______,  _______,            _______,  _______,  _______,  _______,  KC_LEFT,   KC_RIGHT,  _______,
