...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MD] = LAYOUT(
        _______,          _______, _______, _______, _______, KC_MPLY, KC_MSTP, KC_MPRV, KC_MNXT, TG(_GL), KC_MUTE, KC_VOLD, KC_VOLU,    _______, _______, QK_BOOT,
...
layer_state_t layer_state_set_user(layer_state_t state) {
    if (IS_LAYER_ON_STATE(state, _GL)) {
        fn_led_on();
    } else {
        fn_led_off();
    }
