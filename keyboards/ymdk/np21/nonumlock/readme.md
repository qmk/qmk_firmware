...
This is a version of the ymdk/np21 keyboard definition. It uses software backlight to unify the "numlock" led into the backlight.
This is useful in case you want to use it as a macropad instead of just a numpad
