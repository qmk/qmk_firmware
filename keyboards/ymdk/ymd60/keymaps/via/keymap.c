...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT_60_tsangan_hhkb(
                ...
                _______, _______, RGB_TOG, RGB_VAI, RGB_SPI, _______, _______, _______, _______, _______,  _______, _______, _______,  _______,
                _______, _______, _______, RGB_VAD, RGB_SPD, _______, _______, _______, _______, _______,  _______, _______,           _______,           
