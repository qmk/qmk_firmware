...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        RESET,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_INS,
        ...
        _______,  _______,  _______,                      _______,                                _______,  _______,  KC_APP,            RGB_VAD,  KC_VOLD,  RGB_VAI
    ),
   [2] = LAYOUT(
