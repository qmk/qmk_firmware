...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY]=LAYOUT_ortho_4x12(
		...
		TD(TD_SIFT_CAPSLOCK),	KC_Z,			KC_X,			KC_C,			KC_V,					KC_B,					KC_N,				KC_M,				KC_COMM,			KC_DOT,		KC_SLSH,	KC_SFTENT,
    ...
    [_MOV] = LAYOUT_ortho_4x12(
		...
		KC_TRNS,	MO(_MOUSE),	KC_LCTL,	KC_LALT,	KC_LSFT,			KC_HOME,	KC_LEFT,	KC_DOWN,	KC_UP,	KC_RGHT,	KC_NO,			KC_NO,
    ...
    [_ONE_HAND] = LAYOUT_ortho_4x12(
		...
		KC_SFTENT,	KC_SLSH,	KC_DOT,	KC_COMM,	KC_M,	KC_N,		KC_B,		KC_V,	KC_C,	KC_X,	KC_Z,	TD(TD_SIFT_CAPSLOCK),
	...
	[_MOUSE]=LAYOUT_ortho_4x12(
		KC_TRNS,	KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_BTN1,		KC_MS_UP,		KC_MS_BTN2,		KC_MS_WH_UP,	    KC_MS_ACCEL0,
