...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY]=LAYOUT_ortho_4x12(
		...
		KC_LCTL,				KC_LALT,	OSM(MOD_RALT),	KC_LGUI,		LT(_LOWER,KC_BSPC),		LT(_ONE_HAND,KC_SPACE),	LT(_ONE_HAND,KC_SPACE),	LT(_RAISE,KC_ENT),	TD(TD_WIN_MENU),	KC_RALT,	KC_RCTL,	KC_LEAD
	),
    ...
    [_LEFT_NUM_PAD] = LAYOUT_ortho_4x12(
        KC_TAB,   				KC_BSPC, 	KC_7, 		KC_8,	KC_9, 	KC_NO,		KC_NO, 		KC_NO,	KC_NO,	KC_TRNS,	KC_NO,		TO(_QWERTY),
