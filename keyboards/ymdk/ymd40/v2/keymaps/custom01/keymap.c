...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_ortho_4x12(
        ...
        KC_F7,		KC_F8,		KC_F9,	KC_F10,		KC_F11,			KC_F12,		KC_NO,		KC_NO,		KC_NO,		KC_LBRC,	KC_RBRC,	KC_VOLU,
        KC_NO,		KC_NO,		KC_NO,	KC_MUTE,	MO(_AJUSTES),	KC_SPC,		KC_SPC,		KC_ENT,		KC_MRWD,	KC_MPLY,	KC_MFFD,	KC_VOLD
    ),

    [_LOWER] = LAYOUT_ortho_4x12(
		KC_GRV,		KC_1,		KC_2,		KC_3,		KC_4,		KC_5,	KC_6,		KC_7,		KC_8,		KC_9,		KC_0,		KC_BSPC,
		KC_F1,		KC_F2,		KC_F3,		KC_F4,		KC_F5,		KC_F6,	KC_BSLS,	KC_MINS,	KC_EQL,		KC_LBRC,	KC_RBRC,	KC_BSLS,
        KC_F7,		KC_F8,		KC_F9,		KC_F10,		KC_F11,		KC_F12,	KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_VOLU,
		KC_NO,		KC_NO,		KC_NO,		KC_MUTE,	KC_BSPC,	KC_SPC,	KC_SPC,		KC_TRNS,	KC_MRWD,	KC_MPLY,	KC_MFFD,	KC_VOLD
    ),
