...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY]=LAYOUT_ortho_4x12(
		...
		KC_LCTL,				KC_LALT,	OSM(MOD_RALT),	KC_LGUI,		LT(_LOWER,KC_BSPC),		LT(_ONE_HAND,KC_SPACE),	LT(_ONE_HAND,KC_SPACE),	LT(_RAISE,KC_ENT),	TD(TD_WIN_MENU),	KC_RALT,	TG(_LEFT_NUM_PAD),	KC_LEAD
	),
    ...
    [_LEFT_NUM_PAD] = LAYOUT_ortho_4x12(
        KC_TAB,   				KC_BSPC, 	KC_7, 		KC_8,	KC_9, 	KC_NO,		KC_NO, 		KC_NO,	KC_NO,	KC_NO,	KC_NO,		KC_NO,
        LM(_QWERTY, MOD_LCTL),	KC_BSPC, 	KC_4, 		KC_5, 	KC_6,	KC_NO,		KC_NO, 		KC_NO, 	KC_NO, 	KC_NO, 	KC_NO,		KC_NO,
        LM(_QWERTY, MOD_LCTL), 	KC_BSPC, 	KC_1, 		KC_2, 	KC_3, 	KC_NO, 		KC_NO, 		KC_NO,	KC_NO, 	KC_NO,	KC_NO,		KC_NO,
        LM(_QWERTY, MOD_LCTL),	KC_0, 		KC_0,  		KC_0, 	KC_0, 	A(KC_TAB), 	A(KC_TAB), 	KC_NO,	KC_NO, 	KC_NO, 	KC_TRNS,	KC_TRNS
    )
