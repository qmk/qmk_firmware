...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FUNCT] = LAYOUT_truefox(\
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_F13,  KC_F14,  KC_F15, KC_DEL, MC_MUTE,\
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MC_VOLU,\
        _______, _______, _______, _______, _______, _______, _______, _______, KC_MRWD, KC_MFFD, KC_MPLY, _______, _______, MC_VOLD,\
