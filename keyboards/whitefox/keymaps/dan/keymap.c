...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = KEYMAP_ISO( \
        ...
        KC_FN5, KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,KC_NUHS,     KC_ENT, KC_PGDN,\
        KC_LSFT,KC_FN1, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,     KC_UP,  KC_HOME,\
        KC_FN2,KC_LALT, KC_FN6,                KC_FN0,           KC_FN7, KC_FN8, KC_FN10,     KC_LEFT,KC_DOWN,KC_RGHT \
    ),
    ...
    [1] = KEYMAP_ISO( \
        ...
        KC_TRNS,KC_VOLD,KC_VOLU,KC_MUTE,KC_TRNS,BL_TOGG,KC_TRNS,KC_BSPC,KC_DEL,KC_FN10,KC_LEFT,KC_RIGHT,KC_TRNS,    KC_PENT, KC_PGUP,\
