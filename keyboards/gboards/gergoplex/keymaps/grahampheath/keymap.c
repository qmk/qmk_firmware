...
#define KC_GUI_ENT MT(MOD_LGUI, KC_ENT)  // Tap for Esc, hold for GUI (Meta, Command, Win)
#define KC_ALT_ESC MT(MOD_LALT, KC_ESC)  // Tap for Enter, hold for Alt (Option)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ALPHA] = LAYOUT_split_3x5_3(
      ...
      KC_SFT_Z, KC_X,   KC_C,   KC_V,   KC_B,          KC_N, KC_M, KC_COMM, KC_DOT, KC_SFT_SL,
          KC_ALT_ESC, KC_GUI_ENT, KC_SPE_SPC,          KC_NUM_SPC, MT(MOD_RGUI, KC_BSPC), KC_SFT_TAB 
      ),
  ...
  [_NUMBERS] = LAYOUT_split_3x5_3(
      ...
      KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,       KC_F11, KC_F12, KC_TRNS, KC_TRNS, KC_VOLD,
