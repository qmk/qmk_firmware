...
// └─────────┴─────────┴─────────┴─────────┴─────────┴─────────┘
  ...
  [_BASE] = LAYOUT(
             KC_KP_7, KC_KP_8,   KC_KP_9,     KC_PSLS, MO(_ADMIN),
             KC_KP_4, KC_KP_5,   KC_KP_6,     KC_PAST, TG(_MOUSE),
             KC_KP_1, KC_KP_2,   KC_KP_3,     KC_PMNS, TG(_MIDI),
     MU_TOG, KC_KP_0, KC_KP_DOT, KC_KP_EQUAL, KC_PPLS, MO(_MUSIC)
  ),
...
// └─────────┴─────────┴─────────┴─────────┴─────────┴─────────┘
  ...
  [_MOUSE] = LAYOUT(
             KC_MS_BTN5, _______,       KC_MS_WH_UP,   _______,        _______,
             _______,    KC_MS_BTN1,    KC_MS_UP,      KC_MS_BTN2,     TG(_MOUSE),
             KC_MS_BTN4, KC_MS_LEFT,    KC_MS_DOWN,    KC_MS_RIGHT,    _______,
    _______, KC_MS_BTN3, KC_MS_WH_LEFT, KC_MS_WH_DOWN, KC_MS_WH_RIGHT, _______
  ),
