...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 /* ANSI
   ...
   * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
   * | Shift |   ;   |   Q   |   J   |   K   |   X   |  Esc  |  UP   |  MENU |   B   |   M   |   W   |   V   |   Z   | Enter |
   * |-------+-------+-------+-------+-----------------------|-------|-----------------------+-------+-------+-------+-------|
...
[_ANSI] = LAYOUT( /* Base ANSI */
 ...
 KC_LSFT, KC_SCLN, KC_Q   , KC_J   , KC_K   , KC_X   , KC_ESC , KC_UP  , KC_APP , KC_B   , KC_M   , KC_W   , KC_V   , KC_Z   , KC_ENT ,\
...
[_JIS] = LAYOUT( /* JIS */
 ...
 _______, JU_SCLN, _______, _______, _______, _______, JU_LBRC, KC_UP  , JU_RBRC, _______, _______, _______, _______, _______, _______,\
 _______, _______, _______, _______, LOWER  , CTandSP, KC_LEFT, KC_DOWN, KC_RGHT, SFandSP, RAISE  , _______, _______, _______, _______ \
),
 ...
 /* RAISE 
   ...
   * |-------+-------+-------+-------+-----------------------|-------|-----------------------+-------+-------+-------+-------|
   * | _____ | CAPS  | _____ | _____ | ADJUST|       | Home  | PgDN  |  End  |       | _____ | _____ | _____ | _____ |       |
   * `-----------------------------------------------------------------------------------------------------------------------'
   */
[_RAISE] = LAYOUT( /* RAISE */
 ...
 KC_LSFT, UNDO   , CUT    , COPY   , PASTE  , KC_LBRC, XXXXXXX, KC_PGUP, XXXXXXX, KC_RBRC, KC_PENT, XXXXXXX, XXXXXXX, XXXXXXX, _______,\
 _______, KC_CAPS, _______, _______, ADJUST , XXXXXXX, KC_HOME, KC_PGDN, KC_END , XXXXXXX, _______, _______, _______, _______, _______\
),
 ...
 /* LOWER 
   ...
   * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
   * | _____ | UNDO  |  CUT  | COPY  | PASTE |   [   |       | PgUP  |       |   ]   |   1   |   2   |   3   |   *   | Enter |
   * |-------+-------+-------+-------+-----------------------|-------|-----------------------+-------+-------+-------+-------|
   * | _____ | CAPS  | _____ | _____ | _____ |       | Home  | PgDN  |  End  |       |   0   |       |   .   |       | _____ |
   * `-----------------------------------------------------------------------------------------------------------------------'
   */
[_LOWER] = LAYOUT( /* LOWER */
 ...
 KC_LSFT, UNDO   , CUT    , COPY   , PASTE  , KC_LBRC, XXXXXXX, KC_PGUP, XXXXXXX, KC_RBRC, KC_P1  , KC_P2  , KC_P3  , KC_PAST, KC_PENT,\
 _______, KC_CAPS, _______, _______, _______, XXXXXXX, KC_HOME, KC_PGDN, KC_END , XXXXXXX, KC_P0  , XXXXXXX, KC_PDOT, XXXXXXX, _______
),
