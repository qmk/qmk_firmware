...
LAYOUT(
  ...
  KC_LCTL, KC_LALT, KC_LGUI, KC_BSLS, MO(2),      KC_SPC,        MO(1),   KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
),
...
LAYOUT( /* Right */
  _______, KC_1,    KC_2,    KC_3,    KC_COMMA, _______, _______, _______, _______, _______, _______, _______,
...
LAYOUT( /* Tab */
  ...
  KC_ESC,  RGB_TOG, RGB_MOD, RGB_VAI, RGB_VAD, _______, _______, _______, _______, _______, _______, _______,
