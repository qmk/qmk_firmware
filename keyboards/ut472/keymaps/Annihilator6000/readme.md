...
Has layouts for Qwerty, Workman, Colemak, Colemak-Mod-DH, and Dvorak. Qwerty is the default layout. Layouts are switched Planck-style using the Raise and Lower keys at the same time and pressing one of the H, J, K, L, or ; keys (this is while on the Qwerty layout - adjust if on another layout). See Layer 8 below for layout keymapping.

![UT47.2 layout image 1](https://i.imgur.com/egTfwR3.jpg)
![UT47.2 layout image 2](https://i.imgur.com/rejI7dV.jpg) 
