...
[_NU] = { /* Numbers and symbols */
  {KC_EXLM, KC_AT,   KC_UP,   KC_LCBR, KC_RCBR, _______, KC_PGUP, KC_7,    KC_8,   KC_9, KC_ASTR},
  {KC_HASH, KC_LEFT, KC_DOWN, KC_RGHT, KC_DLR,  _______, KC_PGDN, KC_4,    KC_5,   KC_6, KC_PLUS},
