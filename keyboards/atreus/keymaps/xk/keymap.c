...
/*
  ...
  │ X  │ C  │ D  │ V  │ Z  ├────┐    ┌────┤ K  │ H  │ ,  │ .  │ /  │
  ├────┼────┼────┼────┼────┤    │    │    ├────┼────┼────┼────┼────┤
  │SFTn│CTLn│ALTn│ '  │SPC │BKSP│    │TAB │ENT │PGDN│ROUS│ \  │ESC │
  └────┴────┴────┴────┴────┴────┘    └────┴────┴────┴────┴────┴────┘
   HOLD
  ┌────┬────┬────┬────┬────┐              ┌────┬────┬────┬────┬────┐
  │    │    │    │    │    │              │    │    │    │    │ALT │
  ...
  │    │    │    │    │    ├────┐    ┌────┤    │    │    │    │CTL │
  ├────┼────┼────┼────┼────┤    │    │    ├────┼────┼────┼────┼────┤
  │SFT │CTL │ALT │L!@#│L123│L OH│    │L OH│L123│L!@#│ROUS│L FN│LESC│
  └────┴────┴────┴────┴────┴────┘    └────┴────┴────┴────┴────┴────┘
   DOUBLETAP
  ┌────┬────┬────┬────┬────┐              ┌────┬────┬────┬────┬────┐
  │    │    │    │    │    │              │    │    │    │    │    │
...
[_COLEMAK] = KEYMAP( \
     ...
     KC_X,   KC_C,   KC_D,    KC_V,    KC_Z,                      KC_K,     KC_H,     KC_COMM,  KC_DOT,  CTL_IT,  \
    KYSFT,  KYCTL,  KYALT,  XK_APO,  XK_SPC,  XK_BSP,  XK_TAB,  XK_ENT,  XK_PGDN, TT(_MLAYER),  PIPBOY,  XK_ESC  \
),
...
[_KAMELOC] = KEYMAP( \
  ...
  KC_SLSH,  KC_DOT,     KC_COMM,         KC_H,   KC_K,                       KC_Z,         KC_V,    KC_D,    KC_C,    KC_X,  \
   XK_ESC,  PIPBOY, TT(_MLAYER), TG(_NUMBTAB), KC_ENT,  _______, _______,  XK_SPC, TG(_NUMBTAB),   KYALT,   KYCTL,   KYSFT  \
),
...
[_MLAYER] =  KEYMAP( \
   KC_ESC,   NAVCH,  NAVCPU,  NAVCPD,   NAVCE,                        M(1),    M(0), KC_MS_U,    M(0),    M(2),  \
  XXXXXXX,   NAVCL,   NAVCU,   NAVCD,   NAVCR,                        M(5), KC_MS_L, KC_MS_D, KC_MS_R, KC_ACL2,  \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN5,                     KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R,    M(5),  \
  _______, _______, _______, KC_BTN2, KC_BTN1,  _______, _______,  KC_BTN1, KC_BTN2, _______, KC_ACL0, _______ \
),
