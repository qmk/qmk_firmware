...
/* ADJUST Layer
  ...
  [_ADJUST] = {
    ...
    {KC_F11,  _______, _______, _______, _______, XXXXXXX, _______, _______, _______, _______, KC_F12 },
    {_______, QWERTY,  COLEMAK, DVORAK,  _______, _______, _______, _______, _______, _______, _______},
