...
const uint16_t PROGMEM keymaps[][ MATRIX_ROWS ][ MATRIX_COLS ] = {
  ...
  */
  [_PUNCUR] = LAYOUT(
    ...
    KC_ESC,  xxxxxx,  KC_CIRC, LSFT(KC_QUOT), KC_INS,                        KC_LEFT, KC_UP,   KC_RIGHT, KC_PGUP,   xxxxxx,
    xxxxxx,  xxxxxx,  KC_PSCR, KC_SLCK,       KC_CAPS,                       KC_HOME, KC_DOWN, KC_END,   KC_PGDOWN, xxxxxx,
  ...
  */
  [_FUNVIM] = LAYOUT(
    ...
    KC_F11, KC_F12, xxxxxx, xxxxxx, xxxxxx,                      KC_H,   KC_K,   KC_L,   LCTL(KC_B), xxxxxx,
    xxxxxx, xxxxxx, xxxxxx, xxxxxx, xxxxxx,                      KC_0,   KC_J,   KC_DLR, LCTL(KC_F), xxxxxx,
  ...
  */
  [_MOUSE] = LAYOUT(
    ...
    KC_ESC,       xxxxxx,       xxxxxx,       xxxxxx, xxxxxx,                       KC_MS_L, KC_MS_U, KC_MS_R, KC_MS_WH_UP,   xxxxxx,
    xxxxxx,       xxxxxx,       xxxxxx,       xxxxxx, xxxxxx,                       xxxxxx,  KC_MS_D, xxxxxx,  KC_MS_WH_DOWN, xxxxxx,
