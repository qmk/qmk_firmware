...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = KEYMAP( \
            ...
            KC_ESC, KC_TAB, KC_LGUI, KC_LSFT, KC_BSPC, KC_LALT, KC_SPC, LOWER, KC_MINS, KC_QUOT, KC_ENT   \
            ),
     ...
     */
    [_LOWER] = KEYMAP( \
            KC_EXLM, KC_AT,   KC_UP,   KC_LCBR, KC_RCBR, KC_NO,   KC_PGUP, KC_7,    KC_8,   KC_9, KC_ASTR, \
            KC_HASH, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  KC_NO,   KC_PGDN, KC_4,    KC_5,   KC_6, KC_PLUS, \
            KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_AMPR, KC_LCTL, KC_GRV,  KC_1,    KC_2,   KC_3, KC_BSLS, \
            RAISE,   KC_INS,  KC_LGUI, KC_LSFT, KC_BSPC, KC_LALT, KC_SPC,  KC_TRNS, KC_DOT, KC_0, KC_EQL   \
            ),
    ...
    [_RAISE] = KEYMAP( \
            ...
            KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_NO,   KC_DOWN, KC_F4,  KC_F5,   KC_F6,   KC_F11, \
            KC_TRNS, KC_VOLU, KC_TRNS, KC_TRNS, RESET,   KC_LCTL, KC_TRNS, KC_F1,  KC_F2,   KC_F3,   KC_F12, \
            KC_NO,   KC_VOLD, KC_LGUI, KC_LSFT, KC_BSPC, KC_LALT, KC_SPC,  QWERTY, KC_PSCR, KC_SLCK, KC_PAUS \
            )
