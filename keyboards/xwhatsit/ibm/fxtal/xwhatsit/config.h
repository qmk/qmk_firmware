...
#define MANUFACTURER Tom Wong-Cornall/Alectardy98/Purdea Andrei
#define PRODUCT IBM Model F XT/Bigfoot FXTal
#define DESCRIPTION QMK firmware for the IBM Model F XT/Bigfoot FXTal keyboard using the original Xwhatsit model F controller PCB
