# xwhatsit/through_hole/ibm/fssk

![xwhatsit/through_hole/ibm/fssk](https://deskthority.net/download/file.php?id=29306)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make xwhatsit/through_hole/ibm/fssk:default
