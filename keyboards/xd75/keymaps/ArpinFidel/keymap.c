 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | SELECT |        | MS 2   | MS UP  | MS 1   | MS 3   | P7     | P8     | P9     | -      |        | UP     |        | RGB HD | RGB HI |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { KC_MSEL, _______, KC_BTN2, KC_MS_U, KC_BTN1, KC_BTN3, KC_P7,   KC_P8,   KC_P9,   KC_MINS, _______, KC_UP  , _______ , RGB_HUD, RGB_HUI  },
