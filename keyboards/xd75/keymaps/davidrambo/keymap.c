 ...
 */
 ...
 [_NAV] = { /* NAVIGATION for Mac */
  ...
  { _______, _______, _______, _______, _______, _______, _______, _______, _______, G_TAB  , ABSPS  , KC_HOME, KC_END , G_GRV  , _______},
 ...
 [_NAVPC] = { /* NAVIGATION FOR WINDOWS: replaces Alt with Control, GUI with Alt, and browser tab shortcuts*/
  ...
  { _______, _______, _______, _______, _______, _______, _______, _______, _______, A_TAB  , CBSPS  , KC_HOME, KC_END , _______, _______},
  { RESET  , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
 }
};
