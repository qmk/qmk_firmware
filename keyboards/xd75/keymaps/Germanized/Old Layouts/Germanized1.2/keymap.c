...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    { KC_LCTL, KC_LALT, TT(1), KC_SPC, KC_SPC, KC_SPC, KC_SPC, TT(1), MT(MOD_RALT, KC_PAUS), KC_RGUI, DE_LESS, KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT },
    },
	...
	{ TO(0),   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, OSL(2),  KC_TRNS, KC_TRNS, KC_TRNS, KC_NLCK, KC_0,   DE_PLUS, DE_MINS },
	}, 
