...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWZ] = {
	{ KC_ESC,  KC_1,    KC_2,  KC_3,   KC_4,   KC_5,   KC_6,   KC_7,  KC_8,                  KC_9,    KC_0,    DE_SS,   DE_ACUT, KC_BSPC, KC_NO   }, 
    ...
    { KC_LCTL, KC_LALT, TT(1), KC_SPC, KC_NO,  KC_SPC, KC_NO,  TT(1), MT(MOD_RALT, KC_PAUS), KC_RGUI, DE_LESS, KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT },
    },
	
	[_TMP] = {
	{ KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, DE_SLSH, DE_ASTR }, 
	{ KC_TRNS, KC_MSTP, KC_TRNS, RGB_VAI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS,  KC_ENT,  KC_7,   KC_9,    KC_9    }, 
	{ KC_MPRV, KC_MPLY, KC_MNXT, RGB_TOG, RGB_MOD, KC_TRNS, KC_TRNS, KC_TRNS, RESET,   KC_TRNS, KC_MENU, KC_ENT,  KC_4,   KC_5,    KC_6    }, 
	{ KC_VOLD, KC_VOLU, KC_MUTE, RGB_VAD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR, KC_ENT,  KC_1,   KC_2,    KC_3    }, 
	{ TO(0),   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NLCK, KC_0,   DE_PLUS, DE_MINS },
	}, 
