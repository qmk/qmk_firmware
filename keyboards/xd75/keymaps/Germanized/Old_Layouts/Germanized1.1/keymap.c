...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    { KC_LCTL, KC_LALT, MO(1), KC_SPC, KC_SPC, KC_SPC, KC_SPC, MO(1), MT(MOD_RALT, KC_PAUS), KC_RGUI, DE_LESS, KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT },
    },
	...
	{ KC_VOLD, KC_VOLU, KC_MUTE, RGB_VAD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR, KC_ENT,  KC_END,  KC_DOWN, KC_PGDN }, 
