...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = {
        ...
        {KC_FUN,KC_LGUI,KC_LALT,KC_LCTL,MO(_LOWER), KC_SPFN, KC_PGDN, KC_PGUP, KC_HOME, KC_SPFN, KC_RCTL, KC_RALT, KC_RGUI, HYPER,KC_FUN},
    },
    [_GAMR] = {
    ...
    [_LOWER] = {
        ...
        {_______, _______, _______, _______, _______, KC_PIPE, _______, _______, _______, KC_BSLS, _______, _______, _______, _______, _______},
        {_______, _______, _______, _______, _______, _______, _______, _______, KC_END,  _______, _______, _______, _______, _______, _______},
    },
    [_SPCFN] = {
        {_______, _______, _______, _______, _______, _______, KC_F10,  KC_F11,  KC_F12,  _______, _______,_______,KC_MINS,  KC_EQL, KC_DEL},
        {KC_GRV,  _______, _______, KC_PGUP, _______, KC_LBRC, KC_F7,   KC_F8,   KC_F9,   KC_RBRC, _______, KC_UP,   _______, _______, _______},
        {_______, _______, KC_HOME, KC_PGDN, KC_END,  KC_LCBR, KC_F4,   KC_F5,   KC_F6,   KC_RCBR, KC_LEFT, KC_DOWN, KC_RIGHT,_______, _______},
        {_______, _______, _______, _______, _______, KC_LPRN, KC_MPRV, KC_MNXT, KC_MPLY,   KC_RPRN, _______, _______, _______, _______, _______},
