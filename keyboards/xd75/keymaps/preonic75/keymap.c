 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | CAP LK | A      | R      | S      | T      | D      | HOME   | DEL    | PG UP  | H      | N      | E      | I      | O      | '      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 ...
 */
 ...
 [_COLEMAK] = { /* QWERTY */
  ...
  { KC_CAPS, KC_A,    KC_R,    KC_S,    KC_T,   KC_D,   KC_HOME, KC_DEL,  KC_PGUP, KC_H,   KC_N,   KC_E,    KC_I,    KC_O, KC_QUOT },
  { KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,   KC_END,  KC_UP,   KC_PGDN, KC_K,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_RSFT, KC_ENT) },
  { KC_LCTL, KC_LGUI, KC_LALT, RAISE, KC_SPC, KC_SPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_SPC, KC_SPC, LOWER, KC_RALT, KC_RGUI, KC_RCTL },
 },
 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | CAP LK | A      | O      | E      | U      | I      | HOME   | DEL    | PG UP  | D      | H      | T      | N      | S      | /      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 ...
 */
 ...
 [_DVORAK] = { /* QWERTY */
  { KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,   KC_5,   KC_MINS, KC_GRV,  KC_EQL,  KC_6,   KC_7,   KC_8,    KC_9,    KC_0,    KC_BSPC },
  { KC_TAB,  KC_QUOT,    KC_COMM,    KC_DOT,    KC_P,   KC_Y,   KC_LBRC, KC_BSLS, KC_RBRC, KC_F,   KC_G,   KC_C,    KC_R,    KC_L,    KC_DEL },
  { KC_CAPS, KC_A,    KC_O,    KC_E,    KC_U,   KC_I,   KC_HOME, KC_DEL,  KC_PGUP, KC_D,   KC_H,   KC_T,    KC_N,    KC_S  , KC_SLSH },
  { KC_LSFT, KC_SCLN,    KC_Q,    KC_J,    KC_K,   KC_X,   KC_END,  KC_UP,   KC_PGDN, KC_B,   KC_M,   KC_W, KC_V,  KC_Z, MT(MOD_RSFT, KC_ENT) },
  { KC_LCTL, KC_LGUI, KC_LALT, RAISE, KC_SPC, KC_SPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_SPC, KC_SPC, LOWER, KC_RALT, KC_RGUI, KC_RCTL },
 },
