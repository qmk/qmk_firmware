...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        CW_TOGG, OSM(MOD_LGUI), KC_LEFT_ALT, KC_BACKSPACE, OSM(MOD_LALT),                                 KC_SPACE, OSM(MOD_RALT), KC_RIGHT_CTRL, KC_NO, KC_NO
        ),
    [1] = LAYOUT(
        _______, _______, _______, _______, _______,                                                                 KC_PSCR, _______, _______, _______,
        ...
        _______, _______, _______, KC_DEL, _______,                                                        KC_PGDN, _______, _______, _______, _______
        )};
