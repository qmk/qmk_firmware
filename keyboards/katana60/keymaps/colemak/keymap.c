...
#define K_PRVWD LALT(KC_LEFT)      // Previous word, MacOS
#define K_NXTWD LALT(KC_RIGHT)     // Next word, MacOS
#define K_LSTRT LGUI(KC_LEFT)      // Start of line, MacOS
#define K_LEND  LGUI(KC_RIGHT)     // End of line, MacOS
#define UNDO    LGUI(KC_Z)         // UNDO
#define CUT     LGUI(KC_X)         // UNDO
#define COPY    LGUI(KC_C)         // UNDO
#define PASTE   LGUI(KC_V)         // UNDO
...
[BASE] = KEYMAP( /* Base */
  ...
  MO(2),   KC_LCTL, KC_LALT, KC_LGUI,                   KC_BSPC, KC_DEL,  K_SPCFN,          KC_RGUI, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT
    ),
[NUMB] = KEYMAP(
  _______, _______, _______, _______, _______, _______, _______, DF(0),   _______, _______, _______, KC_PSLS, KC_PAST, KC_PMNS, _______,
  _______, _______, KC_BTN2, KC_MS_U, KC_BTN1, _______, _______,          _______, _______, KC_7,    KC_8,    KC_9,    KC_PPLS, _______,
  _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______,          _______, _______, KC_4,    KC_5,    KC_6,    KC_PPLS, _______,
...
[CURS] = KEYMAP(
  ...
  _______, _______, _______, KC_WH_U, _______, _______, _______,          _______, _______, K_PRVWD, KC_UP,   K_NXTWD, _______, _______,
  _______, _______, _______, KC_WH_D, KC_LSFT, _______, _______,          _______, KC_BSPC, KC_LEFT, KC_DOWN, KC_RIGHT,KC_DEL,  _______,
  _______, UNDO,    CUT,     COPY,    _______, PASTE,   _______, _______, _______, _______, K_LSTRT, _______, K_LEND,  _______, _______,
