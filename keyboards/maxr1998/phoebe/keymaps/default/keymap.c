...
[_QWERTZ] = {
  ...
  {KC_LCTL, KC_LGUI, KC_LALT, KC_LALT, KC_SC,   KC_SPC,  KC_SPC,  KC_ALGR, KC_FN,   KC_LEFT, KC_DOWN, KC_RGHT}
},
...
[_FN] = {
  ...
  {XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, XXXXXXX, KC_HOME, KC_PGDN, KC_END }
},
