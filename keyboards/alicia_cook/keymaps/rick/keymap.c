...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_ESC, KC_SCLN,KC_COMM,KC_DOT, KC_P,   KC_Y,            KC_F,   KC_G,   KC_C,   KC_R,   KC_L,   KC_BSPC, KC_BSPC,
        KC_LCTL,SH_A,   CT_O,   AL_T,   KC_U,   GU_I,            GU_D,   KC_H,   AL_T,   CT_N,   SH_S,   KC_ENT,
        KC_LSFT,KC_QUOT,KC_Q,   KC_J,   KC_K,   KC_X,            KC_B,   KC_M,   KC_W,   KC_V,   KC_Z,   KC_RSFT,MO(1),
