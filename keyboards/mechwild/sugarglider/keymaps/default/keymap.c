...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(                                                            
    KC_Q, KC_W,    KC_E, KC_R,    KC_T,    KC_ENT,                       KC_NUM,    KC_BSPC, KC_Y,    KC_U, KC_I,    KC_O,    KC_P,
    KC_A, KC_S,    KC_D, KC_F,    KC_G,    KC_ENT,           KC_MUTE,    KC_CAPS,    KC_BSPC, KC_H,    KC_J, KC_K,    KC_L,    KC_SCLN,
    KC_Z, KC_X,    KC_C, KC_V,    KC_B,    QK_GESC,                      KC_SCRL,    KC_RGUI, KC_N,    KC_M, KC_COMM, KC_DOT,  KC_SLSH,
