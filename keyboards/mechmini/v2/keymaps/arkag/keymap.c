...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_2u_space_ortho(
    ...
    M_PMOD,  LRALT,   M_SMOD,  LOWER,   RAISE,        KC_SPC,      KC_SLSH, KC_LEAD, KC_LEFT, KC_DOWN, KC_RGHT),
  ...
  [_LOWER] = LAYOUT_2u_space_ortho(
    ...
    _______, _______, _______, _______, _______,      _______,     KC_BSLS, LAZY,    KC_HOME, KC_PGDN, KC_END),
