...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_2u_space_ortho(
    ...
    KC_TAB,  KC_A,    KC_S,    KC_D,    TAP_F,   KC_G,    KC_H,    TAP_J,   KC_K,    KC_L,    KC_SCLN, QUOTE,
  ...
  [_RAISE] = LAYOUT_2u_space_ortho(
    ...
    _______, OBRACK,  CBRACK,  KC_EQL,  TAP_MIN, _______, _______, TAP_4,   KC_5,    KC_6,    _______, KC_NLCK,
