...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [_QWERTY] = LAYOUT_2u_space_ortho(
                ...
                M_PMOD,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_ENT,
                M_SMOD,  LRALT,   LAZY,    LOWER,   RAISE,        SPACE,       KC_SLSH, KC_BSLS, KC_LEFT, KC_DOWN, KC_RGHT),
        ...
        [_RAISE] = LAYOUT_2u_space_ortho(
                ...
                _______, _______, M_OS,    KEEB,    _______,      _______,     _______, _______, KC_PSLS, KC_PMNS, KC_PAST),
        ...
        [_LOWER] = LAYOUT_2u_space_ortho(
                ...
                _______, _______, M_CALC,  _______, _______,       MEDIA,      _______, _______,  KC_HOME, KC_PGDN, KC_END),
