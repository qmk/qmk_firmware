...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[base] = LAYOUT_2u_space_ortho(
		...
		KC_ESC,     KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     TD(0),    KC_ENT,
		KC_LSFT,    KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     TD(1),    TD(2),    TD(3),    KC_RSFT,
		KC_LCTL,    MO(3), KC_LALT,  KC_LGUI,  MO(1),        KC_SPC,         MO(2),    KC_VOLD,  KC_MPLY,  KC_VOLU,  KC_GRV),
	...
	[raise] = LAYOUT_2u_space_ortho(
		...
		KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,      KC_TRNS,        KC_TRNS,  KC_MPRV,  KC_TRNS,  KC_MFFD,  KC_TRNS),
  ...
  [RS_layer] = LAYOUT_2u_space_ortho( 
		...
		KC_LSFT,    KC_Z,     KC_X,     KC_C,      KC_V,     KC_B,     KC_N,     KC_M,     TD(1),    TD(2),    TD(3),    KC_RSFT,
		KC_LCTL,    KC_TRNS,  KC_LALT,  KC_LGUI,   MO(1),        KC_SPC,         MO(2),    KC_VOLD,  KC_MPLY,  KC_VOLU,  KC_GRV),
};
