...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        ...
        KC_TRNS, TERM_ON, TERM_OFF, CREDIT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL, KC_END, KC_PGDN, KC_TRNS,
...
void raw_hid_receive(uint8_t *data, uint8_t length) {
    // char result[15 + length] = "Received Data: ";
    // for (int i = 0; i < length; i++) {
    //     result[i + 16] = data[i];
    // }
    // raw_hid_send(result, 15 + length);
