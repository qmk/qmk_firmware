...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
	    ...
	    KC_ESC,        KC_LGUI, KC_LALT, LT(2,KC_CAPS), CTL_T(KC_BSPC),           SFT_T(KC_SPC), LT(1,KC_TAB),  TG(4),   KC_DEL, KC_ENT
	),
	[1] = LAYOUT(
	...
	[4] = LAYOUT(
		KC_WREF,       KC_NO,   KC_NO,   KC_NO,         KC_WSTP,                   KC_BTN3,      KC_WH_U,       KC_VOLD, KC_VOLU, KC_MUTE,
	 	KC_BTN3,       KC_ACL0, KC_ACL1, KC_ACL2,       KC_NO,                     KC_MS_L,      KC_MS_D,       KC_MS_U, KC_MS_R, KC_BTN1,
		KC_UNDO,       KC_CUT,  KC_COPY, KC_PSTE,       KC_FIND,                   KC_WH_L,      KC_WH_D,       KC_WH_R, KC_F11, KC_BTN2,
		KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS,                   KC_TRNS,      KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS
	)
};
