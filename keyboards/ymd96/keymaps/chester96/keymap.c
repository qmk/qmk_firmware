...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	*/
    ...
    KEYMAP(
			...
			KC_GRV,  KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,      KC_EQL,          KC_BSPC,          KC_DEL,     KC_KP_SLASH, KC_KP_ASTERISK, KC_CALCULATOR, \
    ...
    KEYMAP(
			KC_ESC,  KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11,       KC_F12,      	KC_PSCR, KC_PAUS, KC_NUMLOCK,    KC_SCROLLLOCK,      KC_PGUP,   	   KC_PGDN, \
			KC_GRV,  KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,      KC_EQL,          KC_BSPC,          KC_INS,     KC_KP_SLASH, KC_KP_ASTERISK, KC_CALCULATOR, \
			KC_TAB,  KC_Q,   KC_UP,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC,      KC_RBRC,         KC_BSLS,          RGB_TOG,      RGB_MOD,       RGB_HUI,          KC_PMNS,    \
			KC_TRNS, KC_LEFT,   KC_DOWN,   KC_RGHT,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,                       KC_ENT,           RGB_VAI,      RGB_VAD,       RGB_HUD,          KC_PPLS, \
			KC_LSFT, KC_Z,   ICON_EMAIL,   CHESTER_LOGIN,   CHESTER_EMAIL,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,                               KC_RSFT, KC_VOLU,   KC_P1,      KC_P2,       KC_P3,          KC_PENT, \
			KC_LCTL, KC_LGUI,KC_LALT,                              KC_SPC,                        KC_LALT,  KC_TRNS,  KC_RCTL,       KC_MUTE,     KC_VOLD,      KC_RGHT,     BL_STEP,          BL_TOGG  \
	),
};
