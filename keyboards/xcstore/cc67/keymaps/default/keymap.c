...
*/
    ...
    [_FN1]  = LAYOUT_65_ansi_blocker(
                ...
                _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_SAI,          RGB_SAD, RGB_VAI, RGB_HUD,
                _______, _______, _______,                            _______,          _______, _______,                   RGB_TOG, RGB_VAD, RGB_MOD
            ),
