The MechMicro is a clone board of the MechMini. It does not support an ortho layout, but does have some more options in the staggered layout. It uses a pro micro as the controller.
