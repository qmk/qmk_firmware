...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ortho_4x10(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT, LT(2,KC_BSPC), LT(1,KC_SPC), LT(4,KC_ENT), KC_APP,  KC_DEL, KC_ESC),
  [1] = LAYOUT_ortho_4x10(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,   KC_PENT, KC_TRNS, KC_TRNS, KC_TRNS),
  [2] = LAYOUT_ortho_4x10(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO,   KC_PENT, KC_NO,   KC_NO,   KC_NO),
  [3] = LAYOUT_ortho_4x10(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BSPC, KC_NO,   KC_PENT,   KC_NO,   KC_NO,   KC_NO),
  [4] = LAYOUT_ortho_4x10(
