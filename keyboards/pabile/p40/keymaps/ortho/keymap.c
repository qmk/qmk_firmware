...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ortho_4x10(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, LT(2,KC_BSPC), LT(1,KC_SPC),  KC_NO, LT(4,KC_ENT), KC_DEL,  KC_ESC, KC_RSFT),
  [1] = LAYOUT_ortho_4x10(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_PENT, KC_TRNS, KC_TRNS, KC_TRNS),
  [2] = LAYOUT_ortho_4x10(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,   KC_NO, KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
  [3] = LAYOUT_ortho_4x10(
  ...
  [4] = LAYOUT_ortho_4x10(
    ...
    KC_PEQL, KC_P0, KC_PDOT, KC_TRNS, KC_BSPC, KC_NO, KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS),
};
