...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      KC_LCTL, MO(2),   KC_LALT,                   KC_SPACE,                                    KC_LEFT, KC_DOWN, KC_RGHT, MO(1)
  ),
  [1] = LAYOUT(
      ...
      _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  KC_SLSH,                   _______,
  ...
  [2] = LAYOUT(
      ...
      APB_TOG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
