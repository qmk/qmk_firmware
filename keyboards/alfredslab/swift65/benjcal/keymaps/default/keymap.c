...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ansi_blocker(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _KC_CLN, KC_GRV,           _______,             KC_PGDN,
        QK_BOOT,          _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_TILD, _______, KC_VOLU,
