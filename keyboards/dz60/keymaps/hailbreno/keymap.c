...
* @Last Modified time: 2018-04-30 16:38:27
*/
...
[_QWERTY] = LAYOUT_2_shifts(
  ...
  KC_LCTL,            KC_LALT,  KC_LGUI,  KC_BSPC,    FUNC2,   KC_SPC,     KC_RALT,  KC_APP,  KC_LEFT,  KC_DOWN,  KC_RIGHT),
...
[_COLEMAK] = LAYOUT_2_shifts(
  ...
  KC_LSFT, X,         KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,  KC_K,  KC_M,  KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,  KC_UP,  KC_DEL,
  KC_LCTL,            KC_LALT,  KC_LGUI,  KC_BSPC,    FUNC2,   KC_SPC,     KC_RALT,  KC_APP,  KC_LEFT,  KC_DOWN,  KC_RIGHT),
...
[_DVORAK] = LAYOUT_2_shifts(
  ...
  KC_LSFT, X,         KC_SCLN,  KC_Q,  KC_J,  KC_K,  KC_X,  KC_B,  KC_M,  KC_W, KC_V,  KC_Z,  KC_RSFT,  KC_UP,       KC_DEL,
  KC_LCTL,            KC_LALT,  KC_LGUI,  KC_BSPC,    FUNC2,   KC_SPC,     KC_RALT,  KC_APP,  KC_LEFT,  KC_DOWN,  KC_RIGHT),
