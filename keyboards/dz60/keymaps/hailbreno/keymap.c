 ...
 * `-----------------------------------------------------------------------------------------'
 ...
 [LAYOUT] = LAYOUT_all(
  ...
  _______, XXX,       _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
[_QWERTY] = LAYOUT_all(
  ...
  SC_LSPO, XXX,         KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,  KC_N,  KC_M,  KC_COMM, KC_DOT,  KC_SLSH,  SC_RSPC,  KC_UP,     RGB0,
...
[_COLEMAK] = LAYOUT_all(
  ...
  SC_LSPO, XXX,         KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,  KC_K,  KC_M,  KC_COMM, KC_DOT,  KC_SLSH,  SC_RSPC,  KC_UP,     RGB0,
  KC_LCTL,            KC_LALT,  KC_LGUI,  KC_BSPC,    FUNC2,   KC_SPC,     KC_RALT,  KC_APP,  KC_LEFT,  KC_DOWN,   KC_RGHT),
...
[_DVORAK] = LAYOUT_all(
  ...
  SC_LSPO, XXX,         KC_SCLN,  KC_Q,  KC_J,  KC_K,  KC_X,  KC_B,  KC_M,  KC_W, KC_V,  KC_Z,  SC_RSPC,     KC_UP,       RGB0,
  KC_LCTL,            KC_LALT,  KC_LGUI,  KC_BSPC,    FUNC2,   KC_SPC,      KC_RALT,  KC_APP,  KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[_FUNC] = LAYOUT_all(
  ...
  _______, XXX,        _______, _______, _______, _______, _______, KC_END, _______, _______, _______, _______, _______, KC_PGUP, _______,
...
[_RGB] = LAYOUT_all(
  ...
  _______, XXX,       _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG, _______,
  _______, _______, _______,           _______,        _______,           _______,         _______, _______, _______, _______, _______),
