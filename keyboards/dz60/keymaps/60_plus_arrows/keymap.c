 ...
 * |-----------------------------------------------------------------------------------------+
 * | Shift     |  Z  |  X  |  C  |  V  |  B  |  N  |  M  |  ,  |  .  | RSh | RSh |  U  | FN  |
 * |-----------------------------------------------------------------------------------------+
 * | Ctrl |  Alt  |  Cmd  |              Space                |  /  | RAlt |  L  |  D  |  R  |
 * `-----------------------------------------------------------------------------------------'
 */
  ...
  KEYMAP_2_SHIFTS(
      ...
      KC_LSFT, ______, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_RSFT, KC_RSFT, KC_UP, MO(1),
      KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_SPC, KC_SPC, KC_SLSH, KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT
      ),
