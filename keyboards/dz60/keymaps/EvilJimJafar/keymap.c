...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    LAYOUT_b_4_9(
        ...
        KC_CAPS, TG(_NUM), KC_LALT,    MT(MOD_LGUI, KC_SPC),MO(_CODING),KC_SPC, KC_MPLY, KC_MFFD,   KC_LEFT,    KC_DOWN,   KC_RGHT
    ),
    ...
    */
    ...
    [_NAV] = LAYOUT_b_4_9(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_LEFT, _______, KC_RGHT, _______, KC_TILD,          _______,
