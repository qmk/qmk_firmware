...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_b_4_9(
       ...
       //
       // |------2.25--------|--------|--------|--------|--------|--------|--------|--------|--------|--------||----1.75------|--------|--------||
               KC_LSHIFT,      KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,    KC_N,    KC_M,   KC_COMM, KC_DOT,  SFT_T(KC_SLSH),  KC_UP, MO(_RGB),
       // |------------------|--------|--------|--------|--------|--------|--------|--------|--------|--------||--------------|--------|--------||
       //
       // |---1.25---|---1.25---||---1.25---||--------2.25--------||---1.25---|------2.75----------||--------|--------|--------|--------|--------|
             KC_CAPS,  KC_LALT,    KC_LGUI,       MO(_CODING),       MO(_NAV),      KC_SPC,          KC_HYPR, TG(_NUM), KC_LEFT, KC_DOWN, KC_RGHT
       // |----------|----------||----------||--------------------||----------|--------------------||--------|--------|--------|--------|--------|
          ),

    [_CODING] = LAYOUT_b_4_9(
         KC_GRV,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL,
        _______, _______, _______, _______, _______, _______, _______, KC_LBRC, _______, _______, KC_RBRC, _______, _______,   RESET,
    ...
    [_NAV] = LAYOUT_b_4_9(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_HOME,   KC_UP,  KC_END, _______, KC_TILD, _______,   RESET,
        _______, _______, _______, _______, _______, _______, _______, KC_LEFT, _______, KC_RGHT, _______,  KC_GRV,          _______,
        _______,          _______, _______, _______, _______, _______, KC_PGDN, KC_DOWN, KC_PGUP, _______, _______, _______, _______,
        _______, _______, _______,          _______, _______,          _______,          _______, _______, _______, _______, _______
    ),
    [_NUMPAD] = LAYOUT_b_4_9(
          ...
          KC_NO,   KC_NO,   KC_NO,            KC_NO,   KC_NO,            KC_NO,            KC_P0,   KC_PDOT, KC_NO,   KC_NO,   KC_NO
    ),
    [_RGB] = LAYOUT_b_4_9(
