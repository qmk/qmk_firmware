...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_MAIN] = LAYOUT_all(
		...
		TT(_GAMING)    , KC_LGUI , KC_LALT , KC_SPC  , TT(_EXTENDED)   , KC_SPC  , KC_RALT , KC_LEFT    , KC_DOWN    , KC_RIGHT    , MO(_SETTINGS)
		),

	[_EXTENDED] = LAYOUT_all(
		KC_ESC          , KC_F1   , KC_F2   , KC_F3   , KC_F4   , KC_F5   , KC_F6   , KC_F7      , KC_F8      , KC_F9       , KC_F10  , KC_F11     , KC_F12     , XXXXXXX     , KC_DEL  ,
  		_______         , _______  , KC_UP  , KC_EXEC  , _______  , _______  , _______  , _______     , _______     , KC_PAUS      , KC_SLCK  , KC_INS     , _______     , MO(_SETTINGS)     ,
	...
	[_GAMING] = LAYOUT_all(
		...
		_______        , KC_M  , _______  , _______  , _______  , KC_DEL  , _______  , KC_HOME    , KC_PGDOWN  , KC_END      , _______
		),
	...
	[_MOUSE] = LAYOUT_all(
		KC_ESC          , KC_F1   , KC_F2   , KC_F3   , KC_F4   , KC_F5   , KC_F6   , KC_F7      , KC_F8      , KC_F9       , KC_MS_ACCEL0  , KC_MS_ACCEL1     , KC_MS_ACCEL2     , XXXXXXX     , KC_DEL  ,
  		KC_MS_WH_UP         , KC_MS_WH_LEFT  , KC_MS_UP  , KC_MS_WH_RIGHT  , _______  , _______  , _______  , _______     , _______     , KC_PAUS      , _______  , _______     , _______     , _______     ,
