...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPC,  MO(_FN), KC_SPC,           KC_RGUI, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_DIR] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, C(KC_RGHT), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    [_FN] = LAYOUT(
        ...
        _______, _______, BL_TOGG, BL_DEC,  BL_INC,  _______, _______, _______, _______, _______, _______, _______, KC_VOLU, _______,
