...
#define LAYOUT_60_ansi_p( x1, iso, x2, cur5, x3, x4, x5, \
    ...
    { k40,  k41,   KC_NO, k43,  KC_NO, KC_NO, k46,  KC_NO, KC_NO, KC_NO, k4a,  k4b,  (x3 & ~cur5)|(k4d & cur5),	(x3 & cur5)|(k4d & ~cur5),   k4e   }  \
}
...
//=========================================================
	...
	LAYOUT_60_ansi_p(NO_XTRA, false, NO_XTRA, false, NO_XTRA, NO_XTRA, NO_XTRA,
