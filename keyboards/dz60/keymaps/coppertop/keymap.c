 ...
 */
	[_FN] = LAYOUT_directional(
		...
		______,  RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW, RGB_M_SN, RGB_M_K, RGB_M_X, RGB_M_G, XXXXXX,  XXXXXX, KC_PGUP,  BL_INC, KC_PGDN, 
 ...
 */
	[_MEDIA] = LAYOUT_directional(
		XXXXXX, XXXXXX, XXXXXX,  XXXXXX,  XXXXXX,  XXXXXX, XXXXXX,  XXXXXX,  KC_PSLS, KC_PAST, KC_PMNS, KC_PEQL, XXXXXX, ______, ______, 
