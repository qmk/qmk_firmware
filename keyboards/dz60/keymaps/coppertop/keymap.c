 ...
 */
	[_FN] = LAYOUT_directional(
		...
		KC_NO,  RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, KC_NO,   KC_NO,   KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO, 
		KC_CAPS, KC_NO,  RGB_HUD, RGB_SAD, RGB_VAD, KC_NO,   KC_NO,   KC_NO,  KC_NO,  KC_NO,  KC_SLCK, KC_PAUS, KC_PSCR, 
		KC_TRNS,  RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW, RGB_M_SN, RGB_M_K, RGB_M_X, RGB_M_G, KC_NO,  KC_NO, KC_PGUP,  BL_INC, KC_PGDN, 
 ...
 */
	[_MEDIA] = LAYOUT_directional(
		KC_NO, KC_NO, KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_NO,  KC_NO,  KC_PSLS, KC_PAST, KC_PMNS, KC_PEQL, KC_NO, KC_TRNS, KC_TRNS, 
