...
#define KC_RITE KC_RIGHT
#define KC_PAWS KC_PAUSE

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BL] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
		...
		KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGLT, KC_RADN, KC_RCTL
	),
	[_FL] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
		...
		_______, KC_LEFT, KC_DOWN, KC_RITE, _______, _______, KC_SLCK, KC_VOLD, KC_VOLU, KC_PAWS, _______, _______, _______,
