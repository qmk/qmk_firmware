 ...
 */
	LAYOUT_60_hhkb(
		...
		RGB_TOG,         ______,  ______,  ______,  ______,  ______,  ______,  ______,  KC_PSCR, KC_SLCK, KC_PAUS,  KC_UP,     ______,   KC_CLR,
		KC_CAPS,         KC_VOLD, KC_VOLU, KC_MUTE, ______,  ______,  KC_PAST, KC_PSLS, KC_HOME, KC_PGUP, KC_LEFT,  KC_RIGHT,  KC_RETURN,
		______,          ______,  ______,  ______,  ______,  ______,  KC_PPLS, KC_PMNS, KC_END,  KC_PGDN, KC_DOWN,  ______,     ______,
		        ______,           ______,                    ______,                             KC_APP,            ______),
};
