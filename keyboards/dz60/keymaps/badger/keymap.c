...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY]     = LAYOUT_64_ansi(\
     ...
     KC_LSFT,   KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,   KC_UP,    LT_END,  \
     KC_LCTL,   KC_LALT,  KC_LGUI,  KC_SPC,   FUNCTION, KC_RALT,  KC_LEFT,  KC_DOWN,  KC_RIGHT),

  [_MOVE]       = LAYOUT_64_ansi(\
     ...
     _______,   MM_UH,    MM_BH,    MAC_CPY,  MAC_PST,  IJ_IMPH,  _______,  IJ_REN,   IJ_IMPL,  IJ_DECL,  IJ_USAG,  _______,   _______,  _______, \
     _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______),

  [_FUNCTION]   = LAYOUT_64_ansi(\
     ...
     _______,   _______,  _______,  KC_CAPS,  _______,   KC_MPRV,  KC_MNXT,  KC_MUTE,  KC_WBAK,  KC_WFWD,  KC_WSCH,  _______,   _______,  CONFIG, \
     _______,   _______,  _______,  _______,  _______,   KC_RALT,  KC_RGUI,  KC_RCTL,  _______),

  [_MACRO]      = LAYOUT_64_ansi(\
     ...
     _______,   DF_1,     DF_2,     CONST,    _______,   SHEBANG,  KC_MNXT,  TS_IMPT,  KC_WBAK,  KC_WFWD,  KC_WSCH,  _______,   _______,  _______, \
     _______,   _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______),

  [_CONFIG]     = LAYOUT_64_ansi(\
     ...
     _______,   LAG_SWP,  LAG_NRM,  _______,  RGB_RMOD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  RGB_M_K,  _______,  _______,  _______,   _______,  _______, \
     _______,   _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______)
};
