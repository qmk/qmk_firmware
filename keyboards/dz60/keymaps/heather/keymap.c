 ...
 * |-----------------------------------------------------------------------------------------+
 * |   Shift   |  Z  |  X  |  C  |  V  |  B  |  N  |  M  |  ,  |  .  |  /  |Shift| Up  |Prsc |
 * |-----------------------------------------------------------------------------------------+
 ...
 */
	[_DEFAULT] = LAYOUT_2_shifts(
		...
		KC_LSFT, KC_NO, KC_Z,  KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, KC_PSCR, 
 ...
 */
	[_FN] = LAYOUT_2_shifts(
		...
		XXXXXX,  RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, XXXXXX,   XXXXXX,   XXXXXX,  XXXXXX,  XXXXXX,  XXXXXX,  XXXXXX,  XXXXXX,  XXXXXX, 
		KC_CAPS, XXXXXX,  RGB_HUD, RGB_SAD, RGB_VAD, XXXXXX,   XXXXXX,   XXXXXX,  XXXXXX,  XXXXXX,  KC_SLCK, KC_PAUS, KC_PSCR, 
		______,  XXXXXX,  RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW, RGB_M_SN, RGB_M_K, RGB_M_X, RGB_M_G, XXXXXX,  XXXXXX,  KC_PGUP,  BL_INC, KC_PGDN, 
 ...
 */
	[_MEDIA] = LAYOUT_2_shifts(
		XXXXXX, XXXXXX, XXXXXX,  XXXXXX,  XXXXXX,  XXXXXX, XXXXXX,  XXXXXX,  KC_PSLS, KC_PAST, KC_PMNS, KC_PEQL, XXXXXX, XXXXXX, XXXXXX, 
		XXXXXX, XXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXX, XXXXXX,  KC_P7,   KC_P8,   KC_P9,   KC_PPLS, XXXXXX,  XXXXXX, RESET, 
		______, XXXXXX, KC_MUTE, KC_VOLD, KC_VOLU, XXXXXX, XXXXXX,  KC_P4,   KC_P5,   KC_P6,   KC_PPLS, XXXXXX,  XXXXXX, 
		______, XXXXXX, XXXXXX,  XXXXXX,  XXXXXX,  XXXXXX, XXXXXX,  XXXXXX,  KC_P1,   KC_P2,   KC_P3,   KC_PENT, XXXXXX, XXXXXX, XXXXXX, 
		______, ______, ______,  XXXXXX,  ______,  KC_P0,  KC_PDOT, XXXXXX,  XXXXXX,  XXXXXX,  XXXXXX
		)
};