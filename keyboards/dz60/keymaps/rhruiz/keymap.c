...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT(
		...
		KC_LSFT,   KC_NO,    KC_Z,     KC_X,    KC_C,     KC_V,    KC_B,     KC_N,     KC_M,   KC_COMM,  KC_DOT,     KC_SLSH,  MT(MOD_RSFT, KC_UP),  TG(_FN2),
		MO(_FN1),  KC_LALT,  KC_LGUI,  KC_SPC,  FN2BSPC,  CMDENT,  KC_LGUI,  MT(MOD_LALT, KC_LEFT),  KC_NO,  MT(MOD_RCTL, KC_DOWN),   LT(_FN1, KC_RIGHT)),
