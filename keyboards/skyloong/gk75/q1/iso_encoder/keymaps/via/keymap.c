...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN_INDEX] =  LAYOUT_all(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,     _______,    _______,   NK_TOGG,  _______,    _______,      _______,  _______,  RGB_VAI,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_MAC] = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS), ENCODER_CCW_CW(KC_F14, KC_F15), ENCODER_CCW_CW(G(KC_SLSH), G(KC_RBRC)), ENCODER_CCW_CW(C(KC_UP), C(KC_DOWN)) },
