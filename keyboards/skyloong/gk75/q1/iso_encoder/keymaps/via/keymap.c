...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN] =   LAYOUT_all(
        ...
        KC_CAPS,     KC_A,     KC_S,     KC_D,     KC_F,     KC_G,        KC_H,     KC_J,       KC_K,     KC_L,         KC_SCLN,     KC_QUOT,   KC_ENT,   KC_NUHS,   KC_PGUP,
    ...
    [_MAC] =  LAYOUT_all(
        _______,             KC_F14,   KC_F15, C(KC_UP),  KC_WSCH,   G(KC_SPC), LSG(KC_4),   KC_MPRV,  KC_MPLY,         KC_MNXT,      KC_MUTE,  KC_VOLD,  KC_VOLU,   KC_PSCR,
         KC_GRV,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,        KC_6,      KC_7,       KC_8,     KC_9,            KC_0,     KC_MINS,   KC_EQL,   KC_BSPC,   KC_HOME,
         KC_TAB,     KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,        KC_Y,      KC_U,       KC_I,     KC_O,            KC_P,     KC_LBRC,  KC_RBRC,              KC_DEL,
        KC_CAPS,     KC_A,     KC_S,     KC_D,     KC_F,     KC_G,        KC_H,      KC_J,       KC_K,     KC_L,         KC_SCLN,     KC_QUOT,   KC_ENT,   KC_NUHS,   KC_PGUP,
        KC_LSFT,  KC_NUBS,     KC_Z,     KC_X,     KC_C,     KC_V,        KC_B,      KC_N,       KC_M,  KC_COMM,          KC_DOT,     KC_SLSH,  KC_RSFT,     KC_UP,
        KC_LCTL,  KC_LALT,  KC_LGUI,             KC_SPC,   KC_SPC,      KC_SPC,    KC_SPC,              KC_RALT,  MO(_MAC_INDEX),     _______,  _______,   _______,   _______
    ),

    [_WIN_INDEX] =  LAYOUT_all(
        _______,             KC_F14,   KC_F15, G(KC_TAB),  KC_WSCH,  G(C(KC_S)), LCA(KC_A),   KC_MPRV,  KC_MPLY,    KC_MNXT,      KC_MUTE,  KC_VOLD,  KC_VOLU,   KC_PAUS,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_WIN] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(RGB_VAD, RGB_VAI), ENCODER_CCW_CW(C(KC_WH_D), C(KC_WH_U)), ENCODER_CCW_CW(LSG(KC_TAB),G(KC_TAB)) },
    [_MAC] = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS), ENCODER_CCW_CW(KC_TRNS, KC_TRNS), ENCODER_CCW_CW(LAG(KC_MINS), LAG(KC_EQL)), ENCODER_CCW_CW(C(KC_UP), C(KC_DOWN)) },
