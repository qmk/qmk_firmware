...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_space_split(
      KC_GRAVE,     KC_1,     KC_2,     KC_3,      KC_4,     KC_5,     KC_6,     KC_7,       KC_8,      KC_9,        KC_0,    KC_MINUS,    KC_EQUAL,    KC_BSPC,
       ...
       KC_LCTL,  KC_LWIN,  KC_LALT,              KC_SPC,             KC_SPC,               KC_SPC,   KC_RALT,      KC_APP,     KC_RCTL,                   MO(1)
    ),
    /* Fn+ */
    [_FN] = LAYOUT_space_split(
       ...
       KC_LSFT,  RGB_HUI,  RGB_SAI,  RGB_SPI,     KC_NO,    KC_NO,    KC_NO,    KC_NO,      KC_NO,     KC_UP,       KC_UP,                   KC_RSFT,
       KC_CALC,  KC_MAIL,    KC_NO,              KC_SPC,             KC_SPC, 	           KC_SPC,   KC_LEFT,     KC_DOWN,     KC_RGHT,                    KC_NO
    ),
