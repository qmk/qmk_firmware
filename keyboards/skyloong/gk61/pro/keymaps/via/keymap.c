...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ansi_61(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,            KC_SPC,   KC_SPC,      KC_MUTE,            KC_SPC,   KC_RALT,  KC_APP,   KC_RCTL,            MO(2)
    ),
    ...
    [1] = LAYOUT_ansi_61(
        ...
        KC_LCTL,  KC_LALT,  KC_LGUI,            _______,  _______,     _______,            _______,  KC_RGUI,  KC_RALT,  KC_RCTL,            MO(2)
    ),
