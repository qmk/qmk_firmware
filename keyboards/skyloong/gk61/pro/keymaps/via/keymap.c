...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN_INDEX] =  LAYOUT_all(
        ...
        _______,  _______,    TO(0),    TO(1),  _______,  _______,     _______,  _______,  _______,  _______,  RGB_M_P,  RM_PREV,  RM_PREV,  RM_TOGG,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_WIN_INDEX] = { ENCODER_CCW_CW(RM_HUED, RM_HUEU) },
    [_MAC_INDEX] = { ENCODER_CCW_CW(RM_HUED, RM_HUEU) }
};
#endif
