...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN] =   LAYOUT_all(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,             KC_SPC,   KC_SPC,                 KC_SPC,             KC_RALT,    KC_APP,   KC_RCTL,         MO(_WIN_INDEX),   KC_LEFT,   KC_DOWN,    KC_RGHT
    ),

    [_MAC] =  LAYOUT_all(
        _______,             KC_F14,   KC_F15, C(KC_UP),  KC_WSCH,   G(KC_SPC), LSG(KC_4),    KC_MPRV,  KC_MPLY,   KC_MNXT,   KC_MUTE,  KC_VOLD,     KC_VOLU,    KC_PSCR,  KC_SCRL,   KC_PAUS,
         KC_GRV,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,        KC_6,      KC_7,       KC_8,     KC_9,      KC_0,   KC_MINS,   KC_EQL,     KC_BSPC,     KC_INS,  KC_HOME,   KC_PGUP,
         KC_TAB,     KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,        KC_Y,      KC_U,       KC_I,     KC_O,      KC_P,   KC_LBRC,  KC_RBRC,                  KC_DEL,   KC_END,   KC_PGDN,
        KC_CAPS,     KC_A,     KC_S,     KC_D,     KC_F,     KC_G,        KC_H,      KC_J,       KC_K,     KC_L,   KC_SCLN,   KC_QUOT,               KC_NUHS,     KC_ENT,
        KC_LSFT,  KC_NUBS,     KC_Z,     KC_X,     KC_C,     KC_V,        KC_B,      KC_N,       KC_M,  KC_COMM,    KC_DOT,   KC_SLSH,               KC_RSFT,                KC_UP,
        KC_LCTL,  KC_LALT,  KC_LGUI,             KC_SPC,   KC_SPC,                 KC_SPC,              KC_RALT,   KC_RCMD,   KC_RCTL,        MO(_MAC_INDEX),    KC_LEFT,  KC_DOWN,    KC_RGHT
    ),
