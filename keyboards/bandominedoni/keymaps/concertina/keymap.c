...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_OPEN] = LAYOUT(
       ...
       MY_Cs3, MY_Ds3, MY_G3, MY_As3, MY_Ds4, MY_F4, MY_D4, \
         MY_G2, MY_B2, MY_D3, MY_F3, MY_A3, MY_B3, XXXXXXX, \
      XXXXXXX, MY_Gs3, MY_Fs3, MI_A3, MY_C4, MY_E4, MY_Fs4, \
     XXXXXXX, TG_SWAP, XXXXXXX, MY_A2, XXXXXXX, MY_E3, XXXXXXX, XXXXXXX,  \

     MYMOSWP,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     FN_MUTE, \
         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
        MI_F1, MI_As1, MI_Ds2, MI_G2, MI_As2, MI_Cs2, \
     XXXXXXX, MI_G1, MI_B1, MI_D2, MI_F2, MI_A2, MI_C3, XXXXXXX, \
       MI_A1, MI_Fs2, MI_A2, MY_C3, MI_E3, MI_Gs2, XXXXXXX, XXXXXXX, \
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MY_C2, XXXXXXX, XXXXXXX \
    ),

    [_CLOSE] = LAYOUT(
                  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
       MY_Fs3, MY_Cs3, MY_A3, MY_Gs3, MY_Cs4, MY_A4, MY_C5, \
         MY_F3, MY_C3, MY_E3, MY_G3, MY_C4, MY_E4, XXXXXXX, \
       XXXXXXX, MY_As3, MI_G3, MY_B3, MY_D4, MY_G4, MY_B4, \
     XXXXXXX, TG_SWAP, XXXXXXX, MY_Ds3, XXXXXXX, MY_D3, XXXXXXX, XXXXXXX,  \

     MYMOSWP,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     FN_MUTE,
         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
        MI_E1, MI_A1, MI_Cs2, MI_A2, MI_Gs2, MI_Fs2, \
     XXXXXXX, MI_C1, MI_G1, MI_C2, MI_E2, MI_G2, MI_As2, XXXXXXX, \
       MI_B1, MI_D2, MY_G2, MI_B2, MI_D3, MI_F2, XXXXXXX, XXXXXXX, \
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MY_C2, XXXXXXX, XXXXXXX \
    ),
