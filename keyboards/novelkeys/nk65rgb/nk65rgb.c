...
led_config_t g_led_config = { {
    {  0,  4,  8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 64 },
    {  1,  5, 9, 13, 17, 21, 25, 29, 33, 37, 41, 45, 49,  NO_LED, 65 },
    {  2,  6, 10, 14, 18, 22, 26, 30, 34, 38, 42, 46, 53, 54, 68},
    {  3,  NO_LED,  7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 50, 51, 66 },
    { 56, 57, 58,  NO_LED,  NO_LED,  NO_LED, 59,  NO_LED,  NO_LED, 47, 61, 62, 63, 55, 67 }
}, {
