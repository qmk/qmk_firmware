...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DVORAK] = LAYOUT ( /* dvorak */
    ...
    KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    LOWER,   RAISE,   KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_RSFT,
    KC_LCTL, KC_LALT, KC_LEFT, KC_RGHT,          KC_BSPC, KC_LGUI, KC_ENT,  KC_SPC,           KC_UP,   KC_DOWN, KC_RGUI, KC_RCTL
  ),
