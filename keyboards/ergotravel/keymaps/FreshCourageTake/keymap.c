...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|                        |--------+--------+--------+--------+--------+--------+--------|
     KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_DELETE,                          KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
  //|--------+--------+--------+--------+--------+--------+--------|                        |--------+--------+--------+--------+--------+--------+--------|
     KC_LSFT, LCTL_T(KC_Z), LSFT_T(KC_X), LALT_T(KC_C), KC_V, KC_B, KC_ENT,                 _______, KC_N, KC_M, RALT_T(KC_COMM), RSFT_T(KC_DOT), RCTL_T(KC_SLSH), KC_RSFT,
  //|--------+--------+--------+--------+--------+--------+--------|                        |--------+--------+--------+--------+--------+--------+--------|
     _______, KC_LGUI, _______, MO(_NUMPAD),   MO(_ARROWS),   MO(_NUMFUN),                LT(_NUMFUN, KC_ENT),  LT(_SYMBOLS, KC_SPC),            _______, _______,   _______, _______
  //`--------+--------+--------+--------+--------+--------+--------/                        \--------+--------+--------+--------+--------+--------+--------'
  ),
  ...
  [_NUMFUN] = LAYOUT(
     ...
     _______, _______,  DM_REC1, DM_RSTP, DM_PLY1, _______, _______,         _______,  _______, DM_PLY2, DM_RSTP, DM_REC2, _______, _______,
  ...
  [_NUMPAD] = LAYOUT(
     ...
     _______, _______, _______, _______,           _______, _______,         _______,  KC_MINUS,          KC_KP_0, _______, _______, _______
  )
