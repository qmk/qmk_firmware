...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT_ANSI(
        ...
        KC_MUTE,KC_LANG2,KC_LALT,KC_LGUI,       SP_SFT,         SP_RAI,         KC_RGUI,OPT_IME,KC_LANG1,KC_LEFT,KC_DOWN,KC_RGHT  \
    ),
    [_WIN] = LAYOUT_ANSI(
        ...
        _______,        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______, \
        _______,_______,KC_LGUI,KC_LALT,        _______,        _______,        KC_APP, ALT_GRV,_______,_______,_______,_______  \
    ),
    [_NUM] = LAYOUT_ANSI(
...
#define JONES_LED_INDICATOR_INDEX 4
