...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_all(
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,           UG_VALU, UG_SATD,
      _______, _______, _______,                            UG_TOGG,                   _______, _______, _______,          UG_NEXT, UG_VALD, UG_PREV
  ),
  [2] = LAYOUT_all(
