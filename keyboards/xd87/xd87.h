...
#define LAYOUT_7bit( \
    K00, K01, K02, K03, K04, K05, K56, K06, K07, K08, K09, K0A, K0B, K0C, K0D, K0E, K0F, K0G, \
    ...
    K50, K51, K52, K53,      K55, K57, K58,           K5A, K5B, K5C, K5D,      K5E, K5F, K5G  \
) { \
...
/* 5 */   { K50,   K51,   K52,   K53,   KC_NO, K55,   K56,   K57,   K58,   KC_NO, K5A,   K5B,   K5C,   K5D,   K5E,   K5F,   K5G   }  \
}
...
#define LAYOUT_tkl_iso( \
    ...
    K50,   K51,   K52,   KC_NO,        KC_NO, KC_NO, K58,                 K5A,   K5B,   K5C,   K5D,          K5E,   K5F,   K5G    \
)
