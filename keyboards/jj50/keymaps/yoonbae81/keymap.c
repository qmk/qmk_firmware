...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_MAIN] = LAYOUT(
     ...
     MO(1),   MO(2),   KC_LGUI, KC_LALT, LT(1,KC_ENT), KC_NO, KC_SPC, KC_NO, LT(1,KC_RALT),LT(2,KC_RCTL), MO(1), MO(2)
  ),
  ...
  [_FN1] = LAYOUT(
     ...
     _______, KC_LBRC, KC_END,  KC_NO,   KC_PGDN, KC_RBRC, KC_NO,   KC_PGDN, KC_END,  KC_ENT,  KC_INS,  KC_DEL,
     _______, TO(2),   _______, _______, _______, _______, KC_BSPC, _______, _______, _______, _______, TO(2)
  ),
  ...
  [_FN2] = LAYOUT(
     ...
     _______, KC_NO,   KC_NO,   KC_NO,   KC_WH_D, KC_NO,   KC_NO,   KC_1,    KC_2,    KC_3,    KC_PPLS, KC_BSPC,
     _______, _______, KC_BTN1, KC_BTN2, _______, _______, KC_0,    _______, KC_PDOT, KC_BTN1, KC_BTN2, KC_NO
  ),
