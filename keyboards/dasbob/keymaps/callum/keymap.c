...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYMBOL] = LAYOUT_split_3x5_3(
        ...
        KC_PLUS, KC_PIPE, KC_AT,   KC_BSLS, KC_PERC, KC_QUOT, KC_AMPR, KC_SCLN, KC_COLN, KC_EXLM,
    ...
    [NAVIGATION] = LAYOUT_split_3x5_3(
        ...
        SPACE_L,    SPACE_R,   BACK,    FWD,    KC_MPLY, XXXXXXX,  KC_PGDN, KC_PGUP, SW_TAB, KC_ENT,
                          _______, _______, _______, _______, _______, _______
    ),

    [NUMBER] = LAYOUT_split_3x5_3(
...
// activate the NUMBER layer when the SYMBOL and NAVIGATION layers are active
layer_state_t layer_state_set_user(layer_state_t state) {
    return update_tri_layer_state(state, SYMBOL, NAVIGATION, NUMBER);
}
