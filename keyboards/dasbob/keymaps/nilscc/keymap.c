...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV] = LAYOUT_split_3x5_3(
        XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX,                                KC_CAPS, KC_TAB,  KC_LSFT, KC_LALT, XXXXXXX,
    ...
    [_NUM] = LAYOUT_split_3x5_3(
        KC_F9,  KC_F10, KC_F11, KC_F12, XXXXXXX,                                    KC_NUM,   KC_P7,  KC_P8,  KC_P9,  KC_PSLS,
        KC_F5,  KC_F6,  KC_F7,  KC_F8,  XXXXXXX,                                    KC_PPLS,  KC_P4,  KC_P5,  KC_P6,  KC_PDOT,
        KC_F1,  KC_F2,  KC_F3,  KC_F4,  XXXXXXX,                                    KC_PMNS,  KC_P1,  KC_P2,  KC_P3,  KC_PAST,
                                        XXXXXXX, _______, XXXXXXX,        KC_PENT,  KC_PEQL,  KC_P0
    ),
