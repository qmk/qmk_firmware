...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNC] = LAYOUT_all(
        ...
        KC_TRNS,  KC_WH_U, KC_BTN1, KC_MS_U, KC_BTN2, KC_TRNS, KC_TRNS, AG_NORM, AG_SWAP, QWERTY,  WORKMAN, KC_TRNS, KC_TRNS,          KC_TRNS, KC_INS,
        KC_TRNS,  KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS, KC_TRNS, KC_HOME,  KC_END, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS,          KC_HOME,
