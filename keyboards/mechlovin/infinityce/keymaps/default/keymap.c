...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        KC_GRV,     KC_1,      KC_2,      KC_3,      KC_4,      KC_5,      KC_6,      KC_7,      KC_8,      KC_9,      KC_0,     KC_MINS,     RGB_HUD,   KC_BSPC,                 KC_INS,      KC_HOME,     KC_PGUP,
        KC_TAB,     KC_Q,      KC_W,      RGB_MOD,   KC_R,      KC_T,      RGB_MOD,   KC_U,      KC_I,      KC_O,      KC_P,     KC_LBRC,     KC_RBRC,   KC_SLSH,                 KC_DEL,      KC_END,      KC_PGDN,
