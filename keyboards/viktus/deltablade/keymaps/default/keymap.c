...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 /* Keymap BASE: (Base Layer) Default Split Backspace Layer
   * .--------------------------------------------------------------------.
   ...
   * |--------------------------------------------------------------------|
   * |LCtrl| Alt | Space | Fn | Space | Alt | MO(1)| RCtrl | L | Dn |  R  |
   * `--------------------------------------------------------------------'
   */
[0] = LAYOUT_all( /* Deltablade Base */
