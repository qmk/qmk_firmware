...
#define PRODUCT_ID      0x4442 // "DB" = DeltaBlade
#define DEVICE_VER      0x0001
#define MANUFACTURER    Viktus Design LLC
#define PRODUCT         Deltablade
 ...
 *
*/
#define MATRIX_ROW_PINS { B11, B10, B2, B1, B0, A7, A6, A5, A4, B12 }
#define MATRIX_COL_PINS { A0, A1, A2, A3, B13, B14, B15, A8 }
//{C13, C14, C15, A0,A2,A3,A4,A5,A6, A1,B12,B1}
/* Unused pins, in the default layout, are:
All Extra pins (A8, B15, B14, B13, B3, B5, B8, B9)
*/
