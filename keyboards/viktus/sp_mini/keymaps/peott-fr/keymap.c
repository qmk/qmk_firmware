...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [_BASE] = LAYOUT_all(
			...
			KC_HOME, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, 					 	KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, NUM,
			KC_PGUP, KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G,					 	KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_DEL,
			KC_PGDN, KC_LSPO, KC_Z, KC_X, KC_C, KC_V, KC_B, 				 	KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_UP,
			KC_END, LCTL_T(KC_MPRV), KC_LGUI, LALT_T(KC_MNXT), KC_NO, LHAND, 	RHAND, KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
			),
        [_LHAND] = LAYOUT_all(
			RESET, KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, 			   	KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_PSCR,
			KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_UP, KC_TRNS, KC_TRNS,   	RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, KC_TRNS, KC_TRNS,
			KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, 	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_ENT, KC_TRNS,
			KC_TRNS, KC_LSFT, KC_CALC, KC_MYCM, KC_TRNS, KC_ENT, KC_BSPC, 	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_RSPC, KC_TRNS,
			KC_TRNS, KC_LCTL, KC_TRNS, KC_LALT, KC_TRNS, KC_TRNS,          	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
			),
        [_RHAND] = LAYOUT_all(
