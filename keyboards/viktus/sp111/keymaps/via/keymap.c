...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_all(
    KC_MPLY, KC_MUTE, KC_MPRV, KC_MNXT,      KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,           KC_PSCR, KC_SLCK, KC_PAUS,
    ...
    KC_P0,   KC_P0,   KC_PDOT, KC_PDOT,      KC_LCTL, KC_LALT, KC_LGUI, KC_MUTE, KC_SPC,           KC_SPC,  KC_APP,  KC_RGUI, KC_RALT, KC_RCTL,                            KC_LEFT, KC_DOWN, KC_RIGHT),
