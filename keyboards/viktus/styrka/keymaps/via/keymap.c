...
[0] = LAYOUT_default( /* Styrka Base */
	...
	KC_F9,  KC_F10,  KC_LCTL,        KC_LALT,        KC_SPC,  KC_RALT,             KC_RCTL                                         KC_LEFT,  KC_DN,    KC_RT
  ),
