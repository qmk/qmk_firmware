...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        MO(_FN), KC_MINS,   KC_EQL, KC_LEFT, KC_RGHT, KC_LALT, KC_RGUI, KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, MO(_FN),
        KC_BSPC, KC_LCTL, KC_HOME,  KC_PGUP, KC_RCTL, KC_SPC,
        KC_DEL, KC_END,  KC_PGDN, KC_ENT
    ),
    [_FN] = LAYOUT(
        RGB_TOG,    RGB_MODE_FORWARD,    RGB_MODE_RAINBOW,    KC_9,  KC_0,    KC_MINS, KC_6,    KC_7,    KC_8,    KC_9,  KC_0,    KC_MINS,
        ...
        KC_RGUI, KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, MO(_FN), KC_RGUI, KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, MO(_FN),
        KC_BSPC, KC_LCTL, KC_HOME,  KC_PGUP, KC_RCTL, KC_SPC,
        KC_DEL, KC_END,  KC_PGDN, KC_ENT
    )
};
