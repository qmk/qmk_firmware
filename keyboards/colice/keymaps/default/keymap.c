...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
      KC_ESC, KC_GRV, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,               KC_PSLS,KC_PAST,TG_NUM,                  KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL, KC_BSPC, \
              ...
              KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   RAISE,      KC_MUTE,KC_VOLD,KC_VOLU,KC_PENT,                 KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_UP,  KC_RSFT, \
              RAISE,                  KC_LALT,KC_LGUI,SP_SFT,             KC_P0,          KC_PDOT,                         LOWER,  SP_GUI, KC_LALT,        KC_LEFT,KC_DOWN,KC_RGHT,KC_LCTL \
    ),
    [_NUM] = LAYOUT(
      _______, KC_GRV, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,               KC_PSLS,KC_PAST,TG_NUM,              KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL, KC_BSPC, \
              ...
              KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   LOWER,      KC_P1,  KC_P2,  KC_P3,  KC_PENT,                 KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,_______,_______, \
              RAISE,                  KC_LALT,KC_LGUI,_______,             KC_P0,          KC_PDOT,                         _______,_______,_______,        _______,_______,_______,_______ \
    ),
    [_LOWER] = LAYOUT(
    ...
    [_RAISE] = LAYOUT(
      _______, KC_GRV, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,               KC_PSLS,KC_PAST,KC_PMNS,              KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL, KC_BSPC, \
              KC_TAB, KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,          KC_P7,  KC_P8,  KC_P9,  KC_PMNS,                 KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC,KC_RBRC,KC_BSLS, \
              KC_LCTL,KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,          KC_P4,  KC_P5,  KC_P6,  KC_PPLS,                 KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,KC_ENT, \
              KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   _______,       KC_P1,  KC_P2,  KC_P3,  KC_PENT,                 KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,_______,_______, \
              _______,                  KC_LALT,KC_LGUI,_______,              KC_P0,          KC_PDOT,                         _______,_______,_______,        _______,_______,_______,_______ \
    ),
    [_ADJUST] = LAYOUT(
      _______, KC_GRV, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,              KC_PSLS,KC_PAST,KC_PMNS,             KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL, KC_BSPC, \
              ...
              KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   _______,       RGB_HUD,RGB_SAD,RGB_VAD,  KC_PENT,                 KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,_______,_______, \
              _______,                  KC_LALT,KC_LGUI,_______,              KC_P0,          KC_PDOT,                           _______,_______,_______,        _______,_______,_______,_______ \
    )
};
