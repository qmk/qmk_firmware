...
[_QWERTY] = { /*QWERTY*/
	...
	{KC_TAB,    KC_Q,      KC_W,    KC_E,    KC_R,    KC_T,    XXXXXXX,   XXXXXXX,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,       KC_DEL  },
	{KC_GRV,    KC_A,      KC_S,    KC_D,    KC_F,    KC_G,    XXXXXXX,   XXXXXXX,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,    KC_QUOT },
	{KC_LSFT,   KC_Z,      KC_X,    KC_C,    KC_V,    KC_B,    XXXXXXX,   XXXXXXX,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,    KC_ENT  },
	{KC_LCTL,   KC_LGUI,   KC_LALT, ADJUST,  LOWER,   KC_SPC,  XXXXXXX,   XXXXXXX,    KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,      KC_RIGHT}
}, 
