...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_NO,     KC_LCTRL, KC_LALT, KC_LGUI, MO(_LOWER), KC_NO,     KC_SPACE,     MO(_RAISE), KC_LEFT,  KC_DOWN,  KC_UP,       KC_RIGHT  //HC_NO before space is not a key in hardware
    ),
    [_RAISE] = LAYOUT(
    ...
    [_LOWER] = LAYOUT(
   	KC_NO,     EXCL,     AT,      POUND,   DOLLAR,     PERCENT,   CARAT,        AND,        STAR,     LPAR,      RPAR,        KC_DELETE,               
