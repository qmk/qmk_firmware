...
|---------+--------+--------+--------+--------+--------|                                                     |--------+--------+--------+--------+--------+---------|
| Tab|MEH |   Q~   |   W~   |    E   |   R~   |   T~   |                                                     |   Y~   |   U    | I|Spot |   O    |   P    |Bksp/HYP |
|---------+--------+--------+--------+--------+--------|                                                     |--------+--------+--------+--------+--------+---------|
| LPINKY* | A/LCTL | S/LOPT | D/LGUI | F/LSFT |    G   |                                                     |    H   | J/RSFT | K/RGUI | L/ROPT | COLON* | RPINKY* |
|---------+--------+--------+--------+--------+--------|                                                     |--------+--------+--------+--------+--------+---------|
...
`---------+--------+--------+--------+--------+--------'                                                     `--------+--------+--------+--------+--------+---------'
          ...
          `-----------------------------------'                                                                       `-----------------------------------'
	                                                   ...
	                                                   |SELWORD |Ent/COG*|                 | . /??? | , /NAV |
	                                          ,--------+--------+--------|                 |--------+--------+--------.
	                                          |  Bksp  |  Del   |SPOT|Spc|                 |WINDOW* |        |  SPACE |
	                                          |  ^Del  |   /    |--------|                 |--------|  ENTR* |   /    |
	                                          |  /LGUI |  LSHFT | APPNAV*|                 |  OSMeh |        |  RGUI  |
	                                          `--------------------------'                 `--------------------------'
    Notes:
    ...
    * : indicates one shot
    * ~ indicates hold function, typically CMD+Key (exception is holding Y, gives CMD+SHIFT+Y)
  ...
  _______, _______, _______, _______, _______, _______,                                                       _______, _______, _______, _______, KC_BSLS, _______,
           _______, _______, _______, _______,                                                                         _______, _______, _______, _______,
                                                        KC_PLUS, _______,                   _______, KC_GRV,
                                                                 KC_ASTR,                   _______,
                                               KC_MINS, KC_EQL,  KC_SLSH,                   KC_QUES, KC_DQUO, KC_UNDS
),
...
[_RKEYPAD] = LAYOUT_pretty(
  ...
  _______, _______, _______, _______, _______, _______,                                                       _______, KP4_SFT, KP5_GUI, KP6_OPT, PLS_CTL, _______,
...
[_LKEYPAD] = LAYOUT_pretty(
  ...
  _______, _______, KP4_OPT, KP5_LGU, KP6_SFT, KC_PPLS,                                                       _______, _______, _______, _______, _______, _______,
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    dprintf("\ncallback func symbols layer is %x", IS_LAYER_ON(_SYMBOLS));
        ...
        if (IS_LAYER_ON_STATE(state, _SYMBOLS)) {
            ...
            writePin(LED_KEYPAD, !layer_state_cmp(state, _RKEYPAD));
        }
    }
    return state;
}
