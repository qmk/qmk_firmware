...
// #define SPLIT_WATCHDOG_TIMEOUT 5000 // Increase to 5 seconds

// #define MASTER_LEFT

#define SERIAL_USART_FULL_DUPLEX   // Enable full duplex operation mode.
#define SERIAL_USART_TX_PIN B6     // USART TX pin - for full duplex
#define SERIAL_USART_RX_PIN B7     // USART RX pin - for full duplex
/* If using USART Serial, this helps with STM32 noise */
#define SERIAL_USART_ERR_DETECTION
