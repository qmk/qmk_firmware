...
#define U_LSHIFT    LSFT_T(KC_T)
// right Mac
#define U_RSHIFT  RSFT_T(KC_N)
...
// UL means User Layer Toggle for Mac OS (MOS)
#define UL_TO_COLE      TO(_COLEMAKDH)
#define UL_TO_NUMPAD    TO(_NUMPAD)
#define UL_LT_NUM       LT(_NUMBER, KC_SPC)
#define UL_TO_NAV       TO(_NAVIGATION)
#define UL_LT_SYMB      LT(_SYMBOL, KC_INSERT)             
#define UL_LT_NAV       LT(_NAVIGATION, KC_ENT)
#define UL_LT_FUNC      LT(_FUNCTION, KC_DEL)


// left Windows OS
#define U_LGUI_W      LGUI_T(KC_A)
#define U_LALT_W      LALT_T(KC_R)
#define U_LCTL_W      LCTL_T(KC_S)
#define U_LSHIFT_W    LSFT_T(KC_T)
// right windws
#define U_RSHIFT_W  RSFT_T(KC_N)
#define U_RCTL_W    RCTL_T(KC_E)
#define U_RALT_W    RALT_T(KC_I)
#define U_RGUI_W    GUI_T(KC_O)
// Number Pad for Windows
#define U_RSFT_NPAD  RSFT_T(KC_KP_4)
#define U_RCTL_NPAD  RCTL_T(KC_KP_5)
#define U_RALT_NPAD  RALT_T(KC_KP_6)
#define U_GUI_NPAD   GUI_T(KC_KP_PLUS)
// UL means User Layer Toggle for Windows OS (WOS)
#define UL_TO_COLE_W    TO(_COLDH_WOS)
#define UL_TO_NUMPAD_W  TO(_NUMP_WOS)
#define UL_LT_NUM_W     LT(_NUM_WOS, KC_SPC)
#define UL_TO_NAV_W     TO(_NAV_WOS)
#define UL_LT_SYMB_W    LT(_SYMB_WOS, KC_INSERT)             
#define UL_LT_NAV_W     LT(_NAV_WOS, KC_ENT), 
#define UL_LT_FUNC_W    LT(_FUN_WOS, KC_DEL),



// UL means User Layer Toggle for Windows
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_COLEMAKDH] = LAYOUT_split_3x6_3(
        KC_ESC,   KC_Q,    KC_W,      KC_F,    KC_P,    KC_B,          KC_J,  KC_L,      KC_U,     KC_Y,      KC_SCLN,  KC_BSPC,
        KC_TAB,   U_LCTL,  U_LALT,  U_LGUI,  U_LSHIFT,  KC_G,          KC_M,  U_LSHIFT,  U_LGUI,   U_LALT,    U_LCTL,   KC_QUOT, 
        KC_LSFT,  KC_Z,    KC_X,      KC_C,    KC_D,    KC_V,          KC_K,  KC_H,      KC_COMM,  KC_DOT,    KC_SLSH,  KC_RSFT, 
        UL_TO_NAV,  UL_LT_SYMB,  UL_LT_NUM,                            UL_LT_NAV,  UL_LT_FUNC,  UL_TO_NUMPAD
    ),
    ...
    [_NAVIGATION] = LAYOUT_split_3x6_3(
        ...
        _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  XXXXXXX,       XXXXXXX,  KC_RGUI,  KC_LALT,  KC_RSFT,  KC_RCTL,  XXXXXXX, 
        _______,  MS_WHLL,  MS_WHLD,  MS_WHLU,  MS_WHLR,  XXXXXXX,       XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, 
        UL_TO_COLE,  _______,  _______,                              XXXXXXX,  XXXXXXX,  _______
    ),
     /*
      * ┌──────┬─────┬─────────────┬─────┬─────┬───┐       ┌─────┬───┬───┬───┬───┬─────┐
    ...
    [_FUNCTION] = LAYOUT_split_3x6_3(
        ...
        KC_F14,  KC_F5,    KC_F6,    KC_F7,   KC_F8,   KC_F17,              XXXXXXX,  KC_RGUI,  KC_LALT,  KC_RSFT,  KC_RCTL,  XXXXXXX, 
    ...
    [_NUMPAD] = LAYOUT_split_3x6_3(
        ...
        XXXXXXX,  XXXXXXX,  _______,                                             _______,    XXXXXXX,     UL_TO_COLE
    ),
  ...
  /*                             Windows
    ...
    [_COLDH_WOS] = LAYOUT_split_3x6_3(
        KC_ESC,   KC_Q,    KC_W,    KC_F,    KC_P,      KC_B,          KC_J,  KC_L,      KC_U,     KC_Y,      KC_SCLN,  KC_BSPC,
        KC_TAB,   U_LGUI,  U_LALT,  U_LCTL,  U_LSHIFT,  KC_G,          KC_M,  U_LSHIFT,  U_LCTL,   U_LALT,    U_LGUI,   KC_QUOT, 
        KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_D,      KC_V,          KC_K,  KC_H,      KC_COMM,  KC_DOT,    KC_SLSH,  KC_RSFT,
        UL_TO_NAV_W,  UL_LT_SYMB_W,  UL_LT_NUM_W,                            UL_LT_NAV_W,  UL_LT_FUNC_W,  UL_TO_NUMPAD
    ),

    [_NAV_WOS] = LAYOUT_split_3x6_3(
        _______,  KC_END,   KC_PGDN,  KC_PGUP,  KC_HOME,  XXXXXXX,       XXXXXXX,  QK_MOUSE_CURSOR_LEFT,  QK_MOUSE_CURSOR_UP,  QK_MOUSE_CURSOR_DOWN,  QK_MOUSE_CURSOR_RIGHT,  _______,
        _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  XXXXXXX,       XXXXXXX,  KC_RSFT,  KC_RCTL,  KC_RALT,  KC_LGUI,  XXXXXXX, 
        _______,  MS_WHLL,  MS_WHLD,  MS_WHLU,  MS_WHLR,  XXXXXXX,       XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, 
        UL_TO_COLE_W,  _______,  _______,                              XXXXXXX,  XXXXXXX,  _______
    ),

    [_NUM_WIND] = LAYOUT_split_3x6_3(
        _______,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,         XXXXXXX,   KC_7,     KC_8,  KC_9,    XXXXXXX,  KC_BSPC,
        _______,  KC_LGUI,  KC_LALT,  KC_LCTL,  KC_LSFT,  XXXXXXX,         KC_MINUS,  KC_4,     KC_5,  KC_6,    KC_PLUS,  XXXXXXX,
        _______,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,         KC_DOT,    KC_1,     KC_2,  KC_3,    KC_0,     KC_RSFT,
        XXXXXXX,  XXXXXXX,  _______,                                       _______,   XXXXXXX, UL_TO_COLE_W
    ),
    
    [_FUN_WIND] = LAYOUT_split_3x6_3(
        KC_F15,  KC_F9,    KC_F10,   KC_F11,  KC_F12,  KC_F18,              XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
        KC_F14,  KC_F5,    KC_F6,    KC_F7,   KC_F8,   KC_F17,              XXXXXXX,  KC_RSFT,  KC_RCTL,  KC_RALT,  KC_LGUI,  XXXXXXX, 
        KC_F13,  KC_F1,    KC_F2,    KC_F3,   KC_F4,   KC_F16,              XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, 
        XXXXXXX,  XXXXXXX,  XXXXXXX,                                        XXXXXXX,  XXXXXXX,  XXXXXXX
    ),

    [_SYMB_WIND] = LAYOUT_split_3x6_3(
        _______,    KC_TILD,  KC_GRV,   KC_UNDS,  XXXXXXX,  XXXXXXX,        XXXXXXX,    XXXXXXX,  KC_LPRN,  KC_RPRN,  XXXXXXX,  _______,
        _______,    KC_EXLM,  KC_HASH,  KC_COLN,  KC_AMPR,  KC_PERC,        KC_CIRC,    KC_DLR,   KC_ASTR,  KC_EQL,   KC_SCLN,  XXXXXXX, 
        _______,    KC_LBRC,  KC_AT,    KC_MINS,  KC_RBRC,  XXXXXXX,        XXXXXXX,    KC_LCBR,  KC_PIPE,  KC_BSLS,  KC_RCBR,  _______, 
        XXXXXXX,    XXXXXXX,  XXXXXXX,                                      XXXXXXX,    XXXXXXX,  XXXXXXX
    ...
    [_NUMP_WIND] = LAYOUT_split_3x6_3(
        XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_KP_ENTER,  XXXXXXX,  XXXXXXX,         KC_KP_SLASH,  KC_KP_7,     KC_KP_8,      KC_KP_9,      KC_KP_ASTERISK,  KC_BSPC,
        XXXXXXX,  KC_LGUI,  KC_LALT,  KC_LCTL,      KC_LSFT,  XXXXXXX,         KC_KP_MINUS,  U_GUI_NPAD,  U_RALT_NPAD,  U_RSFT_NPAD,  U_RCTL_NPAD,     XXXXXXX,
        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,      XXXXXXX,  XXXXXXX,         KC_PDOT,      KC_KP_1,     KC_KP_2,      KC_KP_3,      KC_KP_0,         KC_RSFT,
        XXXXXXX,  XXXXXXX,  _______,                                             _______,    XXXXXXX,     UL_TO_COLE_W
    )
};
