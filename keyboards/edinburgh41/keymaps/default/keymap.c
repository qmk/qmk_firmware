/* Copyright 2022 schwarzer_geiger
 *
...
uint32_t layer_state_set_user(uint32_t state) {
  ...
  switch (biton32(state)) {
    ...
    // Keypress behaviour: Copy the content of the case _LOWER. Set input_keycodes.keycode_up = to the keycode you want to press when moving the thumbstick up etc.
    // Scroll behaviour: Copy the content of the case _RAISE.
    case _BASE:
