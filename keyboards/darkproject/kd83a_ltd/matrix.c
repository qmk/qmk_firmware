...
static inline matrix_row_t read_cols(void) {
    return (((((PAL_PORT(A0))->IDR) & ((1U << 5) - 1U)) ^ ((1U << 5) - 1U)) |
            ((((((PAL_PORT(A0))->IDR) >> (PAL_PAD(A8))) & ((1U << 3) - 1U)) ^ ((1U << 3) - 1U)) << 5));
}
...
static void select_row(uint8_t row) {
    switch (row) {
        case 0:
            ATOMIC_BLOCK_FORCEON {
            pal_lld_setgroupmode(PAL_PORT(B0),
                                PAL_PORT_BIT(PAL_PAD(B0)),
                                0U,
        ...
        case 1:
            ATOMIC_BLOCK_FORCEON {
            pal_lld_setgroupmode(PAL_PORT(B1),
                                PAL_PORT_BIT(PAL_PAD(B1)),
                                0U,
                                (PAL_WB32_MODE_OUTPUT |
                                PAL_WB32_OTYPE_PUSHPULL | 
        ...
        case 2:
            ATOMIC_BLOCK_FORCEON {
            pal_lld_setgroupmode(PAL_PORT(B2),
                                PAL_PORT_BIT(PAL_PAD(B2)),
                                0U,
                                (PAL_WB32_MODE_OUTPUT |
                                PAL_WB32_OTYPE_PUSHPULL | 
        ...
        case 3:
            ATOMIC_BLOCK_FORCEON {
            pal_lld_setgroupmode(PAL_PORT(B3),
                                PAL_PORT_BIT(PAL_PAD(B3)),
                                0U,
                                (PAL_WB32_MODE_OUTPUT |
                                PAL_WB32_OTYPE_PUSHPULL | 
        ...
        case 4:
            ATOMIC_BLOCK_FORCEON {
            pal_lld_setgroupmode(PAL_PORT(B4),
                                PAL_PORT_BIT(PAL_PAD(B4)),
                                0U,
                                (PAL_WB32_MODE_OUTPUT |
                                PAL_WB32_OTYPE_PUSHPULL | 
        ...
        case 5:
            ATOMIC_BLOCK_FORCEON {
            pal_lld_setgroupmode(PAL_PORT(B5),
                                PAL_PORT_BIT(PAL_PAD(B5)),
                                0U,
                                (PAL_WB32_MODE_OUTPUT |
                                PAL_WB32_OTYPE_PUSHPULL | 
        ...
        case 6:
            ATOMIC_BLOCK_FORCEON {
            pal_lld_setgroupmode(PAL_PORT(B6),
                                PAL_PORT_BIT(PAL_PAD(B6)),
                                0U,
                                (PAL_WB32_MODE_OUTPUT |
                                PAL_WB32_OTYPE_PUSHPULL | 
        ...
        case 7:
            ATOMIC_BLOCK_FORCEON {
            pal_lld_setgroupmode(PAL_PORT(B7),
                                PAL_PORT_BIT(PAL_PAD(B7)),
                                0U,
                                (PAL_WB32_MODE_OUTPUT |
                                PAL_WB32_OTYPE_PUSHPULL | 
        ...
        case 8:
            ATOMIC_BLOCK_FORCEON {
            pal_lld_setgroupmode(PAL_PORT(B8),
                                PAL_PORT_BIT(PAL_PAD(B8)),
                                0U,
                                (PAL_WB32_MODE_OUTPUT |
                                PAL_WB32_OTYPE_PUSHPULL | 
        ...
        case 9: // Pin B12 was removed from matrix definition. This row can be scanned during scan of B9 row
            ATOMIC_BLOCK_FORCEON {
                pal_lld_setgroupmode(PAL_PORT(B9),
                                    PAL_PORT_BIT(PAL_PAD(B9)) | 
                                    PAL_PORT_BIT(PAL_PAD(B12)),
                                    0U,
                                    (PAL_WB32_MODE_OUTPUT |
        ...
        case 10:
            ATOMIC_BLOCK_FORCEON {
            pal_lld_setgroupmode(PAL_PORT(B10),
                                PAL_PORT_BIT(PAL_PAD(B10)),
                                0U,
                                (PAL_WB32_MODE_OUTPUT |
                                PAL_WB32_OTYPE_PUSHPULL | 
...
uint8_t matrix_scan_custom(matrix_row_t current_matrix[]) {
    ...
    // Set col, read rows
    //for (uint_fast8_t current_row = 0; current_row < MATRIX_ROWS; current_row++) {
