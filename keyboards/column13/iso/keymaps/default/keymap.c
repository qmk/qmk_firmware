...
[_QWERTY] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_DEL,  KA_SPC,  KL_EISU,         KS_SPC,  KL_KANA, KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT,
...
[_LOWER] = LAYOUT(
        ...
        _______, cmd(KC_Z), cmd(KC_X), cmd(KC_C), cmd(KC_V), cmd(KC_B), cmd(KC_N), cmd(KC_M), KC_LCBR,   KC_RCBR,    KC_PGUP,
...
[_RAISE] = LAYOUT(
        ...
        _______,_______,_______,_______,_______,_______,_______,_______,KC_LBRC,KC_RBRC,KC_PGUP,
        _______,_______,_______,_______,_______,        _______,_______,KC_BSLS,KC_HOME,KC_PGDN,KC_END,
...
[_FUNCS] =  LAYOUT(
        ...
        _______,_______,_______,_______,_______,_______,_______,_______,_______,RGB_VAI,RGB_VAD,RGB_SAI,
