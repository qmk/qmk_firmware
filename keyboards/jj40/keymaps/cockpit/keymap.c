...
[_FUNC] = LAYOUT_planck_mit( \
  ...
  KC_CAPS, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, BL_TOGG, BL_BRTG, BL_INC,  KC_BRIU, _______, _______, KC_VOLU, \
  KC_LSFT, KC_CALC, RGB_HUD, RGB_SAD, RGB_VAD, KC_WBAK, KC_WFWD, BL_DEC,  KC_BRID, _______, KC_PSCR, KC_VOLD, \
