 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | nkro | Alt  | NKRO |Lower | Home | End  |Raise | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = KEYMAP( \
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,KC_F7,   KC_F8,  KC_F9,   KC_F10,  KC_F11,  KC_F12,
  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, _______, \
  KC_LSFT, KC_PSCR, S(KC_NUHS), S(KC_NUBS), _______, _______, _______, KC_POWER, _______, BL_ON, BL_STEP, KC_ENT, \
  KC_LCTL, MAGIC_TOGGLE_NKRO, KC_LALT, TG_NKRO, _______, KC_HOME, KC_END, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
),
 ...
 * | Ins  |  `   |   \  |   |  |   [  |   ]  |      |   1  |   2  |   3  |   .  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |      | Alt  |      |Lower | PgDn | PgUp |Raise |   0  |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = KEYMAP( \
