...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_NUMPAD] = KEYMAP( \
    KC_ESC,     KC_P7,   KC_P8,   KC_P9,   KC_PMNS, KC_PSLS, _______, _______, _______, _______, _______, _______, \
    KC_BSPC,    KC_P4,   KC_P5,   KC_P6,   KC_PPLS, KC_PAST, _______, _______, _______, _______, _______, _______, \
