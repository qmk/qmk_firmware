 ...
 * Caps, LAlt, LGui, Space, RAlt, Lock, Left, Down, Right
 */
[_NML] = { /* Normal */
  {KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,   KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,  KC_INS  },
  {KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,   KC_O,    KC_P,    KC_LBRC, KC_RBRC, _______, KC_BSPC, KC_PGUP },
  ...
  {KC_CAPS, KC_LALT, KC_LGUI, _______, _______, _______, _______, _______, KC_SPC, _______, _______, KC_RALT, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT }
},
/*
