...
![Dinkey 32|30](https://i.imgur.com/placeholder.jpg)

A low-profile split keyboard with 32 keys (30-key layout via combos). Part of the Dinkey keyboard series by Idle Builds.

* Keyboard Maintainer: [IdleBuilds](https://github.com/IdleBuilds)
* Hardware Supported: Dinkey 32|30 PCB, ATmega32U4
* Hardware Availability: [Idle Builds GitHub](https://github.com/IdleBuilds/Dinkey)
