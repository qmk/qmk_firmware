...
#define _FL 1
   ...
   const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     [0] = LAYOUT_67_iso(
         ...
         KC_LCTL, KC_LGUI, KC_LALT,          KC_MPLY,                KC_SPC,  KC_ESC,KC_RALT, MO(1),  KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RIGHT),
     ...
     [1] = LAYOUT_67_iso(
        ...
        /* ctrl     win      alt     encoder                  space      encoder        alt      fn       ctrl      left     down     right*/
         KC_LCTL, KC_LGUI, KC_LALT,  KC_MPLY,                KC_TRNS,  KC_ESC,        KC_RALT, KC_TRNS, KC_RCTL,  KC_TRNS, KC_VOLD,  KC_TRNS)
   };
