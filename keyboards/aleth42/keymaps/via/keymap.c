 ...
 */
    [_QWERTY] = LAYOUT( \
        ...
        KC_ESC, KC_LALT   , KC_LGUI, LT(_LOWER, KC_SPC),   LT(_RAISE, KC_SPC), KC_RGUI, KC_RALT, KC_RCTL \
        ),
 ...
 /* Lower Layer
    ...
    [_ADJUST] = LAYOUT( \
		...
		_______, _______, _______, _______, AG_NORM,  _______, _______, AG_SWAP, _______, _______,  KC_F12,  \
		KC_CAPS, RESET, _______, RGB_TOG,  RGB_MOD,  RGB_HUI,  RGB_HUD,  RGB_SAI,  RGB_SAD,  RGB_VAI,  RGB_VAD, \
