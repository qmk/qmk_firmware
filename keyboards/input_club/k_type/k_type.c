...
const is31fl3733_led_t PROGMEM g_is31fl3733_leds[IS31FL3733_LED_COUNT] = {{0, SW2_CS1, SW1_CS1, SW3_CS1},
...
void matrix_init_kb(void) {
     ...
     */
    rgb_matrix_set_speed(RGB_MATRIX_DEFAULT_SPD), rgb_matrix_set_flags(LED_FLAG_ALL);
