...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_65_ansi_blocker_split_bs(
        KC_ESC, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_GRV, KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_QUOT, KC_EQL, TO(_NOHRMOD),
        KC_TAB, KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_LBRC,KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_SCLN,KC_SLSH, KC_BSPC,    KC_DEL,
        MEH_T(KC_ESC),  KC_A,   KC_S,   KC_D,   KC_F,   KC_G,  KC_RBRC, KC_H,   KC_J,   KC_K,   KC_L,   KC_NUHS,KC_ENT,      KC_PGUP,
        KC_LSFT,KC_NUBS,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,  KC_BKLS,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_RSFT,     KC_UP,  KC_PGDN,
        KC_LCTL,KC_LGUI,KC_LALT,               KC_SPC,           KC_RALT,TO(_BASE),  KC_RCTL,     KC_LEFT,KC_DOWN,KC_RGHT
    )
};
