...
|Key                    |Aliases                       |Description                                    |Windows|macOS        |Linux|
|-----------------------|------------------------------|-----------------------------------------------|-------|-------------|-----|
...
|`KC_F11`               |                              |F11                                            |✔      |✔            |✔    |
|`KC_F12`               |                              |F12                                            |✔      |✔            |✔    |
|`KC_PSCREEN`           |`KC_PSCR`                     |Print Screen                                   |✔      |✔<sup>1</sup>|✔    |
|`KC_SCROLLLOCK`        |`KC_SLCK`, `KC_BRMD`          |Scroll Lock, Brightness Down (macOS)           |✔      |✔<sup>1</sup>|✔    |
|`KC_PAUSE`             |`KC_PAUS`, `KC_BRK`, `KC_BRMU`|Pause, Brightness Up (macOS)                   |✔      |✔<sup>1</sup>|✔    |
...
|`KC_POWER`             |                              |System Power                                   |?      |✔<sup>2</sup>|?    |
...
|`KC_SYSTEM_POWER`      |`KC_PWR`                      |System Power Down                              |✔      |✔<sup>2</sup>|✔    |
|`KC_SYSTEM_SLEEP`      |`KC_SLEP`                     |System Sleep                                   |✔      |✔<sup>2</sup>|✔    |
|`KC_SYSTEM_WAKE`       |`KC_WAKE`                     |System Wake                                    |?      |?            |?    |
|`KC_AUDIO_MUTE`        |`KC_MUTE`                     |Mute                                           |✔      |✔            |✔    |
|`KC_AUDIO_VOL_UP`      |`KC_VOLU`                     |Volume Up                                      |✔      |✔<sup>3</sup>|✔    |
|`KC_AUDIO_VOL_DOWN`    |`KC_VOLD`                     |Volume Down                                    |✔      |✔<sup>3</sup>|✔    |
|`KC_MEDIA_NEXT_TRACK`  |`KC_MNXT`                     |Next Track                                     |✔      |✔<sup>4</sup>|✔    |
|`KC_MEDIA_PREV_TRACK`  |`KC_MPRV`                     |Previous Track                                 |✔      |✔<sup>4</sup>|✔    |
...
|`KC_MEDIA_FAST_FORWARD`|`KC_MFFD`                     |Next Track                                     |?      |✔<sup>4</sup>|?    |
|`KC_MEDIA_REWIND`      |`KC_MRWD`                     |Previous Track                                 |?      |✔<sup>4</sup>|?    |
|`KC_BRIGHTNESS_UP`     |`KC_BRIU`                     |Brightness Up                                  |✔      |✔            |✔    |
|`KC_BRIGHTNESS_DOWN`   |`KC_BRID`                     |Brightness Down                                |✔      |✔            |✔    |

<sup>1. Recognized as F13-F15.</sup><br/>
<sup>2. Must be held for about three seconds, and will display a prompt instead.</sup><br/>
<sup>3. Holding Shift+Option allows for finer control of volume level.</sup><br/>
<sup>4. Skips the entire track in iTunes when tapped, seeks within the current track when held.</sup><br/>
