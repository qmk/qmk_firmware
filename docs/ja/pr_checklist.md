...
- PRは、ソースリポジトリ上の `master` ではないブランチを使って投稿する必要があります
    ...
    - もし PR の提出者が自分の master ブランチを使っている場合は、マージ後に ["how to git"](https://docs.qmk.fm/#/ja/newbs_git_using_your_master_branch) ページへのリンクが表示されます - (このドキュメントの最後にメッセージの内容が表示されます)
...
[**Best Practices: Your Fork's Master: Update Often, Commit Never**](https://docs.qmk.fm/#/ja/newbs_git_using_your_master_branch)
