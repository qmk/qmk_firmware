...
QMK は *パルス幅変調* (*Pulse Width Modulation*) すなわち PWM として知られている技術で、特定の比率で急速にオンおよびオフを切り替えることで、これらの LED の輝度を制御できます。PWM 信号のデューティサイクルを変えることで、調光の錯覚を起こすことができます。
...
これらの関数を使って、カスタムコードでバックライトを変更することができます:
