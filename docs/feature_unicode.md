...
There are many ways to get a hex code, but an easy one is https://r12a.github.io/app-conversion/ Just make sure to convert to UTF-16 code units, and that is your string.
