...
* [Debounce API](feature_debuonce.md) - Customization of debouncing algorithms, and the ability to add more/custom debouncing. 
...
* [OLED Driver](feature_oled_driver) - Add OLED screens to your keyboard.
...
* [Velocikey](feature_velocikey.md) - Allows changes in animation speed based on WPM/Typing speed.
