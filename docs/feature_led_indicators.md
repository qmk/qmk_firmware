...
* Configuration options in `info.json` 
...
## `info.json` Options
Information about using data driven configuration specified in the `info.json` file can be found [at the following link](reference_info_json.md#led-indicators). 
