...
**Magic Keycodes** are prefixed with `MAGIC_` and allow you to access the functionality of the deprecated Bootmagic feature *after* your keyboard has initialized. To use these keycodes, assign them to your keymap as you would any other keycode.
