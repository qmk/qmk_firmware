...
* `mouseReport.buttons` - this is a uint8_t in which the all 8 bits are used.  These bits represent the mouse button state - bit 3 is mouse button 5, and bit 7 is mouse button 1.
