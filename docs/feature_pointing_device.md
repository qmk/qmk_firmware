...
| `AZOTEQ_IQS5XX_HOLD_TIME`              | (Optional) Minimum time in ms for press and hold.                                    | `150`       |
...
| `AZOTEQ_IQS5XX_SWIPE_INITIAL_DISTANCE` | (Optional) Minimum travel in pixels before swipe is registered.                      | `50`        |
