# IS31FL3731 Driver :id=is31fl3731-driver
...
### `void is31fl3731_set_color(int index, uint8_t red, uint8_t green, uint8_t blue)` :id=api-is31fl3731-set-color
...
#### Arguments :id=api-is31fl3731-set-value-all-arguments
