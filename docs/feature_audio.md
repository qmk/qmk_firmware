...
|---------------------------------|----------------------|--------------------------------------------------------------------------|
|`AUDIO_PIN`                      | *Not defined*        |Configures the pin that the Solenoid is connected to.                     |
|`AUDIO_PIN_ALT`                  | *Not defined*        |Configures the default dwell time for the solenoid.                       |
|`AUDIO_PIN_ALT_AS_NEGATIVE`      | *Not defined*        |Sets the lower limit for the dwell.                                       |
