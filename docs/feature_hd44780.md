...
You will need to configure the pins used by your display and its number of lines and columns in your keyboards `config.h`.

Uncomment the section labeled HD44780 and change the parameters as needed.
````
/*
