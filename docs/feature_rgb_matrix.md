...
?> For hardware maintainers that wish to host custom effects limited to a specific keyboard, create a `rgb_matrix_kb.inc` file in the root of the keyboard directory. `RGB_MATRIX_CUSTOM_KB = yes` should be set in the keyboard level `rules.mk`.
