...
### Teaching the CLI to flash binaries ([#16584](https://github.com/qmk/qmk_firmware/pull/16584)) :id=cli-flash-binaries
...
### Pointing Device Improvements

Ever since Pointing Device Driver support and Split Pointing Device support were added by _@drashna_ [#14343](https://github.com/qmk/qmk_firmware/pull/14343) and _@daskygit_ [#15304](https://github.com/qmk/qmk_firmware/pull/15304) respectively, there has been increase interest and development of the pointing device driver and the associated code. 

Both the PMW33XX code and the Cirque Pinnacle code have seen a lot of overall improvements to their code, as has the mouse code in general.  Features like circular/edge scrolling for the Cirque, and Kinetic movement for any sensor with "lift detection" ([#17482](https://github.com/qmk/qmk_firmware/pull/17482)).  Additionally, for those that make fast motions with their pointing devices, support for much larger mouse movement reports has been added ([#16371](https://github.com/qmk/qmk_firmware/pull/16371)).
