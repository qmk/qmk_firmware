...
Most systems now mark I2C/SPI etc. as "required", allowing the build system to check whether peripherals are necessary before including them in the build, rather than having each location enable them manually.
