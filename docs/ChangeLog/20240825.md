...
If you're using key overrides, in your `keymap.c` will need to change the signature of your list of key overrides from:
...
**Note:** If no issues arise during this current breaking changes cycle, these sensor firmware ROMs will be removed from QMK entirely.
...
* Add bus acquire/release semantics to SPI start/stop. ([#23439](https://github.com/qmk/qmk_firmware/pull/23439))
