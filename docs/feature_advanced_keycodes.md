...
Additionally, if at least one right modifier is specified in a Mod Tap, it will cause any other modifiers to become their right equivalents, so it is not possible to mix and match the two.
