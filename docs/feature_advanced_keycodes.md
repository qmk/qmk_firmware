...
* `LM(layer, mod)` - Momentarily activates *layer* (like `MO`), but with modifier(s) *mod* active. Only supports layers 0-15 and [these modifiers.](https://github.com/tmk/tmk_keyboard/blob/master/tmk_core/common/action_code.h#L202)
