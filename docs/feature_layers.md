...
|----------------------------------------------|---------------------------------------------------------------------------------------------------------|
| `layer_state_set(layer_mask)`                | Directly sets the layer state (recommended not using it unless you know what you are doing).            |
...
| `default_layer_set(layer_mask)`              | Directly sets the default layer state (recommended not using it unless you know what you are doing).    |
