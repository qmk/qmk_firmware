...
Для постоянного изменения уровня по умолчанию требуется более глубокая настройка, например, вызов функции [process_record_user](custom_quantum_functions.md#programming-the-behavior-of-any-keycode).)
...
В настоящее время LT() и MT() ограничены набором [Basic Keycode set, "базовых"](keycodes_basic.md)/?/ клави-кодов, что означает, что вы не можете использовать такие кей-коды, как LCTL(), KC_TILD или что-либо большее, чем 0xFF. 
