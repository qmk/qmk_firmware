...
Кроме того, если в Mod Tap или Layer Tap указан хотя бы один правосторонний модификатор, это приведет к тому, что все указанные модификаторы станут правосторонними, поэтому их нельзя смешивать и сопоставить//?//.
