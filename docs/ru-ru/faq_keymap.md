...
(Перед прочтением сначала лучше ознакомиться с [обзором свойств ракладок](https://github.com/oleg-rnd/qmk_firmware/blob/master/docs/ru-ru/keymap.md).)

## Какие коды клавиш (кейкоды, кикиды, keycodes) можно использовать?
