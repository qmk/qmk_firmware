...
| `POINTING_MODES_HOLD_TIME`       | (optional) amount of time to hold last direction keycode for `PMO_HOLD` mode type option                | `1-65,535` |     `ms`     |            _Not defined_ |
