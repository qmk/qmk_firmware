...
static int is_teensy_style_console(const uint8_t *report, size_t report_size) { return is_collection(report, report_size, 0xFF310074, HID_COLLECTION_APPLICATION); }
