...
// clang-format on
    ...
    /* LampArray uses Feature Reports (control transfers) only, no interrupt IN data */
    [USB_ENDPOINT_IN_LAMPARRAY] = QMK_USB_ENDPOINT_IN(USB_EP_MODE_TYPE_INTR, LAMPARRAY_EPSIZE, LAMPARRAY_IN_EPNUM, LAMPARRAY_IN_CAPACITY, NULL, NULL),
#endif
...
#if defined(LAMPARRAY_ENABLE)
    [LAMPARRAY_INTERFACE] = USB_ENDPOINT_IN_LAMPARRAY,
#endif
};
