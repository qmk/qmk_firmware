...
enum bmp_custom_keycodes {
    BLE_DIS = 0x5E00, /* Disable BLE HID sending              */
    ...
    SAVE_EE,          /* Save EEPROM emulation */
    DEL_EE,           /* Delete EEPROM emulation */
    xEISU,            /* Send Alt+` or LANG1 */
    xKANA,            /* Send Alt+` or LANG2 */
    EXKC_START,       /* Extended keycode START               */
    EXKC_END       = EXKC_START + BMP_EX_KC_LEN - 1,
    BMP_SAFE_RANGE = SAFE_RANGE
};
