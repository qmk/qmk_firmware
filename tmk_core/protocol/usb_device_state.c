...
static usb_device_state_t usb_device_state = {.idle_rate = 0, .leds = 0, .protocol = USB_PROTOCOL_REPORT, .configure_state = USB_DEVICE_STATE_NO_INIT};

__attribute__((weak)) void notify_usb_device_state_change_kb(usb_device_state_t usb_device_state) {
    notify_usb_device_state_change_user(usb_device_state);
}

__attribute__((weak)) void notify_usb_device_state_change_user(usb_device_state_t usb_device_state) {}

static void notify_usb_device_state_change(usb_device_state_t usb_device_state) {
