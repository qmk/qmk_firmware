...
check-size:
	$(eval MAX_SIZE=$(shell n=`avr-gcc -E -mmcu=$(MCU) $(CFLAGS) $(OPT_DEFS) tmk_core/common/avr/bootloader_size.c 2> /dev/null | grep -v '^#' | grep -A3 AVR_SIZE | sed 's/AVR_SIZE://g'`; echo $$(($$n)) || echo 0))
