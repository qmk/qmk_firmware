...
#    define MCU_STM32L433CC
#elif defined(EEPROM_EMU_STM32L433xB)
#    define MCU_STM32L433CB
#else
...
#    if defined(MCU_STM32F103RB) || defined(MCU_STM32F072CB) || defined(MCU_STM32L433CB)
...
#    elif defined(MCU_STM32F303CC) || defined(MCU_STM32L433CC)
