...
// }FLASH_Status;
//typedef enum {
  //FLASH_COMPLETE = FLASH_ERROR_UNIMPLEMENTED + 1,
  //FLASH_BUSY,
  //FLASH_ERROR_OPERATION,
  //FLASH_ERROR_WRP
//} flash_error_ext_t; 
//typedef flash_error_ext_t FLASH_Status;
//typedef flash_error_t FLASH_Status;
typedef enum { FLASH_BUSY = 1, FLASH_ERROR_PG, FLASH_ERROR_WRP, FLASH_ERROR_OPERATION, FLASH_COMPLETE, FLASH_TIMEOUT, FLASH_BAD_ADDRESS } FLASH_Status;
