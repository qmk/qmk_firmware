 ...
 * mk_xy_delay          milliseconds between the initial key press and first repeated mouse motion event (0-255)
 * mk_wh_delay          milliseconds between the initial mouse wheel event repeated mouse wheel events (0-255)
