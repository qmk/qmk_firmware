...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
    ...
    MO(1),      KC_LCTL,    KC_LALT,        KC_LGUI,        MO(2),              LT(4,KC_ENT),   KC_SPC,     MO(3),      KC_SLSH,    KC_LEFT,        KC_DOWN,        CTL_T(KC_RGHT)),

  KEYMAP(
    KC_ESC,     KC_NLCK,    LCTL(KC_SPC),   KC_UP,          LSFT(KC_SPC),       KC_DLR,         KC_EQL,     KC_P7,      KC_P8,      KC_P9,          KC_PPLS,        KC_BSPC, 
    ...
    MO(1),      KC_LCTL,    KC_LALT,        KC_LGUI,        TO(1),              KC_ENT,         KC_SPC,     KC_PENT,    KC_P0,      KC_PDOT,        KC_PAST,        KC_LCTL),
  ...
  KEYMAP(
    ...
    TO(0),      KC_LCTL,    KC_LALT,        KC_LGUI,        MO(2),      KC_ENT,         KC_SPC,     MO(3),      KC_PSCR,    KC_MPRV,        KC_PGDOWN,      CTL_T(KC_VOLD)),
  ...
  KEYMAP(
    ...
    TO(0),      KC_LCTL,    KC_LALT,        KC_LGUI,        KC_LALT,            KC_LCTL,        KC_TRNS,    MO(3),     AU_TOG,      MU_TOG,     MU_MOD,     CTL_T(KC_RGHT)),

  KEYMAP(
    TO(0),      KC_LSCR,    WIN_LEFT,       KC_MS_WH_UP,    WIN_RIGHT,          KC_TRNS,        KC_TRNS,    KC_MS_BTN1, KC_MS_U,    KC_MS_BTN2,     KC_TRNS,        KC_TRNS, 
    KC_TRNS,    KC_TRNS,    KC_MS_WH_LEFT,  KC_MS_WH_DOWN,  KC_MS_WH_RIGHT,     KC_TRNS,        KC_TRNS,    KC_MS_L,    KC_MS_D,    KC_MS_R,        KC_TRNS,        KC_TRNS, 
    RESET,      KC_TRNS,    KC_MS_ACCEL0,   KC_MS_ACCEL0,   KC_MS_ACCEL0,       KC_TRNS,        KC_TRNS,    TO(0),      TO(1),      TO(2),          TO(3),          TO(4), 
    TO(0),      KC_TRNS,    KC_TRNS,        KC_TRNS,        KC_LALT,            KC_ENT,         KC_SPC,     KC_TRNS,    KC_TRNS,    KC_LEFT,        KC_DOWN,        KC_RCTL),
...
float tone_numlk_on[][2]   = SONG(MARIO_THEME);
float tone_numlk_off[][2]  = SONG(NUM_LOCK_OFF_SOUND);
float tone_scroll_on[][2]  = SONG(ZELDA_TREASURE);
