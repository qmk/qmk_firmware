...
**** The core 4 and 6 key thumb sets, eg. Corne, hummingbird, ferris.
...
Craziness. Data hand thumbs.
These definitions help fill the gaps for a svalboard layout.
There are a lot of thumbs. so many I dont know what to do with them all.
I used the original values from the default keymap. There is no direct mapping as
the layers specific to svalboard do not exist here.

I used tap holds and smart layers where it made sense.
