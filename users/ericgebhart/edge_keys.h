...
#define ___6_CRKBD_THUMBS___ TT(_NAV) ,  BSPC_SYMB, ESC_TOPR, ENT_NAV, SPC_TOPR, TT(_LAYERS)
#define ___6_CRKBD_THUMBS_BP___ TT(_NAV),  BSPC_SYMB_BP, ESC_TOPR_BP, ENT_NAV, SPC_TOPR_BP, TT(_LAYERS)
