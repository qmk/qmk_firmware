...
#define ROW0L_5_6_trns(K01, K02, K03, K04, K05)          \
  ROW0L_6_trns(LANG_N(LEFT1), K01, K02, K03, K04, K05)
...
#define ROW0R_5_6_trns(K01, K02, K03, K04, K05)          \
  ROW0R_6_trns(K01, K02, K03, K04, K05, LANG_N(RIGHT0))
...
#define ROW1L_5_6_trns(K01, K02, K03, K04, K05)          \
  ROW1L_6_trns(LANG_N(LEFT1), K01, K02, K03, K04, K05)
...
#define ROW1R_5_6_trns(K01, K02, K03, K04, K05)          \
  ROW1R_6_trns(K01, K02, K03, K04, K05, LANG_N(RIGHT1))
...
#define ROW2L_5_6_trns(K01, K02, K03, K04, K05)          \
  ROW2L_6_trns(LANG_N(LEFT2), K01, K02, K03, K04, K05)
...
#define ROW2R_5_6_trns(K01, K02, K03, K04, K05)          \
  ROW2R_6_trns(K01, K02, K03, K04, K05, LANG_N(RIGHT2))
...
#define ROW3L_5_6_trns(K01, K02, K03, K04, K05)         \
  ROW3L_6_trns(LANG_N(LEFT3),  K01, K02, K03, K04, K05)
...
#define ROW3R_5_6_trns(K01, K02, K03, K04, K05)         \
  ROW3R_6_trns(K01, K02, K03, K04, K05, LANG_N(RIGHT3))
