...
#define          _________BASE_L4_________                  FUNC,    NUMBER,  KC_LSFT
...
# define _________________QWERTY_L3_________________         MOU_Z,   KC_X,    KC_C,    KC_V,    KC_B
#else
...
#if defined(MOUSELAYER_ENABLED)
# define ________________COLEMAKDH_L3_______________         MOU_Z,   KC_X,    KC_C,    KC_D,    KC_V
#else
...
# define __________________MOUSE_L1_________________         ___x___, ___x___, ___x___, ___x___, MOU_TOG
...
*   |      |      |      | DPI  | sDPI |    |      |      |      |      |MOUTOG|
*   +------+------+------+------+------|    +------+------+------+------+------+
*   | GUI  | Alt  | Ctrl | Shft |MBtn4 |    |      |      |      |      |      |
*   +------+------+------+------+------|    +------+------+------+------+------+
*   |LyrTap|DrgScr|Sniper|      |MBtn5 |    |      |      |      |      |      |
*   `------+------+------+------+------+    +------+------+------+------+------'
*                 |MBtn3 |MBtn1 |MBtn2 |    |      |      |      |
*                 `------+------+------'    `------+------+------'
*/
...
# define __________________MOUSE_L1_________________         __________NONE_3_________, DPI_MOD, S_D_MOD
# define __________________MOUSE_L2_________________         _____________GACS_MODS____________, KC_BTN4
# define __________________MOUSE_L3_________________         _______, DRGSCRL, SNIPING, ___x___, KC_BTN5
# define          _________MOUSE_L4________                  KC_BTN3, KC_BTN1, KC_BTN2

# define __________________MOUSE_R1_________________         ___x___, ___x___, ___x___, ___x___, MOU_TOG
# define __________________MOUSE_R2_________________         ___________________NONE_5__________________
# define __________________MOUSE_R3_________________         ___________________NONE_5__________________
# define          _________MOUSE_R4________                  ___x___, ___x___
