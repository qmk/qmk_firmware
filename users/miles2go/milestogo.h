...
#define ___________________SYM_L3__________________       KC_BSLS,  KC_PERC, KC_AT,   KC_AMPR, KC_UNDS
...
#define ___________________SYM_R3__________________       KC_TILDE, KC_PIPE,  KC_ASTR, KC_DOT,  KC_SLASH
...
// Move in a direction, deleting as we go, or do opposite of Mov layer action 
/*    ,--------------------------------------------.  ,--------------------------------------------.
 * 01 |  Esc   |        | B_print|        |        |  | Zoom-- |LineStrt|   Up   |  EOL   |  Zoom++|
 *    |--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------|
 * 02 |        | Do_DEL | Shift  | Redo   |        |  | WrdLft | Left   |   Down | Right  | WrdRght|
 *    |--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------|
 * 03 |        | Cut    | Copy   | Paste  |Paste   |  | Wabl-- | Tab--  | NewTab | Tab++  | babl++ |
 *    `--------------------------------------------'  `--------------------------------------------'
 */ 
...
#define ____________40__DELMOV_R1__________________       B_ZOUT,  B_DSOL,  B_UP,   B_DEOL, B_ZIN
#define ____________40__DELMOV_R2__________________       B_DLW,   KC_BSPC, B_DOWN, B_DEL,  B_DRW 
#define ____________40__DELMOV_R3__________________       B_DEC,  B_PTAB,  B_NTAB, B_NXTB,  B_INC
