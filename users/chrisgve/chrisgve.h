...
#define ADM_BSL LT(_ADJUST_MAC, KC_BSLS)
#define ADL_BSL LT(_ADJUST_LINUX, KC_BSLS)
#define ADW_BSL LT(_ADJUST_WIN, KC_BSLS)
...
#define PGDN_FM LT(_ADJUST_MAC, KC_PGDN)
#define PGDN_FL LT(_ADJUST_LINUX, KC_PGDN)
#define PGDN_FW LT(_ADJUST_WIN, KC_PGDN)
