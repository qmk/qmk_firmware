 ...
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
#define _______________Qwerty75_Row0_______________	KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_NLCK, GHERKIN75, XXXXXXX, FUNCTION75
#define _______________Qwerty75_Row1_______________ _______________Qwerty_Row__0_______________, KC_KP_7, KC_KP_8, KC_KP_9
#define _______________Qwerty75_Row2_______________ _______________Qwerty_Row__1_______________, KC_KP_4, KC_KP_5, KC_KP_6
#define _______________Qwerty75_Row3_______________ _______________Qwerty_Row__2_______________, KC_KP_1, KC_KP_2, KC_KP_3
#define _______________Qwerty75_Row4_______________ KC_LCTL, KC_LGUI, KC_LALT, KC_LALT, SUBTER75,  KC_LSFT, KC_SPC,  SUPRA75,   KC_RGUI, KC_RALT, KC_DEL,  KC_RCTL, KC_KP_0, KC_KP_0, KC_KP_DOT
 ...
 * |        |        |        |        |        |        |        |        |        |        |SFThold |        |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |SFT/CAPS| Z      | X      | C      | V/NUM  | B/ETC  | N      | M/DIR  | ,/GUI  | ./ALT  | BKSC   | ENT/SFT|   1    |   2    |   3    |
 * |        |SFThold |        |        |        |        |        |        |        |        |CTRLhold|        |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | LCTRL  | LGUI   | ALT    | ALT    | NUM    | ETC    | SPACE  | DIR    | RGUI   | ALT    | DEL    | CTRL   |   0    |   0    |   .    |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 #define _______________Gherkin75_Row0______________ KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_NLCK, QWERTY75, XXXXXXX, FUNCTION75
 #define _______________Gherkin75_Row1______________ _______________GherkinLike_0_______________, KC_KP_7, KC_KP_8, KC_KP_9
 #define _______________Gherkin75_Row2______________ _______________GherkinLike_1_______________, KC_KP_4, KC_KP_5, KC_KP_6
 #define _______________Gherkin75_Row3______________ TD(TD_SFT_CAPS), SFT_T(KC_Z),     KC_X,    KC_C,    LT(NUM75, KC_V),LT(ETC75, KC_B),KC_N,  LT(DIR75, KC_M),  GUI_T(KC_COMM), ALT_T(KC_DOT), CTL_T(KC_BSPC), SFT_T(KC_ENT), KC_KP_1, KC_KP_2, KC_KP_3
 #define _______________Gherkin75_Row4______________ KC_LCTL, KC_LGUI,       KC_LALT, KC_LALT, NUMBER75,      ETCETERA75,       KC_SPC,DIRECTION75,       KC_RGUI,        KC_RALT,       KC_DEL,         KC_RCTL,       KC_KP_0, KC_KP_0, KC_KP_DOT
 ...
 * |    `   | 1      | 2      | 3      | 4      | 5      | 6      | 7      | 8      | 9      | 0      |        |        |        |   +    |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | F11    | F12    |        |        |        |        |        | RGUI   | ./ALT  | BKSC   |        |        |        | ENTER  |
 * |        |        |        |        |        |        |        |        |        |        |CTRLhold|		   |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        | gherkin|        |        |        | ENTER  | SHIFT  |        |        |        |        |        |        |        |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 #define _______________SUBTER75_Row_0______________ _______________SUBTER_Row__0_______________, _______, _______, _______
 #define _______________SUBTER75_Row_1______________ _______________SUBTER_Row__0_______________, KC_PSLS, KC_PAST, KC_PMNS
 #define _______________SUBTER75_Row_2______________ _______________SUBTER_Row__1_______________, _______, _______, KC_PPLS
 #define _______________SUBTER75_Row_3______________ _______________SUBTER_Row__2_______________, _______, _______, KC_PENT
 #define _______________SUBTER75_Row_4______________ _______, _______, GHERKIN75, _______, _______, _______, KC_ENT,  KC_LSFT, _______, _______,	_______,	_______, _______,	_______,	_______
 ...
 */
 ...
 #define _______________SUPRA75__Row_1______________ ________________SUPRA_Row_0________________, _______, _______, _______
 #define _______________SUPRA75__Row_2______________ ________________SUPRA_Row_1________________, _______, _______, _______
 #define _______________SUPRA75__Row_3______________ ________________SUPRA_Row_2________________, _______, _______, _______
 ...
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 #define ___________DIRECTIONS_75_Row_1_____________ _____________DIRECTIONS_Row__0_____________, _______, _______, _______
 #define ___________DIRECTIONS_75_Row_2_____________ _____________DIRECTIONS_Row__1_____________, _______, _______, _______
 #define ___________DIRECTIONS_75_Row_3_____________ _____________DIRECTIONS_Row__2_____________, _______, _______, _______
 #define ___________DIRECTIONS_75_Row_4_____________ _______, _______, QWERTY75,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
 ...
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 #define _____________NUMBERS_75_Row_1______________ _______________NUMBERS_Row_0_______________, KC_PSLS, KC_PAST, KC_PMNS
 #define _____________NUMBERS_75_Row_2______________ _______________NUMBERS_Row_1_______________, _______, _______, KC_PPLS
 #define _____________NUMBERS_75_Row_3______________ _______________NUMBERS_Row_2_______________, _______, _______, KC_PENT
 #define _____________NUMBERS_75_Row_4______________ _______________NUMBERS_Row_3_______________, _______, _______, _______
 
/* Gherkin 75 Et Cetera
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 * |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 * |        |  `     | mUP    |        |        |        | SHIFT  | mScrUp |mScrDown|        |  \     | DEL    |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | mLeft  | mDown  | mRight |        | SHIFT  | mBtn3  | mBtn1  | mBtn2  |  ;     |  '     |        |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | Sft//Cp|        |        |        |        | C-A-D  |mScrLeft| mScrRt | ALT    |  DEL   |        |        |        |        |
 ...
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 #define _____________ETCETERA_75_Row_1_____________ ______________ETCETERA_Row__0______________, _______, _______, _______
 #define _____________ETCETERA_75_Row_2_____________ ______________ETCETERA_Row__1______________, _______, _______, _______
 #define _____________ETCETERA_75_Row_3_____________ ______________ETCETERA_Row__2______________, _______, _______, _______
 #define _____________ETCETERA_75_Row_4_____________ ______________ETCETERA_Row__3______________, _______, _______, _______
 ...
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
#define _____________FUNCTION_75_Row_2_____________ KC_CAPS, KC_BTN5, KC_BTN4, KC_BTN3, KC_BTN2, KC_ACL0, KC_ACL2, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, _______, _______, _______, KC_WH_U
#define _____________FUNCTION_75_Row_3_____________ RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, BL_TOGG, BL_INC,  BL_DEC,  _______, _______, KC_MS_U, KC_WH_D
#define _____________FUNCTION_75_Row_4_____________ _______, _______, _______, _______, _______, _______, KC_BTN1, _______, _______, _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R
