...
Keyboards supporting this layout: lily58, boardsource/lulu, clickety_split/leeloo.

Example build command lines:

#+BEGIN_SRC sh :tangle no
make lily58:manna-harbour_miryoku:flash # lily58
make boardsource/lulu:manna-harbour_miryoku:flash # boardsource/lulu
#+END_SRC
