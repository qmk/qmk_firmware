...
#include "miryoku_alternatives.h"
    ...
    #if defined (MIRYOKU_ALPHAS_GALLIUMV2VIM)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_GALLIUMV2VIM_FLIP
    #if defined (MIRYOKU_ALPHAS_STURDY)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_STURDY_FLIP
    #elif defined (MIRYOKU_ALPHAS_ENGRAMMER)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_ENGRAMMER_FLIP
  ...
  #else
    #if defined (MIRYOKU_ALPHAS_GALLIUMV2VIM)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_GALLIUMV2VIM
    #if defined (MIRYOKU_ALPHAS_STURDY)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_STURDY
    #elif defined (MIRYOKU_ALPHAS_ENGRAMMER)
