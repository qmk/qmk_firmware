...
#define T_LPRN TD(TD_LPRN_LCBR)    // Tap for {, double tap for forward browser
#define T_LPRN TD(TD_RPRN_RCBR)    // Tap for }, double tap for forward browser
...
#define T_GUI  TD(TD_GUI_NUMPAD)  // Tap for Cmd, double tap for NUMPAD on/off
