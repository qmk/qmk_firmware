...
//#    endif
        ...
        case WIN_FN:
            ...
            if (current_layer == MAC_FN) {
                rgb_matrix_set_color_by_keycode(led_min, led_max, current_layer, is_transparent, MAC_LAYER_DEFAULT_COLOR);
            }
#endif
//#ifdef WIN_LAYER_DEFAULT_COLOR
//            else if (current_layer == WIN_FN) {
//                rgb_matrix_set_color_by_keycode(led_min, led_max, current_layer, is_transparent, WIN_LAYER_DEFAULT_COLOR);
//            }
//#endif
            ...
            if (keymap_config.no_gui) {
                rgb_matrix_set_color_by_keycode(led_min, led_max, current_layer, is_guilock_indicator, GUILOCK_INDICATOR_COLOR);
            }
#endif
            break;
    }
...
// check if keycode is the GUILOCK toggle
#ifdef GUILOCK_INDICATOR_COLOR
bool is_guilock_indicator(uint16_t keycode) {
    return keycode == GU_TOGG;
}
#endif
...
// check if keycode is not transparent
