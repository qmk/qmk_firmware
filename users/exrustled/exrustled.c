...
// Combos & declarations
const uint16_t PROGMEM esc_combo[] = {KC_DOT,KC_SLSH, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [FUNL] = LAYOUT_exr(
    ...
    KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_PAUS, KC_NA,   KC_NA,   KC_NA,   KC_NA,   TG(GAME),
  ...
  [GAME] = LAYOUT_exr(
    KC_Q,              KC_D,              KC_R,              KC_W,              KC_B,              KC_J,              KC_F,              KC_U,              KC_P,              KC_QUOT,
    LSFT_T(KC_A),      KC_S,              KC_H,       		 KC_T, 			    KC_G,              KC_Y,              KC_N,      		 KC_E,      		KC_O, 		  LSFT_T(KC_I),
