...
bool exec_henshu(uint32_t keycomb) {
  switch (keycomb) {
    ...
    case B_D|B_F|B_L: // 右
      ...
      return true;
      break;
    case B_D|B_F|B_SCLN: // カタカナ
      ng_katakana();
      henshu_done = true;
      return true;
      break;
    // ------------------------------------------------------
    case B_D|B_F|B_N: // paste
      ng_paste();
      henshu_done = true;
      return true;
      break;
    case B_D|B_F|B_M: // 行頭
      ...
      return true;
      break;
    case B_D|B_F|B_COMM: // 行末
      ng_end();
      henshu_done = true;
      return true;
      break;
    case B_D|B_F|B_DOT: // none
      henshu_done = true;
      return true;
      break;
    case B_D|B_F|B_SLSH: // ひらがな
      ng_hiragana();
      henshu_done = true;
      return true;
      break;
    ...
    case B_C|B_V|B_I: // S上
      ...
      return true;
      break;
    case B_C|B_V|B_O: // copy
      ng_copy();
      henshu_done = true;
      return true;
      break;
    case B_C|B_V|B_P: // 行選択
      ng_home();
      register_code(KC_LSFT);
      ng_end();
      unregister_code(KC_LSFT);
    ...
    case B_C|B_V|B_L: // S右
      ...
      return true;
      break;
    case B_C|B_V|B_SCLN: // 再変換
      ng_saihenkan();
      henshu_done = true;
      return true;
      break;
    // ------------------------------------------------------
    case B_C|B_V|B_N: // cmd+d
      tap_code16(LCMD(KC_D));
      henshu_done = true;
      return true;
      break;
    case B_C|B_V|B_M: // S行頭
      tap_code(KC_ESC);
      register_code(KC_LSFT);
      ng_home();
      unregister_code(KC_LSFT);
    ...
    case B_C|B_V|B_COMM: // S行末
      ...
      return true;
      break;
    case B_C|B_V|B_DOT: // none
      henshu_done = true;
      return true;
      break;
    case B_C|B_V|B_SLSH: // none
      henshu_done = true;
      return true;
      break;
    #endif
