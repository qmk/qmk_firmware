...
#define _______________Y_ADJUST_L1_________________       _______,           KC_F1,   KC_F2,   KC_F3,   KC_F4,     KC_F5
#define _______________Y_ADJUST_L2_________________       _______,           KC_F11,  _______, _______, _______,   _______
...
#define _______________Y_ADJUST_R1_________________       KC_F6,             KC_F7,   KC_F8,   KC_F9,   KC_F10,    _______
#define _______________Y_ADJUST_R2_________________       KC_KB_VOLUME_UP,   _______, _______, _______, KC_F12,    _______
#define _______________Y_ADJUST_R3_________________       KC_KB_VOLUME_DOWN, _______, _______, _______, _______, _______
...
#define _______________Y_GAME_L3___________________       _______, KC_LCTL,  KC_Y,    KC_X,    KC_C,    KC_V, _______
#define __S_G_THUMB_L__                                                      _______, _______, KC_BSPC, KC_SPC,  KC_ENT

#define _______________Y_GAME_R0___________________                _______,  _______,           _______, _______, _______,    _______
#define _______________Y_GAME_R1___________________                KC_P,     KC_L,              KC_G,    _______, _______,    _______
#define _______________Y_GAME_R2___________________                KC_I,     KC_KB_VOLUME_UP,   _______, _______, _______,    _______
#define _______________Y_GAME_R3___________________       _______, KC_M,     KC_KB_VOLUME_DOWN, _______, _______, DF(_ALPHA), _______
#define __S_G_THUMB_R__                                   _______, _______,  _______,           _______, _______
