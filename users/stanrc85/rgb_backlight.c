...
backlight_config g_config = {
	...
	.color_1 = { .h = 0, .s = 255 },
	.color_2 = { .h = 150, .s = 255 },
	.caps_lock_indicator = { .color = { .h = 200, .s = 255 }, .index = 3-1 }, //purple
	.layer_1_indicator = { .color = { .h = 100, .s = 255 }, .index = 60-1 }, //green
	.layer_2_indicator = { .color = { .h = 150, .s = 255 }, .index = 60-1 }, //blue
	.layer_3_indicator = { .color = { .h = 0, .s = 0 }, .index = 60-1 }, //white
	.alphas_mods = {
