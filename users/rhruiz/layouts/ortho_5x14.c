...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN1] = LAYOUT_ortho_5x14_kc(
    ____, EXLM, AT  , HASH, DLR , PERC, ____,   CIRC, AMPR, ASTR, LPRN, RPRN, ____, ____,
  ...
  [_NUM] = LAYOUT_ortho_5x14_kc(
    ____, 1   , 2   , 3   , 4   , 5   , ____,   ____, ____, 7   , 8   , 9   , 0   , ____,
    ____, BTN1, MS_U, BTN2, WH_D, ____, ____,   ____, EQL , 4   , 5   , 6   , PLUS, ____,
    ____, MS_L, MS_D, MS_R, WH_U, ____, WH_D,   ____, ASTR, 1   , 2   , 3   , MINS, ____,
    ____, ____, ____, ____, ____, ____, WH_U,   ____, PLUS, 0   , ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____,   ____, ____, ____, ____, ____, ____, ____
  )
};
