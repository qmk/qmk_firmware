...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [X_N1]        = ACTION_TAP_AND_HOLD_DANCE(KC_EXLM, KC_1),
    ...
    [X_N9]        = ACTION_TAP_AND_HOLD_DANCE(KC_TILD, KC_9),
    [X_N0]        = ACTION_TAP_AND_HOLD_DANCE(KC_QUES, KC_0),
    [X_1N]        = ACTION_TAP_AND_HOLD_DANCE(KC_1, KC_EXLM),
    ...
    [X_9N]        = ACTION_TAP_AND_HOLD_DANCE(KC_9, KC_TILD),
