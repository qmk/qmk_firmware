...
/* QWERTY - For when I get ready to remove the BASE configuration and go with this one.
 * ,----------------------------------+    +----------------------------------.
 * |   Q  |   W  |   E  |   R  |   T  |    |   Y  |   U  |   I  |   O  |   P  |
 * |------+------+------+------+------|    |------+------+------+------+------|
 ...
 *                      `-------------+    +-------------'
 */
#define _______________QWERTY_L1___________________    KC_Q, KC_W, KC_E, KC_R, KC_T
#define _______________QWERTY_L2___________________    KC_A, KC_S, KC_D, KC_F, KC_G
#define _______________QWERTY_L3___________________    KC_Z, KC_X, KC_C, KC_V, KC_B
#define __QWERTY_LT_____                                                 KC_TAB, KC_BSPC

#define _______________QWERTY_R1___________________    KC_Y, KC_U, KC_I,    KC_O,   KC_P
#define _______________QWERTY_R2___________________    KC_H, KC_J, KC_K,    KC_L,   KC_SCLN
#define _______________QWERTY_R3___________________    KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH
#define __QWERTY_RT_____                               KC_SPC, LT_ENT
...
#define _________________ADJ_R3____________________    _______,  _______,  _______,  _______,  QK_BOOT
