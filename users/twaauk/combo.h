...
const uint16_t PROGMEM combo_qy_to5[] = {KC_Q, KC_Y, COMBO_END};
const uint16_t PROGMEM combo_tp_to0[] = {KC_T, KC_P, COMBO_END};
const uint16_t PROGMEM combo_yp_to6[] = {KC_Y, KC_P, COMBO_END};
...
const uint16_t PROGMEM combo_het_to4[] = {KC_H, VKC_SSP, COMBO_END};
const uint16_t PROGMEM combo_wlr_to0[] = {KC_WH_L, KC_WH_R, COMBO_END};

combo_t key_combos[] = {
	COMBO(combo_qy_to5, TO(5)),
	COMBO(combo_tp_to0, TO(0)),
