...
#define LAYER0 LAYER_LAYOUT(											\
        ...
        _______, _______, _______, _______, _______,  VKC_2B,    KC_G,    KC_T,    KC_Y,    KC_H,  VKC_1N, _______, _______, _______)
...
#define LAYER2 LAYER_LAYOUT(											\
        ...
        _______, _______, _______, _______, _______, _______, XXXXXXX, VKC_CAD, KC_MINS, KC_LEFT, KC_COMM, _______, _______, _______)
...
#define LAYER4 LAYER_LAYOUT( \
        ...
        _______, _______, _______, _______, _______, _______, XXXXXXX, VKC_CAD, KC_UNDS, KC_LEFT,   KC_LT, _______, _______, _______)
...
#define LAYER5 LAYER_LAYOUT( \
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, KC_WH_U, KC_WH_L, KC_WH_D, _______, _______, _______)
...
#define LAYER6 LAYER_LAYOUT( \
		...
		_______, XXXXXXX, KC_KP_4, KC_KP_5, KC_KP_6, KC_KP_PLUS,                XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT,_______, \
		_______, KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3,KC_KP_DOT,_______, _______, KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_DOT, _______, \
        _______, _______, _______, _______, _______,KC_KP_DOT,KC_KP_PLUS,KC_KP_MINUS,TO(0),_______,KC_KP_0, _______, _______, _______)
