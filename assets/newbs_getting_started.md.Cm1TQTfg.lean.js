...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[8] || (_cache[8] = createStaticVNode("", 8)),
            ...
            createBaseVNode("div", { class: "info custom-block" }, [
              ...
              createBaseVNode("p", null, [
                createBaseVNode("strong", null, [
                  createTextVNode("The standard QMK build environment installed below does not support "),
                  createBaseVNode("code", null, "musl"),
                  createTextVNode("-based Linux distributions.")
                ])
              ])
            ], -1),
            createBaseVNode("p", null, "Install the QMK CLI by running:", -1),
