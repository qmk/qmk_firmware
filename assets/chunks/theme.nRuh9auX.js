const __vite__fileDeps=["assets/chunks/VPLocalSearchBox.BBvY9B9L.js","assets/chunks/framework.DyMmIvSC.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.BBvY9B9L.js"), true ? __vite__mapDeps([0,1]) : void 0));
