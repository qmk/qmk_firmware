const __vite__fileDeps=["assets/chunks/VPLocalSearchBox.DZEq0jnP.js","assets/chunks/framework.B9AX-CPi.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.DZEq0jnP.js"), true ? __vite__mapDeps([0,1]) : void 0));
