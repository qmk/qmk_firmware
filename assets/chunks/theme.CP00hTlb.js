const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.Cw-GOEXL.js","assets/chunks/framework.Cauyuiy8.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.Cw-GOEXL.js"), true ? __vite__mapDeps([0,1]) : void 0));
