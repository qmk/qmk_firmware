const __vite__fileDeps=["assets/chunks/VPLocalSearchBox.ClzC5v1f.js","assets/chunks/framework.B9AX-CPi.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.ClzC5v1f.js"), true ? __vite__mapDeps([0,1]) : void 0));
