const __vite__fileDeps=["assets/chunks/VPLocalSearchBox.CM-kcfCX.js","assets/chunks/framework.DyMmIvSC.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CM-kcfCX.js"), true ? __vite__mapDeps([0,1]) : void 0));
