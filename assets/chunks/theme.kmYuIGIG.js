const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.B2w9Zvbr.js","assets/chunks/framework.Cauyuiy8.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.B2w9Zvbr.js"), true ? __vite__mapDeps([0,1]) : void 0));
