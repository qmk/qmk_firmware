...
const __pageData = JSON.parse('{"title":"Key Lock","description":"","frontmatter":{},"headers":[],"relativePath":"feature_key_lock.md","filePath":"feature_key_lock.md"}');
const _sfc_main = { name: "feature_key_lock.md" };
...
const feature_key_lock = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  __pageData,
  feature_key_lock as default
};
