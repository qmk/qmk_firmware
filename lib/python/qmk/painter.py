...
if can_import_deps:  # noqa: Conditional based on module presence
    ...
    def missing_deps_warning(cli):
        cli.log.error("Quantum Painter requires the pillow python module to be installed.")
        cli.log.info("Please refer to the installation documentation here and try again:")
        cli.log.info("    https://pillow.readthedocs.io/en/latest/installation.html")
