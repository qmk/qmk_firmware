...
@cli.argument('-j', '--parallel', type=int, help="Set the number of parallel make jobs to run.")
...
def flash(cli):
    ...
    if cli.args.filename:
        ...
        user_keymap = parse_configurator_json(cli.args.filename, parallel=cli.config.flash.parallel if cli.config.flash.parallel else 1)
        ...
        if cli.config.flash.keyboard and cli.config.flash.keymap:
            ...
            command = create_make_command(cli.config.flash.keyboard, cli.config.flash.keymap, cli.args.bootloader, parallel=cli.config.flash.parallel if cli.config.flash.parallel else 1, **envs)
