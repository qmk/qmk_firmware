    ...
    if is_keyboard(cli.config.via_keymap.keyboard):
        try:
            ...
            try:
                ...
                json_content = { 'name': config_h['name'], 'vendorId': config_h['vid'], 'productId': config_h['pid'], 'lighting': { 'extends': 'none' }, 'matrix': { 'rows': config_h['rows'], 'cols': config_h['cols'] }, 'layout': { 'keymap': ["https://caniusevia.com/docs/layouts"] }}
