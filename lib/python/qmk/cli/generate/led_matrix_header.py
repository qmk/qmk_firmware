###
# Generates an LED Matrix header file with all available effects to disable.
...
@cli.argument('-i', '--input', arg_only=True, type=normpath, default=LED_MATRIX_FOLDER, help='The input folder to scan')
@cli.argument('-o', '--output', arg_only=True, type=normpath, default=LED_MATRIX_HEADER, help='The output file to write to')
@cli.argument('-q', '--quiet', arg_only=True, action='store_true', help="Quiet mode, only output error messages")
@cli.subcommand('Generates an Led Matrix header file with all available effects to disable.')
def generate_led_matrix_header(cli):
