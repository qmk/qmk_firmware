...
def is_data_driven(keyboard):
    """Detect if a given keyboard is doing data driven
    """
    # Build the info.json file
    kb_info_json = info_json(keyboard)

    using_data_driven = False
    for layout_name in kb_info_json['layouts']:
        ...
        using_data_driven = True

    return using_data_driven
...
def generate_keyboard_h(cli):
    ...
    using_data_driven = is_data_driven(cli.config.generate_keyboard_h.keyboard)
    ...
    if using_data_driven:
        keyboard_h_lines.append('#include "layouts.h"')
    else:
