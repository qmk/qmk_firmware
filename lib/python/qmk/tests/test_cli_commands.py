...
def test_compile_json():
    result = check_subcommand('compile', 'keyboards/handwired/onekey/keymaps/default_json/keymap.json')
    check_returncode(result)


def test_compile_json_encoder():
    check_subcommand('compile', 'keyboards/handwired/onekey/keymaps/encodertest/keymap.json')
    check_returncode(result)
