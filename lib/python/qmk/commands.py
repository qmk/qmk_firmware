...
def scan_keymap(layers):
    ...
    special = {}
    special = {'MOUSE_ENABLE': 'no', 'BACKLIGHT_ENABLE': 'no', 'UCIS_ENABLE': 'no', 'EXTRAKEY_ENABLE': 'no'}
...
def special_keys(kc):
    ...
    switcher = {
        ...
        'UC_M_BS': ['UCIS_ENABLE'],
        'UC_M_WC': ['UCIS_ENABLE'],
        'KC_PWR': ['EXTRAKEY_ENABLE'],
        'KC_SLEP': ['EXTRAKEY_ENABLE'],
        'KC_WAKE': ['EXTRAKEY_ENABLE'],
        'KC_MUTE': ['EXTRAKEY_ENABLE'],
        'KC_VOLU': ['EXTRAKEY_ENABLE'],
        'KC_VOLD': ['EXTRAKEY_ENABLE'],
        'KC_MNXT': ['EXTRAKEY_ENABLE'],
        'KC_MPRV': ['EXTRAKEY_ENABLE'],
        'KC_MSTP': ['EXTRAKEY_ENABLE'],
        'KC_MPLY': ['EXTRAKEY_ENABLE'],
        'KC_EJCT': ['EXTRAKEY_ENABLE'],
        'KC_CALC': ['EXTRAKEY_ENABLE'],
        'KC_MYCM': ['EXTRAKEY_ENABLE'],
        'KC_WSCH': ['EXTRAKEY_ENABLE'],
        'KC_WHOM': ['EXTRAKEY_ENABLE'],
        'KC_WBAK': ['EXTRAKEY_ENABLE'],
        'KC_WFWD': ['EXTRAKEY_ENABLE'],
        'KC_WSTP': ['EXTRAKEY_ENABLE'],
        'KC_WREF': ['EXTRAKEY_ENABLE'],
        'KC_WFAV': ['EXTRAKEY_ENABLE'],
        'KC_MFFD': ['EXTRAKEY_ENABLE'],
        'KC_MRWD': ['EXTRAKEY_ENABLE'],
        'KC_BRIU': ['EXTRAKEY_ENABLE'],
        'KC_BRID': ['EXTRAKEY_ENABLE'],
    }
