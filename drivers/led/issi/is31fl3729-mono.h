...
#define SSP_DISABLE (0b0 << 4)
#define SSP_ENABLE (0b1 << 4)

#define RNG_5 (0b00 << 2)
#define RNG_15 (0b01 << 2)
#define RNG_24 (0b10 << 2)
#define RNG_34 (0b11 << 2)

#define CLT_1980 0b00
#define CLT_1200 0b01
#define CLT_820 0b10
#define CLT_660 0b11

/* Disabled SSP */
#define IS31FL3729_SSP_DISABLE SSP_DISABLE

/* SSP 5 percent range */
#define IS31FL3729_SSP_5_1980US (SSP_ENABLE | RNG_5 | CLT_1980)
#define IS31FL3729_SSP_5_1200US (SSP_ENABLE | RNG_5 | CLT_1200)
#define IS31FL3729_SSP_5_820US (SSP_ENABLE | RNG_5 | CLT_820)
#define IS31FL3729_SSP_5_660US (SSP_ENABLE | RNG_5 | CLT_660)

/* SSP 15 percent range */
#define IS31FL3729_SSP_15_1980US (SSP_ENABLE | RNG_15 | CLT_1980)
#define IS31FL3729_SSP_15_1200US (SSP_ENABLE | RNG_15 | CLT_1200)
#define IS31FL3729_SSP_15_820US (SSP_ENABLE | RNG_15 | CLT_820)
#define IS31FL3729_SSP_15_660US (SSP_ENABLE | RNG_15 | CLT_660)

/* SSP 24 percent range */
#define IS31FL3729_SSP_24_1980US (SSP_ENABLE | RNG_24 | CLT_1980)
#define IS31FL3729_SSP_24_1200US (SSP_ENABLE | RNG_24 | CLT_1200)
#define IS31FL3729_SSP_24_820US (SSP_ENABLE | RNG_24 | CLT_820)
#define IS31FL3729_SSP_24_660US (SSP_ENABLE | RNG_24 | CLT_660)

/* SSP 34 percent range */
#define IS31FL3729_SSP_34_1980US (SSP_ENABLE | RNG_34 | CLT_1980)
#define IS31FL3729_SSP_34_1200US (SSP_ENABLE | RNG_34 | CLT_1200)
#define IS31FL3729_SSP_34_820US (SSP_ENABLE | RNG_34 | CLT_820)
#define IS31FL3729_SSP_34_660US (SSP_ENABLE | RNG_34 | CLT_660)
