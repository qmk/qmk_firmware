...
#ifndef IS31FL3742A_SW_PULLUP
#    define IS31FL3742A_SW_PULLUP IS31FL3742A_PUR_8K_OHM
#endif

#ifndef IS31FL3742A_CS_PULLDOWN
#    define IS31FL3742A_CS_PULLDOWN IS31FL3742A_PDR_8K_OHM
#endif
...
void is31fl3742a_init(uint8_t addr) {
    ...
    is31fl3742a_write_register(addr, IS31FL3742A_FUNCTION_REG_PULLDOWNUP, (IS31FL3742A_CS_PULLDOWN << 4) | IS31FL3742A_SW_PULLUP);
