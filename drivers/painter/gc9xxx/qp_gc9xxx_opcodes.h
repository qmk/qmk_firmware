...
#define GC9XXX_SET_VSCROLL 0x33             // Set vertical scroll MSB(TFA),LSB(TFA),MSB(VSA),LSB(VSA),MSB(BFA),LSB(BFA)
...
#define GC9XXX_SET_TEAR_SCANLINE 0x44       // Set tearing scanline (ScanLine[7:0])
#define GC9XXX_GET_TEAR_SCANLINE 0x45       // Get tearing scanline (ScanLine[7:0])
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// MADCTL Flags
#define GC9XXX_MADCTL_MY 0b10000000
#define GC9XXX_MADCTL_MX 0b01000000
#define GC9XXX_MADCTL_MV 0b00100000
#define GC9XXX_MADCTL_ML 0b00010000
#define GC9XXX_MADCTL_RGB 0b00000000
#define GC9XXX_MADCTL_BGR 0b00001000
#define GC9XXX_MADCTL_MH 0b00000100
