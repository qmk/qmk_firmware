...
#define GC9107_PIXEL_FORMAT_12_BPP 0x01 // 12 bits per pixel
#define GC9107_PIXEL_FORMAT_16_BPP 0x05 // 16 bits per pixel
#define GC9107_PIXEL_FORMAT_18_BPP 0x06 // 18 bits per pixel
//      Parameter values for
