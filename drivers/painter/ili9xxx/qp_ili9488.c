...
__attribute__((weak)) bool qp_ili9488_init(painter_device_t device, painter_rotation_t rotation) {
    ...
    const uint8_t madctl[] = {
        ...
        [QP_ROTATION_0]   = ILI9XXX_MADCTL_RGB | ILI9XXX_MADCTL_MY,
        [QP_ROTATION_90]  = ILI9XXX_MADCTL_RGB | ILI9XXX_MADCTL_MX | ILI9XXX_MADCTL_MV | ILI9XXX_MADCTL_MY,
        [QP_ROTATION_180] = ILI9XXX_MADCTL_RGB | ILI9XXX_MADCTL_MX,
        [QP_ROTATION_270] = ILI9XXX_MADCTL_RGB | ILI9XXX_MADCTL_MV
