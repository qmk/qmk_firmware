...
[_QW] = { /* Qwerty */
  ...
  {M(0),    KC_LCTL, KC_LALT, KC_LGUI, MO(_LW), KC_SPC,  LT(_MK,KC_SPC),  MO(_RS), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
[_CM] = { /* Colemak */
...
[_MK] = { /* Mouse Keys */
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_BTN1,   KC_MS_UP,  KC_MS_BTN2, KC_TRNS, KC_TRNS},
