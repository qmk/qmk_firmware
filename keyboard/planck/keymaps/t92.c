...
{MO(4), KC_LGUI, KC_LALT, KC_BSLS, MO(1),    KC_SPC    ,   MO(2),  KC_QUOT, KC_LBRC, KC_RBRC, KC_RALT}
    },
   /* 1: Lower layer
 * ,-----------------------------------------------------------------------.
...
{KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_SPC     , KC_TRNS, KC_END,KC_LEFT,KC_DOWN,KC_RIGHT}
    },
  /* 2: Upper layer
 * ,-----------------------------------------------------------------------.
 * |  ~  |  !  |  @  |  #  |  $  |  %  |  ^  |  &  |  *  |  (  |  )  |  BS |
...
{KC_TRNS,LGUI(LCTL(KC_LEFT)),LGUI(LCTL(KC_RIGHT)),LGUI(LCTL(KC_F4)),LCTL(LALT(KC_DELT)),LGUI(KC_SPC) ,KC_TRNS,KC_END,KC_LEFT,KC_DOWN,KC_RIGHT}
    }
};
