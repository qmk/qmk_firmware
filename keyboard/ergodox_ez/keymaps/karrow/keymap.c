 ...
 * |--------+------+------+------+------+------|  (   |           |   )  |------+------+------+------+------+--------|
 * |CAP LOCK|  A   |  S   |  D   |  F   |  G   |------|           |------|  H   |  J   |  K   |  L   | ;  : | ' /CTRL|
 * |--------+------+------+------+------+------|TOGGLE|           |TOGGLE|------+------+------+------+------+--------|
 * |TEMP SYM|  Z   |  X   |  C   |  V   |  B   |LAY 1 |           |LAY 2 |  N   |  M   | ,  < | .  > |  UP  | /    ? |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | CTRL | HOME | END  | P UP |P DOWN|                                       | [  { | ]  } | LEFT | DOWN |RIGHT |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        |CMD WD|ALT   |       |INSERT| DELETE |
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      |CTRL  |       |AltShf|        |      |
 ...
 */
 ...
 [BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_FN1,  KC_Z,    KC_X,   KC_C,   KC_V,   KC_B, TG(SYMB),
        KC_LCTL, KC_HOME, KC_END, KC_PGUP,KC_PGDN,
 ...
 */
 [SYMB] = KEYMAP(
       ...
       KC_COMM, KC_QUOT, LSFT(KC_QUOT), KC_LCBR, KC_RCBR, KC_SCLN,
       KC_TRNS, KC_BSLS, KC_AMPR,       KC_LBRC, KC_RBRC, LSFT(KC_SLSH), KC_TRNS,
       KC_F12,  KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS,
