...
[SYMB] = KEYMAP(
       ...
       KC_TRNS,KC_TRNS,KC_TRNS,DE_EXLM,DE_QST,KC_TRNS,KC_TRNS,
       KC_TRNS,DE_HASH,DE_DLR, DE_BSLS,DE_SLSH,KC_DOT,
       KC_TRNS,KC_TRNS,DE_CIRC,DE_PERC,DE_PIPE,DE_TILD,KC_TRNS,
       ...
       KC_TRNS, DE_AMPR, DE_LESS,   DE_MORE,    DE_DQOT,    DE_QUOT, DE_QST,
