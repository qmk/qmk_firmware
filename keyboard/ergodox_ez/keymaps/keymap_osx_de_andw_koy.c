...
/* Keymap 3: ANDW-Koy layer
 * ANDW-Koy is a special layout designed to be ergonomic. Was created using software to determine the most ergonomic way to type German and English texts.
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [2] = ACTION_LAYER_TAP_TOGGLE(ANDW)                // FN2 - Momentary Layer 2 (ANDW)
};
