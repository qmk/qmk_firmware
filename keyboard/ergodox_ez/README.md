...
3. [Set up a build environment](https://www.pjrc.com/teensy/gcc.html) (on a mac and have [homebrew](http://brew.sh/)? just run `brew tap osx-cross/avr && brew install avr-libc`)
